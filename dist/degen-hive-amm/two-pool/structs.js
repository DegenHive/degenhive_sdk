...
const structs_6 = require("../../degen-hive-dex-config/config/structs");
const structs_7 = require("../../degen-hive-dex-math/curved-math/structs");
const structs_8 = require("../../degen-hive-dex-math/stable-math/structs");
const structs_9 = require("../../degen-hive-dex-math/weighted-math/structs");
const reified_1 = require("../../_framework/reified");
const __1 = require("..");
const PUBLISHED_AT = __1.twopool.PUBLISHED_AT;
const PKG_V1 = __1.twopool.PKG_V1;
/* ============================== CollectedFeeForPool =============================== */
function isCollectedFeeForPool(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${PKG_V1}::two_pool::CollectedFeeForPool` + '<'); }
...
CollectedFeeForPool.$typeName = `${PKG_V1}::two_pool::CollectedFeeForPool`;
...
/* ============================== HarvestedDegenSui =============================== */
function isHarvestedDegenSui(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${PKG_V1}::two_pool::HarvestedDegenSui` + '<'); }
...
HarvestedDegenSui.$typeName = `${PKG_V1}::two_pool::HarvestedDegenSui`;
...
function isSUI_BEE_Pool_Krafted(type) { type = (0, util_1.compressSuiType)(type); return type === `${PKG_V1}::two_pool::SUI_BEE_Pool_Krafted`; }
...
SUI_BEE_Pool_Krafted.$typeName = `${PKG_V1}::two_pool::SUI_BEE_Pool_Krafted`;
SUI_BEE_Pool_Krafted.$numTypeParams = 0;
SUI_BEE_Pool_Krafted.$isPhantom = [];
/* ============================== SUI_HIVE_Pool_Krafted =============================== */
function isSUI_HIVE_Pool_Krafted(type) { type = (0, util_1.compressSuiType)(type); return type === `${PKG_V1}::two_pool::SUI_HIVE_Pool_Krafted`; }
...
SUI_HIVE_Pool_Krafted.$typeName = `${PKG_V1}::two_pool::SUI_HIVE_Pool_Krafted`;

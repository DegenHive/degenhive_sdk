...
/* ============================== CurvedPoolConfig =============================== */
function isCurvedPoolConfig(type) { type = (0, util_1.compressSuiType)(type); return type === `${PKG_V1}::curved_math::CurvedPoolConfig`; }
class CurvedPoolConfig {
    ...
    static fromSuiObjectData(data) {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isCurvedPoolConfig(data.bcs.type)) {
                throw new Error(`object at is not a CurvedPoolConfig object`);
            }
            return CurvedPoolConfig.fromBcs((0, bcs_1.fromB64)(data.bcs.bcsBytes));
        }
        if (data.content) {
            return CurvedPoolConfig.fromSuiParsedData(data.content);
        }
...
CurvedPoolConfig.$typeName = `${PKG_V1}::curved_math::CurvedPoolConfig`;

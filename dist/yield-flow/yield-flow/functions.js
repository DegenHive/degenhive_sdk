...
function addBalanceToPoolFlow(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::add_balance_to_pool_flow`, arguments: [(0, util_1.obj)(tx, args.yieldFlow), (0, util_1.pure)(tx, args.poolAddr, `address`), (0, util_1.obj)(tx, args.hiveBalance), (0, util_1.obj)(tx, args.honeyBalance)], }); }
function addNewThreepoolFlow(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::add_new_threepool_flow`, arguments: [(0, util_1.obj)(tx, args.yieldFlow), (0, util_1.obj)(tx, args.cap), (0, util_1.pure)(tx, args.poolAddr, `address`)], }); }
function addNewTwoPoolFlow(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::add_new_two_pool_flow`, arguments: [(0, util_1.obj)(tx, args.yieldFlow), (0, util_1.obj)(tx, args.cap), (0, util_1.pure)(tx, args.poolAddr, `address`)], }); }
function addStableIdentifier(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::add_stable_identifier`, arguments: [(0, util_1.obj)(tx, args.yieldFlow), (0, util_1.obj)(tx, args.dragonDaoCap), (0, util_1.pure)(tx, args.typeNameIdentifier, `${structs_1.String.$typeName}`)], }); }
function addToTreasury(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::add_to_treasury`, arguments: [(0, util_1.obj)(tx, args.yieldFlow), (0, util_1.obj)(tx, args.balanceSui)], }); }
function claimFeesFromPoolFlow(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::claim_fees_from_pool_flow`, arguments: [(0, util_1.obj)(tx, args.yieldFlow), (0, util_1.obj)(tx, args.dragonFoodCap), (0, util_1.pure)(tx, args.poolAddr, `address`)], }); }
...
function depositHoneyToBurn(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::deposit_honey_to_burn`, arguments: [(0, util_1.obj)(tx, args.yieldFlow), (0, util_1.obj)(tx, args.balanceBee)], }); }
function entryAddToTreasury(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::entry_add_to_treasury`, arguments: [(0, util_1.obj)(tx, args.yieldFlow), (0, util_1.obj)(tx, args.coinX), (0, util_1.pure)(tx, args.amtToDeposit, `u64`)], }); }
...
function getAllPoolFlowBalances(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::get_all_pool_flow_balances`, arguments: [(0, util_1.obj)(tx, args.yieldFlow), (0, util_1.pure)(tx, args.startFrom, `${structs_2.Option.$typeName}<address>`), (0, util_1.pure)(tx, args.limit, `u64`)], }); }
...
function getDecimalsForCoinType(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::get_decimals_for_coin_type`, arguments: [(0, util_1.obj)(tx, args.yieldFlow), (0, util_1.obj)(tx, args.token)], }); }
function getFeeAvailableForPool(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::get_fee_available_for_pool`, arguments: [(0, util_1.obj)(tx, args.yieldFlow), (0, util_1.pure)(tx, args.poolAddr, `address`)], }); }
...
function queryAmmFeeCollectors(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::query_amm_fee_collectors`, arguments: [(0, util_1.obj)(tx, args.yieldFlow), (0, util_1.pure)(tx, args.startFrom, `${structs_2.Option.$typeName}<${structs_1.String.$typeName}>`), (0, util_1.pure)(tx, args.limit, `u64`)], }); }
function queryPrecisionsForCoinTypes(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::query_precisions_for_coin_types`, arguments: [(0, util_1.obj)(tx, args.yieldFlow), (0, util_1.pure)(tx, args.startFrom, `${structs_2.Option.$typeName}<${structs_3.String.$typeName}>`), (0, util_1.pure)(tx, args.limit, `u64`)], }); }
function queryStableIdentifiers(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::query_stable_identifiers`, arguments: [(0, util_1.obj)(tx, args.yieldFlow), (0, util_1.pure)(tx, args.startFrom, `${structs_2.Option.$typeName}<${structs_1.String.$typeName}>`), (0, util_1.pure)(tx, args.limit, `u64`)], }); }
function releaseSuiFromTreasury(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::release_sui_from_treasury`, arguments: [(0, util_1.obj)(tx, args.dragonDaoCap), (0, util_1.obj)(tx, args.yieldFlow), (0, util_1.pure)(tx, args.amt, `u64`), (0, util_1.pure)(tx, args.recepient, `address`)], }); }
function releaseSuiFromTreasuryForBet(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::release_sui_from_treasury_for_bet`, arguments: [(0, util_1.obj)(tx, args.cap), (0, util_1.obj)(tx, args.yieldFlow), (0, util_1.pure)(tx, args.amt, `u64`)], }); }
function removeStableIdentifier(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::remove_stable_identifier`, arguments: [(0, util_1.obj)(tx, args.yieldFlow), (0, util_1.obj)(tx, args.dragonDaoCap), (0, util_1.pure)(tx, args.typeNameIdentifier, `${structs_1.String.$typeName}`)], }); }
function updateDefaultFeeForCurve(tx, typeArg, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::update_default_fee_for_curve`, typeArguments: [typeArg], arguments: [(0, util_1.obj)(tx, args.yieldFlow), (0, util_1.obj)(tx, args.dragonDaoCap), (0, util_1.pure)(tx, args.totalFeeBps, `u64`), (0, util_1.pure)(tx, args.beesFeePct, `u64`)], }); }
...
function updateYieldFlowConfigPct(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::update_yield_flow_config_pct`, arguments: [(0, util_1.obj)(tx, args.yieldFlow), (0, util_1.obj)(tx, args.dragonDaoCap), (0, util_1.pure)(tx, args.newTreasuryPercent, `u64`), (0, util_1.pure)(tx, args.newHoneyBuybackPct, `u64`), (0, util_1.pure)(tx, args.newVoterIncentivesPct, `u64`)], }); }
function whitelistDecimalPrecisions(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::whitelist_decimal_precisions`, arguments: [(0, util_1.obj)(tx, args.yieldFlow), (0, util_1.obj)(tx, args.dragonDaoCap), (0, util_1.pure)(tx, args.coinTypes, `vector<${structs_3.String.$typeName}>`), (0, util_1.pure)(tx, args.decimalPrecisions, `vector<u8>`)], }); }
function withdrawHoneyToBurn(tx, args) { return tx.moveCall({ target: `${PUBLISHED_AT}::yield_flow::withdraw_honey_to_burn`, arguments: [(0, util_1.obj)(tx, args.yieldFlow), (0, util_1.obj)(tx, args.cap)], }); }

...
class TxContext {
    ...
    static get bcs() {
        return bcs_1.bcs.struct("TxContext", {
            sender: bcs_1.bcs.bytes(32).transform({ input: (val) => (0, bcs_1.fromHEX)(val), output: (val) => (0, bcs_1.toHEX)(val), }), tx_hash: bcs_1.bcs.vector(bcs_1.bcs.u8()), epoch: bcs_1.bcs.u64(), epoch_timestamp_ms: bcs_1.bcs.u64(), ids_created: bcs_1.bcs.u64()
        });
    }
    ;

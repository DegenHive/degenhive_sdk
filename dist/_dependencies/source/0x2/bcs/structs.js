...
class BCS {
    ...
    static reified() { return { typeName: BCS.$typeName, fullTypeName: (0, util_1.composeSuiType)(BCS.$typeName, ...[]), typeArgs: [], reifiedTypeArgs: [], fromFields: (fields) => BCS.fromFields(fields), fromFieldsWithTypes: (item) => BCS.fromFieldsWithTypes(item), fromBcs: (data) => BCS.fromBcs(data), bcs: BCS.bcs, fromJSONField: (field) => BCS.fromJSONField(field), fromJSON: (json) => BCS.fromJSON(json), fromSuiParsedData: (content) => BCS.fromSuiParsedData(content), fetch: async (client, id) => BCS.fetch(client, id), new: (fields) => { return new BCS([], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, id) {
        ...
        return BCS.fromBcs((0, bcs_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.BCS = BCS;
BCS.$typeName = "0x2::bcs::BCS";
BCS.$numTypeParams = 0;

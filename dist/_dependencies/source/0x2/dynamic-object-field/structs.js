...
/* ============================== Wrapper =============================== */
function isWrapper(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V28}::dynamic_object_field::Wrapper` + '<'); }
class Wrapper {
    ...
    static fromSuiObjectData(typeArg, data) {
        if (data.bcs) {
            ...
            ;
            return Wrapper.fromBcs(typeArg, (0, bcs_1.fromB64)(data.bcs.bcsBytes));
        }
        if (data.content) {
...
Wrapper.$typeName = `${index_1.PKG_V28}::dynamic_object_field::Wrapper`;

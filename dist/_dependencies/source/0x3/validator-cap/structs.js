...
class UnverifiedValidatorOperationCap {
    ...
    static get bcs() {
        return bcs_1.bcs.struct("UnverifiedValidatorOperationCap", {
            id: structs_1.UID.bcs, authorizer_validator_address: bcs_1.bcs.bytes(32).transform({ input: (val) => (0, bcs_1.fromHEX)(val), output: (val) => (0, bcs_1.toHEX)(val), })
        });
    }
    ;
...
class ValidatorOperationCap {
    ...
    static get bcs() {
        return bcs_1.bcs.struct("ValidatorOperationCap", {
            authorizer_validator_address: bcs_1.bcs.bytes(32).transform({ input: (val) => (0, bcs_1.fromHEX)(val), output: (val) => (0, bcs_1.toHEX)(val), })
        });
    }
    ;

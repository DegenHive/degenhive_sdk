...
class CurvedPoolConfig {
    ...
    static async fetch(client, id) {
        ...
        return CurvedPoolConfig.fromBcs((0, bcs_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.CurvedPoolConfig = CurvedPoolConfig;
CurvedPoolConfig.$typeName = "0x8dedf746c2648f520827d9a31604b86269afd0a4273b37b296742202ccfc306f::curved_math::CurvedPoolConfig";

...
/* ============================== HiveGemKraftCap =============================== */
function isHiveGemKraftCap(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::hive_gems::HiveGemKraftCap`; }
class HiveGemKraftCap {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
        this.$typeName = HiveGemKraftCap.$typeName;
        this.$isPhantom = HiveGemKraftCap.$isPhantom;
    ...
    static async fetch(client, id) {
        ...
        return HiveGemKraftCap.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.HiveGemKraftCap = HiveGemKraftCap;
HiveGemKraftCap.$typeName = `${index_1.PKG_V1}::hive_gems::HiveGemKraftCap`;
HiveGemKraftCap.$numTypeParams = 0;
HiveGemKraftCap.$isPhantom = [];
/* ============================== HiveGems =============================== */
function isHiveGems(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::hive_gems::HiveGems`; }
class HiveGems {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
        this.$typeName = HiveGems.$typeName;
        this.$isPhantom = HiveGems.$isPhantom;
        this.$fullTypeName = (0, util_1.composeSuiType)(HiveGems.$typeName, ...typeArgs);
        this.$typeArgs = typeArgs;
        this.value = fields.value;
    }
    static reified() { return { typeName: HiveGems.$typeName, fullTypeName: (0, util_1.composeSuiType)(HiveGems.$typeName, ...[]), typeArgs: [], isPhantom: HiveGems.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => HiveGems.fromFields(fields), fromFieldsWithTypes: (item) => HiveGems.fromFieldsWithTypes(item), fromBcs: (data) => HiveGems.fromBcs(data), bcs: HiveGems.bcs, fromJSONField: (field) => HiveGems.fromJSONField(field), fromJSON: (json) => HiveGems.fromJSON(json), fromSuiParsedData: (content) => HiveGems.fromSuiParsedData(content), fetch: async (client, id) => HiveGems.fetch(client, id), new: (fields) => { return new HiveGems([], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, id) {
        ...
        return HiveGems.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.HiveGems = HiveGems;
HiveGems.$typeName = `${index_1.PKG_V1}::hive_gems::HiveGems`;
HiveGems.$numTypeParams = 0;
HiveGems.$isPhantom = [];
/* ============================== HiveGemsBurnt =============================== */
function isHiveGemsBurnt(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::hive_gems::HiveGemsBurnt`; }
class HiveGemsBurnt {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
        this.$typeName = HiveGemsBurnt.$typeName;
        this.$isPhantom = HiveGemsBurnt.$isPhantom;
        this.$fullTypeName = (0, util_1.composeSuiType)(HiveGemsBurnt.$typeName, ...typeArgs);
        this.$typeArgs = typeArgs;
        this.value = fields.value;
    }
    static reified() { return { typeName: HiveGemsBurnt.$typeName, fullTypeName: (0, util_1.composeSuiType)(HiveGemsBurnt.$typeName, ...[]), typeArgs: [], isPhantom: HiveGemsBurnt.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => HiveGemsBurnt.fromFields(fields), fromFieldsWithTypes: (item) => HiveGemsBurnt.fromFieldsWithTypes(item), fromBcs: (data) => HiveGemsBurnt.fromBcs(data), bcs: HiveGemsBurnt.bcs, fromJSONField: (field) => HiveGemsBurnt.fromJSONField(field), fromJSON: (json) => HiveGemsBurnt.fromJSON(json), fromSuiParsedData: (content) => HiveGemsBurnt.fromSuiParsedData(content), fetch: async (client, id) => HiveGemsBurnt.fetch(client, id), new: (fields) => { return new HiveGemsBurnt([], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, id) {
        ...
        return HiveGemsBurnt.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.HiveGemsBurnt = HiveGemsBurnt;
HiveGemsBurnt.$typeName = `${index_1.PKG_V1}::hive_gems::HiveGemsBurnt`;
HiveGemsBurnt.$numTypeParams = 0;
HiveGemsBurnt.$isPhantom = [];

...
const structs_2 = require("../../0x2/vec-map/structs");
const index_1 = require("../index");
const bcs_1 = require("@mysten/sui/bcs");
const utils_1 = require("@mysten/sui/utils");
/* ============================== BEE =============================== */
function isBEE(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::bee::BEE`; }
class BEE {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
        this.$typeName = BEE.$typeName;
        this.$isPhantom = BEE.$isPhantom;
        this.$fullTypeName = (0, util_1.composeSuiType)(BEE.$typeName, ...typeArgs);
        this.$typeArgs = typeArgs;
        this.dummyField = fields.dummyField;
    }
    static reified() { return { typeName: BEE.$typeName, fullTypeName: (0, util_1.composeSuiType)(BEE.$typeName, ...[]), typeArgs: [], isPhantom: BEE.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => BEE.fromFields(fields), fromFieldsWithTypes: (item) => BEE.fromFieldsWithTypes(item), fromBcs: (data) => BEE.fromBcs(data), bcs: BEE.bcs, fromJSONField: (field) => BEE.fromJSONField(field), fromJSON: (json) => BEE.fromJSON(json), fromSuiParsedData: (content) => BEE.fromSuiParsedData(content), fetch: async (client, id) => BEE.fetch(client, id), new: (fields) => { return new BEE([], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, id) {
        ...
        return BEE.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.BEE = BEE;
BEE.$typeName = `${index_1.PKG_V1}::bee::BEE`;
BEE.$numTypeParams = 0;
BEE.$isPhantom = [];
/* ============================== BeesTransferred =============================== */
function isBeesTransferred(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::bee::BeesTransferred`; }
class BeesTransferred {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
        this.$typeName = BeesTransferred.$typeName;
        this.$isPhantom = BeesTransferred.$isPhantom;
    ...
    static get bcs() {
        return bcs_1.bcs.struct("BeesTransferred", {
            bees_to_transfer: bcs_1.bcs.u64(), receipient: bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), }), bees_burnt: bcs_1.bcs.u64()
        });
    }
    ;
    ...
    static async fetch(client, id) {
        ...
        return BeesTransferred.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.BeesTransferred = BeesTransferred;
BeesTransferred.$typeName = `${index_1.PKG_V1}::bee::BeesTransferred`;
BeesTransferred.$numTypeParams = 0;
BeesTransferred.$isPhantom = [];
/* ============================== BeesUnwrappedToCoin =============================== */
function isBeesUnwrappedToCoin(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::bee::BeesUnwrappedToCoin`; }
class BeesUnwrappedToCoin {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
        this.$typeName = BeesUnwrappedToCoin.$typeName;
        this.$isPhantom = BeesUnwrappedToCoin.$isPhantom;
    ...
    static reified() { return { typeName: BeesUnwrappedToCoin.$typeName, fullTypeName: (0, util_1.composeSuiType)(BeesUnwrappedToCoin.$typeName, ...[]), typeArgs: [], isPhantom: BeesUnwrappedToCoin.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => BeesUnwrappedToCoin.fromFields(fields), fromFieldsWithTypes: (item) => BeesUnwrappedToCoin.fromFieldsWithTypes(item), fromBcs: (data) => BeesUnwrappedToCoin.fromBcs(data), bcs: BeesUnwrappedToCoin.bcs, fromJSONField: (field) => BeesUnwrappedToCoin.fromJSONField(field), fromJSON: (json) => BeesUnwrappedToCoin.fromJSON(json), fromSuiParsedData: (content) => BeesUnwrappedToCoin.fromSuiParsedData(content), fetch: async (client, id) => BeesUnwrappedToCoin.fetch(client, id), new: (fields) => { return new BeesUnwrappedToCoin([], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, id) {
        ...
        return BeesUnwrappedToCoin.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.BeesUnwrappedToCoin = BeesUnwrappedToCoin;
BeesUnwrappedToCoin.$typeName = `${index_1.PKG_V1}::bee::BeesUnwrappedToCoin`;
BeesUnwrappedToCoin.$numTypeParams = 0;
BeesUnwrappedToCoin.$isPhantom = [];
/* ============================== Burn =============================== */
function isBurn(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::bee::Burn`; }
class Burn {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
        this.$typeName = Burn.$typeName;
        this.$isPhantom = Burn.$isPhantom;
        this.$fullTypeName = (0, util_1.composeSuiType)(Burn.$typeName, ...typeArgs);
        this.$typeArgs = typeArgs;
        this.dummyField = fields.dummyField;
    }
    static reified() { return { typeName: Burn.$typeName, fullTypeName: (0, util_1.composeSuiType)(Burn.$typeName, ...[]), typeArgs: [], isPhantom: Burn.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => Burn.fromFields(fields), fromFieldsWithTypes: (item) => Burn.fromFieldsWithTypes(item), fromBcs: (data) => Burn.fromBcs(data), bcs: Burn.bcs, fromJSONField: (field) => Burn.fromJSONField(field), fromJSON: (json) => Burn.fromJSON(json), fromSuiParsedData: (content) => Burn.fromSuiParsedData(content), fetch: async (client, id) => Burn.fetch(client, id), new: (fields) => { return new Burn([], fields); }, kind: "StructClassReified", }; }
...
class BurnCondition {
    ...
    static async fetch(client, id) {
        ...
        return BurnCondition.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.BurnCondition = BurnCondition;
BurnCondition.$typeName = `${index_1.PKG_V1}::bee::BurnCondition`;
BurnCondition.$numTypeParams = 0;
BurnCondition.$isPhantom = [];

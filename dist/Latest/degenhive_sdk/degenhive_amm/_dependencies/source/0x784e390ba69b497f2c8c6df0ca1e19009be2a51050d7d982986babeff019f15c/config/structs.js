...
exports.TwoAmmFeeClaimCapability = exports.TreasuryResourcesDistributed = exports.TreasuryPercentUpdated = exports.Treasury = exports.ThreeAmmFeeClaimCapability = exports.StableIdentifierRemoved = exports.StableIdentifierAdded = exports.PoolHiveCapability = exports.NewFeeCollectorKrafted = exports.HiveEntryCap = exports.HiveDaoCapability = exports.FeeInfo = exports.FeeExtractedForCoin = exports.FeeCollector = exports.FeeCollectedForCoin = exports.DegenHiveDeployerCap = exports.DefaultFeeSet = exports.DecimalPrecisionForCoinTypesWhitelisted = exports.BuidlersRoyaltyCollectionAbility = exports.Config = void 0;
...
exports.isPoolHiveCapability = isPoolHiveCapability;
...
/* ============================== Config =============================== */
function isConfig(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::config::Config`; }
class Config {
    ...
    static reified() { return { typeName: Config.$typeName, fullTypeName: (0, util_1.composeSuiType)(Config.$typeName, ...[]), typeArgs: [], isPhantom: Config.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => Config.fromFields(fields), fromFieldsWithTypes: (item) => Config.fromFieldsWithTypes(item), fromBcs: (data) => Config.fromBcs(data), bcs: Config.bcs, fromJSONField: (field) => Config.fromJSONField(field), fromJSON: (json) => Config.fromJSON(json), fromSuiParsedData: (content) => Config.fromSuiParsedData(content), fetch: async (client, id) => Config.fetch(client, id), new: (fields) => { return new Config([], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, id) {
        ...
        return Config.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Config = Config;
Config.$typeName = `${index_1.PKG_V1}::config::Config`;
Config.$numTypeParams = 0;
Config.$isPhantom = [];
/* ============================== BuidlersRoyaltyCollectionAbility =============================== */
function isBuidlersRoyaltyCollectionAbility(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::config::BuidlersRoyaltyCollectionAbility`; }
class BuidlersRoyaltyCollectionAbility {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
        this.$typeName = BuidlersRoyaltyCollectionAbility.$typeName;
        this.$isPhantom = BuidlersRoyaltyCollectionAbility.$isPhantom;
        this.$fullTypeName = (0, util_1.composeSuiType)(BuidlersRoyaltyCollectionAbility.$typeName, ...typeArgs);
        this.$typeArgs = typeArgs;
        this.id = fields.id;
    }
    static reified() { return { typeName: BuidlersRoyaltyCollectionAbility.$typeName, fullTypeName: (0, util_1.composeSuiType)(BuidlersRoyaltyCollectionAbility.$typeName, ...[]), typeArgs: [], isPhantom: BuidlersRoyaltyCollectionAbility.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => BuidlersRoyaltyCollectionAbility.fromFields(fields), fromFieldsWithTypes: (item) => BuidlersRoyaltyCollectionAbility.fromFieldsWithTypes(item), fromBcs: (data) => BuidlersRoyaltyCollectionAbility.fromBcs(data), bcs: BuidlersRoyaltyCollectionAbility.bcs, fromJSONField: (field) => BuidlersRoyaltyCollectionAbility.fromJSONField(field), fromJSON: (json) => BuidlersRoyaltyCollectionAbility.fromJSON(json), fromSuiParsedData: (content) => BuidlersRoyaltyCollectionAbility.fromSuiParsedData(content), fetch: async (client, id) => BuidlersRoyaltyCollectionAbility.fetch(client, id), new: (fields) => { return new BuidlersRoyaltyCollectionAbility([], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, id) {
        ...
        return BuidlersRoyaltyCollectionAbility.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.BuidlersRoyaltyCollectionAbility = BuidlersRoyaltyCollectionAbility;
BuidlersRoyaltyCollectionAbility.$typeName = `${index_1.PKG_V1}::config::BuidlersRoyaltyCollectionAbility`;
BuidlersRoyaltyCollectionAbility.$numTypeParams = 0;
BuidlersRoyaltyCollectionAbility.$isPhantom = [];
/* ============================== DecimalPrecisionForCoinTypesWhitelisted =============================== */
function isDecimalPrecisionForCoinTypesWhitelisted(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::config::DecimalPrecisionForCoinTypesWhitelisted`; }
class DecimalPrecisionForCoinTypesWhitelisted {
    ...
    static async fetch(client, id) {
        ...
        return DecimalPrecisionForCoinTypesWhitelisted.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.DecimalPrecisionForCoinTypesWhitelisted = DecimalPrecisionForCoinTypesWhitelisted;
DecimalPrecisionForCoinTypesWhitelisted.$typeName = `${index_1.PKG_V1}::config::DecimalPrecisionForCoinTypesWhitelisted`;
DecimalPrecisionForCoinTypesWhitelisted.$numTypeParams = 0;
DecimalPrecisionForCoinTypesWhitelisted.$isPhantom = [];
/* ============================== DefaultFeeSet =============================== */
function isDefaultFeeSet(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::config::DefaultFeeSet`; }
class DefaultFeeSet {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static reified() { return { typeName: DefaultFeeSet.$typeName, fullTypeName: (0, util_1.composeSuiType)(DefaultFeeSet.$typeName, ...[]), typeArgs: [], isPhantom: DefaultFeeSet.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => DefaultFeeSet.fromFields(fields), fromFieldsWithTypes: (item) => DefaultFeeSet.fromFieldsWithTypes(item), fromBcs: (data) => DefaultFeeSet.fromBcs(data), bcs: DefaultFeeSet.bcs, fromJSONField: (field) => DefaultFeeSet.fromJSONField(field), fromJSON: (json) => DefaultFeeSet.fromJSON(json), fromSuiParsedData: (content) => DefaultFeeSet.fromSuiParsedData(content), fetch: async (client, id) => DefaultFeeSet.fetch(client, id), new: (fields) => { return new DefaultFeeSet([], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, id) {
        ...
        return DefaultFeeSet.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.DefaultFeeSet = DefaultFeeSet;
DefaultFeeSet.$typeName = `${index_1.PKG_V1}::config::DefaultFeeSet`;
DefaultFeeSet.$numTypeParams = 0;
DefaultFeeSet.$isPhantom = [];
/* ============================== DegenHiveDeployerCap =============================== */
function isDegenHiveDeployerCap(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::config::DegenHiveDeployerCap`; }
class DegenHiveDeployerCap {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
        this.$typeName = DegenHiveDeployerCap.$typeName;
        this.$isPhantom = DegenHiveDeployerCap.$isPhantom;
    ...
    static async fetch(client, id) {
        ...
        return DegenHiveDeployerCap.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.DegenHiveDeployerCap = DegenHiveDeployerCap;
DegenHiveDeployerCap.$typeName = `${index_1.PKG_V1}::config::DegenHiveDeployerCap`;
DegenHiveDeployerCap.$numTypeParams = 0;
DegenHiveDeployerCap.$isPhantom = [];
/* ============================== FeeCollectedForCoin =============================== */
function isFeeCollectedForCoin(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::config::FeeCollectedForCoin`; }
class FeeCollectedForCoin {
    ...
    static async fetch(client, id) {
        ...
        return FeeCollectedForCoin.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.FeeCollectedForCoin = FeeCollectedForCoin;
FeeCollectedForCoin.$typeName = `${index_1.PKG_V1}::config::FeeCollectedForCoin`;
FeeCollectedForCoin.$numTypeParams = 0;
FeeCollectedForCoin.$isPhantom = [];
/* ============================== FeeCollector =============================== */
function isFeeCollector(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V1}::config::FeeCollector` + '<'); }
class FeeCollector {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return FeeCollector.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.FeeCollector = FeeCollector;
FeeCollector.$typeName = `${index_1.PKG_V1}::config::FeeCollector`;
FeeCollector.$numTypeParams = 1;
FeeCollector.$isPhantom = [true,];
/* ============================== FeeExtractedForCoin =============================== */
function isFeeExtractedForCoin(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::config::FeeExtractedForCoin`; }
class FeeExtractedForCoin {
    ...
    static async fetch(client, id) {
        ...
        return FeeExtractedForCoin.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.FeeExtractedForCoin = FeeExtractedForCoin;
FeeExtractedForCoin.$typeName = `${index_1.PKG_V1}::config::FeeExtractedForCoin`;
FeeExtractedForCoin.$numTypeParams = 0;
FeeExtractedForCoin.$isPhantom = [];
/* ============================== FeeInfo =============================== */
function isFeeInfo(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::config::FeeInfo`; }
class FeeInfo {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, id) {
        ...
        return FeeInfo.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.FeeInfo = FeeInfo;
FeeInfo.$typeName = `${index_1.PKG_V1}::config::FeeInfo`;
FeeInfo.$numTypeParams = 0;
FeeInfo.$isPhantom = [];
/* ============================== HiveDaoCapability =============================== */
function isHiveDaoCapability(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::config::HiveDaoCapability`; }
class HiveDaoCapability {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
        this.$typeName = HiveDaoCapability.$typeName;
        this.$isPhantom = HiveDaoCapability.$isPhantom;
        this.$fullTypeName = (0, util_1.composeSuiType)(HiveDaoCapability.$typeName, ...typeArgs);
        this.$typeArgs = typeArgs;
        this.id = fields.id;
    }
    static reified() { return { typeName: HiveDaoCapability.$typeName, fullTypeName: (0, util_1.composeSuiType)(HiveDaoCapability.$typeName, ...[]), typeArgs: [], isPhantom: HiveDaoCapability.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => HiveDaoCapability.fromFields(fields), fromFieldsWithTypes: (item) => HiveDaoCapability.fromFieldsWithTypes(item), fromBcs: (data) => HiveDaoCapability.fromBcs(data), bcs: HiveDaoCapability.bcs, fromJSONField: (field) => HiveDaoCapability.fromJSONField(field), fromJSON: (json) => HiveDaoCapability.fromJSON(json), fromSuiParsedData: (content) => HiveDaoCapability.fromSuiParsedData(content), fetch: async (client, id) => HiveDaoCapability.fetch(client, id), new: (fields) => { return new HiveDaoCapability([], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, id) {
        ...
        return HiveDaoCapability.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.HiveDaoCapability = HiveDaoCapability;
HiveDaoCapability.$typeName = `${index_1.PKG_V1}::config::HiveDaoCapability`;
HiveDaoCapability.$numTypeParams = 0;
HiveDaoCapability.$isPhantom = [];
/* ============================== HiveEntryCap =============================== */
function isHiveEntryCap(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::config::HiveEntryCap`; }
class HiveEntryCap {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
        this.$typeName = HiveEntryCap.$typeName;
        this.$isPhantom = HiveEntryCap.$isPhantom;
        this.$fullTypeName = (0, util_1.composeSuiType)(HiveEntryCap.$typeName, ...typeArgs);
        this.$typeArgs = typeArgs;
        this.id = fields.id;
    }
    static reified() { return { typeName: HiveEntryCap.$typeName, fullTypeName: (0, util_1.composeSuiType)(HiveEntryCap.$typeName, ...[]), typeArgs: [], isPhantom: HiveEntryCap.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => HiveEntryCap.fromFields(fields), fromFieldsWithTypes: (item) => HiveEntryCap.fromFieldsWithTypes(item), fromBcs: (data) => HiveEntryCap.fromBcs(data), bcs: HiveEntryCap.bcs, fromJSONField: (field) => HiveEntryCap.fromJSONField(field), fromJSON: (json) => HiveEntryCap.fromJSON(json), fromSuiParsedData: (content) => HiveEntryCap.fromSuiParsedData(content), fetch: async (client, id) => HiveEntryCap.fetch(client, id), new: (fields) => { return new HiveEntryCap([], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, id) {
        ...
        return HiveEntryCap.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.HiveEntryCap = HiveEntryCap;
HiveEntryCap.$typeName = `${index_1.PKG_V1}::config::HiveEntryCap`;
HiveEntryCap.$numTypeParams = 0;
HiveEntryCap.$isPhantom = [];
/* ============================== NewFeeCollectorKrafted =============================== */
function isNewFeeCollectorKrafted(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::config::NewFeeCollectorKrafted`; }
class NewFeeCollectorKrafted {
    ...
    static get bcs() {
        return bcs_1.bcs.struct("NewFeeCollectorKrafted", {
            coin_type: structs_1.String.bcs, fee_collector_addr: bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), })
        });
    }
    ;
    ...
    static async fetch(client, id) {
        ...
        return NewFeeCollectorKrafted.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.NewFeeCollectorKrafted = NewFeeCollectorKrafted;
NewFeeCollectorKrafted.$typeName = `${index_1.PKG_V1}::config::NewFeeCollectorKrafted`;
NewFeeCollectorKrafted.$numTypeParams = 0;
NewFeeCollectorKrafted.$isPhantom = [];
/* ============================== PoolHiveCapability =============================== */
function isPoolHiveCapability(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::config::PoolHiveCapability`; }
class PoolHiveCapability {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
        this.$typeName = PoolHiveCapability.$typeName;
        this.$isPhantom = PoolHiveCapability.$isPhantom;
        this.$fullTypeName = (0, util_1.composeSuiType)(PoolHiveCapability.$typeName, ...typeArgs);
        this.$typeArgs = typeArgs;
        this.id = fields.id;
    }
    static reified() { return { typeName: PoolHiveCapability.$typeName, fullTypeName: (0, util_1.composeSuiType)(PoolHiveCapability.$typeName, ...[]), typeArgs: [], isPhantom: PoolHiveCapability.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => PoolHiveCapability.fromFields(fields), fromFieldsWithTypes: (item) => PoolHiveCapability.fromFieldsWithTypes(item), fromBcs: (data) => PoolHiveCapability.fromBcs(data), bcs: PoolHiveCapability.bcs, fromJSONField: (field) => PoolHiveCapability.fromJSONField(field), fromJSON: (json) => PoolHiveCapability.fromJSON(json), fromSuiParsedData: (content) => PoolHiveCapability.fromSuiParsedData(content), fetch: async (client, id) => PoolHiveCapability.fetch(client, id), new: (fields) => { return new PoolHiveCapability([], fields); }, kind: "StructClassReified", }; }
    static get r() { return PoolHiveCapability.reified(); }
    static phantom() { return (0, reified_1.phantom)(PoolHiveCapability.reified()); }
    static get p() { return PoolHiveCapability.phantom(); }
    static get bcs() {
        return bcs_1.bcs.struct("PoolHiveCapability", {
            id: structs_6.UID.bcs
        });
    }
    ;
    static fromFields(fields) { return PoolHiveCapability.reified().new({ id: (0, reified_1.decodeFromFields)(structs_6.UID.reified(), fields.id) }); }
    static fromFieldsWithTypes(item) {
        if (!isPoolHiveCapability(item.type)) {
            throw new Error("not a PoolHiveCapability type");
        }
        return PoolHiveCapability.reified().new({ id: (0, reified_1.decodeFromFieldsWithTypes)(structs_6.UID.reified(), item.fields.id) });
    }
    static fromBcs(data) { return PoolHiveCapability.fromFields(PoolHiveCapability.bcs.parse(data)); }
    toJSONField() {
        return {
            id: this.id,
        };
    ...
    toJSON() { return { $typeName: this.$typeName, $typeArgs: this.$typeArgs, ...this.toJSONField() }; }
    static fromJSONField(field) { return PoolHiveCapability.reified().new({ id: (0, reified_1.decodeFromJSONField)(structs_6.UID.reified(), field.id) }); }
    static fromJSON(json) {
        if (json.$typeName !== PoolHiveCapability.$typeName) {
            throw new Error("not a WithTwoGenerics json object");
        }
        ;
    ...
    static fromSuiParsedData(content) { if (content.dataType !== "moveObject") {
        throw new Error("not an object");
    } if (!isPoolHiveCapability(content.type)) {
        throw new Error(`object at ${content.fields.id} is not a PoolHiveCapability object`);
    } return PoolHiveCapability.fromFieldsWithTypes(content); }
    static async fetch(client, id) {
        var _a, _b;
        const res = await client.getObject({ id, options: { showBcs: true, }, });
        if (res.error) {
            throw new Error(`error fetching PoolHiveCapability object at id ${id}: ${res.error.code}`);
        }
        if (((_b = (_a = res.data) === null || _a === void 0 ? void 0 : _a.bcs) === null || _b === void 0 ? void 0 : _b.dataType) !== "moveObject" || !isPoolHiveCapability(res.data.bcs.type)) {
            throw new Error(`object at id ${id} is not a PoolHiveCapability object`);
        }
        return PoolHiveCapability.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.PoolHiveCapability = PoolHiveCapability;
PoolHiveCapability.$typeName = `${index_1.PKG_V1}::config::PoolHiveCapability`;
PoolHiveCapability.$numTypeParams = 0;
PoolHiveCapability.$isPhantom = [];
/* ============================== StableIdentifierAdded =============================== */
function isStableIdentifierAdded(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::config::StableIdentifierAdded`; }
class StableIdentifierAdded {
    ...
    static async fetch(client, id) {
        ...
        return StableIdentifierAdded.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.StableIdentifierAdded = StableIdentifierAdded;
StableIdentifierAdded.$typeName = `${index_1.PKG_V1}::config::StableIdentifierAdded`;
StableIdentifierAdded.$numTypeParams = 0;
StableIdentifierAdded.$isPhantom = [];
/* ============================== StableIdentifierRemoved =============================== */
function isStableIdentifierRemoved(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::config::StableIdentifierRemoved`; }
class StableIdentifierRemoved {
    ...
    static async fetch(client, id) {
        ...
        return StableIdentifierRemoved.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.StableIdentifierRemoved = StableIdentifierRemoved;
StableIdentifierRemoved.$typeName = `${index_1.PKG_V1}::config::StableIdentifierRemoved`;
StableIdentifierRemoved.$numTypeParams = 0;
StableIdentifierRemoved.$isPhantom = [];
/* ============================== ThreeAmmFeeClaimCapability =============================== */
function isThreeAmmFeeClaimCapability(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::config::ThreeAmmFeeClaimCapability`; }
class ThreeAmmFeeClaimCapability {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
        this.$typeName = ThreeAmmFeeClaimCapability.$typeName;
        this.$isPhantom = ThreeAmmFeeClaimCapability.$isPhantom;
        this.$fullTypeName = (0, util_1.composeSuiType)(ThreeAmmFeeClaimCapability.$typeName, ...typeArgs);
        this.$typeArgs = typeArgs;
        this.id = fields.id;
    }
    static reified() { return { typeName: ThreeAmmFeeClaimCapability.$typeName, fullTypeName: (0, util_1.composeSuiType)(ThreeAmmFeeClaimCapability.$typeName, ...[]), typeArgs: [], isPhantom: ThreeAmmFeeClaimCapability.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => ThreeAmmFeeClaimCapability.fromFields(fields), fromFieldsWithTypes: (item) => ThreeAmmFeeClaimCapability.fromFieldsWithTypes(item), fromBcs: (data) => ThreeAmmFeeClaimCapability.fromBcs(data), bcs: ThreeAmmFeeClaimCapability.bcs, fromJSONField: (field) => ThreeAmmFeeClaimCapability.fromJSONField(field), fromJSON: (json) => ThreeAmmFeeClaimCapability.fromJSON(json), fromSuiParsedData: (content) => ThreeAmmFeeClaimCapability.fromSuiParsedData(content), fetch: async (client, id) => ThreeAmmFeeClaimCapability.fetch(client, id), new: (fields) => { return new ThreeAmmFeeClaimCapability([], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, id) {
        ...
        return ThreeAmmFeeClaimCapability.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.ThreeAmmFeeClaimCapability = ThreeAmmFeeClaimCapability;
ThreeAmmFeeClaimCapability.$typeName = `${index_1.PKG_V1}::config::ThreeAmmFeeClaimCapability`;
ThreeAmmFeeClaimCapability.$numTypeParams = 0;
ThreeAmmFeeClaimCapability.$isPhantom = [];
/* ============================== Treasury =============================== */
function isTreasury(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V1}::config::Treasury` + '<'); }
class Treasury {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
        this.$typeName = Treasury.$typeName;
        this.$isPhantom = Treasury.$isPhantom;
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return Treasury.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Treasury = Treasury;
Treasury.$typeName = `${index_1.PKG_V1}::config::Treasury`;
Treasury.$numTypeParams = 1;
Treasury.$isPhantom = [true,];
/* ============================== TreasuryPercentUpdated =============================== */
function isTreasuryPercentUpdated(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::config::TreasuryPercentUpdated`; }
class TreasuryPercentUpdated {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
        this.$typeName = TreasuryPercentUpdated.$typeName;
        this.$isPhantom = TreasuryPercentUpdated.$isPhantom;
    ...
    static async fetch(client, id) {
        ...
        return TreasuryPercentUpdated.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.TreasuryPercentUpdated = TreasuryPercentUpdated;
TreasuryPercentUpdated.$typeName = `${index_1.PKG_V1}::config::TreasuryPercentUpdated`;
TreasuryPercentUpdated.$numTypeParams = 0;
TreasuryPercentUpdated.$isPhantom = [];
/* ============================== TreasuryResourcesDistributed =============================== */
function isTreasuryResourcesDistributed(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::config::TreasuryResourcesDistributed`; }
...
class TwoAmmFeeClaimCapability {
    ...
    static async fetch(client, id) {
        ...
        return TwoAmmFeeClaimCapability.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.TwoAmmFeeClaimCapability = TwoAmmFeeClaimCapability;
TwoAmmFeeClaimCapability.$typeName = `${index_1.PKG_V1}::config::TwoAmmFeeClaimCapability`;
TwoAmmFeeClaimCapability.$numTypeParams = 0;
TwoAmmFeeClaimCapability.$isPhantom = [];

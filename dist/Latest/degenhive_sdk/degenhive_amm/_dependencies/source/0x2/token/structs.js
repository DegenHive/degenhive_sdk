...
/* ============================== RuleKey =============================== */
function isRuleKey(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::token::RuleKey` + '<'); }
class RuleKey {
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return RuleKey.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.RuleKey = RuleKey;
RuleKey.$typeName = `${index_1.PKG_V21}::token::RuleKey`;
RuleKey.$numTypeParams = 1;
RuleKey.$isPhantom = [true,];
/* ============================== ActionRequest =============================== */
function isActionRequest(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::token::ActionRequest` + '<'); }
class ActionRequest {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static get bcs() {
        return bcs_1.bcs.struct("ActionRequest", {
            name: structs_2.String.bcs, amount: bcs_1.bcs.u64(), sender: bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), }), recipient: structs_1.Option.bcs(bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), })), spent_balance: structs_1.Option.bcs(structs_4.Balance.bcs), approvals: structs_7.VecSet.bcs(structs_3.TypeName.bcs)
        });
    }
    ;
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return ActionRequest.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.ActionRequest = ActionRequest;
ActionRequest.$typeName = `${index_1.PKG_V21}::token::ActionRequest`;
ActionRequest.$numTypeParams = 1;
ActionRequest.$isPhantom = [true,];
/* ============================== Token =============================== */
function isToken(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::token::Token` + '<'); }
class Token {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return Token.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Token = Token;
Token.$typeName = `${index_1.PKG_V21}::token::Token`;
Token.$numTypeParams = 1;
Token.$isPhantom = [true,];
/* ============================== TokenPolicy =============================== */
function isTokenPolicy(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::token::TokenPolicy` + '<'); }
class TokenPolicy {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return TokenPolicy.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.TokenPolicy = TokenPolicy;
TokenPolicy.$typeName = `${index_1.PKG_V21}::token::TokenPolicy`;
TokenPolicy.$numTypeParams = 1;
TokenPolicy.$isPhantom = [true,];
/* ============================== TokenPolicyCap =============================== */
function isTokenPolicyCap(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::token::TokenPolicyCap` + '<'); }
class TokenPolicyCap {
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return TokenPolicyCap.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.TokenPolicyCap = TokenPolicyCap;
TokenPolicyCap.$typeName = `${index_1.PKG_V21}::token::TokenPolicyCap`;
TokenPolicyCap.$numTypeParams = 1;
TokenPolicyCap.$isPhantom = [true,];
/* ============================== TokenPolicyCreated =============================== */
function isTokenPolicyCreated(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::token::TokenPolicyCreated` + '<'); }
class TokenPolicyCreated {
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return TokenPolicyCreated.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.TokenPolicyCreated = TokenPolicyCreated;
TokenPolicyCreated.$typeName = `${index_1.PKG_V21}::token::TokenPolicyCreated`;

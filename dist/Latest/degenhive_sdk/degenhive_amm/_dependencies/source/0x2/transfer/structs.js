...
/* ============================== Receiving =============================== */
function isReceiving(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::transfer::Receiving` + '<'); }
class Receiving {
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return Receiving.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Receiving = Receiving;
Receiving.$typeName = `${index_1.PKG_V21}::transfer::Receiving`;

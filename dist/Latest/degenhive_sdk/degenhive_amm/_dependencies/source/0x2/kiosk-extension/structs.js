...
/* ============================== Extension =============================== */
function isExtension(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::kiosk_extension::Extension`; }
class Extension {
    ...
    static async fetch(client, id) {
        ...
        return Extension.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Extension = Extension;
Extension.$typeName = `${index_1.PKG_V21}::kiosk_extension::Extension`;
Extension.$numTypeParams = 0;
Extension.$isPhantom = [];
/* ============================== ExtensionKey =============================== */
function isExtensionKey(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::kiosk_extension::ExtensionKey` + '<'); }
class ExtensionKey {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return ExtensionKey.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.ExtensionKey = ExtensionKey;
ExtensionKey.$typeName = `${index_1.PKG_V21}::kiosk_extension::ExtensionKey`;

...
/* ============================== ObjectBag =============================== */
function isObjectBag(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::object_bag::ObjectBag`; }
class ObjectBag {
    ...
    static async fetch(client, id) {
        ...
        return ObjectBag.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.ObjectBag = ObjectBag;
ObjectBag.$typeName = `${index_1.PKG_V21}::object_bag::ObjectBag`;

...
/* ============================== ActiveJwk =============================== */
function isActiveJwk(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::authenticator_state::ActiveJwk`; }
class ActiveJwk {
    ...
    static async fetch(client, id) {
        ...
        return ActiveJwk.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.ActiveJwk = ActiveJwk;
ActiveJwk.$typeName = `${index_1.PKG_V21}::authenticator_state::ActiveJwk`;
ActiveJwk.$numTypeParams = 0;
ActiveJwk.$isPhantom = [];
/* ============================== AuthenticatorState =============================== */
function isAuthenticatorState(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::authenticator_state::AuthenticatorState`; }
class AuthenticatorState {
    ...
    static async fetch(client, id) {
        ...
        return AuthenticatorState.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.AuthenticatorState = AuthenticatorState;
AuthenticatorState.$typeName = `${index_1.PKG_V21}::authenticator_state::AuthenticatorState`;
AuthenticatorState.$numTypeParams = 0;
AuthenticatorState.$isPhantom = [];
/* ============================== AuthenticatorStateInner =============================== */
function isAuthenticatorStateInner(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::authenticator_state::AuthenticatorStateInner`; }
class AuthenticatorStateInner {
    ...
    static reified() { return { typeName: AuthenticatorStateInner.$typeName, fullTypeName: (0, util_1.composeSuiType)(AuthenticatorStateInner.$typeName, ...[]), typeArgs: [], isPhantom: AuthenticatorStateInner.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => AuthenticatorStateInner.fromFields(fields), fromFieldsWithTypes: (item) => AuthenticatorStateInner.fromFieldsWithTypes(item), fromBcs: (data) => AuthenticatorStateInner.fromBcs(data), bcs: AuthenticatorStateInner.bcs, fromJSONField: (field) => AuthenticatorStateInner.fromJSONField(field), fromJSON: (json) => AuthenticatorStateInner.fromJSON(json), fromSuiParsedData: (content) => AuthenticatorStateInner.fromSuiParsedData(content), fetch: async (client, id) => AuthenticatorStateInner.fetch(client, id), new: (fields) => { return new AuthenticatorStateInner([], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, id) {
        ...
        return AuthenticatorStateInner.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.AuthenticatorStateInner = AuthenticatorStateInner;
AuthenticatorStateInner.$typeName = `${index_1.PKG_V21}::authenticator_state::AuthenticatorStateInner`;
AuthenticatorStateInner.$numTypeParams = 0;
AuthenticatorStateInner.$isPhantom = [];
/* ============================== JWK =============================== */
function isJWK(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::authenticator_state::JWK`; }
class JWK {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, id) {
        ...
        return JWK.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.JWK = JWK;
JWK.$typeName = `${index_1.PKG_V21}::authenticator_state::JWK`;
JWK.$numTypeParams = 0;
JWK.$isPhantom = [];
/* ============================== JwkId =============================== */
function isJwkId(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::authenticator_state::JwkId`; }
class JwkId {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static reified() { return { typeName: JwkId.$typeName, fullTypeName: (0, util_1.composeSuiType)(JwkId.$typeName, ...[]), typeArgs: [], isPhantom: JwkId.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => JwkId.fromFields(fields), fromFieldsWithTypes: (item) => JwkId.fromFieldsWithTypes(item), fromBcs: (data) => JwkId.fromBcs(data), bcs: JwkId.bcs, fromJSONField: (field) => JwkId.fromJSONField(field), fromJSON: (json) => JwkId.fromJSON(json), fromSuiParsedData: (content) => JwkId.fromSuiParsedData(content), fetch: async (client, id) => JwkId.fetch(client, id), new: (fields) => { return new JwkId([], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, id) {
        ...
        return JwkId.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.JwkId = JwkId;
JwkId.$typeName = `${index_1.PKG_V21}::authenticator_state::JwkId`;

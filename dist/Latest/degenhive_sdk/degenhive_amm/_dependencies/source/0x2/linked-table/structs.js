...
/* ============================== LinkedTable =============================== */
function isLinkedTable(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::linked_table::LinkedTable` + '<'); }
class LinkedTable {
    ...
    static async fetch(client, typeArgs, id) {
        ...
        ;
        return LinkedTable.fromBcs(typeArgs, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.LinkedTable = LinkedTable;
LinkedTable.$typeName = `${index_1.PKG_V21}::linked_table::LinkedTable`;
LinkedTable.$numTypeParams = 2;
LinkedTable.$isPhantom = [false, true,];
/* ============================== Node =============================== */
function isNode(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::linked_table::Node` + '<'); }
class Node {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static reified(K, V) { return { typeName: Node.$typeName, fullTypeName: (0, util_1.composeSuiType)(Node.$typeName, ...[(0, reified_1.extractType)(K), (0, reified_1.extractType)(V)]), typeArgs: [(0, reified_1.extractType)(K), (0, reified_1.extractType)(V)], isPhantom: Node.$isPhantom, reifiedTypeArgs: [K, V], fromFields: (fields) => Node.fromFields([K, V], fields), fromFieldsWithTypes: (item) => Node.fromFieldsWithTypes([K, V], item), fromBcs: (data) => Node.fromBcs([K, V], data), bcs: Node.bcs((0, reified_1.toBcs)(K), (0, reified_1.toBcs)(V)), fromJSONField: (field) => Node.fromJSONField([K, V], field), fromJSON: (json) => Node.fromJSON([K, V], json), fromSuiParsedData: (content) => Node.fromSuiParsedData([K, V], content), fetch: async (client, id) => Node.fetch(client, [K, V], id), new: (fields) => { return new Node([(0, reified_1.extractType)(K), (0, reified_1.extractType)(V)], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, typeArgs, id) {
        ...
        ;
        return Node.fromBcs(typeArgs, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Node = Node;
Node.$typeName = `${index_1.PKG_V21}::linked_table::Node`;

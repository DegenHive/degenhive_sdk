...
/* ============================== VerifiedIssuer =============================== */
function isVerifiedIssuer(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::zklogin_verified_issuer::VerifiedIssuer`; }
class VerifiedIssuer {
    ...
    static get bcs() {
        return bcs_1.bcs.struct("VerifiedIssuer", {
            id: structs_2.UID.bcs, owner: bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), }), issuer: structs_1.String.bcs
        });
    }
    ;
    ...
    static async fetch(client, id) {
        ...
        return VerifiedIssuer.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.VerifiedIssuer = VerifiedIssuer;
VerifiedIssuer.$typeName = `${index_1.PKG_V21}::zklogin_verified_issuer::VerifiedIssuer`;

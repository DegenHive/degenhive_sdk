...
/* ============================== SUI =============================== */
function isSUI(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::sui::SUI`; }
class SUI {
    ...
    static async fetch(client, id) {
        ...
        return SUI.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.SUI = SUI;
SUI.$typeName = `${index_1.PKG_V21}::sui::SUI`;
SUI.$numTypeParams = 0;
SUI.$isPhantom = [];

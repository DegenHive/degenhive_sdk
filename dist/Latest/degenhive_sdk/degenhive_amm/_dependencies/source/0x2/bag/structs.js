...
/* ============================== Bag =============================== */
function isBag(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::bag::Bag`; }
class Bag {
    ...
    static async fetch(client, id) {
        ...
        return Bag.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Bag = Bag;
Bag.$typeName = `${index_1.PKG_V21}::bag::Bag`;
Bag.$numTypeParams = 0;
Bag.$isPhantom = [];

...
/* ============================== Url =============================== */
function isUrl(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::url::Url`; }
class Url {
    ...
    static async fetch(client, id) {
        ...
        return Url.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Url = Url;
Url.$typeName = `${index_1.PKG_V21}::url::Url`;
Url.$numTypeParams = 0;
Url.$isPhantom = [];

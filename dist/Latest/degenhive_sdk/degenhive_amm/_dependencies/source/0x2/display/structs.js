...
/* ============================== Display =============================== */
function isDisplay(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::display::Display` + '<'); }
class Display {
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return Display.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Display = Display;
Display.$typeName = `${index_1.PKG_V21}::display::Display`;
Display.$numTypeParams = 1;
Display.$isPhantom = [true,];
/* ============================== DisplayCreated =============================== */
function isDisplayCreated(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::display::DisplayCreated` + '<'); }
class DisplayCreated {
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return DisplayCreated.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.DisplayCreated = DisplayCreated;
DisplayCreated.$typeName = `${index_1.PKG_V21}::display::DisplayCreated`;
DisplayCreated.$numTypeParams = 1;
DisplayCreated.$isPhantom = [true,];
/* ============================== VersionUpdated =============================== */
function isVersionUpdated(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::display::VersionUpdated` + '<'); }
class VersionUpdated {
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return VersionUpdated.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.VersionUpdated = VersionUpdated;
VersionUpdated.$typeName = `${index_1.PKG_V21}::display::VersionUpdated`;

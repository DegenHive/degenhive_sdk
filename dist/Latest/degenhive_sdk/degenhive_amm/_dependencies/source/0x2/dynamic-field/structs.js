...
/* ============================== Field =============================== */
function isField(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::dynamic_field::Field` + '<'); }
class Field {
    ...
    static async fetch(client, typeArgs, id) {
        ...
        ;
        return Field.fromBcs(typeArgs, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Field = Field;
Field.$typeName = `${index_1.PKG_V21}::dynamic_field::Field`;

...
/* ============================== Table =============================== */
function isTable(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::table::Table` + '<'); }
class Table {
    ...
    static async fetch(client, typeArgs, id) {
        ...
        ;
        return Table.fromBcs(typeArgs, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Table = Table;
Table.$typeName = `${index_1.PKG_V21}::table::Table`;

...
/* ============================== Publisher =============================== */
function isPublisher(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::package::Publisher`; }
class Publisher {
    ...
    static async fetch(client, id) {
        ...
        return Publisher.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Publisher = Publisher;
Publisher.$typeName = `${index_1.PKG_V21}::package::Publisher`;
Publisher.$numTypeParams = 0;
Publisher.$isPhantom = [];
/* ============================== UpgradeCap =============================== */
function isUpgradeCap(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::package::UpgradeCap`; }
class UpgradeCap {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, id) {
        ...
        return UpgradeCap.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.UpgradeCap = UpgradeCap;
UpgradeCap.$typeName = `${index_1.PKG_V21}::package::UpgradeCap`;
UpgradeCap.$numTypeParams = 0;
UpgradeCap.$isPhantom = [];
/* ============================== UpgradeReceipt =============================== */
function isUpgradeReceipt(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::package::UpgradeReceipt`; }
class UpgradeReceipt {
    ...
    static async fetch(client, id) {
        ...
        return UpgradeReceipt.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.UpgradeReceipt = UpgradeReceipt;
UpgradeReceipt.$typeName = `${index_1.PKG_V21}::package::UpgradeReceipt`;
UpgradeReceipt.$numTypeParams = 0;
UpgradeReceipt.$isPhantom = [];
/* ============================== UpgradeTicket =============================== */
function isUpgradeTicket(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::package::UpgradeTicket`; }
class UpgradeTicket {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static reified() { return { typeName: UpgradeTicket.$typeName, fullTypeName: (0, util_1.composeSuiType)(UpgradeTicket.$typeName, ...[]), typeArgs: [], isPhantom: UpgradeTicket.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => UpgradeTicket.fromFields(fields), fromFieldsWithTypes: (item) => UpgradeTicket.fromFieldsWithTypes(item), fromBcs: (data) => UpgradeTicket.fromBcs(data), bcs: UpgradeTicket.bcs, fromJSONField: (field) => UpgradeTicket.fromJSONField(field), fromJSON: (json) => UpgradeTicket.fromJSON(json), fromSuiParsedData: (content) => UpgradeTicket.fromSuiParsedData(content), fetch: async (client, id) => UpgradeTicket.fetch(client, id), new: (fields) => { return new UpgradeTicket([], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, id) {
        ...
        return UpgradeTicket.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.UpgradeTicket = UpgradeTicket;
UpgradeTicket.$typeName = `${index_1.PKG_V21}::package::UpgradeTicket`;

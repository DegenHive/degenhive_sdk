...
/* ============================== VerifiedID =============================== */
function isVerifiedID(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::zklogin_verified_id::VerifiedID`; }
class VerifiedID {
    ...
    static get bcs() {
        return bcs_1.bcs.struct("VerifiedID", {
            id: structs_2.UID.bcs, owner: bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), }), key_claim_name: structs_1.String.bcs, key_claim_value: structs_1.String.bcs, issuer: structs_1.String.bcs, audience: structs_1.String.bcs
        });
    }
    ;
    ...
    static async fetch(client, id) {
        ...
        return VerifiedID.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.VerifiedID = VerifiedID;
VerifiedID.$typeName = `${index_1.PKG_V21}::zklogin_verified_id::VerifiedID`;

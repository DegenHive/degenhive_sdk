...
/* ============================== G1 =============================== */
function isG1(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::bls12381::G1`; }
class G1 {
    ...
    static async fetch(client, id) {
        ...
        return G1.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.G1 = G1;
G1.$typeName = `${index_1.PKG_V21}::bls12381::G1`;
G1.$numTypeParams = 0;
G1.$isPhantom = [];
/* ============================== G2 =============================== */
function isG2(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::bls12381::G2`; }
class G2 {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, id) {
        ...
        return G2.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.G2 = G2;
G2.$typeName = `${index_1.PKG_V21}::bls12381::G2`;
G2.$numTypeParams = 0;
G2.$isPhantom = [];
/* ============================== GT =============================== */
function isGT(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::bls12381::GT`; }
class GT {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, id) {
        ...
        return GT.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.GT = GT;
GT.$typeName = `${index_1.PKG_V21}::bls12381::GT`;
GT.$numTypeParams = 0;
GT.$isPhantom = [];
/* ============================== Scalar =============================== */
function isScalar(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::bls12381::Scalar`; }
class Scalar {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, id) {
        ...
        return Scalar.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Scalar = Scalar;
Scalar.$typeName = `${index_1.PKG_V21}::bls12381::Scalar`;

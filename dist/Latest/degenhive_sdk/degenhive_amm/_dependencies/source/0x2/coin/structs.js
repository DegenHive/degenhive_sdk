...
/* ============================== Coin =============================== */
function isCoin(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::coin::Coin` + '<'); }
class Coin {
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return Coin.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Coin = Coin;
Coin.$typeName = `${index_1.PKG_V21}::coin::Coin`;
Coin.$numTypeParams = 1;
Coin.$isPhantom = [true,];
/* ============================== CoinMetadata =============================== */
function isCoinMetadata(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::coin::CoinMetadata` + '<'); }
class CoinMetadata {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return CoinMetadata.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.CoinMetadata = CoinMetadata;
CoinMetadata.$typeName = `${index_1.PKG_V21}::coin::CoinMetadata`;
CoinMetadata.$numTypeParams = 1;
CoinMetadata.$isPhantom = [true,];
/* ============================== CurrencyCreated =============================== */
function isCurrencyCreated(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::coin::CurrencyCreated` + '<'); }
class CurrencyCreated {
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return CurrencyCreated.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.CurrencyCreated = CurrencyCreated;
CurrencyCreated.$typeName = `${index_1.PKG_V21}::coin::CurrencyCreated`;
CurrencyCreated.$numTypeParams = 1;
CurrencyCreated.$isPhantom = [true,];
/* ============================== DenyCap =============================== */
function isDenyCap(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::coin::DenyCap` + '<'); }
class DenyCap {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return DenyCap.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.DenyCap = DenyCap;
DenyCap.$typeName = `${index_1.PKG_V21}::coin::DenyCap`;
DenyCap.$numTypeParams = 1;
DenyCap.$isPhantom = [true,];
/* ============================== RegulatedCoinMetadata =============================== */
function isRegulatedCoinMetadata(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::coin::RegulatedCoinMetadata` + '<'); }
class RegulatedCoinMetadata {
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return RegulatedCoinMetadata.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.RegulatedCoinMetadata = RegulatedCoinMetadata;
RegulatedCoinMetadata.$typeName = `${index_1.PKG_V21}::coin::RegulatedCoinMetadata`;
RegulatedCoinMetadata.$numTypeParams = 1;
RegulatedCoinMetadata.$isPhantom = [true,];
/* ============================== TreasuryCap =============================== */
function isTreasuryCap(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::coin::TreasuryCap` + '<'); }
class TreasuryCap {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return TreasuryCap.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.TreasuryCap = TreasuryCap;
TreasuryCap.$typeName = `${index_1.PKG_V21}::coin::TreasuryCap`;

...
/* ============================== BCS =============================== */
function isBCS(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::bcs::BCS`; }
class BCS {
    ...
    static async fetch(client, id) {
        ...
        return BCS.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.BCS = BCS;
BCS.$typeName = `${index_1.PKG_V21}::bcs::BCS`;
BCS.$numTypeParams = 0;
BCS.$isPhantom = [];

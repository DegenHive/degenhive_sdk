...
/* ============================== Entry =============================== */
function isEntry(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::vec_map::Entry` + '<'); }
class Entry {
    ...
    static async fetch(client, typeArgs, id) {
        ...
        ;
        return Entry.fromBcs(typeArgs, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Entry = Entry;
Entry.$typeName = `${index_1.PKG_V21}::vec_map::Entry`;
Entry.$numTypeParams = 2;
Entry.$isPhantom = [false, false,];
/* ============================== VecMap =============================== */
function isVecMap(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::vec_map::VecMap` + '<'); }
class VecMap {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static reified(K, V) { return { typeName: VecMap.$typeName, fullTypeName: (0, util_1.composeSuiType)(VecMap.$typeName, ...[(0, reified_1.extractType)(K), (0, reified_1.extractType)(V)]), typeArgs: [(0, reified_1.extractType)(K), (0, reified_1.extractType)(V)], isPhantom: VecMap.$isPhantom, reifiedTypeArgs: [K, V], fromFields: (fields) => VecMap.fromFields([K, V], fields), fromFieldsWithTypes: (item) => VecMap.fromFieldsWithTypes([K, V], item), fromBcs: (data) => VecMap.fromBcs([K, V], data), bcs: VecMap.bcs((0, reified_1.toBcs)(K), (0, reified_1.toBcs)(V)), fromJSONField: (field) => VecMap.fromJSONField([K, V], field), fromJSON: (json) => VecMap.fromJSON([K, V], json), fromSuiParsedData: (content) => VecMap.fromSuiParsedData([K, V], content), fetch: async (client, id) => VecMap.fetch(client, [K, V], id), new: (fields) => { return new VecMap([(0, reified_1.extractType)(K), (0, reified_1.extractType)(V)], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, typeArgs, id) {
        ...
        ;
        return VecMap.fromBcs(typeArgs, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.VecMap = VecMap;
VecMap.$typeName = `${index_1.PKG_V21}::vec_map::VecMap`;

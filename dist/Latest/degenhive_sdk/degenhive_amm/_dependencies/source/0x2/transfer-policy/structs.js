...
/* ============================== RuleKey =============================== */
function isRuleKey(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::transfer_policy::RuleKey` + '<'); }
class RuleKey {
...
RuleKey.$typeName = `${index_1.PKG_V21}::transfer_policy::RuleKey`;
RuleKey.$numTypeParams = 1;
RuleKey.$isPhantom = [true,];
/* ============================== TransferPolicy =============================== */
function isTransferPolicy(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::transfer_policy::TransferPolicy` + '<'); }
class TransferPolicy {
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return TransferPolicy.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.TransferPolicy = TransferPolicy;
TransferPolicy.$typeName = `${index_1.PKG_V21}::transfer_policy::TransferPolicy`;
TransferPolicy.$numTypeParams = 1;
TransferPolicy.$isPhantom = [true,];
/* ============================== TransferPolicyCap =============================== */
function isTransferPolicyCap(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::transfer_policy::TransferPolicyCap` + '<'); }
class TransferPolicyCap {
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return TransferPolicyCap.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.TransferPolicyCap = TransferPolicyCap;
TransferPolicyCap.$typeName = `${index_1.PKG_V21}::transfer_policy::TransferPolicyCap`;
TransferPolicyCap.$numTypeParams = 1;
TransferPolicyCap.$isPhantom = [true,];
/* ============================== TransferPolicyCreated =============================== */
function isTransferPolicyCreated(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::transfer_policy::TransferPolicyCreated` + '<'); }
class TransferPolicyCreated {
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return TransferPolicyCreated.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.TransferPolicyCreated = TransferPolicyCreated;
TransferPolicyCreated.$typeName = `${index_1.PKG_V21}::transfer_policy::TransferPolicyCreated`;
TransferPolicyCreated.$numTypeParams = 1;
TransferPolicyCreated.$isPhantom = [true,];
/* ============================== TransferPolicyDestroyed =============================== */
function isTransferPolicyDestroyed(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::transfer_policy::TransferPolicyDestroyed` + '<'); }
class TransferPolicyDestroyed {
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return TransferPolicyDestroyed.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.TransferPolicyDestroyed = TransferPolicyDestroyed;
TransferPolicyDestroyed.$typeName = `${index_1.PKG_V21}::transfer_policy::TransferPolicyDestroyed`;
TransferPolicyDestroyed.$numTypeParams = 1;
TransferPolicyDestroyed.$isPhantom = [true,];
/* ============================== TransferRequest =============================== */
function isTransferRequest(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::transfer_policy::TransferRequest` + '<'); }
class TransferRequest {
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return TransferRequest.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.TransferRequest = TransferRequest;
TransferRequest.$typeName = `${index_1.PKG_V21}::transfer_policy::TransferRequest`;

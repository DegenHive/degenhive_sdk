...
/* ============================== ObjectTable =============================== */
function isObjectTable(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::object_table::ObjectTable` + '<'); }
class ObjectTable {
    ...
    static async fetch(client, typeArgs, id) {
        ...
        ;
        return ObjectTable.fromBcs(typeArgs, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.ObjectTable = ObjectTable;
ObjectTable.$typeName = `${index_1.PKG_V21}::object_table::ObjectTable`;

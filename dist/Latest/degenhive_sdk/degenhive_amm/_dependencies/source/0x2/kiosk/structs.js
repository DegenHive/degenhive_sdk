...
/* ============================== Borrow =============================== */
function isBorrow(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::kiosk::Borrow`; }
class Borrow {
    ...
    static reified() { return { typeName: Borrow.$typeName, fullTypeName: (0, util_1.composeSuiType)(Borrow.$typeName, ...[]), typeArgs: [], isPhantom: Borrow.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => Borrow.fromFields(fields), fromFieldsWithTypes: (item) => Borrow.fromFieldsWithTypes(item), fromBcs: (data) => Borrow.fromBcs(data), bcs: Borrow.bcs, fromJSONField: (field) => Borrow.fromJSONField(field), fromJSON: (json) => Borrow.fromJSON(json), fromSuiParsedData: (content) => Borrow.fromSuiParsedData(content), fetch: async (client, id) => Borrow.fetch(client, id), new: (fields) => { return new Borrow([], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, id) {
        ...
        return Borrow.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Borrow = Borrow;
Borrow.$typeName = `${index_1.PKG_V21}::kiosk::Borrow`;
Borrow.$numTypeParams = 0;
Borrow.$isPhantom = [];
/* ============================== Item =============================== */
function isItem(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::kiosk::Item`; }
class Item {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, id) {
        ...
        return Item.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Item = Item;
Item.$typeName = `${index_1.PKG_V21}::kiosk::Item`;
Item.$numTypeParams = 0;
Item.$isPhantom = [];
/* ============================== ItemDelisted =============================== */
function isItemDelisted(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::kiosk::ItemDelisted` + '<'); }
class ItemDelisted {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return ItemDelisted.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.ItemDelisted = ItemDelisted;
ItemDelisted.$typeName = `${index_1.PKG_V21}::kiosk::ItemDelisted`;
ItemDelisted.$numTypeParams = 1;
ItemDelisted.$isPhantom = [true,];
/* ============================== ItemListed =============================== */
function isItemListed(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::kiosk::ItemListed` + '<'); }
class ItemListed {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return ItemListed.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.ItemListed = ItemListed;
ItemListed.$typeName = `${index_1.PKG_V21}::kiosk::ItemListed`;
ItemListed.$numTypeParams = 1;
ItemListed.$isPhantom = [true,];
/* ============================== ItemPurchased =============================== */
function isItemPurchased(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::kiosk::ItemPurchased` + '<'); }
class ItemPurchased {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return ItemPurchased.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.ItemPurchased = ItemPurchased;
ItemPurchased.$typeName = `${index_1.PKG_V21}::kiosk::ItemPurchased`;
ItemPurchased.$numTypeParams = 1;
ItemPurchased.$isPhantom = [true,];
/* ============================== Kiosk =============================== */
function isKiosk(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::kiosk::Kiosk`; }
class Kiosk {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static get bcs() {
        return bcs_1.bcs.struct("Kiosk", {
            id: structs_2.UID.bcs, profits: structs_1.Balance.bcs, owner: bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), }), item_count: bcs_1.bcs.u32(), allow_extensions: bcs_1.bcs.bool()
        });
    }
    ;
    ...
    static async fetch(client, id) {
        ...
        return Kiosk.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Kiosk = Kiosk;
Kiosk.$typeName = `${index_1.PKG_V21}::kiosk::Kiosk`;
Kiosk.$numTypeParams = 0;
Kiosk.$isPhantom = [];
/* ============================== KioskOwnerCap =============================== */
function isKioskOwnerCap(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::kiosk::KioskOwnerCap`; }
class KioskOwnerCap {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, id) {
        ...
        return KioskOwnerCap.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.KioskOwnerCap = KioskOwnerCap;
KioskOwnerCap.$typeName = `${index_1.PKG_V21}::kiosk::KioskOwnerCap`;
KioskOwnerCap.$numTypeParams = 0;
KioskOwnerCap.$isPhantom = [];
/* ============================== Listing =============================== */
function isListing(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::kiosk::Listing`; }
class Listing {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
...
Listing.$typeName = `${index_1.PKG_V21}::kiosk::Listing`;
Listing.$numTypeParams = 0;
Listing.$isPhantom = [];
/* ============================== Lock =============================== */
function isLock(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V21}::kiosk::Lock`; }
class Lock {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static reified() { return { typeName: Lock.$typeName, fullTypeName: (0, util_1.composeSuiType)(Lock.$typeName, ...[]), typeArgs: [], isPhantom: Lock.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => Lock.fromFields(fields), fromFieldsWithTypes: (item) => Lock.fromFieldsWithTypes(item), fromBcs: (data) => Lock.fromBcs(data), bcs: Lock.bcs, fromJSONField: (field) => Lock.fromJSONField(field), fromJSON: (json) => Lock.fromJSON(json), fromSuiParsedData: (content) => Lock.fromSuiParsedData(content), fetch: async (client, id) => Lock.fetch(client, id), new: (fields) => { return new Lock([], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, id) {
        ...
        return Lock.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Lock = Lock;
Lock.$typeName = `${index_1.PKG_V21}::kiosk::Lock`;
Lock.$numTypeParams = 0;
Lock.$isPhantom = [];
/* ============================== PurchaseCap =============================== */
function isPurchaseCap(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::kiosk::PurchaseCap` + '<'); }
class PurchaseCap {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return PurchaseCap.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.PurchaseCap = PurchaseCap;
PurchaseCap.$typeName = `${index_1.PKG_V21}::kiosk::PurchaseCap`;

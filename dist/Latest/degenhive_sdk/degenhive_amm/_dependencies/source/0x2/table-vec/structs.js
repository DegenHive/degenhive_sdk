...
/* ============================== TableVec =============================== */
function isTableVec(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::table_vec::TableVec` + '<'); }
class TableVec {
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return TableVec.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.TableVec = TableVec;
TableVec.$typeName = `${index_1.PKG_V21}::table_vec::TableVec`;

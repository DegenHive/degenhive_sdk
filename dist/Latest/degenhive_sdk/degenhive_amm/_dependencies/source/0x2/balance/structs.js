...
/* ============================== Balance =============================== */
function isBalance(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::balance::Balance` + '<'); }
class Balance {
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return Balance.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Balance = Balance;
Balance.$typeName = `${index_1.PKG_V21}::balance::Balance`;
Balance.$numTypeParams = 1;
Balance.$isPhantom = [true,];
/* ============================== Supply =============================== */
function isSupply(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V21}::balance::Supply` + '<'); }
class Supply {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return Supply.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Supply = Supply;
Supply.$typeName = `${index_1.PKG_V21}::balance::Supply`;

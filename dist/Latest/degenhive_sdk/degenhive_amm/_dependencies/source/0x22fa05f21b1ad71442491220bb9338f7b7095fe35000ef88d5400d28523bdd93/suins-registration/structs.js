...
class SuinsRegistration {
    ...
    static async fetch(client, id) {
        ...
        return SuinsRegistration.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}

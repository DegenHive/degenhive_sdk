...
/* ============================== Char =============================== */
function isChar(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V8}::ascii::Char`; }
class Char {
    ...
    static async fetch(client, id) {
        ...
        return Char.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Char = Char;
Char.$typeName = `${index_1.PKG_V8}::ascii::Char`;
Char.$numTypeParams = 0;
Char.$isPhantom = [];
/* ============================== String =============================== */
function isString(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V8}::ascii::String`; }
class String {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, id) {
        ...
        return String.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.String = String;
String.$typeName = `${index_1.PKG_V8}::ascii::String`;

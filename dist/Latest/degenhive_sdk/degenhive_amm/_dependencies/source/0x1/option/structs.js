...
/* ============================== Option =============================== */
function isOption(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V8}::option::Option` + '<'); }
class Option {
    ;
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return Option.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Option = Option;
Option.$typeName = `${index_1.PKG_V8}::option::Option`;

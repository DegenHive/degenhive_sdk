...
/* ============================== FixedPoint32 =============================== */
function isFixedPoint32(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V8}::fixed_point32::FixedPoint32`; }
class FixedPoint32 {
    ...
    static async fetch(client, id) {
        ...
        return FixedPoint32.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.FixedPoint32 = FixedPoint32;
FixedPoint32.$typeName = `${index_1.PKG_V8}::fixed_point32::FixedPoint32`;

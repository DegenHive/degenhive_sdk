...
/* ============================== WeightedConfig =============================== */
function isWeightedConfig(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::weighted_math::WeightedConfig`; }
class WeightedConfig {
    ...
    static async fetch(client, id) {
        ...
        return WeightedConfig.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.WeightedConfig = WeightedConfig;
WeightedConfig.$typeName = `${index_1.PKG_V1}::weighted_math::WeightedConfig`;

...
function isGenesisChainParameters(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V10}::genesis::GenesisChainParameters`; }
class GenesisChainParameters {
    ...
    static async fetch(client, id) {
        ...
        return GenesisChainParameters.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.GenesisChainParameters = GenesisChainParameters;
GenesisChainParameters.$typeName = `${index_1.PKG_V10}::genesis::GenesisChainParameters`;
GenesisChainParameters.$numTypeParams = 0;
GenesisChainParameters.$isPhantom = [];
/* ============================== GenesisValidatorMetadata =============================== */
function isGenesisValidatorMetadata(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V10}::genesis::GenesisValidatorMetadata`; }
class GenesisValidatorMetadata {
    ...
    static get bcs() {
        return bcs_1.bcs.struct("GenesisValidatorMetadata", {
            name: bcs_1.bcs.vector(bcs_1.bcs.u8()), description: bcs_1.bcs.vector(bcs_1.bcs.u8()), image_url: bcs_1.bcs.vector(bcs_1.bcs.u8()), project_url: bcs_1.bcs.vector(bcs_1.bcs.u8()), sui_address: bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), }), gas_price: bcs_1.bcs.u64(), commission_rate: bcs_1.bcs.u64(), protocol_public_key: bcs_1.bcs.vector(bcs_1.bcs.u8()), proof_of_possession: bcs_1.bcs.vector(bcs_1.bcs.u8()), network_public_key: bcs_1.bcs.vector(bcs_1.bcs.u8()), worker_public_key: bcs_1.bcs.vector(bcs_1.bcs.u8()), network_address: bcs_1.bcs.vector(bcs_1.bcs.u8()), p2p_address: bcs_1.bcs.vector(bcs_1.bcs.u8()), primary_address: bcs_1.bcs.vector(bcs_1.bcs.u8()), worker_address: bcs_1.bcs.vector(bcs_1.bcs.u8())
        });
    }
    ;
    ...
    static async fetch(client, id) {
        ...
        return GenesisValidatorMetadata.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.GenesisValidatorMetadata = GenesisValidatorMetadata;
GenesisValidatorMetadata.$typeName = `${index_1.PKG_V10}::genesis::GenesisValidatorMetadata`;
GenesisValidatorMetadata.$numTypeParams = 0;
GenesisValidatorMetadata.$isPhantom = [];
/* ============================== TokenAllocation =============================== */
function isTokenAllocation(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V10}::genesis::TokenAllocation`; }
class TokenAllocation {
    ...
    static get bcs() {
        return bcs_1.bcs.struct("TokenAllocation", {
            recipient_address: bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), }), amount_mist: bcs_1.bcs.u64(), staked_with_validator: structs_1.Option.bcs(bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), }))
        });
    }
    ;
    ...
    static async fetch(client, id) {
        ...
        return TokenAllocation.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.TokenAllocation = TokenAllocation;
TokenAllocation.$typeName = `${index_1.PKG_V10}::genesis::TokenAllocation`;
TokenAllocation.$numTypeParams = 0;
TokenAllocation.$isPhantom = [];
/* ============================== TokenDistributionSchedule =============================== */
function isTokenDistributionSchedule(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V10}::genesis::TokenDistributionSchedule`; }
class TokenDistributionSchedule {
    ...
    static async fetch(client, id) {
        ...
        return TokenDistributionSchedule.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.TokenDistributionSchedule = TokenDistributionSchedule;
TokenDistributionSchedule.$typeName = `${index_1.PKG_V10}::genesis::TokenDistributionSchedule`;

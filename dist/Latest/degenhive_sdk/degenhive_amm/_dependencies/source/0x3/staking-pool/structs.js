...
function isPoolTokenExchangeRate(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V10}::staking_pool::PoolTokenExchangeRate`; }
class PoolTokenExchangeRate {
    ...
    static async fetch(client, id) {
        ...
        return PoolTokenExchangeRate.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.PoolTokenExchangeRate = PoolTokenExchangeRate;
PoolTokenExchangeRate.$typeName = `${index_1.PKG_V10}::staking_pool::PoolTokenExchangeRate`;
PoolTokenExchangeRate.$numTypeParams = 0;
PoolTokenExchangeRate.$isPhantom = [];
/* ============================== StakedSui =============================== */
function isStakedSui(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V10}::staking_pool::StakedSui`; }
class StakedSui {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, id) {
        ...
        return StakedSui.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.StakedSui = StakedSui;
StakedSui.$typeName = `${index_1.PKG_V10}::staking_pool::StakedSui`;
StakedSui.$numTypeParams = 0;
StakedSui.$isPhantom = [];
/* ============================== StakingPool =============================== */
function isStakingPool(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V10}::staking_pool::StakingPool`; }
class StakingPool {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, id) {
        ...
        return StakingPool.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.StakingPool = StakingPool;
StakingPool.$typeName = `${index_1.PKG_V10}::staking_pool::StakingPool`;

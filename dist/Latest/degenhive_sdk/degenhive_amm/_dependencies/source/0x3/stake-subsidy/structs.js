...
/* ============================== StakeSubsidy =============================== */
function isStakeSubsidy(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V10}::stake_subsidy::StakeSubsidy`; }
class StakeSubsidy {
    ...
    static async fetch(client, id) {
        ...
        return StakeSubsidy.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.StakeSubsidy = StakeSubsidy;
StakeSubsidy.$typeName = `${index_1.PKG_V10}::stake_subsidy::StakeSubsidy`;

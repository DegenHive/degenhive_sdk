...
function isValidatorEpochInfoEvent(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V10}::validator_set::ValidatorEpochInfoEvent`; }
class ValidatorEpochInfoEvent {
    ...
    static get bcs() {
        return bcs_1.bcs.struct("ValidatorEpochInfoEvent", {
            epoch: bcs_1.bcs.u64(), validator_address: bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), }), reference_gas_survey_quote: bcs_1.bcs.u64(), stake: bcs_1.bcs.u64(), commission_rate: bcs_1.bcs.u64(), pool_staking_reward: bcs_1.bcs.u64(), storage_fund_staking_reward: bcs_1.bcs.u64(), pool_token_exchange_rate: structs_6.PoolTokenExchangeRate.bcs, tallying_rule_reporters: bcs_1.bcs.vector(bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), })), tallying_rule_global_score: bcs_1.bcs.u64()
        });
    }
    ;
    ...
    static async fetch(client, id) {
        ...
        return ValidatorEpochInfoEvent.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.ValidatorEpochInfoEvent = ValidatorEpochInfoEvent;
ValidatorEpochInfoEvent.$typeName = `${index_1.PKG_V10}::validator_set::ValidatorEpochInfoEvent`;
ValidatorEpochInfoEvent.$numTypeParams = 0;
ValidatorEpochInfoEvent.$isPhantom = [];
/* ============================== ValidatorEpochInfoEventV2 =============================== */
function isValidatorEpochInfoEventV2(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V10}::validator_set::ValidatorEpochInfoEventV2`; }
class ValidatorEpochInfoEventV2 {
    ...
    static async fetch(client, id) {
        ...
        return ValidatorEpochInfoEventV2.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.ValidatorEpochInfoEventV2 = ValidatorEpochInfoEventV2;
ValidatorEpochInfoEventV2.$typeName = `${index_1.PKG_V10}::validator_set::ValidatorEpochInfoEventV2`;
ValidatorEpochInfoEventV2.$numTypeParams = 0;
ValidatorEpochInfoEventV2.$isPhantom = [];
/* ============================== ValidatorJoinEvent =============================== */
function isValidatorJoinEvent(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V10}::validator_set::ValidatorJoinEvent`; }
class ValidatorJoinEvent {
    ...
    static get bcs() {
        return bcs_1.bcs.struct("ValidatorJoinEvent", {
            epoch: bcs_1.bcs.u64(), validator_address: bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), }), staking_pool_id: structs_2.ID.bcs
        });
    }
    ;
    ...
    static async fetch(client, id) {
        ...
        return ValidatorJoinEvent.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.ValidatorJoinEvent = ValidatorJoinEvent;
ValidatorJoinEvent.$typeName = `${index_1.PKG_V10}::validator_set::ValidatorJoinEvent`;
ValidatorJoinEvent.$numTypeParams = 0;
ValidatorJoinEvent.$isPhantom = [];
/* ============================== ValidatorLeaveEvent =============================== */
function isValidatorLeaveEvent(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V10}::validator_set::ValidatorLeaveEvent`; }
class ValidatorLeaveEvent {
    ...
    static reified() { return { typeName: ValidatorLeaveEvent.$typeName, fullTypeName: (0, util_1.composeSuiType)(ValidatorLeaveEvent.$typeName, ...[]), typeArgs: [], isPhantom: ValidatorLeaveEvent.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => ValidatorLeaveEvent.fromFields(fields), fromFieldsWithTypes: (item) => ValidatorLeaveEvent.fromFieldsWithTypes(item), fromBcs: (data) => ValidatorLeaveEvent.fromBcs(data), bcs: ValidatorLeaveEvent.bcs, fromJSONField: (field) => ValidatorLeaveEvent.fromJSONField(field), fromJSON: (json) => ValidatorLeaveEvent.fromJSON(json), fromSuiParsedData: (content) => ValidatorLeaveEvent.fromSuiParsedData(content), fetch: async (client, id) => ValidatorLeaveEvent.fetch(client, id), new: (fields) => { return new ValidatorLeaveEvent([], fields); }, kind: "StructClassReified", }; }
    ...
    static get bcs() {
        return bcs_1.bcs.struct("ValidatorLeaveEvent", {
            epoch: bcs_1.bcs.u64(), validator_address: bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), }), staking_pool_id: structs_2.ID.bcs, is_voluntary: bcs_1.bcs.bool()
        });
    }
    ;
    ...
    static async fetch(client, id) {
        ...
        return ValidatorLeaveEvent.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.ValidatorLeaveEvent = ValidatorLeaveEvent;
ValidatorLeaveEvent.$typeName = `${index_1.PKG_V10}::validator_set::ValidatorLeaveEvent`;
ValidatorLeaveEvent.$numTypeParams = 0;
ValidatorLeaveEvent.$isPhantom = [];
/* ============================== ValidatorSet =============================== */
function isValidatorSet(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V10}::validator_set::ValidatorSet`; }
class ValidatorSet {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static reified() { return { typeName: ValidatorSet.$typeName, fullTypeName: (0, util_1.composeSuiType)(ValidatorSet.$typeName, ...[]), typeArgs: [], isPhantom: ValidatorSet.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => ValidatorSet.fromFields(fields), fromFieldsWithTypes: (item) => ValidatorSet.fromFieldsWithTypes(item), fromBcs: (data) => ValidatorSet.fromBcs(data), bcs: ValidatorSet.bcs, fromJSONField: (field) => ValidatorSet.fromJSONField(field), fromJSON: (json) => ValidatorSet.fromJSON(json), fromSuiParsedData: (content) => ValidatorSet.fromSuiParsedData(content), fetch: async (client, id) => ValidatorSet.fetch(client, id), new: (fields) => { return new ValidatorSet([], fields); }, kind: "StructClassReified", }; }
    ...
    static get bcs() {
        return bcs_1.bcs.struct("ValidatorSet", {
            total_stake: bcs_1.bcs.u64(), active_validators: bcs_1.bcs.vector(structs_8.Validator.bcs), pending_active_validators: structs_3.TableVec.bcs, pending_removals: bcs_1.bcs.vector(bcs_1.bcs.u64()), staking_pool_mappings: structs_4.Table.bcs, inactive_validators: structs_4.Table.bcs, validator_candidates: structs_4.Table.bcs, at_risk_validators: structs_5.VecMap.bcs(bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), }), bcs_1.bcs.u64()), extra_fields: structs_1.Bag.bcs
        });
    }
    ;
    ...
    static async fetch(client, id) {
        ...
        return ValidatorSet.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.ValidatorSet = ValidatorSet;
ValidatorSet.$typeName = `${index_1.PKG_V10}::validator_set::ValidatorSet`;

...
/* ============================== StakingRequestEvent =============================== */
function isStakingRequestEvent(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V10}::validator::StakingRequestEvent`; }
class StakingRequestEvent {
    ...
    static get bcs() {
        return bcs_1.bcs.struct("StakingRequestEvent", {
            pool_id: structs_4.ID.bcs, validator_address: bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), }), staker_address: bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), }), epoch: bcs_1.bcs.u64(), amount: bcs_1.bcs.u64()
        });
    }
    ;
    ...
    static async fetch(client, id) {
        ...
        return StakingRequestEvent.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.StakingRequestEvent = StakingRequestEvent;
StakingRequestEvent.$typeName = `${index_1.PKG_V10}::validator::StakingRequestEvent`;
StakingRequestEvent.$numTypeParams = 0;
StakingRequestEvent.$isPhantom = [];
/* ============================== UnstakingRequestEvent =============================== */
function isUnstakingRequestEvent(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V10}::validator::UnstakingRequestEvent`; }
class UnstakingRequestEvent {
    ...
    static get bcs() {
        return bcs_1.bcs.struct("UnstakingRequestEvent", {
            pool_id: structs_4.ID.bcs, validator_address: bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), }), staker_address: bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), }), stake_activation_epoch: bcs_1.bcs.u64(), unstaking_epoch: bcs_1.bcs.u64(), principal_amount: bcs_1.bcs.u64(), reward_amount: bcs_1.bcs.u64()
        });
    }
    ;
    ...
    static async fetch(client, id) {
        ...
        return UnstakingRequestEvent.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.UnstakingRequestEvent = UnstakingRequestEvent;
UnstakingRequestEvent.$typeName = `${index_1.PKG_V10}::validator::UnstakingRequestEvent`;
UnstakingRequestEvent.$numTypeParams = 0;
UnstakingRequestEvent.$isPhantom = [];
/* ============================== Validator =============================== */
function isValidator(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V10}::validator::Validator`; }
class Validator {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static reified() { return { typeName: Validator.$typeName, fullTypeName: (0, util_1.composeSuiType)(Validator.$typeName, ...[]), typeArgs: [], isPhantom: Validator.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => Validator.fromFields(fields), fromFieldsWithTypes: (item) => Validator.fromFieldsWithTypes(item), fromBcs: (data) => Validator.fromBcs(data), bcs: Validator.bcs, fromJSONField: (field) => Validator.fromJSONField(field), fromJSON: (json) => Validator.fromJSON(json), fromSuiParsedData: (content) => Validator.fromSuiParsedData(content), fetch: async (client, id) => Validator.fetch(client, id), new: (fields) => { return new Validator([], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, id) {
        ...
        return Validator.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.Validator = Validator;
Validator.$typeName = `${index_1.PKG_V10}::validator::Validator`;
Validator.$numTypeParams = 0;
Validator.$isPhantom = [];
/* ============================== ValidatorMetadata =============================== */
function isValidatorMetadata(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V10}::validator::ValidatorMetadata`; }
class ValidatorMetadata {
    ...
    static async fetch(client, id) {
        ...
        return ValidatorMetadata.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.ValidatorMetadata = ValidatorMetadata;
ValidatorMetadata.$typeName = `${index_1.PKG_V10}::validator::ValidatorMetadata`;

...
/* ============================== StorageFund =============================== */
function isStorageFund(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V10}::storage_fund::StorageFund`; }
class StorageFund {
    ...
    static async fetch(client, id) {
        ...
        return StorageFund.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.StorageFund = StorageFund;
StorageFund.$typeName = `${index_1.PKG_V10}::storage_fund::StorageFund`;

...
/* ============================== BeesBurnt =============================== */
function isBeesBurnt(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::bee_trade::BeesBurnt`; }
class BeesBurnt {
    ...
    static async fetch(client, id) {
        ...
        return BeesBurnt.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.BeesBurnt = BeesBurnt;
BeesBurnt.$typeName = `${index_1.PKG_V1}::bee_trade::BeesBurnt`;
BeesBurnt.$numTypeParams = 0;
BeesBurnt.$isPhantom = [];
/* ============================== BeesForEngagementPerEpochUpdated =============================== */
function isBeesForEngagementPerEpochUpdated(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::bee_trade::BeesForEngagementPerEpochUpdated`; }
class BeesForEngagementPerEpochUpdated {
    ...
    static async fetch(client, id) {
        ...
        return BeesForEngagementPerEpochUpdated.fromBcs((0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.BeesForEngagementPerEpochUpdated = BeesForEngagementPerEpochUpdated;
BeesForEngagementPerEpochUpdated.$typeName = `${index_1.PKG_V1}::bee_trade::BeesForEngagementPerEpochUpdated`;
BeesForEngagementPerEpochUpdated.$numTypeParams = 0;
BeesForEngagementPerEpochUpdated.$isPhantom = [];
/* ============================== BeesManager =============================== */
function isBeesManager(type) { type = (0, util_1.compressSuiType)(type); return type.startsWith(`${index_1.PKG_V1}::bee_trade::BeesManager` + '<'); }
class BeesManager {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static async fetch(client, typeArg, id) {
        ...
        ;
        return BeesManager.fromBcs(typeArg, (0, utils_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.BeesManager = BeesManager;
BeesManager.$typeName = `${index_1.PKG_V1}::bee_trade::BeesManager`;

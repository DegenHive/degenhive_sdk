...
const structs_4 = require("../../_dependencies/source/0xde95a90163cfc2474c23284f8abe78dd602915dbc0b2a65452bf27c38d11392c/hive-profile/structs");
...
/* ============================== HiveOracle =============================== */
function isHiveOracle(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::oracle::HiveOracle`; }
class HiveOracle {
    ...
    static get bcs() {
        return bcs_1.bcs.struct("HiveOracle", {
            id: structs_3.UID.bcs, update_cap: structs_4.TwapUpdateCap.bcs, sui_hive_pool_addr: structs_1.Option.bcs(bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), })), usdc_sui_pool_addr: structs_1.Option.bcs(bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), })), snapshots: structs_2.LinkedTable.bcs(bcs_1.bcs.u64()), window_size: bcs_1.bcs.u64(), tolerance: bcs_1.bcs.u64(), module_version: bcs_1.bcs.u64()
        });
    }
    ;
...
HiveOracle.$typeName = `${index_1.PKG_V1}::oracle::HiveOracle`;
HiveOracle.$numTypeParams = 0;
HiveOracle.$isPhantom = [];
/* ============================== HiveOracleSnapshotRecorded =============================== */
function isHiveOracleSnapshotRecorded(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::oracle::HiveOracleSnapshotRecorded`; }
class HiveOracleSnapshotRecorded {
    ...
    static reified() { return { typeName: HiveOracleSnapshotRecorded.$typeName, fullTypeName: (0, util_1.composeSuiType)(HiveOracleSnapshotRecorded.$typeName, ...[]), typeArgs: [], isPhantom: HiveOracleSnapshotRecorded.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => HiveOracleSnapshotRecorded.fromFields(fields), fromFieldsWithTypes: (item) => HiveOracleSnapshotRecorded.fromFieldsWithTypes(item), fromBcs: (data) => HiveOracleSnapshotRecorded.fromBcs(data), bcs: HiveOracleSnapshotRecorded.bcs, fromJSONField: (field) => HiveOracleSnapshotRecorded.fromJSONField(field), fromJSON: (json) => HiveOracleSnapshotRecorded.fromJSON(json), fromSuiParsedData: (content) => HiveOracleSnapshotRecorded.fromSuiParsedData(content), fetch: async (client, id) => HiveOracleSnapshotRecorded.fetch(client, id), new: (fields) => { return new HiveOracleSnapshotRecorded([], fields); }, kind: "StructClassReified", }; }
...
HiveOracleSnapshotRecorded.$typeName = `${index_1.PKG_V1}::oracle::HiveOracleSnapshotRecorded`;
HiveOracleSnapshotRecorded.$numTypeParams = 0;
HiveOracleSnapshotRecorded.$isPhantom = [];
/* ============================== HiveOracleUpdated =============================== */
function isHiveOracleUpdated(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::oracle::HiveOracleUpdated`; }
class HiveOracleUpdated {
    ...
    static reified() { return { typeName: HiveOracleUpdated.$typeName, fullTypeName: (0, util_1.composeSuiType)(HiveOracleUpdated.$typeName, ...[]), typeArgs: [], isPhantom: HiveOracleUpdated.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => HiveOracleUpdated.fromFields(fields), fromFieldsWithTypes: (item) => HiveOracleUpdated.fromFieldsWithTypes(item), fromBcs: (data) => HiveOracleUpdated.fromBcs(data), bcs: HiveOracleUpdated.bcs, fromJSONField: (field) => HiveOracleUpdated.fromJSONField(field), fromJSON: (json) => HiveOracleUpdated.fromJSON(json), fromSuiParsedData: (content) => HiveOracleUpdated.fromSuiParsedData(content), fetch: async (client, id) => HiveOracleUpdated.fetch(client, id), new: (fields) => { return new HiveOracleUpdated([], fields); }, kind: "StructClassReified", }; }
    ...
    static get bcs() {
        return bcs_1.bcs.struct("HiveOracleUpdated", {
            sui_hive_pool_addr: structs_1.Option.bcs(bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), })), usdc_sui_pool_addr: structs_1.Option.bcs(bcs_1.bcs.bytes(32).transform({ input: (val) => (0, utils_1.fromHEX)(val), output: (val) => (0, utils_1.toHEX)(val), })), window_size: bcs_1.bcs.u64(), tolerance: bcs_1.bcs.u64()
        });
    }
    ;
...
HiveOracleUpdated.$typeName = `${index_1.PKG_V1}::oracle::HiveOracleUpdated`;
HiveOracleUpdated.$numTypeParams = 0;
HiveOracleUpdated.$isPhantom = [];
/* ============================== HiveTwapSnapshot =============================== */
function isHiveTwapSnapshot(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V1}::oracle::HiveTwapSnapshot`; }
...
HiveTwapSnapshot.$typeName = `${index_1.PKG_V1}::oracle::HiveTwapSnapshot`;

...
/* ============================== TypeName =============================== */
function isTypeName(type) { type = (0, util_1.compressSuiType)(type); return type === "0x1::type_name::TypeName"; }
class TypeName {
    ...
    static reified() { return { typeName: TypeName.$typeName, fullTypeName: (0, util_1.composeSuiType)(TypeName.$typeName, ...[]), typeArgs: [], reifiedTypeArgs: [], fromFields: (fields) => TypeName.fromFields(fields), fromFieldsWithTypes: (item) => TypeName.fromFieldsWithTypes(item), fromBcs: (data) => TypeName.fromBcs(data), bcs: TypeName.bcs, fromJSONField: (field) => TypeName.fromJSONField(field), fromJSON: (json) => TypeName.fromJSON(json), fromSuiParsedData: (content) => TypeName.fromSuiParsedData(content), fetch: async (client, id) => TypeName.fetch(client, id), new: (fields) => { return new TypeName([], fields); }, kind: "StructClassReified", }; }
    ...
    static async fetch(client, id) {
        ...
        return TypeName.fromBcs((0, bcs_1.fromB64)(res.data.bcs.bcsBytes));
    }
}
exports.TypeName = TypeName;
TypeName.$typeName = "0x1::type_name::TypeName";

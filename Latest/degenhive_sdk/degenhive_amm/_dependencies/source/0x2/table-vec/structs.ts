...
export class TableVec<Element extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V21}::table_vec::TableVec`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TableVec.$typeName; readonly $fullTypeName: `${typeof PKG_V21}::table_vec::TableVec<${PhantomToTypeStr<Element>}>`; readonly $typeArgs: [PhantomToTypeStr<Element>]; readonly $isPhantom = TableVec.$isPhantom;

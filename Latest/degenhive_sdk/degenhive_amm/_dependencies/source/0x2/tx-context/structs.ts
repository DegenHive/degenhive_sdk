...
export class TxContext implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V21}::tx_context::TxContext`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = TxContext.$typeName; readonly $fullTypeName: `${typeof PKG_V21}::tx_context::TxContext`; readonly $typeArgs: []; readonly $isPhantom = TxContext.$isPhantom;

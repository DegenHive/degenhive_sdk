...
export class Receiving<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V21}::transfer::Receiving`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = Receiving.$typeName; readonly $fullTypeName: `${typeof PKG_V21}::transfer::Receiving<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = Receiving.$isPhantom;

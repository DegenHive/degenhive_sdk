...
export class Borrow implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V21}::borrow::Borrow`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Borrow.$typeName; readonly $fullTypeName: `${typeof PKG_V21}::borrow::Borrow`; readonly $typeArgs: []; readonly $isPhantom = Borrow.$isPhantom;
...
export class Referent<T extends TypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V21}::borrow::Referent`; static readonly $numTypeParams = 1; static readonly $isPhantom = [false,] as const;

 readonly $typeName = Referent.$typeName; readonly $fullTypeName: `${typeof PKG_V21}::borrow::Referent<${ToTypeStr<T>}>`; readonly $typeArgs: [ToTypeStr<T>]; readonly $isPhantom = Referent.$isPhantom;

...
export class Wrapper<Name extends TypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V21}::dynamic_object_field::Wrapper`; static readonly $numTypeParams = 1; static readonly $isPhantom = [false,] as const;

 readonly $typeName = Wrapper.$typeName; readonly $fullTypeName: `${typeof PKG_V21}::dynamic_object_field::Wrapper<${ToTypeStr<Name>}>`; readonly $typeArgs: [ToTypeStr<Name>]; readonly $isPhantom = Wrapper.$isPhantom;

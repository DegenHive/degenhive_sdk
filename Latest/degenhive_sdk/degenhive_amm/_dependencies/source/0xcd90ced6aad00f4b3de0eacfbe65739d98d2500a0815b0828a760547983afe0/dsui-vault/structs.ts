...
export class DSuiVault implements StructClass { __StructClass = true as const;
 ...
 return DSuiVault.fromBcs( fromB64(res.data.bcs.bcsBytes) ); }
...
export class DegenSUIFeeStructureUpdated implements StructClass { __StructClass = true as const;
 ...
 return DegenSUIFeeStructureUpdated.fromBcs( fromB64(res.data.bcs.bcsBytes) ); }
...
export class UserClaimedSui implements StructClass { __StructClass = true as const;
 ...
 static reified( ): UserClaimedSuiReified { return { typeName: UserClaimedSui.$typeName, fullTypeName: composeSuiType( UserClaimedSui.$typeName, ...[] ) as `${typeof PKG_V1}::dsui_vault::UserClaimedSui`, typeArgs: [ ] as [], isPhantom: UserClaimedSui.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => UserClaimedSui.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => UserClaimedSui.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => UserClaimedSui.fromBcs( data, ), bcs: UserClaimedSui.bcs, fromJSONField: (field: any) => UserClaimedSui.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => UserClaimedSui.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => UserClaimedSui.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => UserClaimedSui.fetch( client, id, ), new: ( fields: UserClaimedSuiFields, ) => { return new UserClaimedSui( [], fields ) }, kind: "StructClassReified", } }
...
export class ValidatorPoolRewardsUpdated implements StructClass { __StructClass = true as const;
 ...
 static reified( ): ValidatorPoolRewardsUpdatedReified { return { typeName: ValidatorPoolRewardsUpdated.$typeName, fullTypeName: composeSuiType( ValidatorPoolRewardsUpdated.$typeName, ...[] ) as `${typeof PKG_V1}::dsui_vault::ValidatorPoolRewardsUpdated`, typeArgs: [ ] as [], isPhantom: ValidatorPoolRewardsUpdated.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => ValidatorPoolRewardsUpdated.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ValidatorPoolRewardsUpdated.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => ValidatorPoolRewardsUpdated.fromBcs( data, ), bcs: ValidatorPoolRewardsUpdated.bcs, fromJSONField: (field: any) => ValidatorPoolRewardsUpdated.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => ValidatorPoolRewardsUpdated.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => ValidatorPoolRewardsUpdated.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => ValidatorPoolRewardsUpdated.fetch( client, id, ), new: ( fields: ValidatorPoolRewardsUpdatedFields, ) => { return new ValidatorPoolRewardsUpdated( [], fields ) }, kind: "StructClassReified", } }

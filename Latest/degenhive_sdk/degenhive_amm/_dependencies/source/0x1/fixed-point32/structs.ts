...
export function isFixedPoint32(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V8}::fixed_point32::FixedPoint32`; }
...
export class FixedPoint32 implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V8}::fixed_point32::FixedPoint32`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = FixedPoint32.$typeName; readonly $fullTypeName: `${typeof PKG_V8}::fixed_point32::FixedPoint32`; readonly $typeArgs: []; readonly $isPhantom = FixedPoint32.$isPhantom;

 readonly value: ToField<"u64">

 private constructor(typeArgs: [], fields: FixedPoint32Fields, ) { this.$fullTypeName = composeSuiType( FixedPoint32.$typeName, ...typeArgs ) as `${typeof PKG_V8}::fixed_point32::FixedPoint32`; this.$typeArgs = typeArgs;

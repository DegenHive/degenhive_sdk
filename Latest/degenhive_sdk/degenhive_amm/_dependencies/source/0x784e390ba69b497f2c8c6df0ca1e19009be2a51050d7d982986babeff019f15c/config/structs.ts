...
export function isBuidlersRoyaltyCollectionAbility(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::config::BuidlersRoyaltyCollectionAbility`; }
...
export class BuidlersRoyaltyCollectionAbility implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::config::BuidlersRoyaltyCollectionAbility`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = BuidlersRoyaltyCollectionAbility.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::config::BuidlersRoyaltyCollectionAbility`; readonly $typeArgs: []; readonly $isPhantom = BuidlersRoyaltyCollectionAbility.$isPhantom;

 readonly id: ToField<UID>

 private constructor(typeArgs: [], fields: BuidlersRoyaltyCollectionAbilityFields, ) { this.$fullTypeName = composeSuiType( BuidlersRoyaltyCollectionAbility.$typeName, ...typeArgs ) as `${typeof PKG_V1}::config::BuidlersRoyaltyCollectionAbility`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified( ): BuidlersRoyaltyCollectionAbilityReified { return { typeName: BuidlersRoyaltyCollectionAbility.$typeName, fullTypeName: composeSuiType( BuidlersRoyaltyCollectionAbility.$typeName, ...[] ) as `${typeof PKG_V1}::config::BuidlersRoyaltyCollectionAbility`, typeArgs: [ ] as [], isPhantom: BuidlersRoyaltyCollectionAbility.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => BuidlersRoyaltyCollectionAbility.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => BuidlersRoyaltyCollectionAbility.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => BuidlersRoyaltyCollectionAbility.fromBcs( data, ), bcs: BuidlersRoyaltyCollectionAbility.bcs, fromJSONField: (field: any) => BuidlersRoyaltyCollectionAbility.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => BuidlersRoyaltyCollectionAbility.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => BuidlersRoyaltyCollectionAbility.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => BuidlersRoyaltyCollectionAbility.fetch( client, id, ), new: ( fields: BuidlersRoyaltyCollectionAbilityFields, ) => { return new BuidlersRoyaltyCollectionAbility( [], fields ) }, kind: "StructClassReified", } }
...
export function isDecimalPrecisionForCoinTypesWhitelisted(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::config::DecimalPrecisionForCoinTypesWhitelisted`; }
...
export class DecimalPrecisionForCoinTypesWhitelisted implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V1}::config::DecimalPrecisionForCoinTypesWhitelisted`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = DecimalPrecisionForCoinTypesWhitelisted.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::config::DecimalPrecisionForCoinTypesWhitelisted`; readonly $typeArgs: []; readonly $isPhantom = DecimalPrecisionForCoinTypesWhitelisted.$isPhantom;

 readonly coinTypes: ToField<Vector<String>>; readonly decimalPrecisions: ToField<Vector<"u8">>

 private constructor(typeArgs: [], fields: DecimalPrecisionForCoinTypesWhitelistedFields, ) { this.$fullTypeName = composeSuiType( DecimalPrecisionForCoinTypesWhitelisted.$typeName, ...typeArgs ) as `${typeof PKG_V1}::config::DecimalPrecisionForCoinTypesWhitelisted`; this.$typeArgs = typeArgs;

 this.coinTypes = fields.coinTypes;; this.decimalPrecisions = fields.decimalPrecisions; }

 static reified( ): DecimalPrecisionForCoinTypesWhitelistedReified { return { typeName: DecimalPrecisionForCoinTypesWhitelisted.$typeName, fullTypeName: composeSuiType( DecimalPrecisionForCoinTypesWhitelisted.$typeName, ...[] ) as `${typeof PKG_V1}::config::DecimalPrecisionForCoinTypesWhitelisted`, typeArgs: [ ] as [], isPhantom: DecimalPrecisionForCoinTypesWhitelisted.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => DecimalPrecisionForCoinTypesWhitelisted.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => DecimalPrecisionForCoinTypesWhitelisted.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => DecimalPrecisionForCoinTypesWhitelisted.fromBcs( data, ), bcs: DecimalPrecisionForCoinTypesWhitelisted.bcs, fromJSONField: (field: any) => DecimalPrecisionForCoinTypesWhitelisted.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => DecimalPrecisionForCoinTypesWhitelisted.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => DecimalPrecisionForCoinTypesWhitelisted.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => DecimalPrecisionForCoinTypesWhitelisted.fetch( client, id, ), new: ( fields: DecimalPrecisionForCoinTypesWhitelistedFields, ) => { return new DecimalPrecisionForCoinTypesWhitelisted( [], fields ) }, kind: "StructClassReified", } }
...
export function isDefaultFeeSet(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::config::DefaultFeeSet`; }
...
export class DefaultFeeSet implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V1}::config::DefaultFeeSet`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = DefaultFeeSet.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::config::DefaultFeeSet`; readonly $typeArgs: []; readonly $isPhantom = DefaultFeeSet.$isPhantom;

 readonly curve: ToField<TypeName>; readonly totalFeeBps: ToField<"u64">; readonly hiveFeePercent: ToField<"u64">

 private constructor(typeArgs: [], fields: DefaultFeeSetFields, ) { this.$fullTypeName = composeSuiType( DefaultFeeSet.$typeName, ...typeArgs ) as `${typeof PKG_V1}::config::DefaultFeeSet`; this.$typeArgs = typeArgs;

 this.curve = fields.curve;; this.totalFeeBps = fields.totalFeeBps;; this.hiveFeePercent = fields.hiveFeePercent; }

 static reified( ): DefaultFeeSetReified { return { typeName: DefaultFeeSet.$typeName, fullTypeName: composeSuiType( DefaultFeeSet.$typeName, ...[] ) as `${typeof PKG_V1}::config::DefaultFeeSet`, typeArgs: [ ] as [], isPhantom: DefaultFeeSet.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => DefaultFeeSet.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => DefaultFeeSet.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => DefaultFeeSet.fromBcs( data, ), bcs: DefaultFeeSet.bcs, fromJSONField: (field: any) => DefaultFeeSet.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => DefaultFeeSet.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => DefaultFeeSet.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => DefaultFeeSet.fetch( client, id, ), new: ( fields: DefaultFeeSetFields, ) => { return new DefaultFeeSet( [], fields ) }, kind: "StructClassReified", } }
...
export function isDegenHiveDeployerCap(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::config::DegenHiveDeployerCap`; }
...
export class DegenHiveDeployerCap implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::config::DegenHiveDeployerCap`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = DegenHiveDeployerCap.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::config::DegenHiveDeployerCap`; readonly $typeArgs: []; readonly $isPhantom = DegenHiveDeployerCap.$isPhantom;

 readonly id: ToField<UID>; readonly managerInitialized: ToField<"bool">; readonly vaultInitialized: ToField<"bool">

 private constructor(typeArgs: [], fields: DegenHiveDeployerCapFields, ) { this.$fullTypeName = composeSuiType( DegenHiveDeployerCap.$typeName, ...typeArgs ) as `${typeof PKG_V1}::config::DegenHiveDeployerCap`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.managerInitialized = fields.managerInitialized;; this.vaultInitialized = fields.vaultInitialized; }

 static reified( ): DegenHiveDeployerCapReified { return { typeName: DegenHiveDeployerCap.$typeName, fullTypeName: composeSuiType( DegenHiveDeployerCap.$typeName, ...[] ) as `${typeof PKG_V1}::config::DegenHiveDeployerCap`, typeArgs: [ ] as [], isPhantom: DegenHiveDeployerCap.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => DegenHiveDeployerCap.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => DegenHiveDeployerCap.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => DegenHiveDeployerCap.fromBcs( data, ), bcs: DegenHiveDeployerCap.bcs, fromJSONField: (field: any) => DegenHiveDeployerCap.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => DegenHiveDeployerCap.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => DegenHiveDeployerCap.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => DegenHiveDeployerCap.fetch( client, id, ), new: ( fields: DegenHiveDeployerCapFields, ) => { return new DegenHiveDeployerCap( [], fields ) }, kind: "StructClassReified", } }
...
export function isFeeCollectedForCoin(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::config::FeeCollectedForCoin`; }
...
export class FeeCollectedForCoin implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V1}::config::FeeCollectedForCoin`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = FeeCollectedForCoin.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::config::FeeCollectedForCoin`; readonly $typeArgs: []; readonly $isPhantom = FeeCollectedForCoin.$isPhantom;

 readonly token: ToField<TypeName>; readonly amount: ToField<"u64">

 private constructor(typeArgs: [], fields: FeeCollectedForCoinFields, ) { this.$fullTypeName = composeSuiType( FeeCollectedForCoin.$typeName, ...typeArgs ) as `${typeof PKG_V1}::config::FeeCollectedForCoin`; this.$typeArgs = typeArgs;

 this.token = fields.token;; this.amount = fields.amount; }

 static reified( ): FeeCollectedForCoinReified { return { typeName: FeeCollectedForCoin.$typeName, fullTypeName: composeSuiType( FeeCollectedForCoin.$typeName, ...[] ) as `${typeof PKG_V1}::config::FeeCollectedForCoin`, typeArgs: [ ] as [], isPhantom: FeeCollectedForCoin.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => FeeCollectedForCoin.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => FeeCollectedForCoin.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => FeeCollectedForCoin.fromBcs( data, ), bcs: FeeCollectedForCoin.bcs, fromJSONField: (field: any) => FeeCollectedForCoin.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => FeeCollectedForCoin.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => FeeCollectedForCoin.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => FeeCollectedForCoin.fetch( client, id, ), new: ( fields: FeeCollectedForCoinFields, ) => { return new FeeCollectedForCoin( [], fields ) }, kind: "StructClassReified", } }
...
export function isFeeCollector(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V1}::config::FeeCollector` + '<'); }
...
export function isFeeExtractedForCoin(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::config::FeeExtractedForCoin`; }
...
export class FeeExtractedForCoin implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V1}::config::FeeExtractedForCoin`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = FeeExtractedForCoin.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::config::FeeExtractedForCoin`; readonly $typeArgs: []; readonly $isPhantom = FeeExtractedForCoin.$isPhantom;

 readonly token: ToField<TypeName>; readonly amount: ToField<"u64">

 private constructor(typeArgs: [], fields: FeeExtractedForCoinFields, ) { this.$fullTypeName = composeSuiType( FeeExtractedForCoin.$typeName, ...typeArgs ) as `${typeof PKG_V1}::config::FeeExtractedForCoin`; this.$typeArgs = typeArgs;

 this.token = fields.token;; this.amount = fields.amount; }

 static reified( ): FeeExtractedForCoinReified { return { typeName: FeeExtractedForCoin.$typeName, fullTypeName: composeSuiType( FeeExtractedForCoin.$typeName, ...[] ) as `${typeof PKG_V1}::config::FeeExtractedForCoin`, typeArgs: [ ] as [], isPhantom: FeeExtractedForCoin.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => FeeExtractedForCoin.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => FeeExtractedForCoin.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => FeeExtractedForCoin.fromBcs( data, ), bcs: FeeExtractedForCoin.bcs, fromJSONField: (field: any) => FeeExtractedForCoin.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => FeeExtractedForCoin.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => FeeExtractedForCoin.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => FeeExtractedForCoin.fetch( client, id, ), new: ( fields: FeeExtractedForCoinFields, ) => { return new FeeExtractedForCoin( [], fields ) }, kind: "StructClassReified", } }
...
export function isFeeInfo(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::config::FeeInfo`; }
...
export class FeeInfo implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V1}::config::FeeInfo`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = FeeInfo.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::config::FeeInfo`; readonly $typeArgs: []; readonly $isPhantom = FeeInfo.$isPhantom;

 readonly totalFeeBps: ToField<"u64">; readonly hiveFeePercent: ToField<"u64">

 private constructor(typeArgs: [], fields: FeeInfoFields, ) { this.$fullTypeName = composeSuiType( FeeInfo.$typeName, ...typeArgs ) as `${typeof PKG_V1}::config::FeeInfo`; this.$typeArgs = typeArgs;

 this.totalFeeBps = fields.totalFeeBps;; this.hiveFeePercent = fields.hiveFeePercent; }

 static reified( ): FeeInfoReified { return { typeName: FeeInfo.$typeName, fullTypeName: composeSuiType( FeeInfo.$typeName, ...[] ) as `${typeof PKG_V1}::config::FeeInfo`, typeArgs: [ ] as [], isPhantom: FeeInfo.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => FeeInfo.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => FeeInfo.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => FeeInfo.fromBcs( data, ), bcs: FeeInfo.bcs, fromJSONField: (field: any) => FeeInfo.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => FeeInfo.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => FeeInfo.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => FeeInfo.fetch( client, id, ), new: ( fields: FeeInfoFields, ) => { return new FeeInfo( [], fields ) }, kind: "StructClassReified", } }
...
export function isHiveDaoCapability(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::config::HiveDaoCapability`; }
...
export class HiveDaoCapability implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::config::HiveDaoCapability`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = HiveDaoCapability.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::config::HiveDaoCapability`; readonly $typeArgs: []; readonly $isPhantom = HiveDaoCapability.$isPhantom;

 readonly id: ToField<UID>

 private constructor(typeArgs: [], fields: HiveDaoCapabilityFields, ) { this.$fullTypeName = composeSuiType( HiveDaoCapability.$typeName, ...typeArgs ) as `${typeof PKG_V1}::config::HiveDaoCapability`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified( ): HiveDaoCapabilityReified { return { typeName: HiveDaoCapability.$typeName, fullTypeName: composeSuiType( HiveDaoCapability.$typeName, ...[] ) as `${typeof PKG_V1}::config::HiveDaoCapability`, typeArgs: [ ] as [], isPhantom: HiveDaoCapability.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => HiveDaoCapability.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => HiveDaoCapability.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => HiveDaoCapability.fromBcs( data, ), bcs: HiveDaoCapability.bcs, fromJSONField: (field: any) => HiveDaoCapability.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => HiveDaoCapability.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => HiveDaoCapability.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => HiveDaoCapability.fetch( client, id, ), new: ( fields: HiveDaoCapabilityFields, ) => { return new HiveDaoCapability( [], fields ) }, kind: "StructClassReified", } }
...
export function isHiveEntryCap(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::config::HiveEntryCap`; }
...
export class HiveEntryCap implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::config::HiveEntryCap`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = HiveEntryCap.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::config::HiveEntryCap`; readonly $typeArgs: []; readonly $isPhantom = HiveEntryCap.$isPhantom;

 readonly id: ToField<UID>

 private constructor(typeArgs: [], fields: HiveEntryCapFields, ) { this.$fullTypeName = composeSuiType( HiveEntryCap.$typeName, ...typeArgs ) as `${typeof PKG_V1}::config::HiveEntryCap`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified( ): HiveEntryCapReified { return { typeName: HiveEntryCap.$typeName, fullTypeName: composeSuiType( HiveEntryCap.$typeName, ...[] ) as `${typeof PKG_V1}::config::HiveEntryCap`, typeArgs: [ ] as [], isPhantom: HiveEntryCap.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => HiveEntryCap.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => HiveEntryCap.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => HiveEntryCap.fromBcs( data, ), bcs: HiveEntryCap.bcs, fromJSONField: (field: any) => HiveEntryCap.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => HiveEntryCap.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => HiveEntryCap.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => HiveEntryCap.fetch( client, id, ), new: ( fields: HiveEntryCapFields, ) => { return new HiveEntryCap( [], fields ) }, kind: "StructClassReified", } }
...
export function isNewFeeCollectorKrafted(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::config::NewFeeCollectorKrafted`; }
...
export class NewFeeCollectorKrafted implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V1}::config::NewFeeCollectorKrafted`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = NewFeeCollectorKrafted.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::config::NewFeeCollectorKrafted`; readonly $typeArgs: []; readonly $isPhantom = NewFeeCollectorKrafted.$isPhantom;

 readonly coinType: ToField<String1>; readonly feeCollectorAddr: ToField<"address">

 private constructor(typeArgs: [], fields: NewFeeCollectorKraftedFields, ) { this.$fullTypeName = composeSuiType( NewFeeCollectorKrafted.$typeName, ...typeArgs ) as `${typeof PKG_V1}::config::NewFeeCollectorKrafted`; this.$typeArgs = typeArgs;

 this.coinType = fields.coinType;; this.feeCollectorAddr = fields.feeCollectorAddr; }

 static reified( ): NewFeeCollectorKraftedReified { return { typeName: NewFeeCollectorKrafted.$typeName, fullTypeName: composeSuiType( NewFeeCollectorKrafted.$typeName, ...[] ) as `${typeof PKG_V1}::config::NewFeeCollectorKrafted`, typeArgs: [ ] as [], isPhantom: NewFeeCollectorKrafted.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => NewFeeCollectorKrafted.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => NewFeeCollectorKrafted.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => NewFeeCollectorKrafted.fromBcs( data, ), bcs: NewFeeCollectorKrafted.bcs, fromJSONField: (field: any) => NewFeeCollectorKrafted.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => NewFeeCollectorKrafted.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => NewFeeCollectorKrafted.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => NewFeeCollectorKrafted.fetch( client, id, ), new: ( fields: NewFeeCollectorKraftedFields, ) => { return new NewFeeCollectorKrafted( [], fields ) }, kind: "StructClassReified", } }
...
export function isPoolHiveCapability(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::config::PoolHiveCapability`; }

export interface PoolHiveCapabilityFields { id: ToField<UID> }

export type PoolHiveCapabilityReified = Reified< PoolHiveCapability, PoolHiveCapabilityFields >;

export class PoolHiveCapability implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::config::PoolHiveCapability`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = PoolHiveCapability.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::config::PoolHiveCapability`; readonly $typeArgs: []; readonly $isPhantom = PoolHiveCapability.$isPhantom;

 readonly id: ToField<UID>

 private constructor(typeArgs: [], fields: PoolHiveCapabilityFields, ) { this.$fullTypeName = composeSuiType( PoolHiveCapability.$typeName, ...typeArgs ) as `${typeof PKG_V1}::config::PoolHiveCapability`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified( ): PoolHiveCapabilityReified { return { typeName: PoolHiveCapability.$typeName, fullTypeName: composeSuiType( PoolHiveCapability.$typeName, ...[] ) as `${typeof PKG_V1}::config::PoolHiveCapability`, typeArgs: [ ] as [], isPhantom: PoolHiveCapability.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => PoolHiveCapability.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => PoolHiveCapability.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => PoolHiveCapability.fromBcs( data, ), bcs: PoolHiveCapability.bcs, fromJSONField: (field: any) => PoolHiveCapability.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => PoolHiveCapability.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => PoolHiveCapability.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => PoolHiveCapability.fetch( client, id, ), new: ( fields: PoolHiveCapabilityFields, ) => { return new PoolHiveCapability( [], fields ) }, kind: "StructClassReified", } }

 static get r() { return PoolHiveCapability.reified() }

 static phantom( ): PhantomReified<ToTypeStr<PoolHiveCapability>> { return phantom(PoolHiveCapability.reified( )); } static get p() { return PoolHiveCapability.phantom() }

 static get bcs() { return bcs.struct("PoolHiveCapability", {

 id: UID.bcs

}) };

 static fromFields( fields: Record<string, any> ): PoolHiveCapability { return PoolHiveCapability.reified( ).new( { id: decodeFromFields(UID.reified(), fields.id) } ) }

 static fromFieldsWithTypes( item: FieldsWithTypes ): PoolHiveCapability { if (!isPoolHiveCapability(item.type)) { throw new Error("not a PoolHiveCapability type");

 }

 return PoolHiveCapability.reified( ).new( { id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id) } ) }

 static fromBcs( data: Uint8Array ): PoolHiveCapability { return PoolHiveCapability.fromFields( PoolHiveCapability.bcs.parse(data) ) }
 ...
 static fromJSONField( field: any ): PoolHiveCapability { return PoolHiveCapability.reified( ).new( { id: decodeFromJSONField(UID.reified(), field.id) } ) }

 static fromJSON( json: Record<string, any> ): PoolHiveCapability { if (json.$typeName !== PoolHiveCapability.$typeName) { throw new Error("not a WithTwoGenerics json object") };

 return PoolHiveCapability.fromJSONField( json, ) }

 static fromSuiParsedData( content: SuiParsedData ): PoolHiveCapability { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isPoolHiveCapability(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a PoolHiveCapability object`); } return PoolHiveCapability.fromFieldsWithTypes( content ); }

 static async fetch( client: SuiClient, id: string ): Promise<PoolHiveCapability> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching PoolHiveCapability object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isPoolHiveCapability(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a PoolHiveCapability object`); }

 return PoolHiveCapability.fromBcs( fromB64(res.data.bcs.bcsBytes) ); }

 }

/* ============================== StableIdentifierAdded =============================== */

export function isStableIdentifierAdded(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::config::StableIdentifierAdded`; }
...
export class StableIdentifierAdded implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V1}::config::StableIdentifierAdded`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = StableIdentifierAdded.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::config::StableIdentifierAdded`; readonly $typeArgs: []; readonly $isPhantom = StableIdentifierAdded.$isPhantom;

 readonly identifier: ToField<String1>

 private constructor(typeArgs: [], fields: StableIdentifierAddedFields, ) { this.$fullTypeName = composeSuiType( StableIdentifierAdded.$typeName, ...typeArgs ) as `${typeof PKG_V1}::config::StableIdentifierAdded`; this.$typeArgs = typeArgs;

 this.identifier = fields.identifier; }

 static reified( ): StableIdentifierAddedReified { return { typeName: StableIdentifierAdded.$typeName, fullTypeName: composeSuiType( StableIdentifierAdded.$typeName, ...[] ) as `${typeof PKG_V1}::config::StableIdentifierAdded`, typeArgs: [ ] as [], isPhantom: StableIdentifierAdded.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => StableIdentifierAdded.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => StableIdentifierAdded.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => StableIdentifierAdded.fromBcs( data, ), bcs: StableIdentifierAdded.bcs, fromJSONField: (field: any) => StableIdentifierAdded.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => StableIdentifierAdded.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => StableIdentifierAdded.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => StableIdentifierAdded.fetch( client, id, ), new: ( fields: StableIdentifierAddedFields, ) => { return new StableIdentifierAdded( [], fields ) }, kind: "StructClassReified", } }
...
export function isStableIdentifierRemoved(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::config::StableIdentifierRemoved`; }
...
export class StableIdentifierRemoved implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V1}::config::StableIdentifierRemoved`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = StableIdentifierRemoved.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::config::StableIdentifierRemoved`; readonly $typeArgs: []; readonly $isPhantom = StableIdentifierRemoved.$isPhantom;

 readonly identifier: ToField<String1>

 private constructor(typeArgs: [], fields: StableIdentifierRemovedFields, ) { this.$fullTypeName = composeSuiType( StableIdentifierRemoved.$typeName, ...typeArgs ) as `${typeof PKG_V1}::config::StableIdentifierRemoved`; this.$typeArgs = typeArgs;

 this.identifier = fields.identifier; }

 static reified( ): StableIdentifierRemovedReified { return { typeName: StableIdentifierRemoved.$typeName, fullTypeName: composeSuiType( StableIdentifierRemoved.$typeName, ...[] ) as `${typeof PKG_V1}::config::StableIdentifierRemoved`, typeArgs: [ ] as [], isPhantom: StableIdentifierRemoved.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => StableIdentifierRemoved.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => StableIdentifierRemoved.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => StableIdentifierRemoved.fromBcs( data, ), bcs: StableIdentifierRemoved.bcs, fromJSONField: (field: any) => StableIdentifierRemoved.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => StableIdentifierRemoved.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => StableIdentifierRemoved.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => StableIdentifierRemoved.fetch( client, id, ), new: ( fields: StableIdentifierRemovedFields, ) => { return new StableIdentifierRemoved( [], fields ) }, kind: "StructClassReified", } }
...
export function isThreeAmmFeeClaimCapability(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::config::ThreeAmmFeeClaimCapability`; }
...
export class ThreeAmmFeeClaimCapability implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::config::ThreeAmmFeeClaimCapability`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = ThreeAmmFeeClaimCapability.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::config::ThreeAmmFeeClaimCapability`; readonly $typeArgs: []; readonly $isPhantom = ThreeAmmFeeClaimCapability.$isPhantom;

 readonly id: ToField<UID>

 private constructor(typeArgs: [], fields: ThreeAmmFeeClaimCapabilityFields, ) { this.$fullTypeName = composeSuiType( ThreeAmmFeeClaimCapability.$typeName, ...typeArgs ) as `${typeof PKG_V1}::config::ThreeAmmFeeClaimCapability`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified( ): ThreeAmmFeeClaimCapabilityReified { return { typeName: ThreeAmmFeeClaimCapability.$typeName, fullTypeName: composeSuiType( ThreeAmmFeeClaimCapability.$typeName, ...[] ) as `${typeof PKG_V1}::config::ThreeAmmFeeClaimCapability`, typeArgs: [ ] as [], isPhantom: ThreeAmmFeeClaimCapability.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => ThreeAmmFeeClaimCapability.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ThreeAmmFeeClaimCapability.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => ThreeAmmFeeClaimCapability.fromBcs( data, ), bcs: ThreeAmmFeeClaimCapability.bcs, fromJSONField: (field: any) => ThreeAmmFeeClaimCapability.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => ThreeAmmFeeClaimCapability.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => ThreeAmmFeeClaimCapability.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => ThreeAmmFeeClaimCapability.fetch( client, id, ), new: ( fields: ThreeAmmFeeClaimCapabilityFields, ) => { return new ThreeAmmFeeClaimCapability( [], fields ) }, kind: "StructClassReified", } }
...
export function isTreasury(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V1}::config::Treasury` + '<'); }
...
export class Treasury<X extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::config::Treasury`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = Treasury.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::config::Treasury<${PhantomToTypeStr<X>}>`; readonly $typeArgs: [PhantomToTypeStr<X>]; readonly $isPhantom = Treasury.$isPhantom;

 readonly id: ToField<UID>; readonly balance: ToField<Balance<X>>

 private constructor(typeArgs: [PhantomToTypeStr<X>], fields: TreasuryFields<X>, ) { this.$fullTypeName = composeSuiType( Treasury.$typeName, ...typeArgs ) as `${typeof PKG_V1}::config::Treasury<${PhantomToTypeStr<X>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.balance = fields.balance; }

 static reified<X extends PhantomReified<PhantomTypeArgument>>( X: X ): TreasuryReified<ToPhantomTypeArgument<X>> { return { typeName: Treasury.$typeName, fullTypeName: composeSuiType( Treasury.$typeName, ...[extractType(X)] ) as `${typeof PKG_V1}::config::Treasury<${PhantomToTypeStr<ToPhantomTypeArgument<X>>}>`, typeArgs: [ extractType(X) ] as [PhantomToTypeStr<ToPhantomTypeArgument<X>>], isPhantom: Treasury.$isPhantom, reifiedTypeArgs: [X], fromFields: (fields: Record<string, any>) => Treasury.fromFields( X, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Treasury.fromFieldsWithTypes( X, item, ), fromBcs: (data: Uint8Array) => Treasury.fromBcs( X, data, ), bcs: Treasury.bcs, fromJSONField: (field: any) => Treasury.fromJSONField( X, field, ), fromJSON: (json: Record<string, any>) => Treasury.fromJSON( X, json, ), fromSuiParsedData: (content: SuiParsedData) => Treasury.fromSuiParsedData( X, content, ), fetch: async (client: SuiClient, id: string) => Treasury.fetch( client, X, id, ), new: ( fields: TreasuryFields<ToPhantomTypeArgument<X>>, ) => { return new Treasury( [extractType(X)], fields ) }, kind: "StructClassReified", } }
...
export function isTreasuryPercentUpdated(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::config::TreasuryPercentUpdated`; }
...
export class TreasuryPercentUpdated implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::config::TreasuryPercentUpdated`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = TreasuryPercentUpdated.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::config::TreasuryPercentUpdated`; readonly $typeArgs: []; readonly $isPhantom = TreasuryPercentUpdated.$isPhantom;

 readonly treasuryFeePercent: ToField<"u64">

 private constructor(typeArgs: [], fields: TreasuryPercentUpdatedFields, ) { this.$fullTypeName = composeSuiType( TreasuryPercentUpdated.$typeName, ...typeArgs ) as `${typeof PKG_V1}::config::TreasuryPercentUpdated`; this.$typeArgs = typeArgs;

 this.treasuryFeePercent = fields.treasuryFeePercent; }

 static reified( ): TreasuryPercentUpdatedReified { return { typeName: TreasuryPercentUpdated.$typeName, fullTypeName: composeSuiType( TreasuryPercentUpdated.$typeName, ...[] ) as `${typeof PKG_V1}::config::TreasuryPercentUpdated`, typeArgs: [ ] as [], isPhantom: TreasuryPercentUpdated.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => TreasuryPercentUpdated.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TreasuryPercentUpdated.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => TreasuryPercentUpdated.fromBcs( data, ), bcs: TreasuryPercentUpdated.bcs, fromJSONField: (field: any) => TreasuryPercentUpdated.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => TreasuryPercentUpdated.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => TreasuryPercentUpdated.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => TreasuryPercentUpdated.fetch( client, id, ), new: ( fields: TreasuryPercentUpdatedFields, ) => { return new TreasuryPercentUpdated( [], fields ) }, kind: "StructClassReified", } }
...
export function isTreasuryResourcesDistributed(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::config::TreasuryResourcesDistributed`; }
...
export function isTwoAmmFeeClaimCapability(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::config::TwoAmmFeeClaimCapability`; }
...
export class TwoAmmFeeClaimCapability implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::config::TwoAmmFeeClaimCapability`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = TwoAmmFeeClaimCapability.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::config::TwoAmmFeeClaimCapability`; readonly $typeArgs: []; readonly $isPhantom = TwoAmmFeeClaimCapability.$isPhantom;

 readonly id: ToField<UID>

 private constructor(typeArgs: [], fields: TwoAmmFeeClaimCapabilityFields, ) { this.$fullTypeName = composeSuiType( TwoAmmFeeClaimCapability.$typeName, ...typeArgs ) as `${typeof PKG_V1}::config::TwoAmmFeeClaimCapability`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified( ): TwoAmmFeeClaimCapabilityReified { return { typeName: TwoAmmFeeClaimCapability.$typeName, fullTypeName: composeSuiType( TwoAmmFeeClaimCapability.$typeName, ...[] ) as `${typeof PKG_V1}::config::TwoAmmFeeClaimCapability`, typeArgs: [ ] as [], isPhantom: TwoAmmFeeClaimCapability.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => TwoAmmFeeClaimCapability.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TwoAmmFeeClaimCapability.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => TwoAmmFeeClaimCapability.fromBcs( data, ), bcs: TwoAmmFeeClaimCapability.bcs, fromJSONField: (field: any) => TwoAmmFeeClaimCapability.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => TwoAmmFeeClaimCapability.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => TwoAmmFeeClaimCapability.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => TwoAmmFeeClaimCapability.fetch( client, id, ), new: ( fields: TwoAmmFeeClaimCapabilityFields, ) => { return new TwoAmmFeeClaimCapability( [], fields ) }, kind: "StructClassReified", } }

...
export function isStakeSubsidy(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V10}::stake_subsidy::StakeSubsidy`; }
...
export class StakeSubsidy implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V10}::stake_subsidy::StakeSubsidy`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = StakeSubsidy.$typeName; readonly $fullTypeName: `${typeof PKG_V10}::stake_subsidy::StakeSubsidy`; readonly $typeArgs: []; readonly $isPhantom = StakeSubsidy.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: StakeSubsidyFields, ) { this.$fullTypeName = composeSuiType( StakeSubsidy.$typeName, ...typeArgs ) as `${typeof PKG_V10}::stake_subsidy::StakeSubsidy`; this.$typeArgs = typeArgs;

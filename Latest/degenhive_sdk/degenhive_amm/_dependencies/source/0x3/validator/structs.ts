...
export function isStakingRequestEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V10}::validator::StakingRequestEvent`; }
...
export class StakingRequestEvent implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V10}::validator::StakingRequestEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = StakingRequestEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V10}::validator::StakingRequestEvent`; readonly $typeArgs: []; readonly $isPhantom = StakingRequestEvent.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: StakingRequestEventFields, ) { this.$fullTypeName = composeSuiType( StakingRequestEvent.$typeName, ...typeArgs ) as `${typeof PKG_V10}::validator::StakingRequestEvent`; this.$typeArgs = typeArgs;
...
export function isUnstakingRequestEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V10}::validator::UnstakingRequestEvent`; }
...
export class UnstakingRequestEvent implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V10}::validator::UnstakingRequestEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = UnstakingRequestEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V10}::validator::UnstakingRequestEvent`; readonly $typeArgs: []; readonly $isPhantom = UnstakingRequestEvent.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: UnstakingRequestEventFields, ) { this.$fullTypeName = composeSuiType( UnstakingRequestEvent.$typeName, ...typeArgs ) as `${typeof PKG_V10}::validator::UnstakingRequestEvent`; this.$typeArgs = typeArgs;
...
export function isValidator(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V10}::validator::Validator`; }
...
export class Validator implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V10}::validator::Validator`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Validator.$typeName; readonly $fullTypeName: `${typeof PKG_V10}::validator::Validator`; readonly $typeArgs: []; readonly $isPhantom = Validator.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: ValidatorFields, ) { this.$fullTypeName = composeSuiType( Validator.$typeName, ...typeArgs ) as `${typeof PKG_V10}::validator::Validator`; this.$typeArgs = typeArgs;
...
export function isValidatorMetadata(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V10}::validator::ValidatorMetadata`; }
...
export class ValidatorMetadata implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V10}::validator::ValidatorMetadata`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = ValidatorMetadata.$typeName; readonly $fullTypeName: `${typeof PKG_V10}::validator::ValidatorMetadata`; readonly $typeArgs: []; readonly $isPhantom = ValidatorMetadata.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: ValidatorMetadataFields, ) { this.$fullTypeName = composeSuiType( ValidatorMetadata.$typeName, ...typeArgs ) as `${typeof PKG_V10}::validator::ValidatorMetadata`; this.$typeArgs = typeArgs;
 ...
 static reified( ): ValidatorMetadataReified { return { typeName: ValidatorMetadata.$typeName, fullTypeName: composeSuiType( ValidatorMetadata.$typeName, ...[] ) as `${typeof PKG_V10}::validator::ValidatorMetadata`, typeArgs: [ ] as [], isPhantom: ValidatorMetadata.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => ValidatorMetadata.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ValidatorMetadata.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => ValidatorMetadata.fromBcs( data, ), bcs: ValidatorMetadata.bcs, fromJSONField: (field: any) => ValidatorMetadata.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => ValidatorMetadata.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => ValidatorMetadata.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => ValidatorMetadata.fetch( client, id, ), new: ( fields: ValidatorMetadataFields, ) => { return new ValidatorMetadata( [], fields ) }, kind: "StructClassReified", } }

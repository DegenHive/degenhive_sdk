...
export function isStorageFund(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V10}::storage_fund::StorageFund`; }
...
export class StorageFund implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V10}::storage_fund::StorageFund`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = StorageFund.$typeName; readonly $fullTypeName: `${typeof PKG_V10}::storage_fund::StorageFund`; readonly $typeArgs: []; readonly $isPhantom = StorageFund.$isPhantom;

...
export function isUnverifiedValidatorOperationCap(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V10}::validator_cap::UnverifiedValidatorOperationCap`; }
...
export function isValidatorOperationCap(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V10}::validator_cap::ValidatorOperationCap`; }

...
export class CurvedPoolConfig implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: CurvedPoolConfigFields, ) { this.$fullTypeName = composeSuiType( CurvedPoolConfig.$typeName, ...typeArgs ) as `${typeof PKG_V1}::curved_math::CurvedPoolConfig`; this.$typeArgs = typeArgs;
 ...
 static reified( ): CurvedPoolConfigReified { return { typeName: CurvedPoolConfig.$typeName, fullTypeName: composeSuiType( CurvedPoolConfig.$typeName, ...[] ) as `${typeof PKG_V1}::curved_math::CurvedPoolConfig`, typeArgs: [ ] as [], isPhantom: CurvedPoolConfig.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => CurvedPoolConfig.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => CurvedPoolConfig.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => CurvedPoolConfig.fromBcs( data, ), bcs: CurvedPoolConfig.bcs, fromJSONField: (field: any) => CurvedPoolConfig.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => CurvedPoolConfig.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => CurvedPoolConfig.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => CurvedPoolConfig.fetch( client, id, ), new: ( fields: CurvedPoolConfigFields, ) => { return new CurvedPoolConfig( [], fields ) }, kind: "StructClassReified", } }

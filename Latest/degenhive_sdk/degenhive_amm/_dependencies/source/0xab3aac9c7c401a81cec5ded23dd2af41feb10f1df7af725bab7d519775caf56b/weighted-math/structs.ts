...
export class WeightedConfig implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: WeightedConfigFields, ) { this.$fullTypeName = composeSuiType( WeightedConfig.$typeName, ...typeArgs ) as `${typeof PKG_V1}::weighted_math::WeightedConfig`; this.$typeArgs = typeArgs;

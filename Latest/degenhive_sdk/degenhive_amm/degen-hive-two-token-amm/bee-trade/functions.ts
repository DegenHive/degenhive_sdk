...
export function transferBees( tx: Transaction, args: TransferBeesArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bee_trade::transfer_bees`, arguments: [ obj(tx, args.beeToken), obj(tx, args.beesManager), obj(tx, args.policy), pure(tx, args.transferAmt, `u64`), pure(tx, args.receipient, `address`) ], }) }
...
export function transferBeesBalance( tx: Transaction, args: TransferBeesBalanceArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bee_trade::transfer_bees_balance`, arguments: [ obj(tx, args.policy), obj(tx, args.beesManager), obj(tx, args.beesBalance), pure(tx, args.recepient, `address`) ], }) }
...
export function removeLiquidityFromXBeePool( tx: Transaction, typeArgs: [string, string, string], args: RemoveLiquidityFromXBeePoolArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bee_trade::remove_liquidity_from_x_bee_pool`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.pool), obj(tx, args.lpCoins), pure(tx, args.coinXOutVal, `u64`), pure(tx, args.coinYOutVal, `u64`), pure(tx, args.maxLpCoinsToBurn, `u64`), obj(tx, args.policy) ], }) }
...
export function addLiquidityToXBeePool( tx: Transaction, typeArgs: [string, string, string], args: AddLiquidityToXBeePoolArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bee_trade::add_liquidity_to_x_bee_pool`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.pool), obj(tx, args.coinX), obj(tx, args.beesTokenIn), pure(tx, args.beesToAdd, `u64`), pure(tx, args.minLpMinted, `u64`), obj(tx, args.beesManager), obj(tx, args.policy) ], }) }
...
export function addLiquidityToXBeePoolAndReturnLp( tx: Transaction, typeArgs: [string, string, string], args: AddLiquidityToXBeePoolAndReturnLpArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bee_trade::add_liquidity_to_x_bee_pool_and_return_lp`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.pool), obj(tx, args.coinX), obj(tx, args.beesTokenIn), pure(tx, args.beesToAdd, `u64`), pure(tx, args.minLpMinted, `u64`), obj(tx, args.beesManager), obj(tx, args.policy) ], }) }

export interface BurnBeesFromSupplyArgs { policy: TransactionObjectInput; beesManager: TransactionObjectInput }

export function burnBeesFromSupply( tx: Transaction, args: BurnBeesFromSupplyArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bee_trade::burn_bees_from_supply`, arguments: [ obj(tx, args.policy), obj(tx, args.beesManager) ], }) }

export interface ClaimBeesForChronicleFarmingArgs { hiveEntryCap: TransactionObjectInput; beesManager: TransactionObjectInput }

export function claimBeesForChronicleFarming( tx: Transaction, args: ClaimBeesForChronicleFarmingArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bee_trade::claim_bees_for_chronicle_farming`, arguments: [ obj(tx, args.hiveEntryCap), obj(tx, args.beesManager) ], }) }
...
export function depositBeeToDexDao( tx: Transaction, args: DepositBeeToDexDaoArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bee_trade::deposit_bee_to_dex_dao`, arguments: [ obj(tx, args.cap), obj(tx, args.beesManager), pure(tx, args.transferAmt, `u64`) ], }) }

export function incrementBeesManager( tx: Transaction, typeArg: string, beesManager: TransactionObjectInput ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bee_trade::increment_bees_manager`, typeArguments: [typeArg], arguments: [ obj(tx, beesManager) ], }) }

export interface KraftGenesisBeesArgs { hiveVault: TransactionObjectInput; beeKraftCap: TransactionObjectInput }

export function kraftGenesisBees( tx: Transaction, typeArg: string, args: KraftGenesisBeesArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bee_trade::kraft_genesis_bees`, typeArguments: [typeArg], arguments: [ obj(tx, args.hiveVault), obj(tx, args.beeKraftCap) ], }) }
...
export function removeLiquidityFromXBeePoolAndReturn( tx: Transaction, typeArgs: [string, string, string], args: RemoveLiquidityFromXBeePoolAndReturnArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bee_trade::remove_liquidity_from_x_bee_pool_and_return`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.pool), obj(tx, args.lpCoins), pure(tx, args.lpToBurn, `u64`), pure(tx, args.coinXOutVal, `u64`), pure(tx, args.coinYOutVal, `u64`), pure(tx, args.maxLpCoinsToBurn, `u64`), obj(tx, args.policy), obj(tx, args.beesManager) ], }) }
...
export function transferBeesFromTreasury( tx: Transaction, args: TransferBeesFromTreasuryArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bee_trade::transfer_bees_from_treasury`, arguments: [ obj(tx, args.cap), obj(tx, args.beesManager), obj(tx, args.policy), pure(tx, args.transferAmt, `u64`), pure(tx, args.receipient, `address`) ], }) }
...
export function updateBeeForEngagementPerEpoch( tx: Transaction, args: UpdateBeeForEngagementPerEpochArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bee_trade::update_bee_for_engagement_per_epoch`, arguments: [ obj(tx, args.cap), obj(tx, args.beesManager), pure(tx, args.beeForEngagementPerEpoch, `u64`) ], }) }

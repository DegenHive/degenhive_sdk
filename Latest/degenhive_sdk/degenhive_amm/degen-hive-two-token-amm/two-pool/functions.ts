...
export interface ClaimPolFromStreamerBuzzArgs { clock: TransactionObjectInput; cap: TransactionObjectInput; registry: TransactionObjectInput; hiveVault: TransactionObjectInput; suiHivePool: TransactionObjectInput; suiBeePool: TransactionObjectInput; thirdPool: TransactionObjectInput; suiFeeCollector: TransactionObjectInput }

export function claimPolFromStreamerBuzz( tx: Transaction, typeArgs: [string, string, string, string, string, string], args: ClaimPolFromStreamerBuzzArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::claim_pol_from_streamer_buzz`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.cap), obj(tx, args.registry), obj(tx, args.hiveVault), obj(tx, args.suiHivePool), obj(tx, args.suiBeePool), obj(tx, args.thirdPool), obj(tx, args.suiFeeCollector) ], }) }

export interface CollectFeeForPoolArgs { pool: TransactionObjectInput; xFeeCollector: TransactionObjectInput; yFeeCollector: TransactionObjectInput }

export function collectFeeForPool( tx: Transaction, typeArgs: [string, string, string], args: CollectFeeForPoolArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::collect_fee_for_pool`, typeArguments: typeArgs, arguments: [ obj(tx, args.pool), obj(tx, args.xFeeCollector), obj(tx, args.yFeeCollector) ], }) }
...
export interface DeployerRegisterPoolBothCoinMetadataAvailableArgs { clock: TransactionObjectInput; cap: TransactionObjectInput; config: TransactionObjectInput; registry: TransactionObjectInput; suiBalance: TransactionObjectInput; feeCollector: TransactionObjectInput; metadataX: TransactionObjectInput; metadataY: TransactionObjectInput; initParams: Array<bigint | TransactionArgument> | TransactionArgument; initialPrices: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null); weights: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null) }

export function deployerRegisterPoolBothCoinMetadataAvailable( tx: Transaction, typeArgs: [string, string, string], args: DeployerRegisterPoolBothCoinMetadataAvailableArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::deployer_register_pool_both_coin_metadata_available`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.cap), obj(tx, args.config), obj(tx, args.registry), obj(tx, args.suiBalance), obj(tx, args.feeCollector), obj(tx, args.metadataX), obj(tx, args.metadataY), pure(tx, args.initParams, `vector<u64>`), pure(tx, args.initialPrices, `${Option.$typeName}<vector<u256>>`), pure(tx, args.weights, `${Option.$typeName}<vector<u64>>`) ], }) }

export interface DeployerRegisterPoolXMetadataAvailableArgs { clock: TransactionObjectInput; cap: TransactionObjectInput; config: TransactionObjectInput; registry: TransactionObjectInput; suiBalance: TransactionObjectInput; feeCollector: TransactionObjectInput; metadataX: TransactionObjectInput; initParams: Array<bigint | TransactionArgument> | TransactionArgument; initialPrices: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null); weights: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null) }

export function deployerRegisterPoolXMetadataAvailable( tx: Transaction, typeArgs: [string, string, string], args: DeployerRegisterPoolXMetadataAvailableArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::deployer_register_pool_x_metadata_available`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.cap), obj(tx, args.config), obj(tx, args.registry), obj(tx, args.suiBalance), obj(tx, args.feeCollector), obj(tx, args.metadataX), pure(tx, args.initParams, `vector<u64>`), pure(tx, args.initialPrices, `${Option.$typeName}<vector<u256>>`), pure(tx, args.weights, `${Option.$typeName}<vector<u64>>`) ], }) }

export interface DeployerRegisterPoolYMetadataAvailableArgs { clock: TransactionObjectInput; cap: TransactionObjectInput; config: TransactionObjectInput; registry: TransactionObjectInput; suiBalance: TransactionObjectInput; feeCollector: TransactionObjectInput; metadataY: TransactionObjectInput; initParams: Array<bigint | TransactionArgument> | TransactionArgument; initialPrices: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null); weights: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null) }

export function deployerRegisterPoolYMetadataAvailable( tx: Transaction, typeArgs: [string, string, string], args: DeployerRegisterPoolYMetadataAvailableArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::deployer_register_pool_y_metadata_available`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.cap), obj(tx, args.config), obj(tx, args.registry), obj(tx, args.suiBalance), obj(tx, args.feeCollector), obj(tx, args.metadataY), pure(tx, args.initParams, `vector<u64>`), pure(tx, args.initialPrices, `${Option.$typeName}<vector<u256>>`), pure(tx, args.weights, `${Option.$typeName}<vector<u64>>`) ], }) }

export interface DistributeDegensuiArgs { config: TransactionObjectInput; dsuiDisperser: TransactionObjectInput; treasury: TransactionObjectInput; degensuiBalance: TransactionObjectInput }

export function distributeDegensui( tx: Transaction, args: DistributeDegensuiArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::distribute_degensui`, arguments: [ obj(tx, args.config), obj(tx, args.dsuiDisperser), obj(tx, args.treasury), obj(tx, args.degensuiBalance) ], }) }

export interface EnablePublicPoolsArgs { cap: TransactionObjectInput; registry: TransactionObjectInput }

export function enablePublicPools( tx: Transaction, args: EnablePublicPoolsArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::enable_public_pools`, arguments: [ obj(tx, args.cap), obj(tx, args.registry) ], }) }
...
export function getDecimalForCoin( tx: Transaction, typeArg: string, config: TransactionObjectInput ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::get_decimal_for_coin`, typeArguments: [typeArg], arguments: [ obj(tx, config) ], }) }
...
export function getPoolRegistery( tx: Transaction, registry: TransactionObjectInput ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::get_pool_registery`, arguments: [ obj(tx, registry) ], }) }
...
export interface HarvestCollectedDegensuiFeeArgs { config: TransactionObjectInput; registry: TransactionObjectInput; dsuiFeeCollector: TransactionObjectInput; dsuiDisperser: TransactionObjectInput; treasury: TransactionObjectInput }

export function harvestCollectedDegensuiFee( tx: Transaction, args: HarvestCollectedDegensuiFeeArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::harvest_collected_degensui_fee`, arguments: [ obj(tx, args.config), obj(tx, args.registry), obj(tx, args.dsuiFeeCollector), obj(tx, args.dsuiDisperser), obj(tx, args.treasury) ], }) }

export interface HarvestDsuiForCollectedFeeXArgs { clock: TransactionObjectInput; config: TransactionObjectInput; registry: TransactionObjectInput; pool: TransactionObjectInput; xFeeCollector: TransactionObjectInput; dsuiDisperser: TransactionObjectInput; treasury: TransactionObjectInput }

export function harvestDsuiForCollectedFeeX( tx: Transaction, typeArgs: [string, string], args: HarvestDsuiForCollectedFeeXArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::harvest_dsui_for_collected_fee_x`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.config), obj(tx, args.registry), obj(tx, args.pool), obj(tx, args.xFeeCollector), obj(tx, args.dsuiDisperser), obj(tx, args.treasury) ], }) }

export interface HarvestDsuiForCollectedFeeYArgs { clock: TransactionObjectInput; config: TransactionObjectInput; registry: TransactionObjectInput; pool: TransactionObjectInput; yFeeCollector: TransactionObjectInput; dsuiDisperser: TransactionObjectInput; treasury: TransactionObjectInput }

export function harvestDsuiForCollectedFeeY( tx: Transaction, typeArgs: [string, string], args: HarvestDsuiForCollectedFeeYArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::harvest_dsui_for_collected_fee_y`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.config), obj(tx, args.registry), obj(tx, args.pool), obj(tx, args.yFeeCollector), obj(tx, args.dsuiDisperser), obj(tx, args.treasury) ], }) }

export interface HarvestSuiForCollectedFeeXArgs { clock: TransactionObjectInput; suiSystemState: TransactionObjectInput; config: TransactionObjectInput; registry: TransactionObjectInput; dsuiVault: TransactionObjectInput; pool: TransactionObjectInput; xFeeCollector: TransactionObjectInput; dsuiDisperser: TransactionObjectInput; treasury: TransactionObjectInput }

export function harvestSuiForCollectedFeeX( tx: Transaction, typeArgs: [string, string], args: HarvestSuiForCollectedFeeXArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::harvest_sui_for_collected_fee_x`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.suiSystemState), obj(tx, args.config), obj(tx, args.registry), obj(tx, args.dsuiVault), obj(tx, args.pool), obj(tx, args.xFeeCollector), obj(tx, args.dsuiDisperser), obj(tx, args.treasury) ], }) }

export interface HarvestSuiForCollectedFeeYArgs { clock: TransactionObjectInput; suiSystemState: TransactionObjectInput; config: TransactionObjectInput; registry: TransactionObjectInput; dsuiVault: TransactionObjectInput; pool: TransactionObjectInput; yFeeCollector: TransactionObjectInput; dsuiDisperser: TransactionObjectInput; treasury: TransactionObjectInput }

export function harvestSuiForCollectedFeeY( tx: Transaction, typeArgs: [string, string], args: HarvestSuiForCollectedFeeYArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::harvest_sui_for_collected_fee_y`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.suiSystemState), obj(tx, args.config), obj(tx, args.registry), obj(tx, args.dsuiVault), obj(tx, args.pool), obj(tx, args.yFeeCollector), obj(tx, args.dsuiDisperser), obj(tx, args.treasury) ], }) }

export interface HarvestSuiOneHopViaXYSuiXArgs { clock: TransactionObjectInput; suiSystemState: TransactionObjectInput; config: TransactionObjectInput; registry: TransactionObjectInput; dsuiVault: TransactionObjectInput; xYPool: TransactionObjectInput; suiXPool: TransactionObjectInput; yFeeCollector: TransactionObjectInput; dsuiDisperser: TransactionObjectInput; treasury: TransactionObjectInput }

export function harvestSuiOneHopViaXYSuiX( tx: Transaction, typeArgs: [string, string, string, string], args: HarvestSuiOneHopViaXYSuiXArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::harvest_sui_one_hop_via_x_y_sui_x`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.suiSystemState), obj(tx, args.config), obj(tx, args.registry), obj(tx, args.dsuiVault), obj(tx, args.xYPool), obj(tx, args.suiXPool), obj(tx, args.yFeeCollector), obj(tx, args.dsuiDisperser), obj(tx, args.treasury) ], }) }

export interface HarvestSuiOneHopViaXYSuiYArgs { clock: TransactionObjectInput; suiSystemState: TransactionObjectInput; config: TransactionObjectInput; registry: TransactionObjectInput; dsuiVault: TransactionObjectInput; xYPool: TransactionObjectInput; suiYPool: TransactionObjectInput; xFeeCollector: TransactionObjectInput; dsuiDisperser: TransactionObjectInput; treasury: TransactionObjectInput }

export function harvestSuiOneHopViaXYSuiY( tx: Transaction, typeArgs: [string, string, string, string], args: HarvestSuiOneHopViaXYSuiYArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::harvest_sui_one_hop_via_x_y_sui_y`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.suiSystemState), obj(tx, args.config), obj(tx, args.registry), obj(tx, args.dsuiVault), obj(tx, args.xYPool), obj(tx, args.suiYPool), obj(tx, args.xFeeCollector), obj(tx, args.dsuiDisperser), obj(tx, args.treasury) ], }) }

export interface HarvestSuiOneHopViaXYXSuiArgs { clock: TransactionObjectInput; suiSystemState: TransactionObjectInput; config: TransactionObjectInput; registry: TransactionObjectInput; dsuiVault: TransactionObjectInput; xYPool: TransactionObjectInput; xSuiPool: TransactionObjectInput; yFeeCollector: TransactionObjectInput; dsuiDisperser: TransactionObjectInput; treasury: TransactionObjectInput }

export function harvestSuiOneHopViaXYXSui( tx: Transaction, typeArgs: [string, string, string, string], args: HarvestSuiOneHopViaXYXSuiArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::harvest_sui_one_hop_via_x_y_x_sui`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.suiSystemState), obj(tx, args.config), obj(tx, args.registry), obj(tx, args.dsuiVault), obj(tx, args.xYPool), obj(tx, args.xSuiPool), obj(tx, args.yFeeCollector), obj(tx, args.dsuiDisperser), obj(tx, args.treasury) ], }) }

export interface HarvestSuiOneHopViaXYYSuiArgs { clock: TransactionObjectInput; suiSystemState: TransactionObjectInput; config: TransactionObjectInput; registry: TransactionObjectInput; dsuiVault: TransactionObjectInput; xYPool: TransactionObjectInput; ySuiPool: TransactionObjectInput; xFeeCollector: TransactionObjectInput; dsuiDisperser: TransactionObjectInput; treasury: TransactionObjectInput }

export function harvestSuiOneHopViaXYYSui( tx: Transaction, typeArgs: [string, string, string, string], args: HarvestSuiOneHopViaXYYSuiArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::harvest_sui_one_hop_via_x_y_y_sui`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.suiSystemState), obj(tx, args.config), obj(tx, args.registry), obj(tx, args.dsuiVault), obj(tx, args.xYPool), obj(tx, args.ySuiPool), obj(tx, args.xFeeCollector), obj(tx, args.dsuiDisperser), obj(tx, args.treasury) ], }) }
...
export function initializePoolRegistry( tx: Transaction, feeClaimCap: TransactionObjectInput ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::initialize_pool_registry`, arguments: [ obj(tx, feeClaimCap) ], }) }
...
export interface InternalRegisterPoolArgs { clock: TransactionObjectInput; config: TransactionObjectInput; registry: TransactionObjectInput; suiBalance: TransactionObjectInput; feeCollector: TransactionObjectInput; decimalX: number | TransactionArgument; decimalY: number | TransactionArgument; initParams: Array<bigint | TransactionArgument> | TransactionArgument; initialPrices: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null); weights: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null) }

export function internalRegisterPool( tx: Transaction, typeArgs: [string, string, string], args: InternalRegisterPoolArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::internal_register_pool`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.config), obj(tx, args.registry), obj(tx, args.suiBalance), obj(tx, args.feeCollector), pure(tx, args.decimalX, `u8`), pure(tx, args.decimalY, `u8`), pure(tx, args.initParams, `vector<u64>`), pure(tx, args.initialPrices, `${Option.$typeName}<vector<u256>>`), pure(tx, args.weights, `${Option.$typeName}<vector<u64>>`) ], }) }
...
export interface LockInSuiBeePoolAddrArgs { clock: TransactionObjectInput; cap: TransactionObjectInput; config: TransactionObjectInput; registry: TransactionObjectInput; metadataY: TransactionObjectInput; suiBalance: TransactionObjectInput; feeCollector: TransactionObjectInput; initParams: Array<bigint | TransactionArgument> | TransactionArgument; initialPrices: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null); weights: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null) }

export function lockInSuiBeePoolAddr( tx: Transaction, typeArgs: [string, string, string], args: LockInSuiBeePoolAddrArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::lock_in_sui_bee_pool_addr`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.cap), obj(tx, args.config), obj(tx, args.registry), obj(tx, args.metadataY), obj(tx, args.suiBalance), obj(tx, args.feeCollector), pure(tx, args.initParams, `vector<u64>`), pure(tx, args.initialPrices, `${Option.$typeName}<vector<u256>>`), pure(tx, args.weights, `${Option.$typeName}<vector<u64>>`) ], }) }

export interface LockInSuiHivePoolAddrArgs { clock: TransactionObjectInput; cap: TransactionObjectInput; config: TransactionObjectInput; registry: TransactionObjectInput; metadataY: TransactionObjectInput; suiBalance: TransactionObjectInput; feeCollector: TransactionObjectInput; initParams: Array<bigint | TransactionArgument> | TransactionArgument; initialPrices: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null); weights: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null) }
...
export interface RegisterPoolBothCoinMetadataAvailableArgs { clock: TransactionObjectInput; config: TransactionObjectInput; registry: TransactionObjectInput; suiBalance: TransactionObjectInput; feeCollector: TransactionObjectInput; metadataX: TransactionObjectInput; metadataY: TransactionObjectInput; initParams: Array<bigint | TransactionArgument> | TransactionArgument; initialPrices: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null); weights: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null) }

export function registerPoolBothCoinMetadataAvailable( tx: Transaction, typeArgs: [string, string, string], args: RegisterPoolBothCoinMetadataAvailableArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::register_pool_both_coin_metadata_available`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.config), obj(tx, args.registry), obj(tx, args.suiBalance), obj(tx, args.feeCollector), obj(tx, args.metadataX), obj(tx, args.metadataY), pure(tx, args.initParams, `vector<u64>`), pure(tx, args.initialPrices, `${Option.$typeName}<vector<u256>>`), pure(tx, args.weights, `${Option.$typeName}<vector<u64>>`) ], }) }

export interface RegisterPoolNoMetadataAvailableArgs { clock: TransactionObjectInput; config: TransactionObjectInput; registry: TransactionObjectInput; suiBalance: TransactionObjectInput; feeCollector: TransactionObjectInput; initParams: Array<bigint | TransactionArgument> | TransactionArgument; initialPrices: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null); weights: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null) }

export function registerPoolNoMetadataAvailable( tx: Transaction, typeArgs: [string, string, string], args: RegisterPoolNoMetadataAvailableArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::register_pool_no_metadata_available`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.config), obj(tx, args.registry), obj(tx, args.suiBalance), obj(tx, args.feeCollector), pure(tx, args.initParams, `vector<u64>`), pure(tx, args.initialPrices, `${Option.$typeName}<vector<u256>>`), pure(tx, args.weights, `${Option.$typeName}<vector<u64>>`) ], }) }

export interface RegisterPoolXMetadataAvailableArgs { clock: TransactionObjectInput; config: TransactionObjectInput; registry: TransactionObjectInput; suiBalance: TransactionObjectInput; feeCollector: TransactionObjectInput; metadataX: TransactionObjectInput; initParams: Array<bigint | TransactionArgument> | TransactionArgument; initialPrices: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null); weights: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null) }

export function registerPoolXMetadataAvailable( tx: Transaction, typeArgs: [string, string, string], args: RegisterPoolXMetadataAvailableArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::register_pool_x_metadata_available`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.config), obj(tx, args.registry), obj(tx, args.suiBalance), obj(tx, args.feeCollector), obj(tx, args.metadataX), pure(tx, args.initParams, `vector<u64>`), pure(tx, args.initialPrices, `${Option.$typeName}<vector<u256>>`), pure(tx, args.weights, `${Option.$typeName}<vector<u64>>`) ], }) }

export interface RegisterPoolYMetadataAvailableArgs { clock: TransactionObjectInput; config: TransactionObjectInput; registry: TransactionObjectInput; suiBalance: TransactionObjectInput; feeCollector: TransactionObjectInput; metadataY: TransactionObjectInput; initParams: Array<bigint | TransactionArgument> | TransactionArgument; initialPrices: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null); weights: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null) }

export function registerPoolYMetadataAvailable( tx: Transaction, typeArgs: [string, string, string], args: RegisterPoolYMetadataAvailableArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::register_pool_y_metadata_available`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.config), obj(tx, args.registry), obj(tx, args.suiBalance), obj(tx, args.feeCollector), obj(tx, args.metadataY), pure(tx, args.initParams, `vector<u64>`), pure(tx, args.initialPrices, `${Option.$typeName}<vector<u256>>`), pure(tx, args.weights, `${Option.$typeName}<vector<u64>>`) ], }) }

export interface RegistryAddArgs { registry: TransactionObjectInput; config: TransactionObjectInput; decimalX: number | TransactionArgument; decimalY: number | TransactionArgument; poolId: string | TransactionArgument }

export function registryAdd( tx: Transaction, typeArgs: [string, string, string], args: RegistryAddArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::registry_add`, typeArguments: typeArgs, arguments: [ obj(tx, args.registry), obj(tx, args.config), pure(tx, args.decimalX, `u8`), pure(tx, args.decimalY, `u8`), pure(tx, args.poolId, `${ID.$typeName}`) ], }) }
...
export interface RemoveLiquidityFromXBeePoolArgs { clock: TransactionObjectInput; pool: TransactionObjectInput; lpCoins: TransactionObjectInput; coinXOutVal: bigint | TransactionArgument; coinYOutVal: bigint | TransactionArgument; maxLpCoinsToBurn: bigint | TransactionArgument }

export function removeLiquidityFromXBeePool( tx: Transaction, typeArgs: [string, string, string], args: RemoveLiquidityFromXBeePoolArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::remove_liquidity_from_x_bee_pool`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.pool), obj(tx, args.lpCoins), pure(tx, args.coinXOutVal, `u64`), pure(tx, args.coinYOutVal, `u64`), pure(tx, args.maxLpCoinsToBurn, `u64`) ], }) }
...
export interface StakeAndDistributeHarvestedDegensuiArgs { suiSystemState: TransactionObjectInput; dsuiVault: TransactionObjectInput; config: TransactionObjectInput; dsuiDisperser: TransactionObjectInput; treasury: TransactionObjectInput; suiBalance: TransactionObjectInput }

export function stakeAndDistributeHarvestedDegensui( tx: Transaction, args: StakeAndDistributeHarvestedDegensuiArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::stake_and_distribute_harvested_degensui`, arguments: [ obj(tx, args.suiSystemState), obj(tx, args.dsuiVault), obj(tx, args.config), obj(tx, args.dsuiDisperser), obj(tx, args.treasury), obj(tx, args.suiBalance) ], }) }

export interface StakeAndHarvestCollectedSuiFeeArgs { suiSystemState: TransactionObjectInput; config: TransactionObjectInput; registry: TransactionObjectInput; dsuiVault: TransactionObjectInput; suiFeeCollector: TransactionObjectInput; dsuiDisperser: TransactionObjectInput; treasury: TransactionObjectInput }

export function stakeAndHarvestCollectedSuiFee( tx: Transaction, args: StakeAndHarvestCollectedSuiFeeArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::stake_and_harvest_collected_sui_fee`, arguments: [ obj(tx, args.suiSystemState), obj(tx, args.config), obj(tx, args.registry), obj(tx, args.dsuiVault), obj(tx, args.suiFeeCollector), obj(tx, args.dsuiDisperser), obj(tx, args.treasury) ], }) }

export interface SwapBeeCoinsArgs { clock: TransactionObjectInput; pool: TransactionObjectInput; xIn: TransactionObjectInput; xOutMin: bigint | TransactionArgument; yIn: TransactionObjectInput; yOutMin: bigint | TransactionArgument; isGiveIn: boolean | TransactionArgument }

export function swapBeeCoins( tx: Transaction, typeArgs: [string, string, string], args: SwapBeeCoinsArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::swap_bee_coins`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.pool), obj(tx, args.xIn), pure(tx, args.xOutMin, `u64`), obj(tx, args.yIn), pure(tx, args.yOutMin, `u64`), pure(tx, args.isGiveIn, `bool`) ], }) }
...
export interface UpdateFeeForPoolArgs { pool: TransactionObjectInput; dexCap: TransactionObjectInput; totalFeeBps: bigint | TransactionArgument; hiveFeePercent: bigint | TransactionArgument }

export function updateFeeForPool( tx: Transaction, typeArgs: [string, string, string], args: UpdateFeeForPoolArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::update_fee_for_pool`, typeArguments: typeArgs, arguments: [ obj(tx, args.pool), obj(tx, args.dexCap), pure(tx, args.totalFeeBps, `u64`), pure(tx, args.hiveFeePercent, `u64`) ], }) }

export interface UpdateKraftFeeArgs { registry: TransactionObjectInput; hiveDaoCap: TransactionObjectInput; kraftFee: bigint | TransactionArgument }

export function updateKraftFee( tx: Transaction, args: UpdateKraftFeeArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::update_kraft_fee`, arguments: [ obj(tx, args.registry), obj(tx, args.hiveDaoCap), pure(tx, args.kraftFee, `u64`) ], }) }

export interface UpdateSuiPolDistributionArgs { poolRegistry: TransactionObjectInput; hiveDaoCap: TransactionObjectInput; suiForHivePoolPct: bigint | TransactionArgument; suiForBeePoolPct: bigint | TransactionArgument }

export function updateSuiPolDistribution( tx: Transaction, args: UpdateSuiPolDistributionArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::update_sui_pol_distribution`, arguments: [ obj(tx, args.poolRegistry), obj(tx, args.hiveDaoCap), pure(tx, args.suiForHivePoolPct, `u64`), pure(tx, args.suiForBeePoolPct, `u64`) ], }) }

export interface UpdateThirdPoolForPolArgs { poolRegistry: TransactionObjectInput; hiveDaoCap: TransactionObjectInput; thirdPool: TransactionObjectInput }

export function updateThirdPoolForPol( tx: Transaction, typeArgs: [string, string], args: UpdateThirdPoolForPolArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::update_third_pool_for_pol`, typeArguments: typeArgs, arguments: [ obj(tx, args.poolRegistry), obj(tx, args.hiveDaoCap), obj(tx, args.thirdPool) ], }) }

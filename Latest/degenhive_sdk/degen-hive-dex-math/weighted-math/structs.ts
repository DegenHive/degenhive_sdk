...
export function isWeightedConfig(type: string): boolean { type = compressSuiType(type); return type === "0x8dedf746c2648f520827d9a31604b86269afd0a4273b37b296742202ccfc306f::weighted_math::WeightedConfig"; }
...
export class WeightedConfig implements StructClass { static readonly $typeName = "0x8dedf746c2648f520827d9a31604b86269afd0a4273b37b296742202ccfc306f::weighted_math::WeightedConfig"; static readonly $numTypeParams = 0;

 readonly $typeName = WeightedConfig.$typeName;

 readonly $fullTypeName: "0x8dedf746c2648f520827d9a31604b86269afd0a4273b37b296742202ccfc306f::weighted_math::WeightedConfig";
 ...
 private constructor(typeArgs: [], fields: WeightedConfigFields, ) { this.$fullTypeName = composeSuiType( WeightedConfig.$typeName, ...typeArgs ) as "0x8dedf746c2648f520827d9a31604b86269afd0a4273b37b296742202ccfc306f::weighted_math::WeightedConfig"; this.$typeArgs = typeArgs;
 ...
 static reified( ): WeightedConfigReified { return { typeName: WeightedConfig.$typeName, fullTypeName: composeSuiType( WeightedConfig.$typeName, ...[] ) as "0x8dedf746c2648f520827d9a31604b86269afd0a4273b37b296742202ccfc306f::weighted_math::WeightedConfig", typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => WeightedConfig.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => WeightedConfig.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => WeightedConfig.fromBcs( data, ), bcs: WeightedConfig.bcs, fromJSONField: (field: any) => WeightedConfig.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => WeightedConfig.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => WeightedConfig.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => WeightedConfig.fetch( client, id, ), new: ( fields: WeightedConfigFields, ) => { return new WeightedConfig( [], fields ) }, kind: "StructClassReified", } }
 ...
 static get bcs() { return bcs.struct("WeightedConfig", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): WeightedConfig { if (!isWeightedConfig(item.type)) { throw new Error("not a WeightedConfig type");
 ...
 static fromJSON( json: Record<string, any> ): WeightedConfig { if (json.$typeName !== WeightedConfig.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static async fetch( client: SuiClient, id: string ): Promise<WeightedConfig> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching WeightedConfig object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isWeightedConfig(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a WeightedConfig object`); }
 return WeightedConfig.fromBcs( fromB64(res.data.bcs.bcsBytes) ); }

...
export function isPoolTokenExchangeRate(type: string): boolean { type = compressSuiType(type); return type === "0x3::staking_pool::PoolTokenExchangeRate"; }
...
export class PoolTokenExchangeRate implements StructClass { static readonly $typeName = "0x3::staking_pool::PoolTokenExchangeRate"; static readonly $numTypeParams = 0;
...
export function isStakedSui(type: string): boolean { type = compressSuiType(type); return type === "0x3::staking_pool::StakedSui"; }
...
export class StakedSui implements StructClass { static readonly $typeName = "0x3::staking_pool::StakedSui"; static readonly $numTypeParams = 0;
 ...
 private constructor(typeArgs: [], fields: StakedSuiFields, ) { this.$fullTypeName = composeSuiType( StakedSui.$typeName, ...typeArgs ) as "0x3::staking_pool::StakedSui"; this.$typeArgs = typeArgs;
...
export function isStakingPool(type: string): boolean { type = compressSuiType(type); return type === "0x3::staking_pool::StakingPool"; }
...
export class StakingPool implements StructClass { static readonly $typeName = "0x3::staking_pool::StakingPool"; static readonly $numTypeParams = 0;
 ...
 private constructor(typeArgs: [], fields: StakingPoolFields, ) { this.$fullTypeName = composeSuiType( StakingPool.$typeName, ...typeArgs ) as "0x3::staking_pool::StakingPool"; this.$typeArgs = typeArgs;
 ...
 id: this.id,activationEpoch: fieldToJSON<Option<"u64">>(`0x1::option::Option<u64>`, this.activationEpoch),deactivationEpoch: fieldToJSON<Option<"u64">>(`0x1::option::Option<u64>`, this.deactivationEpoch),suiBalance: this.suiBalance.toString(),rewardsPool: this.rewardsPool.toJSONField(),poolTokenBalance: this.poolTokenBalance.toString(),exchangeRates: this.exchangeRates.toJSONField(),pendingStake: this.pendingStake.toString(),pendingTotalSuiWithdraw: this.pendingTotalSuiWithdraw.toString(),pendingPoolTokenWithdraw: this.pendingPoolTokenWithdraw.toString(),extraFields: this.extraFields.toJSONField(),

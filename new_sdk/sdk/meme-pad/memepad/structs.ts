...
export class Consumption implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: ConsumptionFields, ) { this.$fullTypeName = composeSuiType( Consumption.$typeName, ...typeArgs ) as `${typeof PKG_V1}::memepad::Consumption`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("Consumption", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): Consumption { if (!isConsumption(item.type)) { throw new Error("not a Consumption type");
 ...
 static fromJSON( json: Record<string, any> ): Consumption { if (json.$typeName !== Consumption.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): Consumption { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isConsumption(data.bcs.type)) { throw new Error(`object at is not a Consumption object`); }

 return Consumption.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Consumption.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<Consumption> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching Consumption object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isConsumption(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a Consumption object`); }
...
export class ConsumptionCondition implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: ConsumptionConditionFields, ) { this.$fullTypeName = composeSuiType( ConsumptionCondition.$typeName, ...typeArgs ) as `${typeof PKG_V1}::memepad::ConsumptionCondition`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("ConsumptionCondition", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): ConsumptionCondition { if (!isConsumptionCondition(item.type)) { throw new Error("not a ConsumptionCondition type");
 ...
 static fromJSON( json: Record<string, any> ): ConsumptionCondition { if (json.$typeName !== ConsumptionCondition.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): ConsumptionCondition { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isConsumptionCondition(data.bcs.type)) { throw new Error(`object at is not a ConsumptionCondition object`); }

 return ConsumptionCondition.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return ConsumptionCondition.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<ConsumptionCondition> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ConsumptionCondition object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isConsumptionCondition(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ConsumptionCondition object`); }
...
export class BeeBribes<X extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<X>], fields: BeeBribesFields<X>, ) { this.$fullTypeName = composeSuiType( BeeBribes.$typeName, ...typeArgs ) as `${typeof PKG_V1}::memepad::BeeBribes<${PhantomToTypeStr<X>}>`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("BeeBribes", {
 ...
 static fromFieldsWithTypes<X extends PhantomReified<PhantomTypeArgument>>( typeArg: X, item: FieldsWithTypes ): BeeBribes<ToPhantomTypeArgument<X>> { if (!isBeeBribes(item.type)) { throw new Error("not a BeeBribes type");
 ...
 static fromJSON<X extends PhantomReified<PhantomTypeArgument>>( typeArg: X, json: Record<string, any> ): BeeBribes<ToPhantomTypeArgument<X>> { if (json.$typeName !== BeeBribes.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch( composeSuiType(BeeBribes.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg], )
 ...
 static fromSuiObjectData<X extends PhantomReified<PhantomTypeArgument>>( typeArg: X, data: SuiObjectData ): BeeBribes<ToPhantomTypeArgument<X>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isBeeBribes(data.bcs.type)) { throw new Error(`object at is not a BeeBribes object`); }

 const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 1) { throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`); }; const gotTypeArg = compressSuiType(gotTypeArgs[0]); const expectedTypeArg = compressSuiType(extractType(typeArg)); if (gotTypeArg !== compressSuiType(extractType(typeArg))) { throw new Error(`type argument mismatch: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); };

 return BeeBribes.fromBcs( typeArg, fromB64(data.bcs.bcsBytes) ); } if (data.content) { return BeeBribes.fromSuiParsedData( typeArg, data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch<X extends PhantomReified<PhantomTypeArgument>>( client: SuiClient, typeArg: X, id: string ): Promise<BeeBribes<ToPhantomTypeArgument<X>>> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BeeBribes object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBeeBribes(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BeeBribes object`); }
...
export class BribesAddedForEmissions implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: BribesAddedForEmissionsFields, ) { this.$fullTypeName = composeSuiType( BribesAddedForEmissions.$typeName, ...typeArgs ) as `${typeof PKG_V1}::memepad::BribesAddedForEmissions`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("BribesAddedForEmissions", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): BribesAddedForEmissions { if (!isBribesAddedForEmissions(item.type)) { throw new Error("not a BribesAddedForEmissions type");
 ...
 static fromJSON( json: Record<string, any> ): BribesAddedForEmissions { if (json.$typeName !== BribesAddedForEmissions.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): BribesAddedForEmissions { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isBribesAddedForEmissions(data.bcs.type)) { throw new Error(`object at is not a BribesAddedForEmissions object`); }

 return BribesAddedForEmissions.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return BribesAddedForEmissions.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<BribesAddedForEmissions> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BribesAddedForEmissions object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBribesAddedForEmissions(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BribesAddedForEmissions object`); }
...
export class CurveParams implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: CurveParamsFields, ) { this.$fullTypeName = composeSuiType( CurveParams.$typeName, ...typeArgs ) as `${typeof PKG_V1}::memepad::CurveParams`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("CurveParams", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): CurveParams { if (!isCurveParams(item.type)) { throw new Error("not a CurveParams type");
 ...
 static fromJSON( json: Record<string, any> ): CurveParams { if (json.$typeName !== CurveParams.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): CurveParams { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isCurveParams(data.bcs.type)) { throw new Error(`object at is not a CurveParams object`); }

 return CurveParams.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return CurveParams.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<CurveParams> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching CurveParams object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isCurveParams(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a CurveParams object`); }
...
export class LaunchConfig implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: LaunchConfigFields, ) { this.$fullTypeName = composeSuiType( LaunchConfig.$typeName, ...typeArgs ) as `${typeof PKG_V1}::memepad::LaunchConfig`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("LaunchConfig", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): LaunchConfig { if (!isLaunchConfig(item.type)) { throw new Error("not a LaunchConfig type");
 ...
 static fromJSON( json: Record<string, any> ): LaunchConfig { if (json.$typeName !== LaunchConfig.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): LaunchConfig { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isLaunchConfig(data.bcs.type)) { throw new Error(`object at is not a LaunchConfig object`); }

 return LaunchConfig.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return LaunchConfig.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<LaunchConfig> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching LaunchConfig object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isLaunchConfig(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a LaunchConfig object`); }
...
export class LiquidityMigratedToAmmPool implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: LiquidityMigratedToAmmPoolFields, ) { this.$fullTypeName = composeSuiType( LiquidityMigratedToAmmPool.$typeName, ...typeArgs ) as `${typeof PKG_V1}::memepad::LiquidityMigratedToAmmPool`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("LiquidityMigratedToAmmPool", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): LiquidityMigratedToAmmPool { if (!isLiquidityMigratedToAmmPool(item.type)) { throw new Error("not a LiquidityMigratedToAmmPool type");
 ...
 static fromJSON( json: Record<string, any> ): LiquidityMigratedToAmmPool { if (json.$typeName !== LiquidityMigratedToAmmPool.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): LiquidityMigratedToAmmPool { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isLiquidityMigratedToAmmPool(data.bcs.type)) { throw new Error(`object at is not a LiquidityMigratedToAmmPool object`); }

 return LiquidityMigratedToAmmPool.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return LiquidityMigratedToAmmPool.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<LiquidityMigratedToAmmPool> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching LiquidityMigratedToAmmPool object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isLiquidityMigratedToAmmPool(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a LiquidityMigratedToAmmPool object`); }
...
export class MemeBurnt implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: MemeBurntFields, ) { this.$fullTypeName = composeSuiType( MemeBurnt.$typeName, ...typeArgs ) as `${typeof PKG_V1}::memepad::MemeBurnt`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("MemeBurnt", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): MemeBurnt { if (!isMemeBurnt(item.type)) { throw new Error("not a MemeBurnt type");
 ...
 static fromJSON( json: Record<string, any> ): MemeBurnt { if (json.$typeName !== MemeBurnt.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): MemeBurnt { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isMemeBurnt(data.bcs.type)) { throw new Error(`object at is not a MemeBurnt object`); }

 return MemeBurnt.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return MemeBurnt.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<MemeBurnt> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching MemeBurnt object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isMemeBurnt(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a MemeBurnt object`); }
...
export class MemeCustody<X extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<X>], fields: MemeCustodyFields<X>, ) { this.$fullTypeName = composeSuiType( MemeCustody.$typeName, ...typeArgs ) as `${typeof PKG_V1}::memepad::MemeCustody<${PhantomToTypeStr<X>}>`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("MemeCustody", {
 ...
 static fromFieldsWithTypes<X extends PhantomReified<PhantomTypeArgument>>( typeArg: X, item: FieldsWithTypes ): MemeCustody<ToPhantomTypeArgument<X>> { if (!isMemeCustody(item.type)) { throw new Error("not a MemeCustody type");
 ...
 static fromJSON<X extends PhantomReified<PhantomTypeArgument>>( typeArg: X, json: Record<string, any> ): MemeCustody<ToPhantomTypeArgument<X>> { if (json.$typeName !== MemeCustody.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch( composeSuiType(MemeCustody.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg], )
 ...
 static fromSuiObjectData<X extends PhantomReified<PhantomTypeArgument>>( typeArg: X, data: SuiObjectData ): MemeCustody<ToPhantomTypeArgument<X>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isMemeCustody(data.bcs.type)) { throw new Error(`object at is not a MemeCustody object`); }

 const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 1) { throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`); }; const gotTypeArg = compressSuiType(gotTypeArgs[0]); const expectedTypeArg = compressSuiType(extractType(typeArg)); if (gotTypeArg !== compressSuiType(extractType(typeArg))) { throw new Error(`type argument mismatch: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); };

 return MemeCustody.fromBcs( typeArg, fromB64(data.bcs.bcsBytes) ); } if (data.content) { return MemeCustody.fromSuiParsedData( typeArg, data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch<X extends PhantomReified<PhantomTypeArgument>>( client: SuiClient, typeArg: X, id: string ): Promise<MemeCustody<ToPhantomTypeArgument<X>>> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching MemeCustody object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isMemeCustody(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a MemeCustody object`); }
...
export class MemeLaunchPad implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: MemeLaunchPadFields, ) { this.$fullTypeName = composeSuiType( MemeLaunchPad.$typeName, ...typeArgs ) as `${typeof PKG_V1}::memepad::MemeLaunchPad`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("MemeLaunchPad", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): MemeLaunchPad { if (!isMemeLaunchPad(item.type)) { throw new Error("not a MemeLaunchPad type");
 ...
 static fromJSON( json: Record<string, any> ): MemeLaunchPad { if (json.$typeName !== MemeLaunchPad.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): MemeLaunchPad { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isMemeLaunchPad(data.bcs.type)) { throw new Error(`object at is not a MemeLaunchPad object`); }

 return MemeLaunchPad.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return MemeLaunchPad.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<MemeLaunchPad> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching MemeLaunchPad object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isMemeLaunchPad(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a MemeLaunchPad object`); }
...
export class MemePool<X extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<X>], fields: MemePoolFields<X>, ) { this.$fullTypeName = composeSuiType( MemePool.$typeName, ...typeArgs ) as `${typeof PKG_V1}::memepad::MemePool<${PhantomToTypeStr<X>}>`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("MemePool", {
 ...
 static fromFieldsWithTypes<X extends PhantomReified<PhantomTypeArgument>>( typeArg: X, item: FieldsWithTypes ): MemePool<ToPhantomTypeArgument<X>> { if (!isMemePool(item.type)) { throw new Error("not a MemePool type");
 ...
 static fromJSON<X extends PhantomReified<PhantomTypeArgument>>( typeArg: X, json: Record<string, any> ): MemePool<ToPhantomTypeArgument<X>> { if (json.$typeName !== MemePool.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch( composeSuiType(MemePool.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg], )
 ...
 static fromSuiObjectData<X extends PhantomReified<PhantomTypeArgument>>( typeArg: X, data: SuiObjectData ): MemePool<ToPhantomTypeArgument<X>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isMemePool(data.bcs.type)) { throw new Error(`object at is not a MemePool object`); }

 const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 1) { throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`); }; const gotTypeArg = compressSuiType(gotTypeArgs[0]); const expectedTypeArg = compressSuiType(extractType(typeArg)); if (gotTypeArg !== compressSuiType(extractType(typeArg))) { throw new Error(`type argument mismatch: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); };

 return MemePool.fromBcs( typeArg, fromB64(data.bcs.bcsBytes) ); } if (data.content) { return MemePool.fromSuiParsedData( typeArg, data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch<X extends PhantomReified<PhantomTypeArgument>>( client: SuiClient, typeArg: X, id: string ): Promise<MemePool<ToPhantomTypeArgument<X>>> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching MemePool object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isMemePool(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a MemePool object`); }
...
export class MemePoolFeeClaimed implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: MemePoolFeeClaimedFields, ) { this.$fullTypeName = composeSuiType( MemePoolFeeClaimed.$typeName, ...typeArgs ) as `${typeof PKG_V1}::memepad::MemePoolFeeClaimed`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("MemePoolFeeClaimed", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): MemePoolFeeClaimed { if (!isMemePoolFeeClaimed(item.type)) { throw new Error("not a MemePoolFeeClaimed type");
 ...
 static fromJSON( json: Record<string, any> ): MemePoolFeeClaimed { if (json.$typeName !== MemePoolFeeClaimed.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): MemePoolFeeClaimed { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isMemePoolFeeClaimed(data.bcs.type)) { throw new Error(`object at is not a MemePoolFeeClaimed object`); }

 return MemePoolFeeClaimed.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return MemePoolFeeClaimed.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<MemePoolFeeClaimed> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching MemePoolFeeClaimed object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isMemePoolFeeClaimed(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a MemePoolFeeClaimed object`); }
...
export class MemePoolMigrationPossible implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: MemePoolMigrationPossibleFields, ) { this.$fullTypeName = composeSuiType( MemePoolMigrationPossible.$typeName, ...typeArgs ) as `${typeof PKG_V1}::memepad::MemePoolMigrationPossible`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("MemePoolMigrationPossible", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): MemePoolMigrationPossible { if (!isMemePoolMigrationPossible(item.type)) { throw new Error("not a MemePoolMigrationPossible type");
 ...
 static fromJSON( json: Record<string, any> ): MemePoolMigrationPossible { if (json.$typeName !== MemePoolMigrationPossible.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): MemePoolMigrationPossible { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isMemePoolMigrationPossible(data.bcs.type)) { throw new Error(`object at is not a MemePoolMigrationPossible object`); }

 return MemePoolMigrationPossible.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return MemePoolMigrationPossible.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<MemePoolMigrationPossible> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching MemePoolMigrationPossible object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isMemePoolMigrationPossible(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a MemePoolMigrationPossible object`); }
...
export class MemeSupplyConfig implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: MemeSupplyConfigFields, ) { this.$fullTypeName = composeSuiType( MemeSupplyConfig.$typeName, ...typeArgs ) as `${typeof PKG_V1}::memepad::MemeSupplyConfig`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("MemeSupplyConfig", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): MemeSupplyConfig { if (!isMemeSupplyConfig(item.type)) { throw new Error("not a MemeSupplyConfig type");
 ...
 static fromJSON( json: Record<string, any> ): MemeSupplyConfig { if (json.$typeName !== MemeSupplyConfig.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): MemeSupplyConfig { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isMemeSupplyConfig(data.bcs.type)) { throw new Error(`object at is not a MemeSupplyConfig object`); }

 return MemeSupplyConfig.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return MemeSupplyConfig.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<MemeSupplyConfig> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching MemeSupplyConfig object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isMemeSupplyConfig(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a MemeSupplyConfig object`); }
...
export class MemesBought implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: MemesBoughtFields, ) { this.$fullTypeName = composeSuiType( MemesBought.$typeName, ...typeArgs ) as `${typeof PKG_V1}::memepad::MemesBought`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("MemesBought", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): MemesBought { if (!isMemesBought(item.type)) { throw new Error("not a MemesBought type");
 ...
 static fromJSON( json: Record<string, any> ): MemesBought { if (json.$typeName !== MemesBought.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): MemesBought { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isMemesBought(data.bcs.type)) { throw new Error(`object at is not a MemesBought object`); }

 return MemesBought.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return MemesBought.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<MemesBought> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching MemesBought object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isMemesBought(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a MemesBought object`); }
...
export class MemesByBee implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: MemesByBeeFields, ) { this.$fullTypeName = composeSuiType( MemesByBee.$typeName, ...typeArgs ) as `${typeof PKG_V1}::memepad::MemesByBee`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("MemesByBee", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): MemesByBee { if (!isMemesByBee(item.type)) { throw new Error("not a MemesByBee type");
 ...
 static fromJSON( json: Record<string, any> ): MemesByBee { if (json.$typeName !== MemesByBee.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): MemesByBee { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isMemesByBee(data.bcs.type)) { throw new Error(`object at is not a MemesByBee object`); }

 return MemesByBee.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return MemesByBee.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<MemesByBee> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching MemesByBee object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isMemesByBee(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a MemesByBee object`); }
...
export class MemesSold implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: MemesSoldFields, ) { this.$fullTypeName = composeSuiType( MemesSold.$typeName, ...typeArgs ) as `${typeof PKG_V1}::memepad::MemesSold`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("MemesSold", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): MemesSold { if (!isMemesSold(item.type)) { throw new Error("not a MemesSold type");
 ...
 static fromJSON( json: Record<string, any> ): MemesSold { if (json.$typeName !== MemesSold.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): MemesSold { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isMemesSold(data.bcs.type)) { throw new Error(`object at is not a MemesSold object`); }

 return MemesSold.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return MemesSold.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<MemesSold> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching MemesSold object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isMemesSold(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a MemesSold object`); }
...
export class NewMemePoolCreated implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: NewMemePoolCreatedFields, ) { this.$fullTypeName = composeSuiType( NewMemePoolCreated.$typeName, ...typeArgs ) as `${typeof PKG_V1}::memepad::NewMemePoolCreated`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("NewMemePoolCreated", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): NewMemePoolCreated { if (!isNewMemePoolCreated(item.type)) { throw new Error("not a NewMemePoolCreated type");
 ...
 static fromJSON( json: Record<string, any> ): NewMemePoolCreated { if (json.$typeName !== NewMemePoolCreated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): NewMemePoolCreated { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isNewMemePoolCreated(data.bcs.type)) { throw new Error(`object at is not a NewMemePoolCreated object`); }

 return NewMemePoolCreated.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return NewMemePoolCreated.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<NewMemePoolCreated> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching NewMemePoolCreated object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isNewMemePoolCreated(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a NewMemePoolCreated object`); }

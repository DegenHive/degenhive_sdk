...
import {HIVE} from "../../0x49ff1fad22d99ddda9118f3df46b83dccdc040f914f715c753aad0321bcd2f8e/hive/structs";
import {MysticalBee} from "../../0xce5c7485a2bc8e523dd57635c43ec1e1912d22289eb34b39b8ac1fe3454ba812/dragon-trainer/structs";
...
export class AuctionConfig implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: AuctionConfigFields, ) { this.$fullTypeName = composeSuiType( AuctionConfig.$typeName, ...typeArgs ) as `${typeof PKG_V1}::queen_maker::AuctionConfig`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("AuctionConfig", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): AuctionConfig { if (!isAuctionConfig(item.type)) { throw new Error("not a AuctionConfig type");
 ...
 static fromJSON( json: Record<string, any> ): AuctionConfig { if (json.$typeName !== AuctionConfig.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): AuctionConfig { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isAuctionConfig(data.bcs.type)) { throw new Error(`object at is not a AuctionConfig object`); }

 return AuctionConfig.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return AuctionConfig.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<AuctionConfig> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching AuctionConfig object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isAuctionConfig(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a AuctionConfig object`); }
...
export class AuctionInfo implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: AuctionInfoFields, ) { this.$fullTypeName = composeSuiType( AuctionInfo.$typeName, ...typeArgs ) as `${typeof PKG_V1}::queen_maker::AuctionInfo`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("AuctionInfo", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): AuctionInfo { if (!isAuctionInfo(item.type)) { throw new Error("not a AuctionInfo type");
 ...
 static fromJSON( json: Record<string, any> ): AuctionInfo { if (json.$typeName !== AuctionInfo.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): AuctionInfo { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isAuctionInfo(data.bcs.type)) { throw new Error(`object at is not a AuctionInfo object`); }

 return AuctionInfo.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return AuctionInfo.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<AuctionInfo> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching AuctionInfo object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isAuctionInfo(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a AuctionInfo object`); }
...
export class BidPool implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: BidPoolFields, ) { this.$fullTypeName = composeSuiType( BidPool.$typeName, ...typeArgs ) as `${typeof PKG_V1}::queen_maker::BidPool`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("BidPool", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): BidPool { if (!isBidPool(item.type)) { throw new Error("not a BidPool type");
 ...
 static fromJSON( json: Record<string, any> ): BidPool { if (json.$typeName !== BidPool.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): BidPool { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isBidPool(data.bcs.type)) { throw new Error(`object at is not a BidPool object`); }

 return BidPool.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return BidPool.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<BidPool> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BidPool object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBidPool(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BidPool object`); }
...
export class BidUpdatedByUser implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: BidUpdatedByUserFields, ) { this.$fullTypeName = composeSuiType( BidUpdatedByUser.$typeName, ...typeArgs ) as `${typeof PKG_V1}::queen_maker::BidUpdatedByUser`; this.$typeArgs = typeArgs;
 ...
 static fromSuiObjectData( data: SuiObjectData ): BidUpdatedByUser { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isBidUpdatedByUser(data.bcs.type)) { throw new Error(`object at is not a BidUpdatedByUser object`); }

 return BidUpdatedByUser.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return BidUpdatedByUser.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export class BidsClosed implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: BidsClosedFields, ) { this.$fullTypeName = composeSuiType( BidsClosed.$typeName, ...typeArgs ) as `${typeof PKG_V1}::queen_maker::BidsClosed`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("BidsClosed", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): BidsClosed { if (!isBidsClosed(item.type)) { throw new Error("not a BidsClosed type");
 ...
 static fromJSON( json: Record<string, any> ): BidsClosed { if (json.$typeName !== BidsClosed.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): BidsClosed { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isBidsClosed(data.bcs.type)) { throw new Error(`object at is not a BidsClosed object`); }

 return BidsClosed.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return BidsClosed.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<BidsClosed> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BidsClosed object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBidsClosed(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BidsClosed object`); }
...
export class BidsOpenForExisting implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: BidsOpenForExistingFields, ) { this.$fullTypeName = composeSuiType( BidsOpenForExisting.$typeName, ...typeArgs ) as `${typeof PKG_V1}::queen_maker::BidsOpenForExisting`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("BidsOpenForExisting", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): BidsOpenForExisting { if (!isBidsOpenForExisting(item.type)) { throw new Error("not a BidsOpenForExisting type");
 ...
 static fromJSON( json: Record<string, any> ): BidsOpenForExisting { if (json.$typeName !== BidsOpenForExisting.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): BidsOpenForExisting { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isBidsOpenForExisting(data.bcs.type)) { throw new Error(`object at is not a BidsOpenForExisting object`); }

 return BidsOpenForExisting.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return BidsOpenForExisting.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<BidsOpenForExisting> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BidsOpenForExisting object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBidsOpenForExisting(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BidsOpenForExisting object`); }
...
export class EnergyAndHealthIncremented implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: EnergyAndHealthIncrementedFields, ) { this.$fullTypeName = composeSuiType( EnergyAndHealthIncremented.$typeName, ...typeArgs ) as `${typeof PKG_V1}::queen_maker::EnergyAndHealthIncremented`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("EnergyAndHealthIncremented", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): EnergyAndHealthIncremented { if (!isEnergyAndHealthIncremented(item.type)) { throw new Error("not a EnergyAndHealthIncremented type");
 ...
 static fromJSON( json: Record<string, any> ): EnergyAndHealthIncremented { if (json.$typeName !== EnergyAndHealthIncremented.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): EnergyAndHealthIncremented { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isEnergyAndHealthIncremented(data.bcs.type)) { throw new Error(`object at is not a EnergyAndHealthIncremented object`); }

 return EnergyAndHealthIncremented.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return EnergyAndHealthIncremented.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<EnergyAndHealthIncremented> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching EnergyAndHealthIncremented object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isEnergyAndHealthIncremented(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a EnergyAndHealthIncremented object`); }
...
export class LeadingDragonBee implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: LeadingDragonBeeFields, ) { this.$fullTypeName = composeSuiType( LeadingDragonBee.$typeName, ...typeArgs ) as `${typeof PKG_V1}::queen_maker::LeadingDragonBee`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("LeadingDragonBee", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): LeadingDragonBee { if (!isLeadingDragonBee(item.type)) { throw new Error("not a LeadingDragonBee type");
 ...
 static fromJSON( json: Record<string, any> ): LeadingDragonBee { if (json.$typeName !== LeadingDragonBee.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): LeadingDragonBee { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isLeadingDragonBee(data.bcs.type)) { throw new Error(`object at is not a LeadingDragonBee object`); }

 return LeadingDragonBee.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return LeadingDragonBee.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<LeadingDragonBee> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching LeadingDragonBee object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isLeadingDragonBee(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a LeadingDragonBee object`); }
...
export class LeadingDragonBeeUpdated implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: LeadingDragonBeeUpdatedFields, ) { this.$fullTypeName = composeSuiType( LeadingDragonBeeUpdated.$typeName, ...typeArgs ) as `${typeof PKG_V1}::queen_maker::LeadingDragonBeeUpdated`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("LeadingDragonBeeUpdated", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): LeadingDragonBeeUpdated { if (!isLeadingDragonBeeUpdated(item.type)) { throw new Error("not a LeadingDragonBeeUpdated type");
 ...
 static fromJSON( json: Record<string, any> ): LeadingDragonBeeUpdated { if (json.$typeName !== LeadingDragonBeeUpdated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): LeadingDragonBeeUpdated { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isLeadingDragonBeeUpdated(data.bcs.type)) { throw new Error(`object at is not a LeadingDragonBeeUpdated object`); }

 return LeadingDragonBeeUpdated.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return LeadingDragonBeeUpdated.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<LeadingDragonBeeUpdated> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching LeadingDragonBeeUpdated object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isLeadingDragonBeeUpdated(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a LeadingDragonBeeUpdated object`); }
...
export class MinBidLimitUpdated implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: MinBidLimitUpdatedFields, ) { this.$fullTypeName = composeSuiType( MinBidLimitUpdated.$typeName, ...typeArgs ) as `${typeof PKG_V1}::queen_maker::MinBidLimitUpdated`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("MinBidLimitUpdated", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): MinBidLimitUpdated { if (!isMinBidLimitUpdated(item.type)) { throw new Error("not a MinBidLimitUpdated type");
 ...
 static fromJSON( json: Record<string, any> ): MinBidLimitUpdated { if (json.$typeName !== MinBidLimitUpdated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): MinBidLimitUpdated { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isMinBidLimitUpdated(data.bcs.type)) { throw new Error(`object at is not a MinBidLimitUpdated object`); }

 return MinBidLimitUpdated.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return MinBidLimitUpdated.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<MinBidLimitUpdated> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching MinBidLimitUpdated object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isMinBidLimitUpdated(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a MinBidLimitUpdated object`); }
...
export class NewBeeAddedToCompetition implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: NewBeeAddedToCompetitionFields, ) { this.$fullTypeName = composeSuiType( NewBeeAddedToCompetition.$typeName, ...typeArgs ) as `${typeof PKG_V1}::queen_maker::NewBeeAddedToCompetition`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("NewBeeAddedToCompetition", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): NewBeeAddedToCompetition { if (!isNewBeeAddedToCompetition(item.type)) { throw new Error("not a NewBeeAddedToCompetition type");
 ...
 static fromJSON( json: Record<string, any> ): NewBeeAddedToCompetition { if (json.$typeName !== NewBeeAddedToCompetition.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): NewBeeAddedToCompetition { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isNewBeeAddedToCompetition(data.bcs.type)) { throw new Error(`object at is not a NewBeeAddedToCompetition object`); }

 return NewBeeAddedToCompetition.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return NewBeeAddedToCompetition.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<NewBeeAddedToCompetition> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching NewBeeAddedToCompetition object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isNewBeeAddedToCompetition(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a NewBeeAddedToCompetition object`); }
...
export class ParticipatingBees implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: ParticipatingBeesFields, ) { this.$fullTypeName = composeSuiType( ParticipatingBees.$typeName, ...typeArgs ) as `${typeof PKG_V1}::queen_maker::ParticipatingBees`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("ParticipatingBees", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): ParticipatingBees { if (!isParticipatingBees(item.type)) { throw new Error("not a ParticipatingBees type");
 ...
 static fromJSON( json: Record<string, any> ): ParticipatingBees { if (json.$typeName !== ParticipatingBees.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): ParticipatingBees { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isParticipatingBees(data.bcs.type)) { throw new Error(`object at is not a ParticipatingBees object`); }

 return ParticipatingBees.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return ParticipatingBees.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<ParticipatingBees> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ParticipatingBees object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isParticipatingBees(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ParticipatingBees object`); }
...
export class ParticipationPosition implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: ParticipationPositionFields, ) { this.$fullTypeName = composeSuiType( ParticipationPosition.$typeName, ...typeArgs ) as `${typeof PKG_V1}::queen_maker::ParticipationPosition`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("ParticipationPosition", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): ParticipationPosition { if (!isParticipationPosition(item.type)) { throw new Error("not a ParticipationPosition type");
 ...
 static fromJSON( json: Record<string, any> ): ParticipationPosition { if (json.$typeName !== ParticipationPosition.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): ParticipationPosition { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isParticipationPosition(data.bcs.type)) { throw new Error(`object at is not a ParticipationPosition object`); }

 return ParticipationPosition.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return ParticipationPosition.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<ParticipationPosition> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ParticipationPosition object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isParticipationPosition(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ParticipationPosition object`); }
...
export class QueenClaimedByItsOwner implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: QueenClaimedByItsOwnerFields, ) { this.$fullTypeName = composeSuiType( QueenClaimedByItsOwner.$typeName, ...typeArgs ) as `${typeof PKG_V1}::queen_maker::QueenClaimedByItsOwner`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("QueenClaimedByItsOwner", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): QueenClaimedByItsOwner { if (!isQueenClaimedByItsOwner(item.type)) { throw new Error("not a QueenClaimedByItsOwner type");
 ...
 static fromJSON( json: Record<string, any> ): QueenClaimedByItsOwner { if (json.$typeName !== QueenClaimedByItsOwner.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): QueenClaimedByItsOwner { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isQueenClaimedByItsOwner(data.bcs.type)) { throw new Error(`object at is not a QueenClaimedByItsOwner object`); }

 return QueenClaimedByItsOwner.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return QueenClaimedByItsOwner.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<QueenClaimedByItsOwner> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching QueenClaimedByItsOwner object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isQueenClaimedByItsOwner(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a QueenClaimedByItsOwner object`); }
...
export class QueenCompetitionOver implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: QueenCompetitionOverFields, ) { this.$fullTypeName = composeSuiType( QueenCompetitionOver.$typeName, ...typeArgs ) as `${typeof PKG_V1}::queen_maker::QueenCompetitionOver`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("QueenCompetitionOver", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): QueenCompetitionOver { if (!isQueenCompetitionOver(item.type)) { throw new Error("not a QueenCompetitionOver type");
 ...
 static fromJSON( json: Record<string, any> ): QueenCompetitionOver { if (json.$typeName !== QueenCompetitionOver.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): QueenCompetitionOver { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isQueenCompetitionOver(data.bcs.type)) { throw new Error(`object at is not a QueenCompetitionOver object`); }

 return QueenCompetitionOver.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return QueenCompetitionOver.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<QueenCompetitionOver> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching QueenCompetitionOver object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isQueenCompetitionOver(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a QueenCompetitionOver object`); }
...
export class QueenCustody implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: QueenCustodyFields, ) { this.$fullTypeName = composeSuiType( QueenCustody.$typeName, ...typeArgs ) as `${typeof PKG_V1}::queen_maker::QueenCustody`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("QueenCustody", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): QueenCustody { if (!isQueenCustody(item.type)) { throw new Error("not a QueenCustody type");
 ...
 static fromJSON( json: Record<string, any> ): QueenCustody { if (json.$typeName !== QueenCustody.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): QueenCustody { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isQueenCustody(data.bcs.type)) { throw new Error(`object at is not a QueenCustody object`); }

 return QueenCustody.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return QueenCustody.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<QueenCustody> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching QueenCustody object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isQueenCustody(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a QueenCustody object`); }
...
export class QueenMaker implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: QueenMakerFields, ) { this.$fullTypeName = composeSuiType( QueenMaker.$typeName, ...typeArgs ) as `${typeof PKG_V1}::queen_maker::QueenMaker`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("QueenMaker", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): QueenMaker { if (!isQueenMaker(item.type)) { throw new Error("not a QueenMaker type");
 ...
 static fromJSON( json: Record<string, any> ): QueenMaker { if (json.$typeName !== QueenMaker.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): QueenMaker { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isQueenMaker(data.bcs.type)) { throw new Error(`object at is not a QueenMaker object`); }

 return QueenMaker.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return QueenMaker.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<QueenMaker> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching QueenMaker object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isQueenMaker(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a QueenMaker object`); }
...
export class UserBeeReturned implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: UserBeeReturnedFields, ) { this.$fullTypeName = composeSuiType( UserBeeReturned.$typeName, ...typeArgs ) as `${typeof PKG_V1}::queen_maker::UserBeeReturned`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("UserBeeReturned", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): UserBeeReturned { if (!isUserBeeReturned(item.type)) { throw new Error("not a UserBeeReturned type");
 ...
 static fromJSON( json: Record<string, any> ): UserBeeReturned { if (json.$typeName !== UserBeeReturned.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): UserBeeReturned { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isUserBeeReturned(data.bcs.type)) { throw new Error(`object at is not a UserBeeReturned object`); }

 return UserBeeReturned.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return UserBeeReturned.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<UserBeeReturned> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching UserBeeReturned object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isUserBeeReturned(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a UserBeeReturned object`); }

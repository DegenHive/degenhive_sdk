...
export class PoolTokenExchangeRate implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: PoolTokenExchangeRateFields, ) { this.$fullTypeName = composeSuiType( PoolTokenExchangeRate.$typeName, ...typeArgs ) as `${typeof PKG_V17}::staking_pool::PoolTokenExchangeRate`; this.$typeArgs = typeArgs;
...
export class StakedSui implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: StakedSuiFields, ) { this.$fullTypeName = composeSuiType( StakedSui.$typeName, ...typeArgs ) as `${typeof PKG_V17}::staking_pool::StakedSui`; this.$typeArgs = typeArgs;
...
export class StakingPool implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: StakingPoolFields, ) { this.$fullTypeName = composeSuiType( StakingPool.$typeName, ...typeArgs ) as `${typeof PKG_V17}::staking_pool::StakingPool`; this.$typeArgs = typeArgs;

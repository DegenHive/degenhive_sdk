...
export class StakingRequestEvent implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: StakingRequestEventFields, ) { this.$fullTypeName = composeSuiType( StakingRequestEvent.$typeName, ...typeArgs ) as `${typeof PKG_V17}::validator::StakingRequestEvent`; this.$typeArgs = typeArgs;
...
export class UnstakingRequestEvent implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: UnstakingRequestEventFields, ) { this.$fullTypeName = composeSuiType( UnstakingRequestEvent.$typeName, ...typeArgs ) as `${typeof PKG_V17}::validator::UnstakingRequestEvent`; this.$typeArgs = typeArgs;
...
export class Validator implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: ValidatorFields, ) { this.$fullTypeName = composeSuiType( Validator.$typeName, ...typeArgs ) as `${typeof PKG_V17}::validator::Validator`; this.$typeArgs = typeArgs;
...
export class ValidatorMetadata implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: ValidatorMetadataFields, ) { this.$fullTypeName = composeSuiType( ValidatorMetadata.$typeName, ...typeArgs ) as `${typeof PKG_V17}::validator::ValidatorMetadata`; this.$typeArgs = typeArgs;

...
export function isCurve(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V28}::groth16::Curve`; }
...
export class Curve implements StructClass {
    ...
    static readonly $typeName = `${PKG_V28}::groth16::Curve`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

    readonly $typeName = Curve.$typeName; readonly $fullTypeName: `${typeof PKG_V28}::groth16::Curve`; readonly $typeArgs: []; readonly $isPhantom = Curve.$isPhantom;

    readonly id: ToField<"u8">

    private constructor(typeArgs: [], fields: CurveFields,) {
        this.$fullTypeName = composeSuiType(Curve.$typeName, ...typeArgs) as `${typeof PKG_V28}::groth16::Curve`; this.$typeArgs = typeArgs;

        this.id = fields.id;
    }

    static reified(): CurveReified { return { typeName: Curve.$typeName, fullTypeName: composeSuiType(Curve.$typeName, ...[]) as `${typeof PKG_V28}::groth16::Curve`, typeArgs: [] as [], isPhantom: Curve.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Curve.fromFields(fields,), fromFieldsWithTypes: (item: FieldsWithTypes) => Curve.fromFieldsWithTypes(item,), fromBcs: (data: Uint8Array) => Curve.fromBcs(data,), bcs: Curve.bcs, fromJSONField: (field: any) => Curve.fromJSONField(field,), fromJSON: (json: Record<string, any>) => Curve.fromJSON(json,), fromSuiParsedData: (content: SuiParsedData) => Curve.fromSuiParsedData(content,), fromSuiObjectData: (content: SuiObjectData) => Curve.fromSuiObjectData(content,), fetch: async (client: SuiClient, id: string) => Curve.fetch(client, id,), new: (fields: CurveFields,) => { return new Curve([], fields) }, kind: "StructClassReified", } }
    ...
    static fromJSON(json: Record<string, any>): Curve {
        if (json.$typeName !== Curve.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): Curve {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isCurve(data.bcs.type)) { throw new Error(`object at is not a Curve object`); }

            return Curve.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return Curve.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<Curve> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching Curve object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isCurve(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a Curve object`); }
...
export function isPreparedVerifyingKey(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V28}::groth16::PreparedVerifyingKey`; }
...
export class PreparedVerifyingKey implements StructClass {
    ...
    static readonly $typeName = `${PKG_V28}::groth16::PreparedVerifyingKey`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

    readonly $typeName = PreparedVerifyingKey.$typeName; readonly $fullTypeName: `${typeof PKG_V28}::groth16::PreparedVerifyingKey`; readonly $typeArgs: []; readonly $isPhantom = PreparedVerifyingKey.$isPhantom;
    ...
    private constructor(typeArgs: [], fields: PreparedVerifyingKeyFields,) {
        this.$fullTypeName = composeSuiType(PreparedVerifyingKey.$typeName, ...typeArgs) as `${typeof PKG_V28}::groth16::PreparedVerifyingKey`; this.$typeArgs = typeArgs;
    ...
    static fromJSON(json: Record<string, any>): PreparedVerifyingKey {
        if (json.$typeName !== PreparedVerifyingKey.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): PreparedVerifyingKey {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isPreparedVerifyingKey(data.bcs.type)) { throw new Error(`object at is not a PreparedVerifyingKey object`); }

            return PreparedVerifyingKey.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return PreparedVerifyingKey.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<PreparedVerifyingKey> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching PreparedVerifyingKey object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isPreparedVerifyingKey(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a PreparedVerifyingKey object`); }
...
export function isProofPoints(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V28}::groth16::ProofPoints`; }
...
export class ProofPoints implements StructClass {
    ...
    static readonly $typeName = `${PKG_V28}::groth16::ProofPoints`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

    readonly $typeName = ProofPoints.$typeName; readonly $fullTypeName: `${typeof PKG_V28}::groth16::ProofPoints`; readonly $typeArgs: []; readonly $isPhantom = ProofPoints.$isPhantom;

    readonly bytes: ToField<Vector<"u8">>

    private constructor(typeArgs: [], fields: ProofPointsFields,) {
        this.$fullTypeName = composeSuiType(ProofPoints.$typeName, ...typeArgs) as `${typeof PKG_V28}::groth16::ProofPoints`; this.$typeArgs = typeArgs;

        this.bytes = fields.bytes;
    }

    static reified(): ProofPointsReified { return { typeName: ProofPoints.$typeName, fullTypeName: composeSuiType(ProofPoints.$typeName, ...[]) as `${typeof PKG_V28}::groth16::ProofPoints`, typeArgs: [] as [], isPhantom: ProofPoints.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => ProofPoints.fromFields(fields,), fromFieldsWithTypes: (item: FieldsWithTypes) => ProofPoints.fromFieldsWithTypes(item,), fromBcs: (data: Uint8Array) => ProofPoints.fromBcs(data,), bcs: ProofPoints.bcs, fromJSONField: (field: any) => ProofPoints.fromJSONField(field,), fromJSON: (json: Record<string, any>) => ProofPoints.fromJSON(json,), fromSuiParsedData: (content: SuiParsedData) => ProofPoints.fromSuiParsedData(content,), fromSuiObjectData: (content: SuiObjectData) => ProofPoints.fromSuiObjectData(content,), fetch: async (client: SuiClient, id: string) => ProofPoints.fetch(client, id,), new: (fields: ProofPointsFields,) => { return new ProofPoints([], fields) }, kind: "StructClassReified", } }
    ...
    static fromJSON(json: Record<string, any>): ProofPoints {
        if (json.$typeName !== ProofPoints.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): ProofPoints {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isProofPoints(data.bcs.type)) { throw new Error(`object at is not a ProofPoints object`); }

            return ProofPoints.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ProofPoints.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<ProofPoints> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ProofPoints object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isProofPoints(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ProofPoints object`); }
...
export function isPublicProofInputs(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V28}::groth16::PublicProofInputs`; }
...
export class PublicProofInputs implements StructClass {
    ...
    static readonly $typeName = `${PKG_V28}::groth16::PublicProofInputs`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

    readonly $typeName = PublicProofInputs.$typeName; readonly $fullTypeName: `${typeof PKG_V28}::groth16::PublicProofInputs`; readonly $typeArgs: []; readonly $isPhantom = PublicProofInputs.$isPhantom;

    readonly bytes: ToField<Vector<"u8">>

    private constructor(typeArgs: [], fields: PublicProofInputsFields,) {
        this.$fullTypeName = composeSuiType(PublicProofInputs.$typeName, ...typeArgs) as `${typeof PKG_V28}::groth16::PublicProofInputs`; this.$typeArgs = typeArgs;

        this.bytes = fields.bytes;
    }

    static reified(): PublicProofInputsReified { return { typeName: PublicProofInputs.$typeName, fullTypeName: composeSuiType(PublicProofInputs.$typeName, ...[]) as `${typeof PKG_V28}::groth16::PublicProofInputs`, typeArgs: [] as [], isPhantom: PublicProofInputs.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => PublicProofInputs.fromFields(fields,), fromFieldsWithTypes: (item: FieldsWithTypes) => PublicProofInputs.fromFieldsWithTypes(item,), fromBcs: (data: Uint8Array) => PublicProofInputs.fromBcs(data,), bcs: PublicProofInputs.bcs, fromJSONField: (field: any) => PublicProofInputs.fromJSONField(field,), fromJSON: (json: Record<string, any>) => PublicProofInputs.fromJSON(json,), fromSuiParsedData: (content: SuiParsedData) => PublicProofInputs.fromSuiParsedData(content,), fromSuiObjectData: (content: SuiObjectData) => PublicProofInputs.fromSuiObjectData(content,), fetch: async (client: SuiClient, id: string) => PublicProofInputs.fetch(client, id,), new: (fields: PublicProofInputsFields,) => { return new PublicProofInputs([], fields) }, kind: "StructClassReified", } }
    ...
    static fromJSON(json: Record<string, any>): PublicProofInputs {
        if (json.$typeName !== PublicProofInputs.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): PublicProofInputs {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isPublicProofInputs(data.bcs.type)) { throw new Error(`object at is not a PublicProofInputs object`); }

            return PublicProofInputs.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return PublicProofInputs.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<PublicProofInputs> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching PublicProofInputs object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isPublicProofInputs(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a PublicProofInputs object`); }

...
import {TwapUpdateCap} from "../../0xce5c7485a2bc8e523dd57635c43ec1e1912d22289eb34b39b8ac1fe3454ba812/dragon-trainer/structs";
...
export class HiveOracle implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: HiveOracleFields, ) { this.$fullTypeName = composeSuiType( HiveOracle.$typeName, ...typeArgs ) as `${typeof PKG_V1}::oracle::HiveOracle`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("HiveOracle", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): HiveOracle { if (!isHiveOracle(item.type)) { throw new Error("not a HiveOracle type");
 ...
 static fromJSON( json: Record<string, any> ): HiveOracle { if (json.$typeName !== HiveOracle.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): HiveOracle { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isHiveOracle(data.bcs.type)) { throw new Error(`object at is not a HiveOracle object`); }

 return HiveOracle.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return HiveOracle.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<HiveOracle> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HiveOracle object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHiveOracle(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HiveOracle object`); }
...
export class HiveOracleSnapshotRecorded implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: HiveOracleSnapshotRecordedFields, ) { this.$fullTypeName = composeSuiType( HiveOracleSnapshotRecorded.$typeName, ...typeArgs ) as `${typeof PKG_V1}::oracle::HiveOracleSnapshotRecorded`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("HiveOracleSnapshotRecorded", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): HiveOracleSnapshotRecorded { if (!isHiveOracleSnapshotRecorded(item.type)) { throw new Error("not a HiveOracleSnapshotRecorded type");
 ...
 static fromJSON( json: Record<string, any> ): HiveOracleSnapshotRecorded { if (json.$typeName !== HiveOracleSnapshotRecorded.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): HiveOracleSnapshotRecorded { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isHiveOracleSnapshotRecorded(data.bcs.type)) { throw new Error(`object at is not a HiveOracleSnapshotRecorded object`); }

 return HiveOracleSnapshotRecorded.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return HiveOracleSnapshotRecorded.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<HiveOracleSnapshotRecorded> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HiveOracleSnapshotRecorded object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHiveOracleSnapshotRecorded(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HiveOracleSnapshotRecorded object`); }
...
export class HiveOracleUpdated implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: HiveOracleUpdatedFields, ) { this.$fullTypeName = composeSuiType( HiveOracleUpdated.$typeName, ...typeArgs ) as `${typeof PKG_V1}::oracle::HiveOracleUpdated`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("HiveOracleUpdated", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): HiveOracleUpdated { if (!isHiveOracleUpdated(item.type)) { throw new Error("not a HiveOracleUpdated type");
 ...
 static fromJSON( json: Record<string, any> ): HiveOracleUpdated { if (json.$typeName !== HiveOracleUpdated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): HiveOracleUpdated { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isHiveOracleUpdated(data.bcs.type)) { throw new Error(`object at is not a HiveOracleUpdated object`); }

 return HiveOracleUpdated.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return HiveOracleUpdated.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<HiveOracleUpdated> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HiveOracleUpdated object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHiveOracleUpdated(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HiveOracleUpdated object`); }
...
export class HiveTwapSnapshot implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: HiveTwapSnapshotFields, ) { this.$fullTypeName = composeSuiType( HiveTwapSnapshot.$typeName, ...typeArgs ) as `${typeof PKG_V1}::oracle::HiveTwapSnapshot`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("HiveTwapSnapshot", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): HiveTwapSnapshot { if (!isHiveTwapSnapshot(item.type)) { throw new Error("not a HiveTwapSnapshot type");
 ...
 static fromJSON( json: Record<string, any> ): HiveTwapSnapshot { if (json.$typeName !== HiveTwapSnapshot.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): HiveTwapSnapshot { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isHiveTwapSnapshot(data.bcs.type)) { throw new Error(`object at is not a HiveTwapSnapshot object`); }

 return HiveTwapSnapshot.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return HiveTwapSnapshot.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<HiveTwapSnapshot> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HiveTwapSnapshot object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHiveTwapSnapshot(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HiveTwapSnapshot object`); }

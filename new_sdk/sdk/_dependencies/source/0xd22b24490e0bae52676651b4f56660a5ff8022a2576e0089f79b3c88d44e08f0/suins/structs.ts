...
export class ConfigKey<Config extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static fromSuiObjectData<Config extends PhantomReified<PhantomTypeArgument>>( typeArg: Config, data: SuiObjectData ): ConfigKey<ToPhantomTypeArgument<Config>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isConfigKey(data.bcs.type)) { throw new Error(`object at is not a ConfigKey object`); }

 const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 1) { throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`); }; const gotTypeArg = compressSuiType(gotTypeArgs[0]); const expectedTypeArg = compressSuiType(extractType(typeArg)); if (gotTypeArg !== compressSuiType(extractType(typeArg))) { throw new Error(`type argument mismatch: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); };

 return ConfigKey.fromBcs( typeArg, fromB64(data.bcs.bcsBytes) ); } if (data.content) { return ConfigKey.fromSuiParsedData( typeArg, data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export class AppKey<App extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static fromSuiObjectData<App extends PhantomReified<PhantomTypeArgument>>( typeArg: App, data: SuiObjectData ): AppKey<ToPhantomTypeArgument<App>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isAppKey(data.bcs.type)) { throw new Error(`object at is not a AppKey object`); }

 const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 1) { throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`); }; const gotTypeArg = compressSuiType(gotTypeArgs[0]); const expectedTypeArg = compressSuiType(extractType(typeArg)); if (gotTypeArg !== compressSuiType(extractType(typeArg))) { throw new Error(`type argument mismatch: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); };

 return AppKey.fromBcs( typeArg, fromB64(data.bcs.bcsBytes) ); } if (data.content) { return AppKey.fromSuiParsedData( typeArg, data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export class RegistryKey<Config extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static fromSuiObjectData<Config extends PhantomReified<PhantomTypeArgument>>( typeArg: Config, data: SuiObjectData ): RegistryKey<ToPhantomTypeArgument<Config>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isRegistryKey(data.bcs.type)) { throw new Error(`object at is not a RegistryKey object`); }

 const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 1) { throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`); }; const gotTypeArg = compressSuiType(gotTypeArgs[0]); const expectedTypeArg = compressSuiType(extractType(typeArg)); if (gotTypeArg !== compressSuiType(extractType(typeArg))) { throw new Error(`type argument mismatch: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); };

 return RegistryKey.fromBcs( typeArg, fromB64(data.bcs.bcsBytes) ); } if (data.content) { return RegistryKey.fromSuiParsedData( typeArg, data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export class SUINS implements StructClass { __StructClass = true as const;
 ...
 static fromSuiObjectData( data: SuiObjectData ): SUINS { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isSUINS(data.bcs.type)) { throw new Error(`object at is not a SUINS object`); }

 return SUINS.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return SUINS.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

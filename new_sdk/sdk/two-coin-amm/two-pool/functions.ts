...
export interface RemoveLiquidityPumpPoolArgs { clock: TransactionObjectInput; cap: TransactionObjectInput; pool: TransactionObjectInput; lpCoins: TransactionObjectInput; coinXOutVal: bigint | TransactionArgument; coinYOutVal: bigint | TransactionArgument; maxLpCoinsToBurn: bigint | TransactionArgument }

export function removeLiquidityPumpPool( tx: Transaction, typeArgs: [string, string, string], args: RemoveLiquidityPumpPoolArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::two_pool::remove_liquidity_pump_pool`, typeArguments: typeArgs, arguments: [ obj(tx, args.clock), obj(tx, args.cap), obj(tx, args.pool), obj(tx, args.lpCoins), pure(tx, args.coinXOutVal, `u64`), pure(tx, args.coinYOutVal, `u64`), pure(tx, args.maxLpCoinsToBurn, `u64`) ], }) }

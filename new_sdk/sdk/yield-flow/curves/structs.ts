...
export class Curved implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: CurvedFields, ) { this.$fullTypeName = composeSuiType( Curved.$typeName, ...typeArgs ) as `${typeof PKG_V1}::curves::Curved`; this.$typeArgs = typeArgs;
 ...
 static fromSuiObjectData( data: SuiObjectData ): Curved { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isCurved(data.bcs.type)) { throw new Error(`object at is not a Curved object`); }

 return Curved.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Curved.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export class Stable implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: StableFields, ) { this.$fullTypeName = composeSuiType( Stable.$typeName, ...typeArgs ) as `${typeof PKG_V1}::curves::Stable`; this.$typeArgs = typeArgs;
 ...
 static fromSuiObjectData( data: SuiObjectData ): Stable { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isStable(data.bcs.type)) { throw new Error(`object at is not a Stable object`); }

 return Stable.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Stable.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export class Weighted implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: WeightedFields, ) { this.$fullTypeName = composeSuiType( Weighted.$typeName, ...typeArgs ) as `${typeof PKG_V1}::curves::Weighted`; this.$typeArgs = typeArgs;
 ...
 static fromSuiObjectData( data: SuiObjectData ): Weighted { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isWeighted(data.bcs.type)) { throw new Error(`object at is not a Weighted object`); }

 return Weighted.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Weighted.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

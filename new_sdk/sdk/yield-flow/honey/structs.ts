...
export class Consumption implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: ConsumptionFields, ) { this.$fullTypeName = composeSuiType( Consumption.$typeName, ...typeArgs ) as `${typeof PKG_V1}::honey::Consumption`; this.$typeArgs = typeArgs;
...
export class ConsumptionCondition implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: ConsumptionConditionFields, ) { this.$fullTypeName = composeSuiType( ConsumptionCondition.$typeName, ...typeArgs ) as `${typeof PKG_V1}::honey::ConsumptionCondition`; this.$typeArgs = typeArgs;
...
export class HONEY implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: HONEYFields, ) { this.$fullTypeName = composeSuiType( HONEY.$typeName, ...typeArgs ) as `${typeof PKG_V1}::honey::HONEY`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("HONEY", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): HONEY { if (!isHONEY(item.type)) { throw new Error("not a HONEY type");
 ...
 static fromJSON( json: Record<string, any> ): HONEY { if (json.$typeName !== HONEY.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): HONEY { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isHONEY(data.bcs.type)) { throw new Error(`object at is not a HONEY object`); }

 return HONEY.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return HONEY.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<HONEY> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HONEY object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHONEY(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HONEY object`); }
...
export class HoneyTransferred implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: HoneyTransferredFields, ) { this.$fullTypeName = composeSuiType( HoneyTransferred.$typeName, ...typeArgs ) as `${typeof PKG_V1}::honey::HoneyTransferred`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("HoneyTransferred", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): HoneyTransferred { if (!isHoneyTransferred(item.type)) { throw new Error("not a HoneyTransferred type");
 ...
 static fromJSON( json: Record<string, any> ): HoneyTransferred { if (json.$typeName !== HoneyTransferred.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): HoneyTransferred { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isHoneyTransferred(data.bcs.type)) { throw new Error(`object at is not a HoneyTransferred object`); }

 return HoneyTransferred.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return HoneyTransferred.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<HoneyTransferred> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HoneyTransferred object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHoneyTransferred(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HoneyTransferred object`); }
...
export class HoneyUnwrappedToCoin implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: HoneyUnwrappedToCoinFields, ) { this.$fullTypeName = composeSuiType( HoneyUnwrappedToCoin.$typeName, ...typeArgs ) as `${typeof PKG_V1}::honey::HoneyUnwrappedToCoin`; this.$typeArgs = typeArgs;
 ...
 static get bcs() { return bcs.struct("HoneyUnwrappedToCoin", {
 ...
 static fromFieldsWithTypes( item: FieldsWithTypes ): HoneyUnwrappedToCoin { if (!isHoneyUnwrappedToCoin(item.type)) { throw new Error("not a HoneyUnwrappedToCoin type");
 ...
 static fromJSON( json: Record<string, any> ): HoneyUnwrappedToCoin { if (json.$typeName !== HoneyUnwrappedToCoin.$typeName) { throw new Error("not a WithTwoGenerics json object") };
 ...
 static fromSuiObjectData( data: SuiObjectData ): HoneyUnwrappedToCoin { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isHoneyUnwrappedToCoin(data.bcs.type)) { throw new Error(`object at is not a HoneyUnwrappedToCoin object`); }

 return HoneyUnwrappedToCoin.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return HoneyUnwrappedToCoin.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<HoneyUnwrappedToCoin> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HoneyUnwrappedToCoin object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHoneyUnwrappedToCoin(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HoneyUnwrappedToCoin object`); }

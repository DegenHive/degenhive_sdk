...
import { TwoAmmFeeClaimCapability } from "../../degen-hive-dex-config/config/structs";
import { CurvedPoolConfig } from "../../degen-hive-dex-math/curved-math/structs";
import { StablePoolConfig } from "../../degen-hive-dex-math/stable-math/structs";
import { WeightedConfig } from "../../degen-hive-dex-math/weighted-math/structs";
...
export class CollectedFeeForPool<X extends PhantomTypeArgument, Y extends PhantomTypeArgument, Curve extends PhantomTypeArgument> implements StructClass {
    ...
    private constructor(typeArgs: [PhantomToTypeStr<X>, PhantomToTypeStr<Y>, PhantomToTypeStr<Curve>], fields: CollectedFeeForPoolFields<X, Y, Curve>,) {
        this.$fullTypeName = composeSuiType(CollectedFeeForPool.$typeName, ...typeArgs) as `${typeof PKG_V1}::two_pool::CollectedFeeForPool<${PhantomToTypeStr<X>}, ${PhantomToTypeStr<Y>}, ${PhantomToTypeStr<Curve>}>`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("CollectedFeeForPool", {
    ...
    static fromFieldsWithTypes<X extends PhantomReified<PhantomTypeArgument>, Y extends PhantomReified<PhantomTypeArgument>, Curve extends PhantomReified<PhantomTypeArgument>>(typeArgs: [X, Y, Curve], item: FieldsWithTypes): CollectedFeeForPool<ToPhantomTypeArgument<X>, ToPhantomTypeArgument<Y>, ToPhantomTypeArgument<Curve>> {
    ...
    static fromJSON<X extends PhantomReified<PhantomTypeArgument>, Y extends PhantomReified<PhantomTypeArgument>, Curve extends PhantomReified<PhantomTypeArgument>>(typeArgs: [X, Y, Curve], json: Record<string, any>): CollectedFeeForPool<ToPhantomTypeArgument<X>, ToPhantomTypeArgument<Y>, ToPhantomTypeArgument<Curve>> {
        if (json.$typeName !== CollectedFeeForPool.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch(composeSuiType(CollectedFeeForPool.$typeName, ...typeArgs.map(extractType)), json.$typeArgs, typeArgs,)
    ...
    static async fetch<X extends PhantomReified<PhantomTypeArgument>, Y extends PhantomReified<PhantomTypeArgument>, Curve extends PhantomReified<PhantomTypeArgument>>(client: SuiClient, typeArgs: [X, Y, Curve], id: string): Promise<CollectedFeeForPool<ToPhantomTypeArgument<X>, ToPhantomTypeArgument<Y>, ToPhantomTypeArgument<Curve>>> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching CollectedFeeForPool object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isCollectedFeeForPool(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a CollectedFeeForPool object`); }
...
export class HarvestedDegenSui<X extends PhantomTypeArgument> implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<X>], fields: HarvestedDegenSuiFields<X>,) {
        this.$fullTypeName = composeSuiType(HarvestedDegenSui.$typeName, ...typeArgs) as `${typeof PKG_V1}::two_pool::HarvestedDegenSui<${PhantomToTypeStr<X>}>`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HarvestedDegenSui", {
    ...
    static fromFieldsWithTypes<X extends PhantomReified<PhantomTypeArgument>>(typeArg: X, item: FieldsWithTypes): HarvestedDegenSui<ToPhantomTypeArgument<X>> {
    ...
    static fromJSON<X extends PhantomReified<PhantomTypeArgument>>(typeArg: X, json: Record<string, any>): HarvestedDegenSui<ToPhantomTypeArgument<X>> {
        if (json.$typeName !== HarvestedDegenSui.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch(composeSuiType(HarvestedDegenSui.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg],)
    ...
    static async fetch<X extends PhantomReified<PhantomTypeArgument>>(client: SuiClient, typeArg: X, id: string): Promise<HarvestedDegenSui<ToPhantomTypeArgument<X>>> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HarvestedDegenSui object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHarvestedDegenSui(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HarvestedDegenSui object`); }
...
export class SUI_BEE_Pool_Krafted implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: SUI_BEE_Pool_KraftedFields,) {
        this.$fullTypeName = composeSuiType(SUI_BEE_Pool_Krafted.$typeName, ...typeArgs) as `${typeof PKG_V1}::two_pool::SUI_BEE_Pool_Krafted`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("SUI_BEE_Pool_Krafted", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): SUI_BEE_Pool_Krafted {
    ...
    static fromJSON(json: Record<string, any>): SUI_BEE_Pool_Krafted {
        if (json.$typeName !== SUI_BEE_Pool_Krafted.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static async fetch(client: SuiClient, id: string): Promise<SUI_BEE_Pool_Krafted> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching SUI_BEE_Pool_Krafted object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isSUI_BEE_Pool_Krafted(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a SUI_BEE_Pool_Krafted object`); }
...
export class SUI_HIVE_Pool_Krafted implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: SUI_HIVE_Pool_KraftedFields,) {
        this.$fullTypeName = composeSuiType(SUI_HIVE_Pool_Krafted.$typeName, ...typeArgs) as `${typeof PKG_V1}::two_pool::SUI_HIVE_Pool_Krafted`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("SUI_HIVE_Pool_Krafted", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): SUI_HIVE_Pool_Krafted {
    ...
    static fromJSON(json: Record<string, any>): SUI_HIVE_Pool_Krafted {
        if (json.$typeName !== SUI_HIVE_Pool_Krafted.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static async fetch(client: SuiClient, id: string): Promise<SUI_HIVE_Pool_Krafted> {

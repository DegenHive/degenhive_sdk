...
export function isHiveGemKraftCap(type: string): boolean { type = compressSuiType(type); return type === "0x3ba4e7a050d6e5a787359a260802c0835b05bdf69be3fad19682a5677de3fdc::hive_gems::HiveGemKraftCap"; }
...
export class HiveGemKraftCap implements StructClass { static readonly $typeName = "0x3ba4e7a050d6e5a787359a260802c0835b05bdf69be3fad19682a5677de3fdc::hive_gems::HiveGemKraftCap"; static readonly $numTypeParams = 0;

 readonly $typeName = HiveGemKraftCap.$typeName;

 readonly $fullTypeName: "0x3ba4e7a050d6e5a787359a260802c0835b05bdf69be3fad19682a5677de3fdc::hive_gems::HiveGemKraftCap";

 readonly $typeArgs: [];

 readonly id: ToField<UID>; readonly kraftedTotal: ToField<"u64">

 private constructor(typeArgs: [], fields: HiveGemKraftCapFields, ) { this.$fullTypeName = composeSuiType( HiveGemKraftCap.$typeName, ...typeArgs ) as "0x3ba4e7a050d6e5a787359a260802c0835b05bdf69be3fad19682a5677de3fdc::hive_gems::HiveGemKraftCap"; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.kraftedTotal = fields.kraftedTotal; }

 static reified( ): HiveGemKraftCapReified { return { typeName: HiveGemKraftCap.$typeName, fullTypeName: composeSuiType( HiveGemKraftCap.$typeName, ...[] ) as "0x3ba4e7a050d6e5a787359a260802c0835b05bdf69be3fad19682a5677de3fdc::hive_gems::HiveGemKraftCap", typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => HiveGemKraftCap.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => HiveGemKraftCap.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => HiveGemKraftCap.fromBcs( data, ), bcs: HiveGemKraftCap.bcs, fromJSONField: (field: any) => HiveGemKraftCap.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => HiveGemKraftCap.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => HiveGemKraftCap.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => HiveGemKraftCap.fetch( client, id, ), new: ( fields: HiveGemKraftCapFields, ) => { return new HiveGemKraftCap( [], fields ) }, kind: "StructClassReified", } }
...
export function isHiveGems(type: string): boolean { type = compressSuiType(type); return type === "0x3ba4e7a050d6e5a787359a260802c0835b05bdf69be3fad19682a5677de3fdc::hive_gems::HiveGems"; }

export interface HiveGemsFields { value: ToField<"u64"> }

export type HiveGemsReified = Reified< HiveGems, HiveGemsFields >;

export class HiveGems implements StructClass { static readonly $typeName = "0x3ba4e7a050d6e5a787359a260802c0835b05bdf69be3fad19682a5677de3fdc::hive_gems::HiveGems"; static readonly $numTypeParams = 0;

 readonly $typeName = HiveGems.$typeName;

 readonly $fullTypeName: "0x3ba4e7a050d6e5a787359a260802c0835b05bdf69be3fad19682a5677de3fdc::hive_gems::HiveGems";

 readonly $typeArgs: [];

 readonly value: ToField<"u64">

 private constructor(typeArgs: [], fields: HiveGemsFields, ) { this.$fullTypeName = composeSuiType( HiveGems.$typeName, ...typeArgs ) as "0x3ba4e7a050d6e5a787359a260802c0835b05bdf69be3fad19682a5677de3fdc::hive_gems::HiveGems"; this.$typeArgs = typeArgs;

 this.value = fields.value; }

 static reified( ): HiveGemsReified { return { typeName: HiveGems.$typeName, fullTypeName: composeSuiType( HiveGems.$typeName, ...[] ) as "0x3ba4e7a050d6e5a787359a260802c0835b05bdf69be3fad19682a5677de3fdc::hive_gems::HiveGems", typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => HiveGems.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => HiveGems.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => HiveGems.fromBcs( data, ), bcs: HiveGems.bcs, fromJSONField: (field: any) => HiveGems.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => HiveGems.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => HiveGems.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => HiveGems.fetch( client, id, ), new: ( fields: HiveGemsFields, ) => { return new HiveGems( [], fields ) }, kind: "StructClassReified", } }
...
export function isHiveGemsBurnt(type: string): boolean { type = compressSuiType(type); return type === "0x3ba4e7a050d6e5a787359a260802c0835b05bdf69be3fad19682a5677de3fdc::hive_gems::HiveGemsBurnt"; }
...
export class HiveGemsBurnt implements StructClass { static readonly $typeName = "0x3ba4e7a050d6e5a787359a260802c0835b05bdf69be3fad19682a5677de3fdc::hive_gems::HiveGemsBurnt"; static readonly $numTypeParams = 0;

 readonly $typeName = HiveGemsBurnt.$typeName;

 readonly $fullTypeName: "0x3ba4e7a050d6e5a787359a260802c0835b05bdf69be3fad19682a5677de3fdc::hive_gems::HiveGemsBurnt";

 readonly $typeArgs: [];

 readonly value: ToField<"u64">

 private constructor(typeArgs: [], fields: HiveGemsBurntFields, ) { this.$fullTypeName = composeSuiType( HiveGemsBurnt.$typeName, ...typeArgs ) as "0x3ba4e7a050d6e5a787359a260802c0835b05bdf69be3fad19682a5677de3fdc::hive_gems::HiveGemsBurnt"; this.$typeArgs = typeArgs;

 this.value = fields.value; }

 static reified( ): HiveGemsBurntReified { return { typeName: HiveGemsBurnt.$typeName, fullTypeName: composeSuiType( HiveGemsBurnt.$typeName, ...[] ) as "0x3ba4e7a050d6e5a787359a260802c0835b05bdf69be3fad19682a5677de3fdc::hive_gems::HiveGemsBurnt", typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => HiveGemsBurnt.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => HiveGemsBurnt.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => HiveGemsBurnt.fromBcs( data, ), bcs: HiveGemsBurnt.bcs, fromJSONField: (field: any) => HiveGemsBurnt.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => HiveGemsBurnt.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => HiveGemsBurnt.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => HiveGemsBurnt.fetch( client, id, ), new: ( fields: HiveGemsBurntFields, ) => { return new HiveGemsBurnt( [], fields ) }, kind: "StructClassReified", } }

...
export class ConfigKey<Config extends PhantomTypeArgument> implements StructClass {
    ...
    static fromFieldsWithTypes<Config extends PhantomReified<PhantomTypeArgument>>(typeArg: Config, item: FieldsWithTypes): ConfigKey<ToPhantomTypeArgument<Config>> {
    ...
    static fromJSON<Config extends PhantomReified<PhantomTypeArgument>>(typeArg: Config, json: Record<string, any>): ConfigKey<ToPhantomTypeArgument<Config>> {
        if (json.$typeName !== ConfigKey.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch(composeSuiType(ConfigKey.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg],)
    ...
    static fromSuiObjectData<Config extends PhantomReified<PhantomTypeArgument>>(typeArg: Config, data: SuiObjectData): ConfigKey<ToPhantomTypeArgument<Config>> {
        if (data.bcs) {
            ...
            return ConfigKey.fromBcs(typeArg, fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ConfigKey.fromSuiParsedData(typeArg, data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch<Config extends PhantomReified<PhantomTypeArgument>>(client: SuiClient, typeArg: Config, id: string): Promise<ConfigKey<ToPhantomTypeArgument<Config>>> {
        ...
        return ConfigKey.fromSuiObjectData(typeArg, res.data);
    }
...
export class AdminCap implements StructClass {
    ...
    private constructor(typeArgs: [], fields: AdminCapFields,) {
        this.$fullTypeName = composeSuiType(AdminCap.$typeName, ...typeArgs) as `${typeof PKG_V1}::suins::AdminCap`; this.$typeArgs = typeArgs;
    ...
    static fromJSON(json: Record<string, any>): AdminCap {
        if (json.$typeName !== AdminCap.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): AdminCap {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isAdminCap(data.bcs.type)) { throw new Error(`object at is not a AdminCap object`); }

            return AdminCap.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return AdminCap.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<AdminCap> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching AdminCap object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isAdminCap(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a AdminCap object`); }
...
export class AppKey<App extends PhantomTypeArgument> implements StructClass {
    __StructClass = true as const;
    ...
    static fromFieldsWithTypes<App extends PhantomReified<PhantomTypeArgument>>(typeArg: App, item: FieldsWithTypes): AppKey<ToPhantomTypeArgument<App>> {
    ...
    static fromJSON<App extends PhantomReified<PhantomTypeArgument>>(typeArg: App, json: Record<string, any>): AppKey<ToPhantomTypeArgument<App>> {
        if (json.$typeName !== AppKey.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch(composeSuiType(AppKey.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg],)
    ...
    static fromSuiObjectData<App extends PhantomReified<PhantomTypeArgument>>(typeArg: App, data: SuiObjectData): AppKey<ToPhantomTypeArgument<App>> {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isAppKey(data.bcs.type)) { throw new Error(`object at is not a AppKey object`); }

            const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 1) { throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`); }; const gotTypeArg = compressSuiType(gotTypeArgs[0]); const expectedTypeArg = compressSuiType(extractType(typeArg)); if (gotTypeArg !== compressSuiType(extractType(typeArg))) { throw new Error(`type argument mismatch: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); };

            return AppKey.fromBcs(typeArg, fromB64(data.bcs.bcsBytes));
        } if (data.content) { return AppKey.fromSuiParsedData(typeArg, data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch<App extends PhantomReified<PhantomTypeArgument>>(client: SuiClient, typeArg: App, id: string): Promise<AppKey<ToPhantomTypeArgument<App>>> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching AppKey object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isAppKey(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a AppKey object`); }

        return AppKey.fromSuiObjectData(typeArg, res.data);
    }
...
export class RegistryKey<Config extends PhantomTypeArgument> implements StructClass {
    __StructClass = true as const;
    ...
    static fromFieldsWithTypes<Config extends PhantomReified<PhantomTypeArgument>>(typeArg: Config, item: FieldsWithTypes): RegistryKey<ToPhantomTypeArgument<Config>> {
    ...
    static fromJSON<Config extends PhantomReified<PhantomTypeArgument>>(typeArg: Config, json: Record<string, any>): RegistryKey<ToPhantomTypeArgument<Config>> {
        if (json.$typeName !== RegistryKey.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch(composeSuiType(RegistryKey.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg],)
    ...
    static fromSuiObjectData<Config extends PhantomReified<PhantomTypeArgument>>(typeArg: Config, data: SuiObjectData): RegistryKey<ToPhantomTypeArgument<Config>> {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isRegistryKey(data.bcs.type)) { throw new Error(`object at is not a RegistryKey object`); }

            const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 1) { throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`); }; const gotTypeArg = compressSuiType(gotTypeArgs[0]); const expectedTypeArg = compressSuiType(extractType(typeArg)); if (gotTypeArg !== compressSuiType(extractType(typeArg))) { throw new Error(`type argument mismatch: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); };

            return RegistryKey.fromBcs(typeArg, fromB64(data.bcs.bcsBytes));
        } if (data.content) { return RegistryKey.fromSuiParsedData(typeArg, data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch<Config extends PhantomReified<PhantomTypeArgument>>(client: SuiClient, typeArg: Config, id: string): Promise<RegistryKey<ToPhantomTypeArgument<Config>>> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching RegistryKey object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isRegistryKey(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a RegistryKey object`); }

        return RegistryKey.fromSuiObjectData(typeArg, res.data);
    }
...
export class SUINS implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: SUINSFields,) {
        this.$fullTypeName = composeSuiType(SUINS.$typeName, ...typeArgs) as `${typeof PKG_V1}::suins::SUINS`; this.$typeArgs = typeArgs;

        this.dummyField = fields.dummyField;
    }

    static reified(): SUINSReified { return { typeName: SUINS.$typeName, fullTypeName: composeSuiType(SUINS.$typeName, ...[]) as `${typeof PKG_V1}::suins::SUINS`, typeArgs: [] as [], isPhantom: SUINS.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => SUINS.fromFields(fields,), fromFieldsWithTypes: (item: FieldsWithTypes) => SUINS.fromFieldsWithTypes(item,), fromBcs: (data: Uint8Array) => SUINS.fromBcs(data,), bcs: SUINS.bcs, fromJSONField: (field: any) => SUINS.fromJSONField(field,), fromJSON: (json: Record<string, any>) => SUINS.fromJSON(json,), fromSuiParsedData: (content: SuiParsedData) => SUINS.fromSuiParsedData(content,), fromSuiObjectData: (content: SuiObjectData) => SUINS.fromSuiObjectData(content,), fetch: async (client: SuiClient, id: string) => SUINS.fetch(client, id,), new: (fields: SUINSFields,) => { return new SUINS([], fields) }, kind: "StructClassReified", } }
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): SUINS {
    ...
    static fromJSON(json: Record<string, any>): SUINS {
        if (json.$typeName !== SUINS.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): SUINS {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isSUINS(data.bcs.type)) { throw new Error(`object at is not a SUINS object`); }

            return SUINS.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return SUINS.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<SUINS> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching SUINS object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isSUINS(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a SUINS object`); }

        return SUINS.fromSuiObjectData(res.data);
    }

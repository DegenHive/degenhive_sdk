...
import { Bag } from "../../source/0x2/bag/structs";
import { Balance } from "../../source/0x2/balance/structs";
import { TreasuryCap } from "../../source/0x2/coin/structs";
...
import { FungibleStakedSui, PoolTokenExchangeRate, StakedSui } from "../../source/0x3/staking-pool/structs";
...
const PKG_V1 = dsuivault.PKG_V1

/* ============================== ConfigParams =============================== */

export function isConfigParams(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::dsui_vault::ConfigParams`; }

export interface ConfigParamsFields { pauseStake: ToField<"bool">; protocolFeePercent: ToField<"u64">; redeemFeeBps: ToField<"u64">; unstakeDelayEpoches: ToField<"u64">; treasuryPercent: ToField<"u64"> }

export type ConfigParamsReified = Reified<ConfigParams, ConfigParamsFields>;

export class ConfigParams implements StructClass {
    ...
    readonly pauseStake: ToField<"bool">; readonly protocolFeePercent: ToField<"u64">; readonly redeemFeeBps: ToField<"u64">; readonly unstakeDelayEpoches: ToField<"u64">; readonly treasuryPercent: ToField<"u64">

    private constructor(typeArgs: [], fields: ConfigParamsFields,) {
        this.$fullTypeName = composeSuiType(ConfigParams.$typeName, ...typeArgs) as `${typeof PKG_V1}::dsui_vault::ConfigParams`; this.$typeArgs = typeArgs;

        this.pauseStake = fields.pauseStake;; this.protocolFeePercent = fields.protocolFeePercent;; this.redeemFeeBps = fields.redeemFeeBps;; this.unstakeDelayEpoches = fields.unstakeDelayEpoches;; this.treasuryPercent = fields.treasuryPercent;
    }
    ...
    static get bcs() {
        return bcs.struct("ConfigParams", {

            pause_stake: bcs.bool(), protocol_fee_percent: bcs.u64(), redeem_fee_bps: bcs.u64(), unstake_delay_epoches: bcs.u64(), treasury_percent: bcs.u64()

        })
    };

    static fromFields(fields: Record<string, any>): ConfigParams { return ConfigParams.reified().new({ pauseStake: decodeFromFields("bool", fields.pause_stake), protocolFeePercent: decodeFromFields("u64", fields.protocol_fee_percent), redeemFeeBps: decodeFromFields("u64", fields.redeem_fee_bps), unstakeDelayEpoches: decodeFromFields("u64", fields.unstake_delay_epoches), treasuryPercent: decodeFromFields("u64", fields.treasury_percent) }) }

    static fromFieldsWithTypes(item: FieldsWithTypes): ConfigParams {
        if (!isConfigParams(item.type)) {
            throw new Error("not a ConfigParams type");

        }

        return ConfigParams.reified().new({ pauseStake: decodeFromFieldsWithTypes("bool", item.fields.pause_stake), protocolFeePercent: decodeFromFieldsWithTypes("u64", item.fields.protocol_fee_percent), redeemFeeBps: decodeFromFieldsWithTypes("u64", item.fields.redeem_fee_bps), unstakeDelayEpoches: decodeFromFieldsWithTypes("u64", item.fields.unstake_delay_epoches), treasuryPercent: decodeFromFieldsWithTypes("u64", item.fields.treasury_percent) })
    }
    ...
    static fromSuiObjectData(data: SuiObjectData): ConfigParams {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isConfigParams(data.bcs.type)) { throw new Error(`object at is not a ConfigParams object`); }

            return ConfigParams.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ConfigParams.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<ConfigParams> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ConfigParams object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isConfigParams(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ConfigParams object`); }
...
export class DSuiVault implements StructClass {
    ...
    readonly id: ToField<UID>; readonly dsuiKraftCap: ToField<TreasuryCap<ToPhantom<DSUI>>>; readonly configParams: ToField<ConfigParams>; readonly whitelistedValidators: ToField<Vector<"address">>; readonly validatorPools: ToField<LinkedTable<"address", ToPhantom<ValidatorPool>>>; readonly selectedValidatorMapping: ToField<LinkedTable<"address", ToPhantom<Balance<ToPhantom<SUI>>>>>; readonly suiToStake: ToField<Balance<ToPhantom<SUI>>>; readonly hiveFeeVault: ToField<Balance<ToPhantom<SUI>>>; readonly unstakedSuiReserve: ToField<Balance<ToPhantom<SUI>>>; readonly unstakeEpochs: ToField<LinkedTable<"u64", ToPhantom<RequestsForEpoch>>>; readonly totalSuiSupply: ToField<"u64">; readonly dsuiSupply: ToField<"u64">; readonly suiToUnstake: ToField<"u64">; readonly uncollectedProtocolFees: ToField<"u64">; readonly lastRefreshEpoch: ToField<"u64">; readonly suiClaimablePerDsui: ToField<"u128">; readonly bag: ToField<Bag>; readonly version: ToField<"u64">

    private constructor(typeArgs: [], fields: DSuiVaultFields,) {
        this.$fullTypeName = composeSuiType(DSuiVault.$typeName, ...typeArgs) as `${typeof PKG_V1}::dsui_vault::DSuiVault`; this.$typeArgs = typeArgs;

        this.id = fields.id;; this.dsuiKraftCap = fields.dsuiKraftCap;; this.configParams = fields.configParams;; this.whitelistedValidators = fields.whitelistedValidators;; this.validatorPools = fields.validatorPools;; this.selectedValidatorMapping = fields.selectedValidatorMapping;; this.suiToStake = fields.suiToStake;; this.hiveFeeVault = fields.hiveFeeVault;; this.unstakedSuiReserve = fields.unstakedSuiReserve;; this.unstakeEpochs = fields.unstakeEpochs;; this.totalSuiSupply = fields.totalSuiSupply;; this.dsuiSupply = fields.dsuiSupply;; this.suiToUnstake = fields.suiToUnstake;; this.uncollectedProtocolFees = fields.uncollectedProtocolFees;; this.lastRefreshEpoch = fields.lastRefreshEpoch;; this.suiClaimablePerDsui = fields.suiClaimablePerDsui;; this.bag = fields.bag;; this.version = fields.version;
    }
    ...
    static get bcs() {
        return bcs.struct("DSuiVault", {

            id: UID.bcs, dsui_kraft_cap: TreasuryCap.bcs, config_params: ConfigParams.bcs, whitelisted_validators: bcs.vector(bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val), })), validator_pools: LinkedTable.bcs(bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val), })), selected_validator_mapping: LinkedTable.bcs(bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val), })), sui_to_stake: Balance.bcs, hive_fee_vault: Balance.bcs, unstaked_sui_reserve: Balance.bcs, unstake_epochs: LinkedTable.bcs(bcs.u64()), total_sui_supply: bcs.u64(), dsui_supply: bcs.u64(), sui_to_unstake: bcs.u64(), uncollected_protocol_fees: bcs.u64(), last_refresh_epoch: bcs.u64(), sui_claimable_per_dsui: bcs.u128(), bag: Bag.bcs, version: bcs.u64()

        })
    };

    static fromFields(fields: Record<string, any>): DSuiVault { return DSuiVault.reified().new({ id: decodeFromFields(UID.reified(), fields.id), dsuiKraftCap: decodeFromFields(TreasuryCap.reified(reified.phantom(DSUI.reified())), fields.dsui_kraft_cap), configParams: decodeFromFields(ConfigParams.reified(), fields.config_params), whitelistedValidators: decodeFromFields(reified.vector("address"), fields.whitelisted_validators), validatorPools: decodeFromFields(LinkedTable.reified("address", reified.phantom(ValidatorPool.reified())), fields.validator_pools), selectedValidatorMapping: decodeFromFields(LinkedTable.reified("address", reified.phantom(Balance.reified(reified.phantom(SUI.reified())))), fields.selected_validator_mapping), suiToStake: decodeFromFields(Balance.reified(reified.phantom(SUI.reified())), fields.sui_to_stake), hiveFeeVault: decodeFromFields(Balance.reified(reified.phantom(SUI.reified())), fields.hive_fee_vault), unstakedSuiReserve: decodeFromFields(Balance.reified(reified.phantom(SUI.reified())), fields.unstaked_sui_reserve), unstakeEpochs: decodeFromFields(LinkedTable.reified("u64", reified.phantom(RequestsForEpoch.reified())), fields.unstake_epochs), totalSuiSupply: decodeFromFields("u64", fields.total_sui_supply), dsuiSupply: decodeFromFields("u64", fields.dsui_supply), suiToUnstake: decodeFromFields("u64", fields.sui_to_unstake), uncollectedProtocolFees: decodeFromFields("u64", fields.uncollected_protocol_fees), lastRefreshEpoch: decodeFromFields("u64", fields.last_refresh_epoch), suiClaimablePerDsui: decodeFromFields("u128", fields.sui_claimable_per_dsui), bag: decodeFromFields(Bag.reified(), fields.bag), version: decodeFromFields("u64", fields.version) }) }

    static fromFieldsWithTypes(item: FieldsWithTypes): DSuiVault {
        if (!isDSuiVault(item.type)) {
            throw new Error("not a DSuiVault type");

        }

        return DSuiVault.reified().new({ id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), dsuiKraftCap: decodeFromFieldsWithTypes(TreasuryCap.reified(reified.phantom(DSUI.reified())), item.fields.dsui_kraft_cap), configParams: decodeFromFieldsWithTypes(ConfigParams.reified(), item.fields.config_params), whitelistedValidators: decodeFromFieldsWithTypes(reified.vector("address"), item.fields.whitelisted_validators), validatorPools: decodeFromFieldsWithTypes(LinkedTable.reified("address", reified.phantom(ValidatorPool.reified())), item.fields.validator_pools), selectedValidatorMapping: decodeFromFieldsWithTypes(LinkedTable.reified("address", reified.phantom(Balance.reified(reified.phantom(SUI.reified())))), item.fields.selected_validator_mapping), suiToStake: decodeFromFieldsWithTypes(Balance.reified(reified.phantom(SUI.reified())), item.fields.sui_to_stake), hiveFeeVault: decodeFromFieldsWithTypes(Balance.reified(reified.phantom(SUI.reified())), item.fields.hive_fee_vault), unstakedSuiReserve: decodeFromFieldsWithTypes(Balance.reified(reified.phantom(SUI.reified())), item.fields.unstaked_sui_reserve), unstakeEpochs: decodeFromFieldsWithTypes(LinkedTable.reified("u64", reified.phantom(RequestsForEpoch.reified())), item.fields.unstake_epochs), totalSuiSupply: decodeFromFieldsWithTypes("u64", item.fields.total_sui_supply), dsuiSupply: decodeFromFieldsWithTypes("u64", item.fields.dsui_supply), suiToUnstake: decodeFromFieldsWithTypes("u64", item.fields.sui_to_unstake), uncollectedProtocolFees: decodeFromFieldsWithTypes("u64", item.fields.uncollected_protocol_fees), lastRefreshEpoch: decodeFromFieldsWithTypes("u64", item.fields.last_refresh_epoch), suiClaimablePerDsui: decodeFromFieldsWithTypes("u128", item.fields.sui_claimable_per_dsui), bag: decodeFromFieldsWithTypes(Bag.reified(), item.fields.bag), version: decodeFromFieldsWithTypes("u64", item.fields.version) })
    }
    ...
    static fromJSONField(field: any): DSuiVault { return DSuiVault.reified().new({ id: decodeFromJSONField(UID.reified(), field.id), dsuiKraftCap: decodeFromJSONField(TreasuryCap.reified(reified.phantom(DSUI.reified())), field.dsuiKraftCap), configParams: decodeFromJSONField(ConfigParams.reified(), field.configParams), whitelistedValidators: decodeFromJSONField(reified.vector("address"), field.whitelistedValidators), validatorPools: decodeFromJSONField(LinkedTable.reified("address", reified.phantom(ValidatorPool.reified())), field.validatorPools), selectedValidatorMapping: decodeFromJSONField(LinkedTable.reified("address", reified.phantom(Balance.reified(reified.phantom(SUI.reified())))), field.selectedValidatorMapping), suiToStake: decodeFromJSONField(Balance.reified(reified.phantom(SUI.reified())), field.suiToStake), hiveFeeVault: decodeFromJSONField(Balance.reified(reified.phantom(SUI.reified())), field.hiveFeeVault), unstakedSuiReserve: decodeFromJSONField(Balance.reified(reified.phantom(SUI.reified())), field.unstakedSuiReserve), unstakeEpochs: decodeFromJSONField(LinkedTable.reified("u64", reified.phantom(RequestsForEpoch.reified())), field.unstakeEpochs), totalSuiSupply: decodeFromJSONField("u64", field.totalSuiSupply), dsuiSupply: decodeFromJSONField("u64", field.dsuiSupply), suiToUnstake: decodeFromJSONField("u64", field.suiToUnstake), uncollectedProtocolFees: decodeFromJSONField("u64", field.uncollectedProtocolFees), lastRefreshEpoch: decodeFromJSONField("u64", field.lastRefreshEpoch), suiClaimablePerDsui: decodeFromJSONField("u128", field.suiClaimablePerDsui), bag: decodeFromJSONField(Bag.reified(), field.bag), version: decodeFromJSONField("u64", field.version) }) }

    static fromJSON(json: Record<string, any>): DSuiVault {
        if (json.$typeName !== DSuiVault.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): DSuiVault {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isDSuiVault(data.bcs.type)) { throw new Error(`object at is not a DSuiVault object`); }

            return DSuiVault.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return DSuiVault.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<DSuiVault> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching DSuiVault object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isDSuiVault(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a DSuiVault object`); }
...
export interface DegenSUIFeeStructureUpdatedFields { protocolFeePercent: ToField<"u64">; treasuryPercent: ToField<"u64">; redeemFeeBps: ToField<"u64">; unstakeDelayEpoches: ToField<"u64"> }

export type DegenSUIFeeStructureUpdatedReified = Reified<DegenSUIFeeStructureUpdated, DegenSUIFeeStructureUpdatedFields>;

export class DegenSUIFeeStructureUpdated implements StructClass {
    __StructClass = true as const;
    ...
    readonly protocolFeePercent: ToField<"u64">; readonly treasuryPercent: ToField<"u64">; readonly redeemFeeBps: ToField<"u64">; readonly unstakeDelayEpoches: ToField<"u64">

    private constructor(typeArgs: [], fields: DegenSUIFeeStructureUpdatedFields,) {
        this.$fullTypeName = composeSuiType(DegenSUIFeeStructureUpdated.$typeName, ...typeArgs) as `${typeof PKG_V1}::dsui_vault::DegenSUIFeeStructureUpdated`; this.$typeArgs = typeArgs;

        this.protocolFeePercent = fields.protocolFeePercent;; this.treasuryPercent = fields.treasuryPercent;; this.redeemFeeBps = fields.redeemFeeBps;; this.unstakeDelayEpoches = fields.unstakeDelayEpoches;
    }
    ...
    static get bcs() {
        return bcs.struct("DegenSUIFeeStructureUpdated", {

            protocol_fee_percent: bcs.u64(), treasury_percent: bcs.u64(), redeem_fee_bps: bcs.u64(), unstake_delay_epoches: bcs.u64()

        })
    };

    static fromFields(fields: Record<string, any>): DegenSUIFeeStructureUpdated { return DegenSUIFeeStructureUpdated.reified().new({ protocolFeePercent: decodeFromFields("u64", fields.protocol_fee_percent), treasuryPercent: decodeFromFields("u64", fields.treasury_percent), redeemFeeBps: decodeFromFields("u64", fields.redeem_fee_bps), unstakeDelayEpoches: decodeFromFields("u64", fields.unstake_delay_epoches) }) }

    static fromFieldsWithTypes(item: FieldsWithTypes): DegenSUIFeeStructureUpdated {
        if (!isDegenSUIFeeStructureUpdated(item.type)) {
            throw new Error("not a DegenSUIFeeStructureUpdated type");

        }

        return DegenSUIFeeStructureUpdated.reified().new({ protocolFeePercent: decodeFromFieldsWithTypes("u64", item.fields.protocol_fee_percent), treasuryPercent: decodeFromFieldsWithTypes("u64", item.fields.treasury_percent), redeemFeeBps: decodeFromFieldsWithTypes("u64", item.fields.redeem_fee_bps), unstakeDelayEpoches: decodeFromFieldsWithTypes("u64", item.fields.unstake_delay_epoches) })
    }
    ...
    static fromJSONField(field: any): DegenSUIFeeStructureUpdated { return DegenSUIFeeStructureUpdated.reified().new({ protocolFeePercent: decodeFromJSONField("u64", field.protocolFeePercent), treasuryPercent: decodeFromJSONField("u64", field.treasuryPercent), redeemFeeBps: decodeFromJSONField("u64", field.redeemFeeBps), unstakeDelayEpoches: decodeFromJSONField("u64", field.unstakeDelayEpoches) }) }

    static fromJSON(json: Record<string, any>): DegenSUIFeeStructureUpdated {
        if (json.$typeName !== DegenSUIFeeStructureUpdated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): DegenSUIFeeStructureUpdated {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isDegenSUIFeeStructureUpdated(data.bcs.type)) { throw new Error(`object at is not a DegenSUIFeeStructureUpdated object`); }

            return DegenSUIFeeStructureUpdated.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return DegenSUIFeeStructureUpdated.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<DegenSUIFeeStructureUpdated> {
...
export class EmergencyPauseUpdate implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: EmergencyPauseUpdateFields,) {
        this.$fullTypeName = composeSuiType(EmergencyPauseUpdate.$typeName, ...typeArgs) as `${typeof PKG_V1}::dsui_vault::EmergencyPauseUpdate`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("EmergencyPauseUpdate", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): EmergencyPauseUpdate {
    ...
    static fromJSON(json: Record<string, any>): EmergencyPauseUpdate {
        if (json.$typeName !== EmergencyPauseUpdate.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): EmergencyPauseUpdate {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isEmergencyPauseUpdate(data.bcs.type)) { throw new Error(`object at is not a EmergencyPauseUpdate object`); }

            return EmergencyPauseUpdate.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return EmergencyPauseUpdate.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<EmergencyPauseUpdate> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching EmergencyPauseUpdate object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isEmergencyPauseUpdate(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a EmergencyPauseUpdate object`); }
...
export class LsdFeeCollected implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: LsdFeeCollectedFields,) {
        this.$fullTypeName = composeSuiType(LsdFeeCollected.$typeName, ...typeArgs) as `${typeof PKG_V1}::dsui_vault::LsdFeeCollected`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("LsdFeeCollected", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): LsdFeeCollected {
    ...
    static fromJSON(json: Record<string, any>): LsdFeeCollected {
        if (json.$typeName !== LsdFeeCollected.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): LsdFeeCollected {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isLsdFeeCollected(data.bcs.type)) { throw new Error(`object at is not a LsdFeeCollected object`); }

            return LsdFeeCollected.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return LsdFeeCollected.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<LsdFeeCollected> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching LsdFeeCollected object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isLsdFeeCollected(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a LsdFeeCollected object`); }
...
export class RequestsForEpoch implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: RequestsForEpochFields,) {
        this.$fullTypeName = composeSuiType(RequestsForEpoch.$typeName, ...typeArgs) as `${typeof PKG_V1}::dsui_vault::RequestsForEpoch`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("RequestsForEpoch", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): RequestsForEpoch {
    ...
    static fromJSON(json: Record<string, any>): RequestsForEpoch {
        if (json.$typeName !== RequestsForEpoch.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): RequestsForEpoch {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isRequestsForEpoch(data.bcs.type)) { throw new Error(`object at is not a RequestsForEpoch object`); }

            return RequestsForEpoch.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return RequestsForEpoch.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<RequestsForEpoch> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching RequestsForEpoch object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isRequestsForEpoch(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a RequestsForEpoch object`); }
...
export class RequestsForEpochDestroyed implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: RequestsForEpochDestroyedFields,) {
        this.$fullTypeName = composeSuiType(RequestsForEpochDestroyed.$typeName, ...typeArgs) as `${typeof PKG_V1}::dsui_vault::RequestsForEpochDestroyed`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("RequestsForEpochDestroyed", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): RequestsForEpochDestroyed {
    ...
    static fromJSON(json: Record<string, any>): RequestsForEpochDestroyed {
        if (json.$typeName !== RequestsForEpochDestroyed.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): RequestsForEpochDestroyed {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isRequestsForEpochDestroyed(data.bcs.type)) { throw new Error(`object at is not a RequestsForEpochDestroyed object`); }

            return RequestsForEpochDestroyed.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return RequestsForEpochDestroyed.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<RequestsForEpochDestroyed> {
...
export class StakeOperationProcessed implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: StakeOperationProcessedFields,) {
        this.$fullTypeName = composeSuiType(StakeOperationProcessed.$typeName, ...typeArgs) as `${typeof PKG_V1}::dsui_vault::StakeOperationProcessed`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("StakeOperationProcessed", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): StakeOperationProcessed {
    ...
    static fromJSON(json: Record<string, any>): StakeOperationProcessed {
        if (json.$typeName !== StakeOperationProcessed.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): StakeOperationProcessed {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isStakeOperationProcessed(data.bcs.type)) { throw new Error(`object at is not a StakeOperationProcessed object`); }

            return StakeOperationProcessed.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return StakeOperationProcessed.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<StakeOperationProcessed> {
...
export class StakeSuiRequest implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: StakeSuiRequestFields,) {
        this.$fullTypeName = composeSuiType(StakeSuiRequest.$typeName, ...typeArgs) as `${typeof PKG_V1}::dsui_vault::StakeSuiRequest`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("StakeSuiRequest", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): StakeSuiRequest {
    ...
    static fromJSON(json: Record<string, any>): StakeSuiRequest {
        if (json.$typeName !== StakeSuiRequest.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): StakeSuiRequest {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isStakeSuiRequest(data.bcs.type)) { throw new Error(`object at is not a StakeSuiRequest object`); }

            return StakeSuiRequest.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return StakeSuiRequest.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<StakeSuiRequest> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching StakeSuiRequest object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isStakeSuiRequest(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a StakeSuiRequest object`); }
...
export interface StakeSuiRequestsProcessedFields { curEpoch: ToField<"u64">; totalSuiStaked: ToField<"u64">; suiToUnstakedForRequests: ToField<"u64">; protocolFeeCollected: ToField<"u64">; suiClaimablePerDsui: ToField<"u128"> }

export type StakeSuiRequestsProcessedReified = Reified<StakeSuiRequestsProcessed, StakeSuiRequestsProcessedFields>;

export class StakeSuiRequestsProcessed implements StructClass {
    __StructClass = true as const;
    ...
    readonly curEpoch: ToField<"u64">; readonly totalSuiStaked: ToField<"u64">; readonly suiToUnstakedForRequests: ToField<"u64">; readonly protocolFeeCollected: ToField<"u64">; readonly suiClaimablePerDsui: ToField<"u128">

    private constructor(typeArgs: [], fields: StakeSuiRequestsProcessedFields,) {
        this.$fullTypeName = composeSuiType(StakeSuiRequestsProcessed.$typeName, ...typeArgs) as `${typeof PKG_V1}::dsui_vault::StakeSuiRequestsProcessed`; this.$typeArgs = typeArgs;

        this.curEpoch = fields.curEpoch;; this.totalSuiStaked = fields.totalSuiStaked;; this.suiToUnstakedForRequests = fields.suiToUnstakedForRequests;; this.protocolFeeCollected = fields.protocolFeeCollected;; this.suiClaimablePerDsui = fields.suiClaimablePerDsui;
    }
    ...
    static get bcs() {
        return bcs.struct("StakeSuiRequestsProcessed", {

            cur_epoch: bcs.u64(), total_sui_staked: bcs.u64(), sui_to_unstaked_for_requests: bcs.u64(), protocol_fee_collected: bcs.u64(), sui_claimable_per_dsui: bcs.u128()

        })
    };

    static fromFields(fields: Record<string, any>): StakeSuiRequestsProcessed { return StakeSuiRequestsProcessed.reified().new({ curEpoch: decodeFromFields("u64", fields.cur_epoch), totalSuiStaked: decodeFromFields("u64", fields.total_sui_staked), suiToUnstakedForRequests: decodeFromFields("u64", fields.sui_to_unstaked_for_requests), protocolFeeCollected: decodeFromFields("u64", fields.protocol_fee_collected), suiClaimablePerDsui: decodeFromFields("u128", fields.sui_claimable_per_dsui) }) }

    static fromFieldsWithTypes(item: FieldsWithTypes): StakeSuiRequestsProcessed {
        if (!isStakeSuiRequestsProcessed(item.type)) {
            throw new Error("not a StakeSuiRequestsProcessed type");

        }

        return StakeSuiRequestsProcessed.reified().new({ curEpoch: decodeFromFieldsWithTypes("u64", item.fields.cur_epoch), totalSuiStaked: decodeFromFieldsWithTypes("u64", item.fields.total_sui_staked), suiToUnstakedForRequests: decodeFromFieldsWithTypes("u64", item.fields.sui_to_unstaked_for_requests), protocolFeeCollected: decodeFromFieldsWithTypes("u64", item.fields.protocol_fee_collected), suiClaimablePerDsui: decodeFromFieldsWithTypes("u128", item.fields.sui_claimable_per_dsui) })
    }
    ...
    static fromJSONField(field: any): StakeSuiRequestsProcessed { return StakeSuiRequestsProcessed.reified().new({ curEpoch: decodeFromJSONField("u64", field.curEpoch), totalSuiStaked: decodeFromJSONField("u64", field.totalSuiStaked), suiToUnstakedForRequests: decodeFromJSONField("u64", field.suiToUnstakedForRequests), protocolFeeCollected: decodeFromJSONField("u64", field.protocolFeeCollected), suiClaimablePerDsui: decodeFromJSONField("u128", field.suiClaimablePerDsui) }) }

    static fromJSON(json: Record<string, any>): StakeSuiRequestsProcessed {
        if (json.$typeName !== StakeSuiRequestsProcessed.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): StakeSuiRequestsProcessed {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isStakeSuiRequestsProcessed(data.bcs.type)) { throw new Error(`object at is not a StakeSuiRequestsProcessed object`); }

            return StakeSuiRequestsProcessed.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return StakeSuiRequestsProcessed.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export class StakeWithSelectedValidatorRequestProcessed implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: StakeWithSelectedValidatorRequestProcessedFields,) {
        this.$fullTypeName = composeSuiType(StakeWithSelectedValidatorRequestProcessed.$typeName, ...typeArgs) as `${typeof PKG_V1}::dsui_vault::StakeWithSelectedValidatorRequestProcessed`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("StakeWithSelectedValidatorRequestProcessed", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): StakeWithSelectedValidatorRequestProcessed {
    ...
    static fromJSON(json: Record<string, any>): StakeWithSelectedValidatorRequestProcessed {
        if (json.$typeName !== StakeWithSelectedValidatorRequestProcessed.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): StakeWithSelectedValidatorRequestProcessed {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isStakeWithSelectedValidatorRequestProcessed(data.bcs.type)) { throw new Error(`object at is not a StakeWithSelectedValidatorRequestProcessed object`); }

            return StakeWithSelectedValidatorRequestProcessed.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return StakeWithSelectedValidatorRequestProcessed.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export interface TotalRewardsUpdatedFields { curEpoch: ToField<"u64">; oldSuiSupply: ToField<"u64">; newSuiSupply: ToField<"u64">; dsuiSupply: ToField<"u64">; feesCharged: ToField<"u64"> }

export type TotalRewardsUpdatedReified = Reified<TotalRewardsUpdated, TotalRewardsUpdatedFields>;

export class TotalRewardsUpdated implements StructClass {
    __StructClass = true as const;
    ...
    readonly curEpoch: ToField<"u64">; readonly oldSuiSupply: ToField<"u64">; readonly newSuiSupply: ToField<"u64">; readonly dsuiSupply: ToField<"u64">; readonly feesCharged: ToField<"u64">

    private constructor(typeArgs: [], fields: TotalRewardsUpdatedFields,) {
        this.$fullTypeName = composeSuiType(TotalRewardsUpdated.$typeName, ...typeArgs) as `${typeof PKG_V1}::dsui_vault::TotalRewardsUpdated`; this.$typeArgs = typeArgs;

        this.curEpoch = fields.curEpoch;; this.oldSuiSupply = fields.oldSuiSupply;; this.newSuiSupply = fields.newSuiSupply;; this.dsuiSupply = fields.dsuiSupply;; this.feesCharged = fields.feesCharged;
    }
    ...
    static get bcs() {
        return bcs.struct("TotalRewardsUpdated", {

            cur_epoch: bcs.u64(), old_sui_supply: bcs.u64(), new_sui_supply: bcs.u64(), dsui_supply: bcs.u64(), fees_charged: bcs.u64()

        })
    };

    static fromFields(fields: Record<string, any>): TotalRewardsUpdated { return TotalRewardsUpdated.reified().new({ curEpoch: decodeFromFields("u64", fields.cur_epoch), oldSuiSupply: decodeFromFields("u64", fields.old_sui_supply), newSuiSupply: decodeFromFields("u64", fields.new_sui_supply), dsuiSupply: decodeFromFields("u64", fields.dsui_supply), feesCharged: decodeFromFields("u64", fields.fees_charged) }) }

    static fromFieldsWithTypes(item: FieldsWithTypes): TotalRewardsUpdated {
        if (!isTotalRewardsUpdated(item.type)) {
            throw new Error("not a TotalRewardsUpdated type");

        }

        return TotalRewardsUpdated.reified().new({ curEpoch: decodeFromFieldsWithTypes("u64", item.fields.cur_epoch), oldSuiSupply: decodeFromFieldsWithTypes("u64", item.fields.old_sui_supply), newSuiSupply: decodeFromFieldsWithTypes("u64", item.fields.new_sui_supply), dsuiSupply: decodeFromFieldsWithTypes("u64", item.fields.dsui_supply), feesCharged: decodeFromFieldsWithTypes("u64", item.fields.fees_charged) })
    }
    ...
    static fromJSONField(field: any): TotalRewardsUpdated { return TotalRewardsUpdated.reified().new({ curEpoch: decodeFromJSONField("u64", field.curEpoch), oldSuiSupply: decodeFromJSONField("u64", field.oldSuiSupply), newSuiSupply: decodeFromJSONField("u64", field.newSuiSupply), dsuiSupply: decodeFromJSONField("u64", field.dsuiSupply), feesCharged: decodeFromJSONField("u64", field.feesCharged) }) }

    static fromJSON(json: Record<string, any>): TotalRewardsUpdated {
        if (json.$typeName !== TotalRewardsUpdated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): TotalRewardsUpdated {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isTotalRewardsUpdated(data.bcs.type)) { throw new Error(`object at is not a TotalRewardsUpdated object`); }

            return TotalRewardsUpdated.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return TotalRewardsUpdated.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<TotalRewardsUpdated> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching TotalRewardsUpdated object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isTotalRewardsUpdated(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a TotalRewardsUpdated object`); }
...
export class UnstakeRequest implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: UnstakeRequestFields,) {
        this.$fullTypeName = composeSuiType(UnstakeRequest.$typeName, ...typeArgs) as `${typeof PKG_V1}::dsui_vault::UnstakeRequest`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("UnstakeRequest", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): UnstakeRequest {
    ...
    static fromJSON(json: Record<string, any>): UnstakeRequest {
        if (json.$typeName !== UnstakeRequest.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): UnstakeRequest {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isUnstakeRequest(data.bcs.type)) { throw new Error(`object at is not a UnstakeRequest object`); }

            return UnstakeRequest.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return UnstakeRequest.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<UnstakeRequest> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching UnstakeRequest object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isUnstakeRequest(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a UnstakeRequest object`); }
...
export interface UserClaimedSuiFields { id: ToField<ID>; owner: ToField<"address">; suiWithdrawn: ToField<"u64">; netSuiWithdrawn: ToField<"u64">; redemptionFees: ToField<"u64">; suiClaimablePerDsui: ToField<"u128">; curEpoch: ToField<"u64"> }

export type UserClaimedSuiReified = Reified<UserClaimedSui, UserClaimedSuiFields>;

export class UserClaimedSui implements StructClass {
    __StructClass = true as const;
    ...
    readonly id: ToField<ID>; readonly owner: ToField<"address">; readonly suiWithdrawn: ToField<"u64">; readonly netSuiWithdrawn: ToField<"u64">; readonly redemptionFees: ToField<"u64">; readonly suiClaimablePerDsui: ToField<"u128">; readonly curEpoch: ToField<"u64">

    private constructor(typeArgs: [], fields: UserClaimedSuiFields,) {
        this.$fullTypeName = composeSuiType(UserClaimedSui.$typeName, ...typeArgs) as `${typeof PKG_V1}::dsui_vault::UserClaimedSui`; this.$typeArgs = typeArgs;

        this.id = fields.id;; this.owner = fields.owner;; this.suiWithdrawn = fields.suiWithdrawn;; this.netSuiWithdrawn = fields.netSuiWithdrawn;; this.redemptionFees = fields.redemptionFees;; this.suiClaimablePerDsui = fields.suiClaimablePerDsui;; this.curEpoch = fields.curEpoch;
    }
    ...
    static get bcs() {
        return bcs.struct("UserClaimedSui", {

            id: ID.bcs, owner: bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val), }), sui_withdrawn: bcs.u64(), net_sui_withdrawn: bcs.u64(), redemption_fees: bcs.u64(), sui_claimable_per_dsui: bcs.u128(), cur_epoch: bcs.u64()

        })
    };

    static fromFields(fields: Record<string, any>): UserClaimedSui { return UserClaimedSui.reified().new({ id: decodeFromFields(ID.reified(), fields.id), owner: decodeFromFields("address", fields.owner), suiWithdrawn: decodeFromFields("u64", fields.sui_withdrawn), netSuiWithdrawn: decodeFromFields("u64", fields.net_sui_withdrawn), redemptionFees: decodeFromFields("u64", fields.redemption_fees), suiClaimablePerDsui: decodeFromFields("u128", fields.sui_claimable_per_dsui), curEpoch: decodeFromFields("u64", fields.cur_epoch) }) }

    static fromFieldsWithTypes(item: FieldsWithTypes): UserClaimedSui {
        if (!isUserClaimedSui(item.type)) {
            throw new Error("not a UserClaimedSui type");

        }

        return UserClaimedSui.reified().new({ id: decodeFromFieldsWithTypes(ID.reified(), item.fields.id), owner: decodeFromFieldsWithTypes("address", item.fields.owner), suiWithdrawn: decodeFromFieldsWithTypes("u64", item.fields.sui_withdrawn), netSuiWithdrawn: decodeFromFieldsWithTypes("u64", item.fields.net_sui_withdrawn), redemptionFees: decodeFromFieldsWithTypes("u64", item.fields.redemption_fees), suiClaimablePerDsui: decodeFromFieldsWithTypes("u128", item.fields.sui_claimable_per_dsui), curEpoch: decodeFromFieldsWithTypes("u64", item.fields.cur_epoch) })
    }
    ...
    static fromJSONField(field: any): UserClaimedSui { return UserClaimedSui.reified().new({ id: decodeFromJSONField(ID.reified(), field.id), owner: decodeFromJSONField("address", field.owner), suiWithdrawn: decodeFromJSONField("u64", field.suiWithdrawn), netSuiWithdrawn: decodeFromJSONField("u64", field.netSuiWithdrawn), redemptionFees: decodeFromJSONField("u64", field.redemptionFees), suiClaimablePerDsui: decodeFromJSONField("u128", field.suiClaimablePerDsui), curEpoch: decodeFromJSONField("u64", field.curEpoch) }) }

    static fromJSON(json: Record<string, any>): UserClaimedSui {
        if (json.$typeName !== UserClaimedSui.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): UserClaimedSui {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isUserClaimedSui(data.bcs.type)) { throw new Error(`object at is not a UserClaimedSui object`); }

            return UserClaimedSui.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return UserClaimedSui.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<UserClaimedSui> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching UserClaimedSui object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isUserClaimedSui(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a UserClaimedSui object`); }
...
export class UserUnstakeRequest implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: UserUnstakeRequestFields,) {
        this.$fullTypeName = composeSuiType(UserUnstakeRequest.$typeName, ...typeArgs) as `${typeof PKG_V1}::dsui_vault::UserUnstakeRequest`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("UserUnstakeRequest", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): UserUnstakeRequest {
    ...
    static fromJSON(json: Record<string, any>): UserUnstakeRequest {
        if (json.$typeName !== UserUnstakeRequest.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): UserUnstakeRequest {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isUserUnstakeRequest(data.bcs.type)) { throw new Error(`object at is not a UserUnstakeRequest object`); }

            return UserUnstakeRequest.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return UserUnstakeRequest.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<UserUnstakeRequest> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching UserUnstakeRequest object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isUserUnstakeRequest(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a UserUnstakeRequest object`); }
...
export interface UserUnstakedInstantlyFields { owner: ToField<"address">; suiWithdrawn: ToField<"u64">; dsuiBurnt: ToField<"u64">; redemptionFees: ToField<"u64">; suiClaimablePerDsui: ToField<"u128">; curEpoch: ToField<"u64"> }

export type UserUnstakedInstantlyReified = Reified<UserUnstakedInstantly, UserUnstakedInstantlyFields>;

export class UserUnstakedInstantly implements StructClass {
    __StructClass = true as const;
    ...
    readonly owner: ToField<"address">; readonly suiWithdrawn: ToField<"u64">; readonly dsuiBurnt: ToField<"u64">; readonly redemptionFees: ToField<"u64">; readonly suiClaimablePerDsui: ToField<"u128">; readonly curEpoch: ToField<"u64">

    private constructor(typeArgs: [], fields: UserUnstakedInstantlyFields,) {
        this.$fullTypeName = composeSuiType(UserUnstakedInstantly.$typeName, ...typeArgs) as `${typeof PKG_V1}::dsui_vault::UserUnstakedInstantly`; this.$typeArgs = typeArgs;

        this.owner = fields.owner;; this.suiWithdrawn = fields.suiWithdrawn;; this.dsuiBurnt = fields.dsuiBurnt;; this.redemptionFees = fields.redemptionFees;; this.suiClaimablePerDsui = fields.suiClaimablePerDsui;; this.curEpoch = fields.curEpoch;
    }
    ...
    static get bcs() {
        return bcs.struct("UserUnstakedInstantly", {

            owner: bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val), }), sui_withdrawn: bcs.u64(), dsui_burnt: bcs.u64(), redemption_fees: bcs.u64(), sui_claimable_per_dsui: bcs.u128(), cur_epoch: bcs.u64()

        })
    };

    static fromFields(fields: Record<string, any>): UserUnstakedInstantly { return UserUnstakedInstantly.reified().new({ owner: decodeFromFields("address", fields.owner), suiWithdrawn: decodeFromFields("u64", fields.sui_withdrawn), dsuiBurnt: decodeFromFields("u64", fields.dsui_burnt), redemptionFees: decodeFromFields("u64", fields.redemption_fees), suiClaimablePerDsui: decodeFromFields("u128", fields.sui_claimable_per_dsui), curEpoch: decodeFromFields("u64", fields.cur_epoch) }) }

    static fromFieldsWithTypes(item: FieldsWithTypes): UserUnstakedInstantly {
        if (!isUserUnstakedInstantly(item.type)) {
            throw new Error("not a UserUnstakedInstantly type");

        }

        return UserUnstakedInstantly.reified().new({ owner: decodeFromFieldsWithTypes("address", item.fields.owner), suiWithdrawn: decodeFromFieldsWithTypes("u64", item.fields.sui_withdrawn), dsuiBurnt: decodeFromFieldsWithTypes("u64", item.fields.dsui_burnt), redemptionFees: decodeFromFieldsWithTypes("u64", item.fields.redemption_fees), suiClaimablePerDsui: decodeFromFieldsWithTypes("u128", item.fields.sui_claimable_per_dsui), curEpoch: decodeFromFieldsWithTypes("u64", item.fields.cur_epoch) })
    }
    ...
    static fromJSONField(field: any): UserUnstakedInstantly { return UserUnstakedInstantly.reified().new({ owner: decodeFromJSONField("address", field.owner), suiWithdrawn: decodeFromJSONField("u64", field.suiWithdrawn), dsuiBurnt: decodeFromJSONField("u64", field.dsuiBurnt), redemptionFees: decodeFromJSONField("u64", field.redemptionFees), suiClaimablePerDsui: decodeFromJSONField("u128", field.suiClaimablePerDsui), curEpoch: decodeFromJSONField("u64", field.curEpoch) }) }

    static fromJSON(json: Record<string, any>): UserUnstakedInstantly {
        if (json.$typeName !== UserUnstakedInstantly.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): UserUnstakedInstantly {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isUserUnstakedInstantly(data.bcs.type)) { throw new Error(`object at is not a UserUnstakedInstantly object`); }

            return UserUnstakedInstantly.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return UserUnstakedInstantly.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<UserUnstakedInstantly> {
...
export class ValidatorListUpdated implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: ValidatorListUpdatedFields,) {
        this.$fullTypeName = composeSuiType(ValidatorListUpdated.$typeName, ...typeArgs) as `${typeof PKG_V1}::dsui_vault::ValidatorListUpdated`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("ValidatorListUpdated", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): ValidatorListUpdated {
    ...
    static fromJSON(json: Record<string, any>): ValidatorListUpdated {
        if (json.$typeName !== ValidatorListUpdated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): ValidatorListUpdated {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isValidatorListUpdated(data.bcs.type)) { throw new Error(`object at is not a ValidatorListUpdated object`); }

            return ValidatorListUpdated.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ValidatorListUpdated.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<ValidatorListUpdated> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ValidatorListUpdated object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isValidatorListUpdated(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ValidatorListUpdated object`); }
...
export interface ValidatorPoolFields { stakingPoolId: ToField<ID>; validatorAddress: ToField<"address">; activeStake: ToField<Option<FungibleStakedSui>>; inactiveStake: ToField<Option<StakedSui>>; exchangeRate: ToField<PoolTokenExchangeRate>; totalSuiAmount: ToField<"u64">; extraFields: ToField<Bag> }

export type ValidatorPoolReified = Reified<ValidatorPool, ValidatorPoolFields>;

export class ValidatorPool implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: ValidatorPoolFields,) {
        this.$fullTypeName = composeSuiType(ValidatorPool.$typeName, ...typeArgs) as `${typeof PKG_V1}::dsui_vault::ValidatorPool`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("ValidatorPool", {
    ...
    static fromSuiObjectData(data: SuiObjectData): ValidatorPool {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isValidatorPool(data.bcs.type)) { throw new Error(`object at is not a ValidatorPool object`); }

            return ValidatorPool.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ValidatorPool.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<ValidatorPool> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ValidatorPool object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isValidatorPool(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ValidatorPool object`); }
...
export interface ValidatorPoolDestroyedFields { validatorAddress: ToField<"address"> }

export type ValidatorPoolDestroyedReified = Reified<ValidatorPoolDestroyed, ValidatorPoolDestroyedFields>;

export class ValidatorPoolDestroyed implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: ValidatorPoolDestroyedFields,) {
        this.$fullTypeName = composeSuiType(ValidatorPoolDestroyed.$typeName, ...typeArgs) as `${typeof PKG_V1}::dsui_vault::ValidatorPoolDestroyed`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("ValidatorPoolDestroyed", {

            validator_address: bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val), })

        })
    };

    static fromFields(fields: Record<string, any>): ValidatorPoolDestroyed { return ValidatorPoolDestroyed.reified().new({ validatorAddress: decodeFromFields("address", fields.validator_address) }) }

    static fromFieldsWithTypes(item: FieldsWithTypes): ValidatorPoolDestroyed {
        if (!isValidatorPoolDestroyed(item.type)) {
            throw new Error("not a ValidatorPoolDestroyed type");

        }

        return ValidatorPoolDestroyed.reified().new({ validatorAddress: decodeFromFieldsWithTypes("address", item.fields.validator_address) })
    }
    ...
    static fromJSONField(field: any): ValidatorPoolDestroyed { return ValidatorPoolDestroyed.reified().new({ validatorAddress: decodeFromJSONField("address", field.validatorAddress) }) }

    static fromJSON(json: Record<string, any>): ValidatorPoolDestroyed {
        if (json.$typeName !== ValidatorPoolDestroyed.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): ValidatorPoolDestroyed {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isValidatorPoolDestroyed(data.bcs.type)) { throw new Error(`object at is not a ValidatorPoolDestroyed object`); }

            return ValidatorPoolDestroyed.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ValidatorPoolDestroyed.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<ValidatorPoolDestroyed> {

...
const PKG_V1 = dragonfood.PKG_V1
...
export class AddHiveAndEnergyForNextCycle implements StructClass {
    ...
    private constructor(typeArgs: [], fields: AddHiveAndEnergyForNextCycleFields,) {
        this.$fullTypeName = composeSuiType(AddHiveAndEnergyForNextCycle.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::AddHiveAndEnergyForNextCycle`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("AddHiveAndEnergyForNextCycle", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): AddHiveAndEnergyForNextCycle {
    ...
    static fromJSON(json: Record<string, any>): AddHiveAndEnergyForNextCycle {
        if (json.$typeName !== AddHiveAndEnergyForNextCycle.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): AddHiveAndEnergyForNextCycle {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isAddHiveAndEnergyForNextCycle(data.bcs.type)) { throw new Error(`object at is not a AddHiveAndEnergyForNextCycle object`); }

            return AddHiveAndEnergyForNextCycle.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return AddHiveAndEnergyForNextCycle.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export class AddedToDragonDen implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: AddedToDragonDenFields,) {
        this.$fullTypeName = composeSuiType(AddedToDragonDen.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::AddedToDragonDen`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("AddedToDragonDen", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): AddedToDragonDen {
    ...
    static fromJSON(json: Record<string, any>): AddedToDragonDen {
        if (json.$typeName !== AddedToDragonDen.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): AddedToDragonDen {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isAddedToDragonDen(data.bcs.type)) { throw new Error(`object at is not a AddedToDragonDen object`); }

            return AddedToDragonDen.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return AddedToDragonDen.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<AddedToDragonDen> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching AddedToDragonDen object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isAddedToDragonDen(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a AddedToDragonDen object`); }
...
export class BribeAddedForEmissions implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BribeAddedForEmissionsFields,) {
        this.$fullTypeName = composeSuiType(BribeAddedForEmissions.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::BribeAddedForEmissions`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BribeAddedForEmissions", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BribeAddedForEmissions {
    ...
    static fromJSON(json: Record<string, any>): BribeAddedForEmissions {
        if (json.$typeName !== BribeAddedForEmissions.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BribeAddedForEmissions {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBribeAddedForEmissions(data.bcs.type)) { throw new Error(`object at is not a BribeAddedForEmissions object`); }

            return BribeAddedForEmissions.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BribeAddedForEmissions.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BribeAddedForEmissions> {
...
export class BribeClaimedByTrainerThreePool implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BribeClaimedByTrainerThreePoolFields,) {
        this.$fullTypeName = composeSuiType(BribeClaimedByTrainerThreePool.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::BribeClaimedByTrainerThreePool`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BribeClaimedByTrainerThreePool", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BribeClaimedByTrainerThreePool {
    ...
    static fromJSON(json: Record<string, any>): BribeClaimedByTrainerThreePool {
        if (json.$typeName !== BribeClaimedByTrainerThreePool.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BribeClaimedByTrainerThreePool {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBribeClaimedByTrainerThreePool(data.bcs.type)) { throw new Error(`object at is not a BribeClaimedByTrainerThreePool object`); }

            return BribeClaimedByTrainerThreePool.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BribeClaimedByTrainerThreePool.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BribeClaimedByTrainerThreePool> {
...
export class BribeClaimedByTrainerTwoPool implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BribeClaimedByTrainerTwoPoolFields,) {
        this.$fullTypeName = composeSuiType(BribeClaimedByTrainerTwoPool.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::BribeClaimedByTrainerTwoPool`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BribeClaimedByTrainerTwoPool", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BribeClaimedByTrainerTwoPool {
    ...
    static fromJSON(json: Record<string, any>): BribeClaimedByTrainerTwoPool {
        if (json.$typeName !== BribeClaimedByTrainerTwoPool.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BribeClaimedByTrainerTwoPool {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBribeClaimedByTrainerTwoPool(data.bcs.type)) { throw new Error(`object at is not a BribeClaimedByTrainerTwoPool object`); }

            return BribeClaimedByTrainerTwoPool.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BribeClaimedByTrainerTwoPool.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BribeClaimedByTrainerTwoPool> {
...
export class BribeMarkedAsToken implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BribeMarkedAsTokenFields,) {
        this.$fullTypeName = composeSuiType(BribeMarkedAsToken.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::BribeMarkedAsToken`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BribeMarkedAsToken", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BribeMarkedAsToken {
    ...
    static fromJSON(json: Record<string, any>): BribeMarkedAsToken {
        if (json.$typeName !== BribeMarkedAsToken.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BribeMarkedAsToken {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBribeMarkedAsToken(data.bcs.type)) { throw new Error(`object at is not a BribeMarkedAsToken object`); }

            return BribeMarkedAsToken.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BribeMarkedAsToken.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BribeMarkedAsToken> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BribeMarkedAsToken object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBribeMarkedAsToken(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BribeMarkedAsToken object`); }
...
export class Bribes implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BribesFields,) {
        this.$fullTypeName = composeSuiType(Bribes.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::Bribes`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): Bribes {
    ...
    static fromJSON(json: Record<string, any>): Bribes {
        if (json.$typeName !== Bribes.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): Bribes {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBribes(data.bcs.type)) { throw new Error(`object at is not a Bribes object`); }

            return Bribes.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return Bribes.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<Bribes> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching Bribes object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBribes(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a Bribes object`); }
...
export class DragonBeeWithdrawalRequested implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: DragonBeeWithdrawalRequestedFields,) {
        this.$fullTypeName = composeSuiType(DragonBeeWithdrawalRequested.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::DragonBeeWithdrawalRequested`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("DragonBeeWithdrawalRequested", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): DragonBeeWithdrawalRequested {
    ...
    static fromJSON(json: Record<string, any>): DragonBeeWithdrawalRequested {
        if (json.$typeName !== DragonBeeWithdrawalRequested.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): DragonBeeWithdrawalRequested {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isDragonBeeWithdrawalRequested(data.bcs.type)) { throw new Error(`object at is not a DragonBeeWithdrawalRequested object`); }

            return DragonBeeWithdrawalRequested.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return DragonBeeWithdrawalRequested.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export class DragonDen<H extends PhantomTypeArgument> implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<H>], fields: DragonDenFields<H>,) {
        this.$fullTypeName = composeSuiType(DragonDen.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::DragonDen<${PhantomToTypeStr<H>}>`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes<H extends PhantomReified<PhantomTypeArgument>>(typeArg: H, item: FieldsWithTypes): DragonDen<ToPhantomTypeArgument<H>> {
    ...
    static fromJSON<H extends PhantomReified<PhantomTypeArgument>>(typeArg: H, json: Record<string, any>): DragonDen<ToPhantomTypeArgument<H>> {
        if (json.$typeName !== DragonDen.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch(composeSuiType(DragonDen.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg],)
    ...
    static fromSuiObjectData<H extends PhantomReified<PhantomTypeArgument>>(typeArg: H, data: SuiObjectData): DragonDen<ToPhantomTypeArgument<H>> {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isDragonDen(data.bcs.type)) { throw new Error(`object at is not a DragonDen object`); }

            const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 1) { throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`); }; const gotTypeArg = compressSuiType(gotTypeArgs[0]); const expectedTypeArg = compressSuiType(extractType(typeArg)); if (gotTypeArg !== compressSuiType(extractType(typeArg))) { throw new Error(`type argument mismatch: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); };

            return DragonDen.fromBcs(typeArg, fromB64(data.bcs.bcsBytes));
        } if (data.content) { return DragonDen.fromSuiParsedData(typeArg, data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch<H extends PhantomReified<PhantomTypeArgument>>(client: SuiClient, typeArg: H, id: string): Promise<DragonDen<ToPhantomTypeArgument<H>>> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching DragonDen object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isDragonDen(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a DragonDen object`); }
...
export class DragonFood implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: DragonFoodFields,) {
        this.$fullTypeName = composeSuiType(DragonFood.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::DragonFood`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): DragonFood {
    ...
    static fromJSON(json: Record<string, any>): DragonFood {
        if (json.$typeName !== DragonFood.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): DragonFood {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isDragonFood(data.bcs.type)) { throw new Error(`object at is not a DragonFood object`); }

            return DragonFood.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return DragonFood.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<DragonFood> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching DragonFood object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isDragonFood(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a DragonFood object`); }
...
export class DragonFoodCycleUpdated implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: DragonFoodCycleUpdatedFields,) {
        this.$fullTypeName = composeSuiType(DragonFoodCycleUpdated.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::DragonFoodCycleUpdated`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("DragonFoodCycleUpdated", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): DragonFoodCycleUpdated {
    ...
    static fromJSON(json: Record<string, any>): DragonFoodCycleUpdated {
        if (json.$typeName !== DragonFoodCycleUpdated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): DragonFoodCycleUpdated {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isDragonFoodCycleUpdated(data.bcs.type)) { throw new Error(`object at is not a DragonFoodCycleUpdated object`); }

            return DragonFoodCycleUpdated.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return DragonFoodCycleUpdated.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<DragonFoodCycleUpdated> {
...
export class DragonFoodVotingConfigUpdated implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: DragonFoodVotingConfigUpdatedFields,) {
        this.$fullTypeName = composeSuiType(DragonFoodVotingConfigUpdated.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::DragonFoodVotingConfigUpdated`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("DragonFoodVotingConfigUpdated", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): DragonFoodVotingConfigUpdated {
    ...
    static fromJSON(json: Record<string, any>): DragonFoodVotingConfigUpdated {
        if (json.$typeName !== DragonFoodVotingConfigUpdated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): DragonFoodVotingConfigUpdated {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isDragonFoodVotingConfigUpdated(data.bcs.type)) { throw new Error(`object at is not a DragonFoodVotingConfigUpdated object`); }

            return DragonFoodVotingConfigUpdated.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return DragonFoodVotingConfigUpdated.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<DragonFoodVotingConfigUpdated> {
...
export class EmissionSchedule implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: EmissionScheduleFields,) {
        this.$fullTypeName = composeSuiType(EmissionSchedule.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::EmissionSchedule`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("EmissionSchedule", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): EmissionSchedule {
    ...
    static fromJSON(json: Record<string, any>): EmissionSchedule {
        if (json.$typeName !== EmissionSchedule.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): EmissionSchedule {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isEmissionSchedule(data.bcs.type)) { throw new Error(`object at is not a EmissionSchedule object`); }

            return EmissionSchedule.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return EmissionSchedule.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<EmissionSchedule> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching EmissionSchedule object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isEmissionSchedule(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a EmissionSchedule object`); }
...
export class EmissionsRcvdByPoolHive implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: EmissionsRcvdByPoolHiveFields,) {
        this.$fullTypeName = composeSuiType(EmissionsRcvdByPoolHive.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::EmissionsRcvdByPoolHive`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("EmissionsRcvdByPoolHive", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): EmissionsRcvdByPoolHive {
    ...
    static fromJSON(json: Record<string, any>): EmissionsRcvdByPoolHive {
        if (json.$typeName !== EmissionsRcvdByPoolHive.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): EmissionsRcvdByPoolHive {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isEmissionsRcvdByPoolHive(data.bcs.type)) { throw new Error(`object at is not a EmissionsRcvdByPoolHive object`); }

            return EmissionsRcvdByPoolHive.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return EmissionsRcvdByPoolHive.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<EmissionsRcvdByPoolHive> {
...
export class FeedingFoodToBee implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: FeedingFoodToBeeFields,) {
        this.$fullTypeName = composeSuiType(FeedingFoodToBee.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::FeedingFoodToBee`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("FeedingFoodToBee", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): FeedingFoodToBee {
    ...
    static fromJSON(json: Record<string, any>): FeedingFoodToBee {
        if (json.$typeName !== FeedingFoodToBee.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): FeedingFoodToBee {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isFeedingFoodToBee(data.bcs.type)) { throw new Error(`object at is not a FeedingFoodToBee object`); }

            return FeedingFoodToBee.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return FeedingFoodToBee.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<FeedingFoodToBee> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching FeedingFoodToBee object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isFeedingFoodToBee(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a FeedingFoodToBee object`); }
...
export class FeesClaimedForEmissions implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: FeesClaimedForEmissionsFields,) {
        this.$fullTypeName = composeSuiType(FeesClaimedForEmissions.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::FeesClaimedForEmissions`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("FeesClaimedForEmissions", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): FeesClaimedForEmissions {
    ...
    static fromJSON(json: Record<string, any>): FeesClaimedForEmissions {
        if (json.$typeName !== FeesClaimedForEmissions.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): FeesClaimedForEmissions {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isFeesClaimedForEmissions(data.bcs.type)) { throw new Error(`object at is not a FeesClaimedForEmissions object`); }

            return FeesClaimedForEmissions.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return FeesClaimedForEmissions.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<FeesClaimedForEmissions> {
...
export class FoodCycleUpdatedForPoolHive implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: FoodCycleUpdatedForPoolHiveFields,) {
        this.$fullTypeName = composeSuiType(FoodCycleUpdatedForPoolHive.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::FoodCycleUpdatedForPoolHive`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("FoodCycleUpdatedForPoolHive", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): FoodCycleUpdatedForPoolHive {
    ...
    static fromJSON(json: Record<string, any>): FoodCycleUpdatedForPoolHive {
        if (json.$typeName !== FoodCycleUpdatedForPoolHive.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): FoodCycleUpdatedForPoolHive {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isFoodCycleUpdatedForPoolHive(data.bcs.type)) { throw new Error(`object at is not a FoodCycleUpdatedForPoolHive object`); }

            return FoodCycleUpdatedForPoolHive.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return FoodCycleUpdatedForPoolHive.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export class FruitLife implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: FruitLifeFields,) {
        this.$fullTypeName = composeSuiType(FruitLife.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::FruitLife`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): FruitLife {
    ...
    static fromJSON(json: Record<string, any>): FruitLife {
        if (json.$typeName !== FruitLife.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): FruitLife {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isFruitLife(data.bcs.type)) { throw new Error(`object at is not a FruitLife object`); }

            return FruitLife.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return FruitLife.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<FruitLife> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching FruitLife object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isFruitLife(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a FruitLife object`); }
...
export class HivePerEpochUpdated implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HivePerEpochUpdatedFields,) {
        this.$fullTypeName = composeSuiType(HivePerEpochUpdated.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::HivePerEpochUpdated`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HivePerEpochUpdated", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HivePerEpochUpdated {
    ...
    static fromJSON(json: Record<string, any>): HivePerEpochUpdated {
        if (json.$typeName !== HivePerEpochUpdated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HivePerEpochUpdated {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHivePerEpochUpdated(data.bcs.type)) { throw new Error(`object at is not a HivePerEpochUpdated object`); }

            return HivePerEpochUpdated.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HivePerEpochUpdated.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HivePerEpochUpdated> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HivePerEpochUpdated object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHivePerEpochUpdated(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HivePerEpochUpdated object`); }
...
export class HoneyFruit<X extends PhantomTypeArgument> implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<X>], fields: HoneyFruitFields<X>,) {
        this.$fullTypeName = composeSuiType(HoneyFruit.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::HoneyFruit<${PhantomToTypeStr<X>}>`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes<X extends PhantomReified<PhantomTypeArgument>>(typeArg: X, item: FieldsWithTypes): HoneyFruit<ToPhantomTypeArgument<X>> {
    ...
    static fromJSON<X extends PhantomReified<PhantomTypeArgument>>(typeArg: X, json: Record<string, any>): HoneyFruit<ToPhantomTypeArgument<X>> {
        if (json.$typeName !== HoneyFruit.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch(composeSuiType(HoneyFruit.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg],)
    ...
    static fromSuiObjectData<X extends PhantomReified<PhantomTypeArgument>>(typeArg: X, data: SuiObjectData): HoneyFruit<ToPhantomTypeArgument<X>> {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHoneyFruit(data.bcs.type)) { throw new Error(`object at is not a HoneyFruit object`); }

            const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 1) { throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`); }; const gotTypeArg = compressSuiType(gotTypeArgs[0]); const expectedTypeArg = compressSuiType(extractType(typeArg)); if (gotTypeArg !== compressSuiType(extractType(typeArg))) { throw new Error(`type argument mismatch: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); };

            return HoneyFruit.fromBcs(typeArg, fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HoneyFruit.fromSuiParsedData(typeArg, data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch<X extends PhantomReified<PhantomTypeArgument>>(client: SuiClient, typeArg: X, id: string): Promise<HoneyFruit<ToPhantomTypeArgument<X>>> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HoneyFruit object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHoneyFruit(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HoneyFruit object`); }
...
export class HoneyFruitDestroyed implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HoneyFruitDestroyedFields,) {
        this.$fullTypeName = composeSuiType(HoneyFruitDestroyed.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::HoneyFruitDestroyed`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HoneyFruitDestroyed", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HoneyFruitDestroyed {
    ...
    static fromJSON(json: Record<string, any>): HoneyFruitDestroyed {
        if (json.$typeName !== HoneyFruitDestroyed.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HoneyFruitDestroyed {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHoneyFruitDestroyed(data.bcs.type)) { throw new Error(`object at is not a HoneyFruitDestroyed object`); }

            return HoneyFruitDestroyed.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HoneyFruitDestroyed.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HoneyFruitDestroyed> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HoneyFruitDestroyed object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHoneyFruitDestroyed(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HoneyFruitDestroyed object`); }
...
export class HoneyFruitKraftedForPoolHive implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HoneyFruitKraftedForPoolHiveFields,) {
        this.$fullTypeName = composeSuiType(HoneyFruitKraftedForPoolHive.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::HoneyFruitKraftedForPoolHive`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HoneyFruitKraftedForPoolHive", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HoneyFruitKraftedForPoolHive {
    ...
    static fromJSON(json: Record<string, any>): HoneyFruitKraftedForPoolHive {
        if (json.$typeName !== HoneyFruitKraftedForPoolHive.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HoneyFruitKraftedForPoolHive {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHoneyFruitKraftedForPoolHive(data.bcs.type)) { throw new Error(`object at is not a HoneyFruitKraftedForPoolHive object`); }

            return HoneyFruitKraftedForPoolHive.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HoneyFruitKraftedForPoolHive.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HoneyFruitKraftedForPoolHive> {
...
export class LendingPoolCapability implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: LendingPoolCapabilityFields,) {
        this.$fullTypeName = composeSuiType(LendingPoolCapability.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::LendingPoolCapability`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("LendingPoolCapability", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): LendingPoolCapability {
    ...
    static fromJSON(json: Record<string, any>): LendingPoolCapability {
        if (json.$typeName !== LendingPoolCapability.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): LendingPoolCapability {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isLendingPoolCapability(data.bcs.type)) { throw new Error(`object at is not a LendingPoolCapability object`); }

            return LendingPoolCapability.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return LendingPoolCapability.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<LendingPoolCapability> {
...
export class LiquidatedLP implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: LiquidatedLPFields,) {
        this.$fullTypeName = composeSuiType(LiquidatedLP.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::LiquidatedLP`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("LiquidatedLP", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): LiquidatedLP {
    ...
    static fromJSON(json: Record<string, any>): LiquidatedLP {
        if (json.$typeName !== LiquidatedLP.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): LiquidatedLP {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isLiquidatedLP(data.bcs.type)) { throw new Error(`object at is not a LiquidatedLP object`); }

            return LiquidatedLP.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return LiquidatedLP.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<LiquidatedLP> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching LiquidatedLP object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isLiquidatedLP(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a LiquidatedLP object`); }
...
export class LockedDragonBee implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: LockedDragonBeeFields,) {
        this.$fullTypeName = composeSuiType(LockedDragonBee.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::LockedDragonBee`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("LockedDragonBee", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): LockedDragonBee {
    ...
    static fromJSON(json: Record<string, any>): LockedDragonBee {
        if (json.$typeName !== LockedDragonBee.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): LockedDragonBee {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isLockedDragonBee(data.bcs.type)) { throw new Error(`object at is not a LockedDragonBee object`); }

            return LockedDragonBee.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return LockedDragonBee.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<LockedDragonBee> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching LockedDragonBee object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isLockedDragonBee(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a LockedDragonBee object`); }
...
export class LockedLP implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: LockedLPFields,) {
        this.$fullTypeName = composeSuiType(LockedLP.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::LockedLP`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): LockedLP {
    ...
    static fromJSON(json: Record<string, any>): LockedLP {
        if (json.$typeName !== LockedLP.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): LockedLP {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isLockedLP(data.bcs.type)) { throw new Error(`object at is not a LockedLP object`); }

            return LockedLP.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return LockedLP.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<LockedLP> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching LockedLP object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isLockedLP(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a LockedLP object`); }
...
export class MoreFruitsAdded implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: MoreFruitsAddedFields,) {
        this.$fullTypeName = composeSuiType(MoreFruitsAdded.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::MoreFruitsAdded`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("MoreFruitsAdded", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): MoreFruitsAdded {
    ...
    static fromJSON(json: Record<string, any>): MoreFruitsAdded {
        if (json.$typeName !== MoreFruitsAdded.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): MoreFruitsAdded {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isMoreFruitsAdded(data.bcs.type)) { throw new Error(`object at is not a MoreFruitsAdded object`); }

            return MoreFruitsAdded.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return MoreFruitsAdded.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<MoreFruitsAdded> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching MoreFruitsAdded object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isMoreFruitsAdded(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a MoreFruitsAdded object`); }
...
export class NewProposalKrafted implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: NewProposalKraftedFields,) {
        this.$fullTypeName = composeSuiType(NewProposalKrafted.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::NewProposalKrafted`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("NewProposalKrafted", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): NewProposalKrafted {
    ...
    static fromJSON(json: Record<string, any>): NewProposalKrafted {
        if (json.$typeName !== NewProposalKrafted.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): NewProposalKrafted {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isNewProposalKrafted(data.bcs.type)) { throw new Error(`object at is not a NewProposalKrafted object`); }

            return NewProposalKrafted.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return NewProposalKrafted.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<NewProposalKrafted> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching NewProposalKrafted object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isNewProposalKrafted(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a NewProposalKrafted object`); }
...
export class PoolHive<H extends PhantomTypeArgument> implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<H>], fields: PoolHiveFields<H>,) {
        this.$fullTypeName = composeSuiType(PoolHive.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::PoolHive<${PhantomToTypeStr<H>}>`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes<H extends PhantomReified<PhantomTypeArgument>>(typeArg: H, item: FieldsWithTypes): PoolHive<ToPhantomTypeArgument<H>> {
    ...
    static fromJSON<H extends PhantomReified<PhantomTypeArgument>>(typeArg: H, json: Record<string, any>): PoolHive<ToPhantomTypeArgument<H>> {
        if (json.$typeName !== PoolHive.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch(composeSuiType(PoolHive.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg],)
    ...
    static fromSuiObjectData<H extends PhantomReified<PhantomTypeArgument>>(typeArg: H, data: SuiObjectData): PoolHive<ToPhantomTypeArgument<H>> {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isPoolHive(data.bcs.type)) { throw new Error(`object at is not a PoolHive object`); }

            const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 1) { throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`); }; const gotTypeArg = compressSuiType(gotTypeArgs[0]); const expectedTypeArg = compressSuiType(extractType(typeArg)); if (gotTypeArg !== compressSuiType(extractType(typeArg))) { throw new Error(`type argument mismatch: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); };

            return PoolHive.fromBcs(typeArg, fromB64(data.bcs.bcsBytes));
        } if (data.content) { return PoolHive.fromSuiParsedData(typeArg, data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch<H extends PhantomReified<PhantomTypeArgument>>(client: SuiClient, typeArg: H, id: string): Promise<PoolHive<ToPhantomTypeArgument<H>>> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching PoolHive object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isPoolHive(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a PoolHive object`); }
...
export class PoolHiveKrafted implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: PoolHiveKraftedFields,) {
        this.$fullTypeName = composeSuiType(PoolHiveKrafted.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::PoolHiveKrafted`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("PoolHiveKrafted", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): PoolHiveKrafted {
    ...
    static fromJSON(json: Record<string, any>): PoolHiveKrafted {
        if (json.$typeName !== PoolHiveKrafted.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): PoolHiveKrafted {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isPoolHiveKrafted(data.bcs.type)) { throw new Error(`object at is not a PoolHiveKrafted object`); }

            return PoolHiveKrafted.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return PoolHiveKrafted.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<PoolHiveKrafted> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching PoolHiveKrafted object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isPoolHiveKrafted(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a PoolHiveKrafted object`); }
...
export class Proposal implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: ProposalFields,) {
        this.$fullTypeName = composeSuiType(Proposal.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::Proposal`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): Proposal {
    ...
    static fromJSON(json: Record<string, any>): Proposal {
        if (json.$typeName !== Proposal.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): Proposal {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isProposal(data.bcs.type)) { throw new Error(`object at is not a Proposal object`); }

            return Proposal.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return Proposal.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<Proposal> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching Proposal object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isProposal(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a Proposal object`); }
...
export class ProposalDeleted implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: ProposalDeletedFields,) {
        this.$fullTypeName = composeSuiType(ProposalDeleted.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::ProposalDeleted`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("ProposalDeleted", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): ProposalDeleted {
    ...
    static fromJSON(json: Record<string, any>): ProposalDeleted {
        if (json.$typeName !== ProposalDeleted.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): ProposalDeleted {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isProposalDeleted(data.bcs.type)) { throw new Error(`object at is not a ProposalDeleted object`); }

            return ProposalDeleted.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ProposalDeleted.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<ProposalDeleted> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ProposalDeleted object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isProposalDeleted(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ProposalDeleted object`); }
...
export class ProposalEvaluated implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: ProposalEvaluatedFields,) {
        this.$fullTypeName = composeSuiType(ProposalEvaluated.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::ProposalEvaluated`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("ProposalEvaluated", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): ProposalEvaluated {
    ...
    static fromJSON(json: Record<string, any>): ProposalEvaluated {
        if (json.$typeName !== ProposalEvaluated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): ProposalEvaluated {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isProposalEvaluated(data.bcs.type)) { throw new Error(`object at is not a ProposalEvaluated object`); }

            return ProposalEvaluated.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ProposalEvaluated.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<ProposalEvaluated> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ProposalEvaluated object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isProposalEvaluated(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ProposalEvaluated object`); }
...
export class ProposalExecuted implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: ProposalExecutedFields,) {
        this.$fullTypeName = composeSuiType(ProposalExecuted.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::ProposalExecuted`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("ProposalExecuted", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): ProposalExecuted {
    ...
    static fromJSON(json: Record<string, any>): ProposalExecuted {
        if (json.$typeName !== ProposalExecuted.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): ProposalExecuted {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isProposalExecuted(data.bcs.type)) { throw new Error(`object at is not a ProposalExecuted object`); }

            return ProposalExecuted.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ProposalExecuted.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<ProposalExecuted> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ProposalExecuted object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isProposalExecuted(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ProposalExecuted object`); }
...
export class RestedLockedDragonBeeReturnedInWild implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: RestedLockedDragonBeeReturnedInWildFields,) {
        this.$fullTypeName = composeSuiType(RestedLockedDragonBeeReturnedInWild.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::RestedLockedDragonBeeReturnedInWild`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("RestedLockedDragonBeeReturnedInWild", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): RestedLockedDragonBeeReturnedInWild {
    ...
    static fromJSON(json: Record<string, any>): RestedLockedDragonBeeReturnedInWild {
        if (json.$typeName !== RestedLockedDragonBeeReturnedInWild.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): RestedLockedDragonBeeReturnedInWild {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isRestedLockedDragonBeeReturnedInWild(data.bcs.type)) { throw new Error(`object at is not a RestedLockedDragonBeeReturnedInWild object`); }

            return RestedLockedDragonBeeReturnedInWild.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return RestedLockedDragonBeeReturnedInWild.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<RestedLockedDragonBeeReturnedInWild> {
...
export class RipeFruitsClaimed<A extends PhantomTypeArgument> implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<A>], fields: RipeFruitsClaimedFields<A>,) {
        this.$fullTypeName = composeSuiType(RipeFruitsClaimed.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::RipeFruitsClaimed<${PhantomToTypeStr<A>}>`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("RipeFruitsClaimed", {
    ...
    static fromFieldsWithTypes<A extends PhantomReified<PhantomTypeArgument>>(typeArg: A, item: FieldsWithTypes): RipeFruitsClaimed<ToPhantomTypeArgument<A>> {
    ...
    static fromJSON<A extends PhantomReified<PhantomTypeArgument>>(typeArg: A, json: Record<string, any>): RipeFruitsClaimed<ToPhantomTypeArgument<A>> {
        if (json.$typeName !== RipeFruitsClaimed.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch(composeSuiType(RipeFruitsClaimed.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg],)
    ...
    static fromSuiObjectData<A extends PhantomReified<PhantomTypeArgument>>(typeArg: A, data: SuiObjectData): RipeFruitsClaimed<ToPhantomTypeArgument<A>> {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isRipeFruitsClaimed(data.bcs.type)) { throw new Error(`object at is not a RipeFruitsClaimed object`); }

            const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 1) { throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`); }; const gotTypeArg = compressSuiType(gotTypeArgs[0]); const expectedTypeArg = compressSuiType(extractType(typeArg)); if (gotTypeArg !== compressSuiType(extractType(typeArg))) { throw new Error(`type argument mismatch: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); };

            return RipeFruitsClaimed.fromBcs(typeArg, fromB64(data.bcs.bcsBytes));
        } if (data.content) { return RipeFruitsClaimed.fromSuiParsedData(typeArg, data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch<A extends PhantomReified<PhantomTypeArgument>>(client: SuiClient, typeArg: A, id: string): Promise<RipeFruitsClaimed<ToPhantomTypeArgument<A>>> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching RipeFruitsClaimed object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isRipeFruitsClaimed(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a RipeFruitsClaimed object`); }
...
export class TradingFeeClaimedByTrainer implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: TradingFeeClaimedByTrainerFields,) {
        this.$fullTypeName = composeSuiType(TradingFeeClaimedByTrainer.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::TradingFeeClaimedByTrainer`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("TradingFeeClaimedByTrainer", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): TradingFeeClaimedByTrainer {
    ...
    static fromJSON(json: Record<string, any>): TradingFeeClaimedByTrainer {
        if (json.$typeName !== TradingFeeClaimedByTrainer.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): TradingFeeClaimedByTrainer {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isTradingFeeClaimedByTrainer(data.bcs.type)) { throw new Error(`object at is not a TradingFeeClaimedByTrainer object`); }

            return TradingFeeClaimedByTrainer.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return TradingFeeClaimedByTrainer.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<TradingFeeClaimedByTrainer> {
...
export class TrainerVotedForEmissions implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: TrainerVotedForEmissionsFields,) {
        this.$fullTypeName = composeSuiType(TrainerVotedForEmissions.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::TrainerVotedForEmissions`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("TrainerVotedForEmissions", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): TrainerVotedForEmissions {
    ...
    static fromJSON(json: Record<string, any>): TrainerVotedForEmissions {
        if (json.$typeName !== TrainerVotedForEmissions.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): TrainerVotedForEmissions {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isTrainerVotedForEmissions(data.bcs.type)) { throw new Error(`object at is not a TrainerVotedForEmissions object`); }

            return TrainerVotedForEmissions.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return TrainerVotedForEmissions.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<TrainerVotedForEmissions> {
...
export class UnbondingFromDragonDen implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: UnbondingFromDragonDenFields,) {
        this.$fullTypeName = composeSuiType(UnbondingFromDragonDen.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::UnbondingFromDragonDen`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("UnbondingFromDragonDen", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): UnbondingFromDragonDen {
    ...
    static fromJSON(json: Record<string, any>): UnbondingFromDragonDen {
        if (json.$typeName !== UnbondingFromDragonDen.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): UnbondingFromDragonDen {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isUnbondingFromDragonDen(data.bcs.type)) { throw new Error(`object at is not a UnbondingFromDragonDen object`); }

            return UnbondingFromDragonDen.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return UnbondingFromDragonDen.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<UnbondingFromDragonDen> {
...
export class UnlockedLP implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: UnlockedLPFields,) {
        this.$fullTypeName = composeSuiType(UnlockedLP.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::UnlockedLP`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): UnlockedLP {
    ...
    static fromJSON(json: Record<string, any>): UnlockedLP {
        if (json.$typeName !== UnlockedLP.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): UnlockedLP {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isUnlockedLP(data.bcs.type)) { throw new Error(`object at is not a UnlockedLP object`); }

            return UnlockedLP.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return UnlockedLP.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<UnlockedLP> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching UnlockedLP object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isUnlockedLP(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a UnlockedLP object`); }
...
export class Vote implements StructClass {
    ...
    private constructor(typeArgs: [], fields: VoteFields,) {
        this.$fullTypeName = composeSuiType(Vote.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::Vote`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): Vote {
        if (!isVote(item.type)) {
    ...
    static fromJSON(json: Record<string, any>): Vote {
        if (json.$typeName !== Vote.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): Vote {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isVote(data.bcs.type)) { throw new Error(`object at is not a Vote object`); }

            return Vote.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return Vote.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<Vote> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching Vote object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isVote(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a Vote object`); }
...
export class VoteCasted implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: VoteCastedFields,) {
        this.$fullTypeName = composeSuiType(VoteCasted.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::VoteCasted`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): VoteCasted {
    ...
    static fromJSON(json: Record<string, any>): VoteCasted {
        if (json.$typeName !== VoteCasted.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): VoteCasted {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isVoteCasted(data.bcs.type)) { throw new Error(`object at is not a VoteCasted object`); }

            return VoteCasted.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return VoteCasted.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<VoteCasted> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching VoteCasted object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isVoteCasted(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a VoteCasted object`); }
...
export class VoteConfig implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: VoteConfigFields,) {
        this.$fullTypeName = composeSuiType(VoteConfig.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::VoteConfig`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): VoteConfig {
    ...
    static fromJSON(json: Record<string, any>): VoteConfig {
        if (json.$typeName !== VoteConfig.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): VoteConfig {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isVoteConfig(data.bcs.type)) { throw new Error(`object at is not a VoteConfig object`); }

            return VoteConfig.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return VoteConfig.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<VoteConfig> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching VoteConfig object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isVoteConfig(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a VoteConfig object`); }
...
export class VotingBribes<X extends PhantomTypeArgument> implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<X>], fields: VotingBribesFields<X>,) {
        this.$fullTypeName = composeSuiType(VotingBribes.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::VotingBribes<${PhantomToTypeStr<X>}>`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("VotingBribes", {
    ...
    static fromFieldsWithTypes<X extends PhantomReified<PhantomTypeArgument>>(typeArg: X, item: FieldsWithTypes): VotingBribes<ToPhantomTypeArgument<X>> {
    ...
    static fromJSON<X extends PhantomReified<PhantomTypeArgument>>(typeArg: X, json: Record<string, any>): VotingBribes<ToPhantomTypeArgument<X>> {
        if (json.$typeName !== VotingBribes.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch(composeSuiType(VotingBribes.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg],)
    ...
    static fromSuiObjectData<X extends PhantomReified<PhantomTypeArgument>>(typeArg: X, data: SuiObjectData): VotingBribes<ToPhantomTypeArgument<X>> {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isVotingBribes(data.bcs.type)) { throw new Error(`object at is not a VotingBribes object`); }

            const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 1) { throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`); }; const gotTypeArg = compressSuiType(gotTypeArgs[0]); const expectedTypeArg = compressSuiType(extractType(typeArg)); if (gotTypeArg !== compressSuiType(extractType(typeArg))) { throw new Error(`type argument mismatch: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); };

            return VotingBribes.fromBcs(typeArg, fromB64(data.bcs.bcsBytes));
        } if (data.content) { return VotingBribes.fromSuiParsedData(typeArg, data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch<X extends PhantomReified<PhantomTypeArgument>>(client: SuiClient, typeArg: X, id: string): Promise<VotingBribes<ToPhantomTypeArgument<X>>> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching VotingBribes object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isVotingBribes(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a VotingBribes object`); }
...
export class VotingPowerIncreasedForLockedBee implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: VotingPowerIncreasedForLockedBeeFields,) {
        this.$fullTypeName = composeSuiType(VotingPowerIncreasedForLockedBee.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_food::VotingPowerIncreasedForLockedBee`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("VotingPowerIncreasedForLockedBee", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): VotingPowerIncreasedForLockedBee {
    ...
    static fromJSON(json: Record<string, any>): VotingPowerIncreasedForLockedBee {
        if (json.$typeName !== VotingPowerIncreasedForLockedBee.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): VotingPowerIncreasedForLockedBee {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isVotingPowerIncreasedForLockedBee(data.bcs.type)) { throw new Error(`object at is not a VotingPowerIncreasedForLockedBee object`); }

            return VotingPowerIncreasedForLockedBee.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return VotingPowerIncreasedForLockedBee.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<VotingPowerIncreasedForLockedBee> {

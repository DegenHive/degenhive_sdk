...
import { String } from "../../source/0x1/ascii/structs";
import { Option } from "../../source/0x1/option/structs";
import { String as String1 } from "../../source/0x1/string/structs";
import { Balance } from "../../source/0x2/balance/structs";
import { LinkedTable } from "../../source/0x2/linked-table/structs";
import { UID } from "../../source/0x2/object/structs";
import { SUI } from "../../source/0x2/sui/structs";
import { Table } from "../../source/0x2/table/structs";
...
const PKG_V1 = dragontrainer.PKG_V1
/* ============================== Listing =============================== */
...
export class Listing implements StructClass {
    ...
    private constructor(typeArgs: [], fields: ListingFields,) {
        this.$fullTypeName = composeSuiType(Listing.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::Listing`; this.$typeArgs = typeArgs;
    ...
    static fromJSON(json: Record<string, any>): Listing {
        if (json.$typeName !== Listing.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): Listing {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isListing(data.bcs.type)) { throw new Error(`object at is not a Listing object`); }

            return Listing.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return Listing.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<Listing> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching Listing object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isListing(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a Listing object`); }
...
export class AppAddedToHiveStore implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: AppAddedToHiveStoreFields,) {
        this.$fullTypeName = composeSuiType(AppAddedToHiveStore.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::AppAddedToHiveStore`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("AppAddedToHiveStore", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): AppAddedToHiveStore {
    ...
    static fromJSON(json: Record<string, any>): AppAddedToHiveStore {
        if (json.$typeName !== AppAddedToHiveStore.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): AppAddedToHiveStore {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isAppAddedToHiveStore(data.bcs.type)) { throw new Error(`object at is not a AppAddedToHiveStore object`); }

            return AppAddedToHiveStore.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return AppAddedToHiveStore.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<AppAddedToHiveStore> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching AppAddedToHiveStore object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isAppAddedToHiveStore(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a AppAddedToHiveStore object`); }
...
export class AppInstalledByProfile implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: AppInstalledByProfileFields,) {
        this.$fullTypeName = composeSuiType(AppInstalledByProfile.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::AppInstalledByProfile`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("AppInstalledByProfile", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): AppInstalledByProfile {
    ...
    static fromJSON(json: Record<string, any>): AppInstalledByProfile {
        if (json.$typeName !== AppInstalledByProfile.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): AppInstalledByProfile {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isAppInstalledByProfile(data.bcs.type)) { throw new Error(`object at is not a AppInstalledByProfile object`); }

            return AppInstalledByProfile.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return AppInstalledByProfile.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<AppInstalledByProfile> {
...
export class AppRemovedByProfile implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: AppRemovedByProfileFields,) {
        this.$fullTypeName = composeSuiType(AppRemovedByProfile.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::AppRemovedByProfile`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("AppRemovedByProfile", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): AppRemovedByProfile {
    ...
    static fromJSON(json: Record<string, any>): AppRemovedByProfile {
        if (json.$typeName !== AppRemovedByProfile.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): AppRemovedByProfile {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isAppRemovedByProfile(data.bcs.type)) { throw new Error(`object at is not a AppRemovedByProfile object`); }

            return AppRemovedByProfile.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return AppRemovedByProfile.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<AppRemovedByProfile> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching AppRemovedByProfile object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isAppRemovedByProfile(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a AppRemovedByProfile object`); }
...
export class BeeAddedToFriendsList implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeeAddedToFriendsListFields,) {
        this.$fullTypeName = composeSuiType(BeeAddedToFriendsList.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeeAddedToFriendsList`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BeeAddedToFriendsList", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeeAddedToFriendsList {
    ...
    static fromJSON(json: Record<string, any>): BeeAddedToFriendsList {
        if (json.$typeName !== BeeAddedToFriendsList.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeeAddedToFriendsList {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeeAddedToFriendsList(data.bcs.type)) { throw new Error(`object at is not a BeeAddedToFriendsList object`); }

            return BeeAddedToFriendsList.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeeAddedToFriendsList.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BeeAddedToFriendsList> {
...
export class BeeAttack implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeeAttackFields,) {
        this.$fullTypeName = composeSuiType(BeeAttack.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeeAttack`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeeAttack {
    ...
    static fromJSON(json: Record<string, any>): BeeAttack {
        if (json.$typeName !== BeeAttack.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeeAttack {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeeAttack(data.bcs.type)) { throw new Error(`object at is not a BeeAttack object`); }

            return BeeAttack.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeeAttack.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BeeAttack> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BeeAttack object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBeeAttack(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BeeAttack object`); }
...
export class BeeCapabilityUpdated implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeeCapabilityUpdatedFields,) {
        this.$fullTypeName = composeSuiType(BeeCapabilityUpdated.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeeCapabilityUpdated`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BeeCapabilityUpdated", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeeCapabilityUpdated {
    ...
    static fromJSON(json: Record<string, any>): BeeCapabilityUpdated {
        if (json.$typeName !== BeeCapabilityUpdated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeeCapabilityUpdated {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeeCapabilityUpdated(data.bcs.type)) { throw new Error(`object at is not a BeeCapabilityUpdated object`); }

            return BeeCapabilityUpdated.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeeCapabilityUpdated.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BeeCapabilityUpdated> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BeeCapabilityUpdated object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBeeCapabilityUpdated(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BeeCapabilityUpdated object`); }
...
export class BeeDeletedFromHiddenWorld implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeeDeletedFromHiddenWorldFields,) {
        this.$fullTypeName = composeSuiType(BeeDeletedFromHiddenWorld.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeeDeletedFromHiddenWorld`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BeeDeletedFromHiddenWorld", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeeDeletedFromHiddenWorld {
    ...
    static fromJSON(json: Record<string, any>): BeeDeletedFromHiddenWorld {
        if (json.$typeName !== BeeDeletedFromHiddenWorld.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeeDeletedFromHiddenWorld {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeeDeletedFromHiddenWorld(data.bcs.type)) { throw new Error(`object at is not a BeeDeletedFromHiddenWorld object`); }

            return BeeDeletedFromHiddenWorld.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeeDeletedFromHiddenWorld.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export class BeeEgg implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeeEggFields,) {
        this.$fullTypeName = composeSuiType(BeeEgg.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeeEgg`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeeEgg {
    ...
    static fromJSON(json: Record<string, any>): BeeEgg {
        if (json.$typeName !== BeeEgg.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeeEgg {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeeEgg(data.bcs.type)) { throw new Error(`object at is not a BeeEgg object`); }

            return BeeEgg.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeeEgg.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BeeEgg> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BeeEgg object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBeeEgg(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BeeEgg object`); }
...
export class BeeEggRecord implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeeEggRecordFields,) {
        this.$fullTypeName = composeSuiType(BeeEggRecord.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeeEggRecord`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BeeEggRecord", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeeEggRecord {
    ...
    static fromJSON(json: Record<string, any>): BeeEggRecord {
        if (json.$typeName !== BeeEggRecord.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeeEggRecord {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeeEggRecord(data.bcs.type)) { throw new Error(`object at is not a BeeEggRecord object`); }

            return BeeEggRecord.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeeEggRecord.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BeeEggRecord> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BeeEggRecord object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBeeEggRecord(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BeeEggRecord object`); }
...
export class BeeFarmedYield implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeeFarmedYieldFields,) {
        this.$fullTypeName = composeSuiType(BeeFarmedYield.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeeFarmedYield`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BeeFarmedYield", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeeFarmedYield {
    ...
    static fromJSON(json: Record<string, any>): BeeFarmedYield {
        if (json.$typeName !== BeeFarmedYield.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeeFarmedYield {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeeFarmedYield(data.bcs.type)) { throw new Error(`object at is not a BeeFarmedYield object`); }

            return BeeFarmedYield.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeeFarmedYield.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BeeFarmedYield> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BeeFarmedYield object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBeeFarmedYield(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BeeFarmedYield object`); }
...
export class BeeHive implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeeHiveFields,) {
        this.$fullTypeName = composeSuiType(BeeHive.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeeHive`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeeHive {
    ...
    static fromJSON(json: Record<string, any>): BeeHive {
        if (json.$typeName !== BeeHive.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeeHive {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeeHive(data.bcs.type)) { throw new Error(`object at is not a BeeHive object`); }

            return BeeHive.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeeHive.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BeeHive> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BeeHive object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBeeHive(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BeeHive object`); }
...
export class BeeInFlight implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeeInFlightFields,) {
        this.$fullTypeName = composeSuiType(BeeInFlight.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeeInFlight`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeeInFlight {
    ...
    static fromJSON(json: Record<string, any>): BeeInFlight {
        if (json.$typeName !== BeeInFlight.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeeInFlight {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeeInFlight(data.bcs.type)) { throw new Error(`object at is not a BeeInFlight object`); }

            return BeeInFlight.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeeInFlight.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BeeInFlight> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BeeInFlight object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBeeInFlight(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BeeInFlight object`); }
...
export class BeeIsNowAQueen implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeeIsNowAQueenFields,) {
        this.$fullTypeName = composeSuiType(BeeIsNowAQueen.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeeIsNowAQueen`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BeeIsNowAQueen", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeeIsNowAQueen {
    ...
    static fromJSON(json: Record<string, any>): BeeIsNowAQueen {
        if (json.$typeName !== BeeIsNowAQueen.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeeIsNowAQueen {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeeIsNowAQueen(data.bcs.type)) { throw new Error(`object at is not a BeeIsNowAQueen object`); }

            return BeeIsNowAQueen.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeeIsNowAQueen.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BeeIsNowAQueen> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BeeIsNowAQueen object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBeeIsNowAQueen(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BeeIsNowAQueen object`); }
...
export class BeeOwnershipUpdated implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeeOwnershipUpdatedFields,) {
        this.$fullTypeName = composeSuiType(BeeOwnershipUpdated.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeeOwnershipUpdated`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BeeOwnershipUpdated", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeeOwnershipUpdated {
    ...
    static fromJSON(json: Record<string, any>): BeeOwnershipUpdated {
        if (json.$typeName !== BeeOwnershipUpdated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeeOwnershipUpdated {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeeOwnershipUpdated(data.bcs.type)) { throw new Error(`object at is not a BeeOwnershipUpdated object`); }

            return BeeOwnershipUpdated.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeeOwnershipUpdated.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BeeOwnershipUpdated> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BeeOwnershipUpdated object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBeeOwnershipUpdated(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BeeOwnershipUpdated object`); }
...
export class BeeRemovedFromFriendsList implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeeRemovedFromFriendsListFields,) {
        this.$fullTypeName = composeSuiType(BeeRemovedFromFriendsList.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeeRemovedFromFriendsList`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BeeRemovedFromFriendsList", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeeRemovedFromFriendsList {
    ...
    static fromJSON(json: Record<string, any>): BeeRemovedFromFriendsList {
        if (json.$typeName !== BeeRemovedFromFriendsList.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeeRemovedFromFriendsList {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeeRemovedFromFriendsList(data.bcs.type)) { throw new Error(`object at is not a BeeRemovedFromFriendsList object`); }

            return BeeRemovedFromFriendsList.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeeRemovedFromFriendsList.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BeeRemovedFromFriendsList> {
...
export class BeeSentToHiddenWorld implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeeSentToHiddenWorldFields,) {
        this.$fullTypeName = composeSuiType(BeeSentToHiddenWorld.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeeSentToHiddenWorld`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BeeSentToHiddenWorld", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeeSentToHiddenWorld {
    ...
    static fromJSON(json: Record<string, any>): BeeSentToHiddenWorld {
        if (json.$typeName !== BeeSentToHiddenWorld.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeeSentToHiddenWorld {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeeSentToHiddenWorld(data.bcs.type)) { throw new Error(`object at is not a BeeSentToHiddenWorld object`); }

            return BeeSentToHiddenWorld.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeeSentToHiddenWorld.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BeeSentToHiddenWorld> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BeeSentToHiddenWorld object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBeeSentToHiddenWorld(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BeeSentToHiddenWorld object`); }
...
export class BeeTransferCancelled implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeeTransferCancelledFields,) {
        this.$fullTypeName = composeSuiType(BeeTransferCancelled.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeeTransferCancelled`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BeeTransferCancelled", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeeTransferCancelled {
    ...
    static fromJSON(json: Record<string, any>): BeeTransferCancelled {
        if (json.$typeName !== BeeTransferCancelled.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeeTransferCancelled {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeeTransferCancelled(data.bcs.type)) { throw new Error(`object at is not a BeeTransferCancelled object`); }

            return BeeTransferCancelled.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeeTransferCancelled.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BeeTransferCancelled> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BeeTransferCancelled object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBeeTransferCancelled(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BeeTransferCancelled object`); }
...
export class BeeTransferInitiated implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeeTransferInitiatedFields,) {
        this.$fullTypeName = composeSuiType(BeeTransferInitiated.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeeTransferInitiated`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BeeTransferInitiated", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeeTransferInitiated {
    ...
    static fromJSON(json: Record<string, any>): BeeTransferInitiated {
        if (json.$typeName !== BeeTransferInitiated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeeTransferInitiated {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeeTransferInitiated(data.bcs.type)) { throw new Error(`object at is not a BeeTransferInitiated object`); }

            return BeeTransferInitiated.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeeTransferInitiated.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BeeTransferInitiated> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BeeTransferInitiated object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBeeTransferInitiated(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BeeTransferInitiated object`); }
...
export class BeeTransfers implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeeTransfersFields,) {
        this.$fullTypeName = composeSuiType(BeeTransfers.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeeTransfers`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BeeTransfers", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeeTransfers {
    ...
    static fromJSON(json: Record<string, any>): BeeTransfers {
        if (json.$typeName !== BeeTransfers.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeeTransfers {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeeTransfers(data.bcs.type)) { throw new Error(`object at is not a BeeTransfers object`); }

            return BeeTransfers.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeeTransfers.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BeeTransfers> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BeeTransfers object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBeeTransfers(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BeeTransfers object`); }
...
export class BeeUpdatedInGenesisBasket implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeeUpdatedInGenesisBasketFields,) {
        this.$fullTypeName = composeSuiType(BeeUpdatedInGenesisBasket.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeeUpdatedInGenesisBasket`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BeeUpdatedInGenesisBasket", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeeUpdatedInGenesisBasket {
    ...
    static fromJSON(json: Record<string, any>): BeeUpdatedInGenesisBasket {
        if (json.$typeName !== BeeUpdatedInGenesisBasket.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeeUpdatedInGenesisBasket {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeeUpdatedInGenesisBasket(data.bcs.type)) { throw new Error(`object at is not a BeeUpdatedInGenesisBasket object`); }

            return BeeUpdatedInGenesisBasket.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeeUpdatedInGenesisBasket.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export class BeesAddedToGenesisBasket implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeesAddedToGenesisBasketFields,) {
        this.$fullTypeName = composeSuiType(BeesAddedToGenesisBasket.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeesAddedToGenesisBasket`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BeesAddedToGenesisBasket", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeesAddedToGenesisBasket {
    ...
    static fromJSON(json: Record<string, any>): BeesAddedToGenesisBasket {
        if (json.$typeName !== BeesAddedToGenesisBasket.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeesAddedToGenesisBasket {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeesAddedToGenesisBasket(data.bcs.type)) { throw new Error(`object at is not a BeesAddedToGenesisBasket object`); }

            return BeesAddedToGenesisBasket.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeesAddedToGenesisBasket.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export class BeesManager implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeesManagerFields,) {
        this.$fullTypeName = composeSuiType(BeesManager.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeesManager`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeesManager {
    ...
    static fromJSON(json: Record<string, any>): BeesManager {
        if (json.$typeName !== BeesManager.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeesManager {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeesManager(data.bcs.type)) { throw new Error(`object at is not a BeesManager object`); }

            return BeesManager.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeesManager.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export class BeesTracker implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BeesTrackerFields,) {
        this.$fullTypeName = composeSuiType(BeesTracker.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BeesTracker`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BeesTracker {
    ...
    static fromJSON(json: Record<string, any>): BeesTracker {
        if (json.$typeName !== BeesTracker.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BeesTracker {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBeesTracker(data.bcs.type)) { throw new Error(`object at is not a BeesTracker object`); }

            return BeesTracker.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BeesTracker.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BeesTracker> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BeesTracker object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBeesTracker(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BeesTracker object`); }
...
export class Bid implements StructClass {
    ...
    private constructor(typeArgs: [], fields: BidFields,) {
        this.$fullTypeName = composeSuiType(Bid.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::Bid`; this.$typeArgs = typeArgs;
    ...
    static fromJSON(json: Record<string, any>): Bid {
        if (json.$typeName !== Bid.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): Bid {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBid(data.bcs.type)) { throw new Error(`object at is not a Bid object`); }

            return Bid.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return Bid.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<Bid> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching Bid object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBid(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a Bid object`); }
...
export class BidCanceled implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BidCanceledFields,) {
        this.$fullTypeName = composeSuiType(BidCanceled.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BidCanceled`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BidCanceled {
    ...
    static fromJSON(json: Record<string, any>): BidCanceled {
        if (json.$typeName !== BidCanceled.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BidCanceled {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBidCanceled(data.bcs.type)) { throw new Error(`object at is not a BidCanceled object`); }

            return BidCanceled.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BidCanceled.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BidCanceled> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BidCanceled object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBidCanceled(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BidCanceled object`); }
...
export class BidDestroyed implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BidDestroyedFields,) {
        this.$fullTypeName = composeSuiType(BidDestroyed.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BidDestroyed`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BidDestroyed", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BidDestroyed {
    ...
    static fromJSON(json: Record<string, any>): BidDestroyed {
        if (json.$typeName !== BidDestroyed.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BidDestroyed {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBidDestroyed(data.bcs.type)) { throw new Error(`object at is not a BidDestroyed object`); }

            return BidDestroyed.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BidDestroyed.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BidDestroyed> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BidDestroyed object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBidDestroyed(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BidDestroyed object`); }
...
export class BidExpired implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BidExpiredFields,) {
        this.$fullTypeName = composeSuiType(BidExpired.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BidExpired`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BidExpired {
    ...
    static fromJSON(json: Record<string, any>): BidExpired {
        if (json.$typeName !== BidExpired.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BidExpired {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBidExpired(data.bcs.type)) { throw new Error(`object at is not a BidExpired object`); }

            return BidExpired.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BidExpired.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BidExpired> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BidExpired object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBidExpired(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BidExpired object`); }
...
export class BidMarkedInvalid implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BidMarkedInvalidFields,) {
        this.$fullTypeName = composeSuiType(BidMarkedInvalid.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BidMarkedInvalid`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BidMarkedInvalid", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BidMarkedInvalid {
    ...
    static fromJSON(json: Record<string, any>): BidMarkedInvalid {
        if (json.$typeName !== BidMarkedInvalid.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BidMarkedInvalid {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBidMarkedInvalid(data.bcs.type)) { throw new Error(`object at is not a BidMarkedInvalid object`); }

            return BidMarkedInvalid.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BidMarkedInvalid.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BidMarkedInvalid> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BidMarkedInvalid object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBidMarkedInvalid(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BidMarkedInvalid object`); }
...
export class BidPlaced implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BidPlacedFields,) {
        this.$fullTypeName = composeSuiType(BidPlaced.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BidPlaced`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BidPlaced {
    ...
    static fromJSON(json: Record<string, any>): BidPlaced {
        if (json.$typeName !== BidPlaced.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BidPlaced {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBidPlaced(data.bcs.type)) { throw new Error(`object at is not a BidPlaced object`); }

            return BidPlaced.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BidPlaced.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BidPlaced> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BidPlaced object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBidPlaced(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BidPlaced object`); }
...
export class BidRecord implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BidRecordFields,) {
        this.$fullTypeName = composeSuiType(BidRecord.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BidRecord`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BidRecord {
    ...
    static fromJSON(json: Record<string, any>): BidRecord {
        if (json.$typeName !== BidRecord.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BidRecord {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBidRecord(data.bcs.type)) { throw new Error(`object at is not a BidRecord object`); }

            return BidRecord.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BidRecord.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BidRecord> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BidRecord object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBidRecord(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BidRecord object`); }
...
export class BirthCertificate implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BirthCertificateFields,) {
        this.$fullTypeName = composeSuiType(BirthCertificate.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BirthCertificate`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BirthCertificate", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BirthCertificate {
    ...
    static fromJSON(json: Record<string, any>): BirthCertificate {
        if (json.$typeName !== BirthCertificate.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BirthCertificate {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBirthCertificate(data.bcs.type)) { throw new Error(`object at is not a BirthCertificate object`); }

            return BirthCertificate.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BirthCertificate.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BirthCertificate> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BirthCertificate object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBirthCertificate(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BirthCertificate object`); }
...
export class BreedingRequestProcessed implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BreedingRequestProcessedFields,) {
        this.$fullTypeName = composeSuiType(BreedingRequestProcessed.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BreedingRequestProcessed`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BreedingRequestProcessed", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BreedingRequestProcessed {
    ...
    static fromJSON(json: Record<string, any>): BreedingRequestProcessed {
        if (json.$typeName !== BreedingRequestProcessed.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BreedingRequestProcessed {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBreedingRequestProcessed(data.bcs.type)) { throw new Error(`object at is not a BreedingRequestProcessed object`); }

            return BreedingRequestProcessed.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BreedingRequestProcessed.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export class BreedingRequestUnprocessed implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BreedingRequestUnprocessedFields,) {
        this.$fullTypeName = composeSuiType(BreedingRequestUnprocessed.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BreedingRequestUnprocessed`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BreedingRequestUnprocessed", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BreedingRequestUnprocessed {
    ...
    static fromJSON(json: Record<string, any>): BreedingRequestUnprocessed {
        if (json.$typeName !== BreedingRequestUnprocessed.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BreedingRequestUnprocessed {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBreedingRequestUnprocessed(data.bcs.type)) { throw new Error(`object at is not a BreedingRequestUnprocessed object`); }

            return BreedingRequestUnprocessed.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BreedingRequestUnprocessed.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BreedingRequestUnprocessed> {
...
export class BreedingRoyalty implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BreedingRoyaltyFields,) {
        this.$fullTypeName = composeSuiType(BreedingRoyalty.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BreedingRoyalty`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BreedingRoyalty", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BreedingRoyalty {
    ...
    static fromJSON(json: Record<string, any>): BreedingRoyalty {
        if (json.$typeName !== BreedingRoyalty.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BreedingRoyalty {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBreedingRoyalty(data.bcs.type)) { throw new Error(`object at is not a BreedingRoyalty object`); }

            return BreedingRoyalty.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BreedingRoyalty.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BreedingRoyalty> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching BreedingRoyalty object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isBreedingRoyalty(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a BreedingRoyalty object`); }
...
export class BuidlersYieldHarvested implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: BuidlersYieldHarvestedFields,) {
        this.$fullTypeName = composeSuiType(BuidlersYieldHarvested.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::BuidlersYieldHarvested`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("BuidlersYieldHarvested", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BuidlersYieldHarvested {
    ...
    static fromJSON(json: Record<string, any>): BuidlersYieldHarvested {
        if (json.$typeName !== BuidlersYieldHarvested.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): BuidlersYieldHarvested {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isBuidlersYieldHarvested(data.bcs.type)) { throw new Error(`object at is not a BuidlersYieldHarvested object`); }

            return BuidlersYieldHarvested.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return BuidlersYieldHarvested.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<BuidlersYieldHarvested> {
...
export class CapabilityAdded implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: CapabilityAddedFields,) {
        this.$fullTypeName = composeSuiType(CapabilityAdded.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::CapabilityAdded`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("CapabilityAdded", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): CapabilityAdded {
    ...
    static fromJSON(json: Record<string, any>): CapabilityAdded {
        if (json.$typeName !== CapabilityAdded.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): CapabilityAdded {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isCapabilityAdded(data.bcs.type)) { throw new Error(`object at is not a CapabilityAdded object`); }

            return CapabilityAdded.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return CapabilityAdded.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<CapabilityAdded> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching CapabilityAdded object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isCapabilityAdded(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a CapabilityAdded object`); }
...
export class CapabilityState implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: CapabilityStateFields,) {
        this.$fullTypeName = composeSuiType(CapabilityState.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::CapabilityState`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("CapabilityState", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): CapabilityState {
    ...
    static fromJSON(json: Record<string, any>): CapabilityState {
        if (json.$typeName !== CapabilityState.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): CapabilityState {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isCapabilityState(data.bcs.type)) { throw new Error(`object at is not a CapabilityState object`); }

            return CapabilityState.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return CapabilityState.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<CapabilityState> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching CapabilityState object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isCapabilityState(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a CapabilityState object`); }
...
export class Configuration implements StructClass {
    ...
    private constructor(typeArgs: [], fields: ConfigurationFields,) {
        this.$fullTypeName = composeSuiType(Configuration.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::Configuration`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("Configuration", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): Configuration {
    ...
    static fromJSON(json: Record<string, any>): Configuration {
        if (json.$typeName !== Configuration.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): Configuration {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isConfiguration(data.bcs.type)) { throw new Error(`object at is not a Configuration object`); }

            return Configuration.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return Configuration.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<Configuration> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching Configuration object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isConfiguration(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a Configuration object`); }
...
export class DRAGON_TRAINER implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: DRAGON_TRAINERFields,) {
        this.$fullTypeName = composeSuiType(DRAGON_TRAINER.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::DRAGON_TRAINER`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("DRAGON_TRAINER", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): DRAGON_TRAINER {
    ...
    static fromJSON(json: Record<string, any>): DRAGON_TRAINER {
        if (json.$typeName !== DRAGON_TRAINER.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): DRAGON_TRAINER {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isDRAGON_TRAINER(data.bcs.type)) { throw new Error(`object at is not a DRAGON_TRAINER object`); }

            return DRAGON_TRAINER.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return DRAGON_TRAINER.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<DRAGON_TRAINER> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching DRAGON_TRAINER object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isDRAGON_TRAINER(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a DRAGON_TRAINER object`); }
...
export class DegenHiveMapStore implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: DegenHiveMapStoreFields,) {
        this.$fullTypeName = composeSuiType(DegenHiveMapStore.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::DegenHiveMapStore`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("DegenHiveMapStore", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): DegenHiveMapStore {
    ...
    static fromJSON(json: Record<string, any>): DegenHiveMapStore {
        if (json.$typeName !== DegenHiveMapStore.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): DegenHiveMapStore {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isDegenHiveMapStore(data.bcs.type)) { throw new Error(`object at is not a DegenHiveMapStore object`); }

            return DegenHiveMapStore.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return DegenHiveMapStore.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<DegenHiveMapStore> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching DegenHiveMapStore object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isDegenHiveMapStore(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a DegenHiveMapStore object`); }
...
export class DegenHiveYieldHarvested implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: DegenHiveYieldHarvestedFields,) {
        this.$fullTypeName = composeSuiType(DegenHiveYieldHarvested.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::DegenHiveYieldHarvested`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("DegenHiveYieldHarvested", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): DegenHiveYieldHarvested {
    ...
    static fromJSON(json: Record<string, any>): DegenHiveYieldHarvested {
        if (json.$typeName !== DegenHiveYieldHarvested.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): DegenHiveYieldHarvested {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isDegenHiveYieldHarvested(data.bcs.type)) { throw new Error(`object at is not a DegenHiveYieldHarvested object`); }

            return DegenHiveYieldHarvested.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return DegenHiveYieldHarvested.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<DegenHiveYieldHarvested> {
...
export class DragonBeeHatched implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: DragonBeeHatchedFields,) {
        this.$fullTypeName = composeSuiType(DragonBeeHatched.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::DragonBeeHatched`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("DragonBeeHatched", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): DragonBeeHatched {
    ...
    static fromJSON(json: Record<string, any>): DragonBeeHatched {
        if (json.$typeName !== DragonBeeHatched.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): DragonBeeHatched {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isDragonBeeHatched(data.bcs.type)) { throw new Error(`object at is not a DragonBeeHatched object`); }

            return DragonBeeHatched.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return DragonBeeHatched.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<DragonBeeHatched> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching DragonBeeHatched object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isDragonBeeHatched(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a DragonBeeHatched object`); }
...
export class DragonDust implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: DragonDustFields,) {
        this.$fullTypeName = composeSuiType(DragonDust.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::DragonDust`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): DragonDust {
    ...
    static fromJSON(json: Record<string, any>): DragonDust {
        if (json.$typeName !== DragonDust.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): DragonDust {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isDragonDust(data.bcs.type)) { throw new Error(`object at is not a DragonDust object`); }

            return DragonDust.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return DragonDust.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<DragonDust> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching DragonDust object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isDragonDust(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a DragonDust object`); }
...
export class DragonEggsBasket implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: DragonEggsBasketFields,) {
        this.$fullTypeName = composeSuiType(DragonEggsBasket.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::DragonEggsBasket`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("DragonEggsBasket", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): DragonEggsBasket {
    ...
    static fromJSON(json: Record<string, any>): DragonEggsBasket {
        if (json.$typeName !== DragonEggsBasket.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): DragonEggsBasket {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isDragonEggsBasket(data.bcs.type)) { throw new Error(`object at is not a DragonEggsBasket object`); }

            return DragonEggsBasket.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return DragonEggsBasket.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<DragonEggsBasket> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching DragonEggsBasket object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isDragonEggsBasket(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a DragonEggsBasket object`); }
...
export class DragonSchool implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: DragonSchoolFields,) {
        this.$fullTypeName = composeSuiType(DragonSchool.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::DragonSchool`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("DragonSchool", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): DragonSchool {
    ...
    static fromJSON(json: Record<string, any>): DragonSchool {
        if (json.$typeName !== DragonSchool.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): DragonSchool {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isDragonSchool(data.bcs.type)) { throw new Error(`object at is not a DragonSchool object`); }

            return DragonSchool.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return DragonSchool.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<DragonSchool> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching DragonSchool object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isDragonSchool(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a DragonSchool object`); }
...
export class DragonSchoolCreated implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: DragonSchoolCreatedFields,) {
        this.$fullTypeName = composeSuiType(DragonSchoolCreated.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::DragonSchoolCreated`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("DragonSchoolCreated", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): DragonSchoolCreated {
    ...
    static fromJSON(json: Record<string, any>): DragonSchoolCreated {
        if (json.$typeName !== DragonSchoolCreated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): DragonSchoolCreated {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isDragonSchoolCreated(data.bcs.type)) { throw new Error(`object at is not a DragonSchoolCreated object`); }

            return DragonSchoolCreated.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return DragonSchoolCreated.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<DragonSchoolCreated> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching DragonSchoolCreated object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isDragonSchoolCreated(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a DragonSchoolCreated object`); }
...
export class DragonTrainer implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: DragonTrainerFields,) {
        this.$fullTypeName = composeSuiType(DragonTrainer.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::DragonTrainer`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("DragonTrainer", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): DragonTrainer {
    ...
    static fromJSON(json: Record<string, any>): DragonTrainer {
        if (json.$typeName !== DragonTrainer.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): DragonTrainer {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isDragonTrainer(data.bcs.type)) { throw new Error(`object at is not a DragonTrainer object`); }

            return DragonTrainer.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return DragonTrainer.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<DragonTrainer> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching DragonTrainer object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isDragonTrainer(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a DragonTrainer object`); }
...
export class DragonTrainerDeleted implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: DragonTrainerDeletedFields,) {
        this.$fullTypeName = composeSuiType(DragonTrainerDeleted.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::DragonTrainerDeleted`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("DragonTrainerDeleted", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): DragonTrainerDeleted {
    ...
    static fromJSON(json: Record<string, any>): DragonTrainerDeleted {
        if (json.$typeName !== DragonTrainerDeleted.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): DragonTrainerDeleted {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isDragonTrainerDeleted(data.bcs.type)) { throw new Error(`object at is not a DragonTrainerDeleted object`); }

            return DragonTrainerDeleted.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return DragonTrainerDeleted.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<DragonTrainerDeleted> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching DragonTrainerDeleted object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isDragonTrainerDeleted(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a DragonTrainerDeleted object`); }
...
export class DragonTrainerKrafted implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: DragonTrainerKraftedFields,) {
        this.$fullTypeName = composeSuiType(DragonTrainerKrafted.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::DragonTrainerKrafted`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("DragonTrainerKrafted", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): DragonTrainerKrafted {
    ...
    static fromJSON(json: Record<string, any>): DragonTrainerKrafted {
        if (json.$typeName !== DragonTrainerKrafted.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): DragonTrainerKrafted {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isDragonTrainerKrafted(data.bcs.type)) { throw new Error(`object at is not a DragonTrainerKrafted object`); }

            return DragonTrainerKrafted.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return DragonTrainerKrafted.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<DragonTrainerKrafted> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching DragonTrainerKrafted object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isDragonTrainerKrafted(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a DragonTrainerKrafted object`); }
...
export class EggBasketInfo implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: EggBasketInfoFields,) {
        this.$fullTypeName = composeSuiType(EggBasketInfo.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::EggBasketInfo`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("EggBasketInfo", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): EggBasketInfo {
    ...
    static fromJSON(json: Record<string, any>): EggBasketInfo {
        if (json.$typeName !== EggBasketInfo.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): EggBasketInfo {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isEggBasketInfo(data.bcs.type)) { throw new Error(`object at is not a EggBasketInfo object`); }

            return EggBasketInfo.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return EggBasketInfo.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<EggBasketInfo> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching EggBasketInfo object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isEggBasketInfo(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a EggBasketInfo object`); }
...
export class EggLaidForDragonBee implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: EggLaidForDragonBeeFields,) {
        this.$fullTypeName = composeSuiType(EggLaidForDragonBee.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::EggLaidForDragonBee`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("EggLaidForDragonBee", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): EggLaidForDragonBee {
    ...
    static fromJSON(json: Record<string, any>): EggLaidForDragonBee {
        if (json.$typeName !== EggLaidForDragonBee.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): EggLaidForDragonBee {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isEggLaidForDragonBee(data.bcs.type)) { throw new Error(`object at is not a EggLaidForDragonBee object`); }

            return EggLaidForDragonBee.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return EggLaidForDragonBee.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<EggLaidForDragonBee> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching EggLaidForDragonBee object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isEggLaidForDragonBee(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a EggLaidForDragonBee object`); }
...
export class ExecutedListing implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: ExecutedListingFields,) {
        this.$fullTypeName = composeSuiType(ExecutedListing.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::ExecutedListing`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("ExecutedListing", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): ExecutedListing {
    ...
    static fromJSON(json: Record<string, any>): ExecutedListing {
        if (json.$typeName !== ExecutedListing.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): ExecutedListing {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isExecutedListing(data.bcs.type)) { throw new Error(`object at is not a ExecutedListing object`); }

            return ExecutedListing.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ExecutedListing.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<ExecutedListing> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ExecutedListing object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isExecutedListing(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ExecutedListing object`); }
...
export class ExecutedListingDestroyed implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: ExecutedListingDestroyedFields,) {
        this.$fullTypeName = composeSuiType(ExecutedListingDestroyed.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::ExecutedListingDestroyed`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("ExecutedListingDestroyed", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): ExecutedListingDestroyed {
    ...
    static fromJSON(json: Record<string, any>): ExecutedListingDestroyed {
        if (json.$typeName !== ExecutedListingDestroyed.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): ExecutedListingDestroyed {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isExecutedListingDestroyed(data.bcs.type)) { throw new Error(`object at is not a ExecutedListingDestroyed object`); }

            return ExecutedListingDestroyed.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ExecutedListingDestroyed.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<ExecutedListingDestroyed> {
...
export class ExitHiveOfProfile implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: ExitHiveOfProfileFields,) {
        this.$fullTypeName = composeSuiType(ExitHiveOfProfile.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::ExitHiveOfProfile`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("ExitHiveOfProfile", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): ExitHiveOfProfile {
    ...
    static fromJSON(json: Record<string, any>): ExitHiveOfProfile {
        if (json.$typeName !== ExitHiveOfProfile.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): ExitHiveOfProfile {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isExitHiveOfProfile(data.bcs.type)) { throw new Error(`object at is not a ExitHiveOfProfile object`); }

            return ExitHiveOfProfile.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ExitHiveOfProfile.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<ExitHiveOfProfile> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ExitHiveOfProfile object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isExitHiveOfProfile(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ExitHiveOfProfile object`); }
...
export class FundsWithdrawnFromProfile implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: FundsWithdrawnFromProfileFields,) {
        this.$fullTypeName = composeSuiType(FundsWithdrawnFromProfile.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::FundsWithdrawnFromProfile`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("FundsWithdrawnFromProfile", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): FundsWithdrawnFromProfile {
    ...
    static fromJSON(json: Record<string, any>): FundsWithdrawnFromProfile {
        if (json.$typeName !== FundsWithdrawnFromProfile.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): FundsWithdrawnFromProfile {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isFundsWithdrawnFromProfile(data.bcs.type)) { throw new Error(`object at is not a FundsWithdrawnFromProfile object`); }

            return FundsWithdrawnFromProfile.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return FundsWithdrawnFromProfile.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<FundsWithdrawnFromProfile> {
...
export class GameMasterKey implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: GameMasterKeyFields,) {
        this.$fullTypeName = composeSuiType(GameMasterKey.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::GameMasterKey`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("GameMasterKey", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): GameMasterKey {
    ...
    static fromJSON(json: Record<string, any>): GameMasterKey {
        if (json.$typeName !== GameMasterKey.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): GameMasterKey {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isGameMasterKey(data.bcs.type)) { throw new Error(`object at is not a GameMasterKey object`); }

            return GameMasterKey.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return GameMasterKey.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<GameMasterKey> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching GameMasterKey object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isGameMasterKey(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a GameMasterKey object`); }
...
export class GenesisBeesUploaderCapability implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: GenesisBeesUploaderCapabilityFields,) {
        this.$fullTypeName = composeSuiType(GenesisBeesUploaderCapability.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::GenesisBeesUploaderCapability`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("GenesisBeesUploaderCapability", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): GenesisBeesUploaderCapability {
    ...
    static fromJSON(json: Record<string, any>): GenesisBeesUploaderCapability {
        if (json.$typeName !== GenesisBeesUploaderCapability.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): GenesisBeesUploaderCapability {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isGenesisBeesUploaderCapability(data.bcs.type)) { throw new Error(`object at is not a GenesisBeesUploaderCapability object`); }

            return GenesisBeesUploaderCapability.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return GenesisBeesUploaderCapability.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<GenesisBeesUploaderCapability> {
...
export class GovernanceInfo implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: GovernanceInfoFields,) {
        this.$fullTypeName = composeSuiType(GovernanceInfo.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::GovernanceInfo`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("GovernanceInfo", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): GovernanceInfo {
    ...
    static fromJSON(json: Record<string, any>): GovernanceInfo {
        if (json.$typeName !== GovernanceInfo.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): GovernanceInfo {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isGovernanceInfo(data.bcs.type)) { throw new Error(`object at is not a GovernanceInfo object`); }

            return GovernanceInfo.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return GovernanceInfo.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<GovernanceInfo> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching GovernanceInfo object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isGovernanceInfo(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a GovernanceInfo object`); }
...
export class HealthInfusedInBee implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HealthInfusedInBeeFields,) {
        this.$fullTypeName = composeSuiType(HealthInfusedInBee.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::HealthInfusedInBee`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HealthInfusedInBee", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HealthInfusedInBee {
    ...
    static fromJSON(json: Record<string, any>): HealthInfusedInBee {
        if (json.$typeName !== HealthInfusedInBee.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HealthInfusedInBee {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHealthInfusedInBee(data.bcs.type)) { throw new Error(`object at is not a HealthInfusedInBee object`); }

            return HealthInfusedInBee.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HealthInfusedInBee.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HealthInfusedInBee> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HealthInfusedInBee object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHealthInfusedInBee(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HealthInfusedInBee object`); }
...
export class HiddenBeeDeleted implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HiddenBeeDeletedFields,) {
        this.$fullTypeName = composeSuiType(HiddenBeeDeleted.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::HiddenBeeDeleted`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HiddenBeeDeleted", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HiddenBeeDeleted {
    ...
    static fromJSON(json: Record<string, any>): HiddenBeeDeleted {
        if (json.$typeName !== HiddenBeeDeleted.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HiddenBeeDeleted {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHiddenBeeDeleted(data.bcs.type)) { throw new Error(`object at is not a HiddenBeeDeleted object`); }

            return HiddenBeeDeleted.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HiddenBeeDeleted.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HiddenBeeDeleted> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HiddenBeeDeleted object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHiddenBeeDeleted(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HiddenBeeDeleted object`); }
...
export class HiddenMysticalBee implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HiddenMysticalBeeFields,) {
        this.$fullTypeName = composeSuiType(HiddenMysticalBee.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::HiddenMysticalBee`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HiddenMysticalBee", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HiddenMysticalBee {
    ...
    static fromJSON(json: Record<string, any>): HiddenMysticalBee {
        if (json.$typeName !== HiddenMysticalBee.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HiddenMysticalBee {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHiddenMysticalBee(data.bcs.type)) { throw new Error(`object at is not a HiddenMysticalBee object`); }

            return HiddenMysticalBee.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HiddenMysticalBee.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HiddenMysticalBee> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HiddenMysticalBee object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHiddenMysticalBee(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HiddenMysticalBee object`); }
...
export class HiddenWorld implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HiddenWorldFields,) {
        this.$fullTypeName = composeSuiType(HiddenWorld.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::HiddenWorld`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HiddenWorld {
    ...
    static fromJSON(json: Record<string, any>): HiddenWorld {
        if (json.$typeName !== HiddenWorld.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HiddenWorld {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHiddenWorld(data.bcs.type)) { throw new Error(`object at is not a HiddenWorld object`); }

            return HiddenWorld.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HiddenWorld.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HiddenWorld> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HiddenWorld object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHiddenWorld(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HiddenWorld object`); }
...
export class HiddenWorldConfig implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HiddenWorldConfigFields,) {
        this.$fullTypeName = composeSuiType(HiddenWorldConfig.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::HiddenWorldConfig`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HiddenWorldConfig", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HiddenWorldConfig {
    ...
    static fromJSON(json: Record<string, any>): HiddenWorldConfig {
        if (json.$typeName !== HiddenWorldConfig.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HiddenWorldConfig {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHiddenWorldConfig(data.bcs.type)) { throw new Error(`object at is not a HiddenWorldConfig object`); }

            return HiddenWorldConfig.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HiddenWorldConfig.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HiddenWorldConfig> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HiddenWorldConfig object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHiddenWorldConfig(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HiddenWorldConfig object`); }
...
export class HiddenWorldQuest implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HiddenWorldQuestFields,) {
        this.$fullTypeName = composeSuiType(HiddenWorldQuest.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::HiddenWorldQuest`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HiddenWorldQuest", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HiddenWorldQuest {
    ...
    static fromJSON(json: Record<string, any>): HiddenWorldQuest {
        if (json.$typeName !== HiddenWorldQuest.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HiddenWorldQuest {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHiddenWorldQuest(data.bcs.type)) { throw new Error(`object at is not a HiddenWorldQuest object`); }

            return HiddenWorldQuest.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HiddenWorldQuest.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HiddenWorldQuest> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HiddenWorldQuest object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHiddenWorldQuest(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HiddenWorldQuest object`); }
...
export class HiddenWorldRewardsClaimed implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HiddenWorldRewardsClaimedFields,) {
        this.$fullTypeName = composeSuiType(HiddenWorldRewardsClaimed.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::HiddenWorldRewardsClaimed`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HiddenWorldRewardsClaimed", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HiddenWorldRewardsClaimed {
    ...
    static fromJSON(json: Record<string, any>): HiddenWorldRewardsClaimed {
        if (json.$typeName !== HiddenWorldRewardsClaimed.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HiddenWorldRewardsClaimed {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHiddenWorldRewardsClaimed(data.bcs.type)) { throw new Error(`object at is not a HiddenWorldRewardsClaimed object`); }

            return HiddenWorldRewardsClaimed.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HiddenWorldRewardsClaimed.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HiddenWorldRewardsClaimed> {
...
export class HiveAddedForHarvest implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HiveAddedForHarvestFields,) {
        this.$fullTypeName = composeSuiType(HiveAddedForHarvest.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::HiveAddedForHarvest`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HiveAddedForHarvest", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HiveAddedForHarvest {
    ...
    static fromJSON(json: Record<string, any>): HiveAddedForHarvest {
        if (json.$typeName !== HiveAddedForHarvest.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HiveAddedForHarvest {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHiveAddedForHarvest(data.bcs.type)) { throw new Error(`object at is not a HiveAddedForHarvest object`); }

            return HiveAddedForHarvest.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HiveAddedForHarvest.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HiveAddedForHarvest> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HiveAddedForHarvest object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHiveAddedForHarvest(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HiveAddedForHarvest object`); }
...
export class HiveAddedToTreasury implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HiveAddedToTreasuryFields,) {
        this.$fullTypeName = composeSuiType(HiveAddedToTreasury.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::HiveAddedToTreasury`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HiveAddedToTreasury", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HiveAddedToTreasury {
    ...
    static fromJSON(json: Record<string, any>): HiveAddedToTreasury {
        if (json.$typeName !== HiveAddedToTreasury.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HiveAddedToTreasury {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHiveAddedToTreasury(data.bcs.type)) { throw new Error(`object at is not a HiveAddedToTreasury object`); }

            return HiveAddedToTreasury.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HiveAddedToTreasury.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HiveAddedToTreasury> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HiveAddedToTreasury object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHiveAddedToTreasury(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HiveAddedToTreasury object`); }
...
export class HiveEnergyInfusedInBee implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HiveEnergyInfusedInBeeFields,) {
        this.$fullTypeName = composeSuiType(HiveEnergyInfusedInBee.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::HiveEnergyInfusedInBee`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HiveEnergyInfusedInBee", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HiveEnergyInfusedInBee {
    ...
    static fromJSON(json: Record<string, any>): HiveEnergyInfusedInBee {
        if (json.$typeName !== HiveEnergyInfusedInBee.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HiveEnergyInfusedInBee {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHiveEnergyInfusedInBee(data.bcs.type)) { throw new Error(`object at is not a HiveEnergyInfusedInBee object`); }

            return HiveEnergyInfusedInBee.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HiveEnergyInfusedInBee.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export class HiveGraph implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HiveGraphFields,) {
        this.$fullTypeName = composeSuiType(HiveGraph.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::HiveGraph`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HiveGraph {
    ...
    static fromJSON(json: Record<string, any>): HiveGraph {
        if (json.$typeName !== HiveGraph.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HiveGraph {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHiveGraph(data.bcs.type)) { throw new Error(`object at is not a HiveGraph object`); }

            return HiveGraph.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HiveGraph.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HiveGraph> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HiveGraph object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHiveGraph(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HiveGraph object`); }
...
export class HiveTwapInfo implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HiveTwapInfoFields,) {
        this.$fullTypeName = composeSuiType(HiveTwapInfo.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::HiveTwapInfo`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HiveTwapInfo", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HiveTwapInfo {
    ...
    static fromJSON(json: Record<string, any>): HiveTwapInfo {
        if (json.$typeName !== HiveTwapInfo.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HiveTwapInfo {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHiveTwapInfo(data.bcs.type)) { throw new Error(`object at is not a HiveTwapInfo object`); }

            return HiveTwapInfo.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HiveTwapInfo.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HiveTwapInfo> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HiveTwapInfo object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHiveTwapInfo(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HiveTwapInfo object`); }
...
export class HiveTwapUpdated implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HiveTwapUpdatedFields,) {
        this.$fullTypeName = composeSuiType(HiveTwapUpdated.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::HiveTwapUpdated`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HiveTwapUpdated", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HiveTwapUpdated {
    ...
    static fromJSON(json: Record<string, any>): HiveTwapUpdated {
        if (json.$typeName !== HiveTwapUpdated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HiveTwapUpdated {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHiveTwapUpdated(data.bcs.type)) { throw new Error(`object at is not a HiveTwapUpdated object`); }

            return HiveTwapUpdated.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HiveTwapUpdated.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HiveTwapUpdated> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HiveTwapUpdated object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHiveTwapUpdated(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HiveTwapUpdated object`); }
...
export class HiveUnlockedFromBee implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HiveUnlockedFromBeeFields,) {
        this.$fullTypeName = composeSuiType(HiveUnlockedFromBee.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::HiveUnlockedFromBee`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HiveUnlockedFromBee", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HiveUnlockedFromBee {
    ...
    static fromJSON(json: Record<string, any>): HiveUnlockedFromBee {
        if (json.$typeName !== HiveUnlockedFromBee.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HiveUnlockedFromBee {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHiveUnlockedFromBee(data.bcs.type)) { throw new Error(`object at is not a HiveUnlockedFromBee object`); }

            return HiveUnlockedFromBee.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HiveUnlockedFromBee.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HiveUnlockedFromBee> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HiveUnlockedFromBee object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHiveUnlockedFromBee(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HiveUnlockedFromBee object`); }
...
export class HiveWithdrawnFromTreasury implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HiveWithdrawnFromTreasuryFields,) {
        this.$fullTypeName = composeSuiType(HiveWithdrawnFromTreasury.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::HiveWithdrawnFromTreasury`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HiveWithdrawnFromTreasury", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HiveWithdrawnFromTreasury {
    ...
    static fromJSON(json: Record<string, any>): HiveWithdrawnFromTreasury {
        if (json.$typeName !== HiveWithdrawnFromTreasury.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HiveWithdrawnFromTreasury {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHiveWithdrawnFromTreasury(data.bcs.type)) { throw new Error(`object at is not a HiveWithdrawnFromTreasury object`); }

            return HiveWithdrawnFromTreasury.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HiveWithdrawnFromTreasury.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export class HoneyAddedForHarvest implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HoneyAddedForHarvestFields,) {
        this.$fullTypeName = composeSuiType(HoneyAddedForHarvest.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::HoneyAddedForHarvest`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HoneyAddedForHarvest", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HoneyAddedForHarvest {
    ...
    static fromJSON(json: Record<string, any>): HoneyAddedForHarvest {
        if (json.$typeName !== HoneyAddedForHarvest.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HoneyAddedForHarvest {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHoneyAddedForHarvest(data.bcs.type)) { throw new Error(`object at is not a HoneyAddedForHarvest object`); }

            return HoneyAddedForHarvest.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HoneyAddedForHarvest.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HoneyAddedForHarvest> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HoneyAddedForHarvest object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHoneyAddedForHarvest(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HoneyAddedForHarvest object`); }
...
export class HoneyAddedToProfile implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HoneyAddedToProfileFields,) {
        this.$fullTypeName = composeSuiType(HoneyAddedToProfile.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::HoneyAddedToProfile`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HoneyAddedToProfile", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HoneyAddedToProfile {
    ...
    static fromJSON(json: Record<string, any>): HoneyAddedToProfile {
        if (json.$typeName !== HoneyAddedToProfile.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HoneyAddedToProfile {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHoneyAddedToProfile(data.bcs.type)) { throw new Error(`object at is not a HoneyAddedToProfile object`); }

            return HoneyAddedToProfile.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HoneyAddedToProfile.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HoneyAddedToProfile> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HoneyAddedToProfile object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHoneyAddedToProfile(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HoneyAddedToProfile object`); }
...
export class HoneyAddedToTreasury implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HoneyAddedToTreasuryFields,) {
        this.$fullTypeName = composeSuiType(HoneyAddedToTreasury.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::HoneyAddedToTreasury`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HoneyAddedToTreasury", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HoneyAddedToTreasury {
    ...
    static fromJSON(json: Record<string, any>): HoneyAddedToTreasury {
        if (json.$typeName !== HoneyAddedToTreasury.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HoneyAddedToTreasury {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHoneyAddedToTreasury(data.bcs.type)) { throw new Error(`object at is not a HoneyAddedToTreasury object`); }

            return HoneyAddedToTreasury.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HoneyAddedToTreasury.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HoneyAddedToTreasury> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching HoneyAddedToTreasury object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isHoneyAddedToTreasury(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a HoneyAddedToTreasury object`); }
...
export class HoneyTransferredToProfile implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: HoneyTransferredToProfileFields,) {
        this.$fullTypeName = composeSuiType(HoneyTransferredToProfile.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::HoneyTransferredToProfile`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("HoneyTransferredToProfile", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): HoneyTransferredToProfile {
    ...
    static fromJSON(json: Record<string, any>): HoneyTransferredToProfile {
        if (json.$typeName !== HoneyTransferredToProfile.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): HoneyTransferredToProfile {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isHoneyTransferredToProfile(data.bcs.type)) { throw new Error(`object at is not a HoneyTransferredToProfile object`); }

            return HoneyTransferredToProfile.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return HoneyTransferredToProfile.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<HoneyTransferredToProfile> {
...
export class IncomingBeeClaimed implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: IncomingBeeClaimedFields,) {
        this.$fullTypeName = composeSuiType(IncomingBeeClaimed.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::IncomingBeeClaimed`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("IncomingBeeClaimed", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): IncomingBeeClaimed {
    ...
    static fromJSON(json: Record<string, any>): IncomingBeeClaimed {
        if (json.$typeName !== IncomingBeeClaimed.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): IncomingBeeClaimed {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isIncomingBeeClaimed(data.bcs.type)) { throw new Error(`object at is not a IncomingBeeClaimed object`); }

            return IncomingBeeClaimed.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return IncomingBeeClaimed.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<IncomingBeeClaimed> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching IncomingBeeClaimed object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isIncomingBeeClaimed(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a IncomingBeeClaimed object`); }
...
export class Inscription implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: InscriptionFields,) {
        this.$fullTypeName = composeSuiType(Inscription.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::Inscription`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): Inscription {
    ...
    static fromJSON(json: Record<string, any>): Inscription {
        if (json.$typeName !== Inscription.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): Inscription {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isInscription(data.bcs.type)) { throw new Error(`object at is not a Inscription object`); }

            return Inscription.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return Inscription.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<Inscription> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching Inscription object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isInscription(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a Inscription object`); }
...
export class InscriptionSetForProfile implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: InscriptionSetForProfileFields,) {
        this.$fullTypeName = composeSuiType(InscriptionSetForProfile.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::InscriptionSetForProfile`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("InscriptionSetForProfile", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): InscriptionSetForProfile {
    ...
    static fromJSON(json: Record<string, any>): InscriptionSetForProfile {
        if (json.$typeName !== InscriptionSetForProfile.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): InscriptionSetForProfile {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isInscriptionSetForProfile(data.bcs.type)) { throw new Error(`object at is not a InscriptionSetForProfile object`); }

            return InscriptionSetForProfile.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return InscriptionSetForProfile.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<InscriptionSetForProfile> {
...
export class JoinedHiveOfProfile implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: JoinedHiveOfProfileFields,) {
        this.$fullTypeName = composeSuiType(JoinedHiveOfProfile.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::JoinedHiveOfProfile`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("JoinedHiveOfProfile", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): JoinedHiveOfProfile {
    ...
    static fromJSON(json: Record<string, any>): JoinedHiveOfProfile {
        if (json.$typeName !== JoinedHiveOfProfile.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): JoinedHiveOfProfile {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isJoinedHiveOfProfile(data.bcs.type)) { throw new Error(`object at is not a JoinedHiveOfProfile object`); }

            return JoinedHiveOfProfile.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return JoinedHiveOfProfile.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<JoinedHiveOfProfile> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching JoinedHiveOfProfile object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isJoinedHiveOfProfile(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a JoinedHiveOfProfile object`); }
...
export class ListingCanceled implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: ListingCanceledFields,) {
        this.$fullTypeName = composeSuiType(ListingCanceled.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::ListingCanceled`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("ListingCanceled", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): ListingCanceled {
    ...
    static fromJSON(json: Record<string, any>): ListingCanceled {
        if (json.$typeName !== ListingCanceled.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): ListingCanceled {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isListingCanceled(data.bcs.type)) { throw new Error(`object at is not a ListingCanceled object`); }

            return ListingCanceled.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ListingCanceled.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<ListingCanceled> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ListingCanceled object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isListingCanceled(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ListingCanceled object`); }
...
export class ListingDestroyed implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: ListingDestroyedFields,) {
        this.$fullTypeName = composeSuiType(ListingDestroyed.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::ListingDestroyed`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("ListingDestroyed", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): ListingDestroyed {
    ...
    static fromJSON(json: Record<string, any>): ListingDestroyed {
        if (json.$typeName !== ListingDestroyed.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): ListingDestroyed {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isListingDestroyed(data.bcs.type)) { throw new Error(`object at is not a ListingDestroyed object`); }

            return ListingDestroyed.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ListingDestroyed.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<ListingDestroyed> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ListingDestroyed object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isListingDestroyed(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ListingDestroyed object`); }
...
export class ListingExpired implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: ListingExpiredFields,) {
        this.$fullTypeName = composeSuiType(ListingExpired.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::ListingExpired`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("ListingExpired", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): ListingExpired {
    ...
    static fromJSON(json: Record<string, any>): ListingExpired {
        if (json.$typeName !== ListingExpired.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): ListingExpired {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isListingExpired(data.bcs.type)) { throw new Error(`object at is not a ListingExpired object`); }

            return ListingExpired.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ListingExpired.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<ListingExpired> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ListingExpired object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isListingExpired(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ListingExpired object`); }
...
export class ListingRecord implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: ListingRecordFields,) {
        this.$fullTypeName = composeSuiType(ListingRecord.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::ListingRecord`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("ListingRecord", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): ListingRecord {
    ...
    static fromJSON(json: Record<string, any>): ListingRecord {
        if (json.$typeName !== ListingRecord.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): ListingRecord {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isListingRecord(data.bcs.type)) { throw new Error(`object at is not a ListingRecord object`); }

            return ListingRecord.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ListingRecord.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<ListingRecord> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ListingRecord object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isListingRecord(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ListingRecord object`); }
...
export class ListingUpdated implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: ListingUpdatedFields,) {
        this.$fullTypeName = composeSuiType(ListingUpdated.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::ListingUpdated`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("ListingUpdated", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): ListingUpdated {
    ...
    static fromJSON(json: Record<string, any>): ListingUpdated {
        if (json.$typeName !== ListingUpdated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): ListingUpdated {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isListingUpdated(data.bcs.type)) { throw new Error(`object at is not a ListingUpdated object`); }

            return ListingUpdated.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ListingUpdated.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<ListingUpdated> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ListingUpdated object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isListingUpdated(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ListingUpdated object`); }
...
export class LockedDegenHiveAssets implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: LockedDegenHiveAssetsFields,) {
        this.$fullTypeName = composeSuiType(LockedDegenHiveAssets.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::LockedDegenHiveAssets`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("LockedDegenHiveAssets", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): LockedDegenHiveAssets {
    ...
    static fromJSON(json: Record<string, any>): LockedDegenHiveAssets {
        if (json.$typeName !== LockedDegenHiveAssets.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): LockedDegenHiveAssets {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isLockedDegenHiveAssets(data.bcs.type)) { throw new Error(`object at is not a LockedDegenHiveAssets object`); }

            return LockedDegenHiveAssets.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return LockedDegenHiveAssets.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<LockedDegenHiveAssets> {
...
export class ManagerConfigUpdated implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: ManagerConfigUpdatedFields,) {
        this.$fullTypeName = composeSuiType(ManagerConfigUpdated.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::ManagerConfigUpdated`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("ManagerConfigUpdated", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): ManagerConfigUpdated {
    ...
    static fromJSON(json: Record<string, any>): ManagerConfigUpdated {
        if (json.$typeName !== ManagerConfigUpdated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): ManagerConfigUpdated {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isManagerConfigUpdated(data.bcs.type)) { throw new Error(`object at is not a ManagerConfigUpdated object`); }

            return ManagerConfigUpdated.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ManagerConfigUpdated.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<ManagerConfigUpdated> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ManagerConfigUpdated object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isManagerConfigUpdated(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ManagerConfigUpdated object`); }
...
export class MarketPlace implements StructClass {
    ...
    private constructor(typeArgs: [], fields: MarketPlaceFields,) {
        this.$fullTypeName = composeSuiType(MarketPlace.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::MarketPlace`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): MarketPlace {
    ...
    static fromJSON(json: Record<string, any>): MarketPlace {
        if (json.$typeName !== MarketPlace.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): MarketPlace {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isMarketPlace(data.bcs.type)) { throw new Error(`object at is not a MarketPlace object`); }

            return MarketPlace.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return MarketPlace.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<MarketPlace> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching MarketPlace object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isMarketPlace(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a MarketPlace object`); }
...
export class MasterKeyReplenished implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: MasterKeyReplenishedFields,) {
        this.$fullTypeName = composeSuiType(MasterKeyReplenished.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::MasterKeyReplenished`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("MasterKeyReplenished", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): MasterKeyReplenished {
    ...
    static fromJSON(json: Record<string, any>): MasterKeyReplenished {
        if (json.$typeName !== MasterKeyReplenished.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): MasterKeyReplenished {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isMasterKeyReplenished(data.bcs.type)) { throw new Error(`object at is not a MasterKeyReplenished object`); }

            return MasterKeyReplenished.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return MasterKeyReplenished.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<MasterKeyReplenished> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching MasterKeyReplenished object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isMasterKeyReplenished(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a MasterKeyReplenished object`); }
...
export class MemeCoinLaunchedViaBee implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: MemeCoinLaunchedViaBeeFields,) {
        this.$fullTypeName = composeSuiType(MemeCoinLaunchedViaBee.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::MemeCoinLaunchedViaBee`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("MemeCoinLaunchedViaBee", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): MemeCoinLaunchedViaBee {
    ...
    static fromJSON(json: Record<string, any>): MemeCoinLaunchedViaBee {
        if (json.$typeName !== MemeCoinLaunchedViaBee.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): MemeCoinLaunchedViaBee {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isMemeCoinLaunchedViaBee(data.bcs.type)) { throw new Error(`object at is not a MemeCoinLaunchedViaBee object`); }

            return MemeCoinLaunchedViaBee.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return MemeCoinLaunchedViaBee.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<MemeCoinLaunchedViaBee> {
...
export class MemepadCapability implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: MemepadCapabilityFields,) {
        this.$fullTypeName = composeSuiType(MemepadCapability.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::MemepadCapability`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("MemepadCapability", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): MemepadCapability {
    ...
    static fromJSON(json: Record<string, any>): MemepadCapability {
        if (json.$typeName !== MemepadCapability.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): MemepadCapability {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isMemepadCapability(data.bcs.type)) { throw new Error(`object at is not a MemepadCapability object`); }

            return MemepadCapability.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return MemepadCapability.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<MemepadCapability> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching MemepadCapability object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isMemepadCapability(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a MemepadCapability object`); }
...
export class MysticalBee implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: MysticalBeeFields,) {
        this.$fullTypeName = composeSuiType(MysticalBee.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::MysticalBee`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): MysticalBee {
    ...
    static fromJSON(json: Record<string, any>): MysticalBee {
        if (json.$typeName !== MysticalBee.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): MysticalBee {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isMysticalBee(data.bcs.type)) { throw new Error(`object at is not a MysticalBee object`); }

            return MysticalBee.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return MysticalBee.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<MysticalBee> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching MysticalBee object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isMysticalBee(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a MysticalBee object`); }
...
export class MysticalBeeRenamed implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: MysticalBeeRenamedFields,) {
        this.$fullTypeName = composeSuiType(MysticalBeeRenamed.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::MysticalBeeRenamed`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("MysticalBeeRenamed", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): MysticalBeeRenamed {
    ...
    static fromJSON(json: Record<string, any>): MysticalBeeRenamed {
        if (json.$typeName !== MysticalBeeRenamed.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): MysticalBeeRenamed {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isMysticalBeeRenamed(data.bcs.type)) { throw new Error(`object at is not a MysticalBeeRenamed object`); }

            return MysticalBeeRenamed.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return MysticalBeeRenamed.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<MysticalBeeRenamed> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching MysticalBeeRenamed object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isMysticalBeeRenamed(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a MysticalBeeRenamed object`); }
...
export class MysticalBeeReturnedFromCompetition implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: MysticalBeeReturnedFromCompetitionFields,) {
        this.$fullTypeName = composeSuiType(MysticalBeeReturnedFromCompetition.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::MysticalBeeReturnedFromCompetition`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("MysticalBeeReturnedFromCompetition", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): MysticalBeeReturnedFromCompetition {
    ...
    static fromJSON(json: Record<string, any>): MysticalBeeReturnedFromCompetition {
        if (json.$typeName !== MysticalBeeReturnedFromCompetition.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): MysticalBeeReturnedFromCompetition {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isMysticalBeeReturnedFromCompetition(data.bcs.type)) { throw new Error(`object at is not a MysticalBeeReturnedFromCompetition object`); }

            return MysticalBeeReturnedFromCompetition.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return MysticalBeeReturnedFromCompetition.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<MysticalBeeReturnedFromCompetition> {
...
export class NectarStore implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: NectarStoreFields,) {
        this.$fullTypeName = composeSuiType(NectarStore.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::NectarStore`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): NectarStore {
    ...
    static fromJSON(json: Record<string, any>): NectarStore {
        if (json.$typeName !== NectarStore.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): NectarStore {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isNectarStore(data.bcs.type)) { throw new Error(`object at is not a NectarStore object`); }

            return NectarStore.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return NectarStore.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<NectarStore> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching NectarStore object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isNectarStore(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a NectarStore object`); }
...
export class NewEggIncubated implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: NewEggIncubatedFields,) {
        this.$fullTypeName = composeSuiType(NewEggIncubated.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::NewEggIncubated`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("NewEggIncubated", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): NewEggIncubated {
    ...
    static fromJSON(json: Record<string, any>): NewEggIncubated {
        if (json.$typeName !== NewEggIncubated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): NewEggIncubated {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isNewEggIncubated(data.bcs.type)) { throw new Error(`object at is not a NewEggIncubated object`); }

            return NewEggIncubated.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return NewEggIncubated.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<NewEggIncubated> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching NewEggIncubated object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isNewEggIncubated(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a NewEggIncubated object`); }
...
export class NewGameSession implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: NewGameSessionFields,) {
        this.$fullTypeName = composeSuiType(NewGameSession.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::NewGameSession`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("NewGameSession", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): NewGameSession {
    ...
    static fromJSON(json: Record<string, any>): NewGameSession {
        if (json.$typeName !== NewGameSession.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): NewGameSession {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isNewGameSession(data.bcs.type)) { throw new Error(`object at is not a NewGameSession object`); }

            return NewGameSession.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return NewGameSession.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<NewGameSession> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching NewGameSession object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isNewGameSession(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a NewGameSession object`); }
...
export class NewListing implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: NewListingFields,) {
        this.$fullTypeName = composeSuiType(NewListing.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::NewListing`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): NewListing {
    ...
    static fromJSON(json: Record<string, any>): NewListing {
        if (json.$typeName !== NewListing.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): NewListing {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isNewListing(data.bcs.type)) { throw new Error(`object at is not a NewListing object`); }

            return NewListing.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return NewListing.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<NewListing> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching NewListing object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isNewListing(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a NewListing object`); }
...
export class P2pGameSession implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: P2pGameSessionFields,) {
        this.$fullTypeName = composeSuiType(P2pGameSession.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::P2pGameSession`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("P2pGameSession", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): P2pGameSession {
    ...
    static fromJSON(json: Record<string, any>): P2pGameSession {
        if (json.$typeName !== P2pGameSession.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): P2pGameSession {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isP2pGameSession(data.bcs.type)) { throw new Error(`object at is not a P2pGameSession object`); }

            return P2pGameSession.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return P2pGameSession.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<P2pGameSession> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching P2pGameSession object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isP2pGameSession(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a P2pGameSession object`); }
...
export class PowersAddedToDragonBee implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: PowersAddedToDragonBeeFields,) {
        this.$fullTypeName = composeSuiType(PowersAddedToDragonBee.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::PowersAddedToDragonBee`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("PowersAddedToDragonBee", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): PowersAddedToDragonBee {
    ...
    static fromJSON(json: Record<string, any>): PowersAddedToDragonBee {
        if (json.$typeName !== PowersAddedToDragonBee.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): PowersAddedToDragonBee {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isPowersAddedToDragonBee(data.bcs.type)) { throw new Error(`object at is not a PowersAddedToDragonBee object`); }

            return PowersAddedToDragonBee.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return PowersAddedToDragonBee.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<PowersAddedToDragonBee> {
...
export class PricingUpdatedForBreeding implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: PricingUpdatedForBreedingFields,) {
        this.$fullTypeName = composeSuiType(PricingUpdatedForBreeding.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::PricingUpdatedForBreeding`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("PricingUpdatedForBreeding", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): PricingUpdatedForBreeding {
    ...
    static fromJSON(json: Record<string, any>): PricingUpdatedForBreeding {
        if (json.$typeName !== PricingUpdatedForBreeding.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): PricingUpdatedForBreeding {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isPricingUpdatedForBreeding(data.bcs.type)) { throw new Error(`object at is not a PricingUpdatedForBreeding object`); }

            return PricingUpdatedForBreeding.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return PricingUpdatedForBreeding.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export class QueenFamilyInfo implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: QueenFamilyInfoFields,) {
        this.$fullTypeName = composeSuiType(QueenFamilyInfo.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::QueenFamilyInfo`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("QueenFamilyInfo", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): QueenFamilyInfo {
    ...
    static fromJSON(json: Record<string, any>): QueenFamilyInfo {
        if (json.$typeName !== QueenFamilyInfo.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): QueenFamilyInfo {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isQueenFamilyInfo(data.bcs.type)) { throw new Error(`object at is not a QueenFamilyInfo object`); }

            return QueenFamilyInfo.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return QueenFamilyInfo.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<QueenFamilyInfo> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching QueenFamilyInfo object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isQueenFamilyInfo(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a QueenFamilyInfo object`); }
...
export class QuestRequest implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: QuestRequestFields,) {
        this.$fullTypeName = composeSuiType(QuestRequest.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::QuestRequest`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("QuestRequest", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): QuestRequest {
    ...
    static fromJSON(json: Record<string, any>): QuestRequest {
        if (json.$typeName !== QuestRequest.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): QuestRequest {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isQuestRequest(data.bcs.type)) { throw new Error(`object at is not a QuestRequest object`); }

            return QuestRequest.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return QuestRequest.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<QuestRequest> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching QuestRequest object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isQuestRequest(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a QuestRequest object`); }
...
export class QuestRequestDestroyed implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: QuestRequestDestroyedFields,) {
        this.$fullTypeName = composeSuiType(QuestRequestDestroyed.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::QuestRequestDestroyed`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("QuestRequestDestroyed", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): QuestRequestDestroyed {
    ...
    static fromJSON(json: Record<string, any>): QuestRequestDestroyed {
        if (json.$typeName !== QuestRequestDestroyed.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): QuestRequestDestroyed {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isQuestRequestDestroyed(data.bcs.type)) { throw new Error(`object at is not a QuestRequestDestroyed object`); }

            return QuestRequestDestroyed.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return QuestRequestDestroyed.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<QuestRequestDestroyed> {
...
export class QuestRequestExpired implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: QuestRequestExpiredFields,) {
        this.$fullTypeName = composeSuiType(QuestRequestExpired.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::QuestRequestExpired`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("QuestRequestExpired", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): QuestRequestExpired {
    ...
    static fromJSON(json: Record<string, any>): QuestRequestExpired {
        if (json.$typeName !== QuestRequestExpired.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): QuestRequestExpired {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isQuestRequestExpired(data.bcs.type)) { throw new Error(`object at is not a QuestRequestExpired object`); }

            return QuestRequestExpired.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return QuestRequestExpired.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<QuestRequestExpired> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching QuestRequestExpired object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isQuestRequestExpired(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a QuestRequestExpired object`); }
...
export class Royalty implements StructClass {
    ...
    private constructor(typeArgs: [], fields: RoyaltyFields,) {
        this.$fullTypeName = composeSuiType(Royalty.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::Royalty`; this.$typeArgs = typeArgs;
    ...
    static fromJSON(json: Record<string, any>): Royalty {
        if (json.$typeName !== Royalty.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): Royalty {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isRoyalty(data.bcs.type)) { throw new Error(`object at is not a Royalty object`); }

            return Royalty.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return Royalty.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<Royalty> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching Royalty object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isRoyalty(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a Royalty object`); }
...
export class RoyaltyProcessed implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: RoyaltyProcessedFields,) {
        this.$fullTypeName = composeSuiType(RoyaltyProcessed.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::RoyaltyProcessed`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("RoyaltyProcessed", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): RoyaltyProcessed {
    ...
    static fromJSON(json: Record<string, any>): RoyaltyProcessed {
        if (json.$typeName !== RoyaltyProcessed.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): RoyaltyProcessed {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isRoyaltyProcessed(data.bcs.type)) { throw new Error(`object at is not a RoyaltyProcessed object`); }

            return RoyaltyProcessed.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return RoyaltyProcessed.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<RoyaltyProcessed> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching RoyaltyProcessed object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isRoyaltyProcessed(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a RoyaltyProcessed object`); }
...
export class RoyaltyUpdated implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: RoyaltyUpdatedFields,) {
        this.$fullTypeName = composeSuiType(RoyaltyUpdated.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::RoyaltyUpdated`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("RoyaltyUpdated", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): RoyaltyUpdated {
    ...
    static fromJSON(json: Record<string, any>): RoyaltyUpdated {
        if (json.$typeName !== RoyaltyUpdated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): RoyaltyUpdated {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isRoyaltyUpdated(data.bcs.type)) { throw new Error(`object at is not a RoyaltyUpdated object`); }

            return RoyaltyUpdated.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return RoyaltyUpdated.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<RoyaltyUpdated> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching RoyaltyUpdated object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isRoyaltyUpdated(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a RoyaltyUpdated object`); }
...
export class SaleExecuted implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: SaleExecutedFields,) {
        this.$fullTypeName = composeSuiType(SaleExecuted.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::SaleExecuted`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("SaleExecuted", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): SaleExecuted {
    ...
    static fromJSON(json: Record<string, any>): SaleExecuted {
        if (json.$typeName !== SaleExecuted.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): SaleExecuted {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isSaleExecuted(data.bcs.type)) { throw new Error(`object at is not a SaleExecuted object`); }

            return SaleExecuted.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return SaleExecuted.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<SaleExecuted> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching SaleExecuted object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isSaleExecuted(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a SaleExecuted object`); }
...
export class StoreAddedToBee implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: StoreAddedToBeeFields,) {
        this.$fullTypeName = composeSuiType(StoreAddedToBee.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::StoreAddedToBee`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("StoreAddedToBee", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): StoreAddedToBee {
    ...
    static fromJSON(json: Record<string, any>): StoreAddedToBee {
        if (json.$typeName !== StoreAddedToBee.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): StoreAddedToBee {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isStoreAddedToBee(data.bcs.type)) { throw new Error(`object at is not a StoreAddedToBee object`); }

            return StoreAddedToBee.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return StoreAddedToBee.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<StoreAddedToBee> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching StoreAddedToBee object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isStoreAddedToBee(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a StoreAddedToBee object`); }
...
export class StoreRemovedFromBee implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: StoreRemovedFromBeeFields,) {
        this.$fullTypeName = composeSuiType(StoreRemovedFromBee.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::StoreRemovedFromBee`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("StoreRemovedFromBee", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): StoreRemovedFromBee {
    ...
    static fromJSON(json: Record<string, any>): StoreRemovedFromBee {
        if (json.$typeName !== StoreRemovedFromBee.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): StoreRemovedFromBee {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isStoreRemovedFromBee(data.bcs.type)) { throw new Error(`object at is not a StoreRemovedFromBee object`); }

            return StoreRemovedFromBee.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return StoreRemovedFromBee.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<StoreRemovedFromBee> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching StoreRemovedFromBee object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isStoreRemovedFromBee(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a StoreRemovedFromBee object`); }
...
export class SuiClaimedFromBeeHive implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: SuiClaimedFromBeeHiveFields,) {
        this.$fullTypeName = composeSuiType(SuiClaimedFromBeeHive.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::SuiClaimedFromBeeHive`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("SuiClaimedFromBeeHive", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): SuiClaimedFromBeeHive {
    ...
    static fromJSON(json: Record<string, any>): SuiClaimedFromBeeHive {
        if (json.$typeName !== SuiClaimedFromBeeHive.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): SuiClaimedFromBeeHive {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isSuiClaimedFromBeeHive(data.bcs.type)) { throw new Error(`object at is not a SuiClaimedFromBeeHive object`); }

            return SuiClaimedFromBeeHive.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return SuiClaimedFromBeeHive.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<SuiClaimedFromBeeHive> {
...
export class SuiNsNameExpired implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: SuiNsNameExpiredFields,) {
        this.$fullTypeName = composeSuiType(SuiNsNameExpired.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::SuiNsNameExpired`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("SuiNsNameExpired", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): SuiNsNameExpired {
    ...
    static fromJSON(json: Record<string, any>): SuiNsNameExpired {
        if (json.$typeName !== SuiNsNameExpired.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): SuiNsNameExpired {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isSuiNsNameExpired(data.bcs.type)) { throw new Error(`object at is not a SuiNsNameExpired object`); }

            return SuiNsNameExpired.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return SuiNsNameExpired.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<SuiNsNameExpired> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching SuiNsNameExpired object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isSuiNsNameExpired(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a SuiNsNameExpired object`); }
...
export class TrainerActiveForQuest implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: TrainerActiveForQuestFields,) {
        this.$fullTypeName = composeSuiType(TrainerActiveForQuest.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::TrainerActiveForQuest`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("TrainerActiveForQuest", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): TrainerActiveForQuest {
    ...
    static fromJSON(json: Record<string, any>): TrainerActiveForQuest {
        if (json.$typeName !== TrainerActiveForQuest.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): TrainerActiveForQuest {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isTrainerActiveForQuest(data.bcs.type)) { throw new Error(`object at is not a TrainerActiveForQuest object`); }

            return TrainerActiveForQuest.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return TrainerActiveForQuest.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<TrainerActiveForQuest> {
...
export class TrainerCanceledActiveQuest implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: TrainerCanceledActiveQuestFields,) {
        this.$fullTypeName = composeSuiType(TrainerCanceledActiveQuest.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::TrainerCanceledActiveQuest`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("TrainerCanceledActiveQuest", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): TrainerCanceledActiveQuest {
    ...
    static fromJSON(json: Record<string, any>): TrainerCanceledActiveQuest {
        if (json.$typeName !== TrainerCanceledActiveQuest.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): TrainerCanceledActiveQuest {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isTrainerCanceledActiveQuest(data.bcs.type)) { throw new Error(`object at is not a TrainerCanceledActiveQuest object`); }

            return TrainerCanceledActiveQuest.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return TrainerCanceledActiveQuest.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<TrainerCanceledActiveQuest> {
...
export class TrainerSession implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: TrainerSessionFields,) {
        this.$fullTypeName = composeSuiType(TrainerSession.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::TrainerSession`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("TrainerSession", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): TrainerSession {
    ...
    static fromJSON(json: Record<string, any>): TrainerSession {
        if (json.$typeName !== TrainerSession.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): TrainerSession {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isTrainerSession(data.bcs.type)) { throw new Error(`object at is not a TrainerSession object`); }

            return TrainerSession.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return TrainerSession.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<TrainerSession> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching TrainerSession object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isTrainerSession(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a TrainerSession object`); }
...
export class TransformationRequestProcessed implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: TransformationRequestProcessedFields,) {
        this.$fullTypeName = composeSuiType(TransformationRequestProcessed.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::TransformationRequestProcessed`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("TransformationRequestProcessed", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): TransformationRequestProcessed {
    ...
    static fromJSON(json: Record<string, any>): TransformationRequestProcessed {
        if (json.$typeName !== TransformationRequestProcessed.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): TransformationRequestProcessed {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isTransformationRequestProcessed(data.bcs.type)) { throw new Error(`object at is not a TransformationRequestProcessed object`); }

            return TransformationRequestProcessed.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return TransformationRequestProcessed.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<TransformationRequestProcessed> {
...
export class TwapUpdateCap implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: TwapUpdateCapFields,) {
        this.$fullTypeName = composeSuiType(TwapUpdateCap.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::TwapUpdateCap`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("TwapUpdateCap", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): TwapUpdateCap {
    ...
    static fromJSON(json: Record<string, any>): TwapUpdateCap {
        if (json.$typeName !== TwapUpdateCap.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): TwapUpdateCap {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isTwapUpdateCap(data.bcs.type)) { throw new Error(`object at is not a TwapUpdateCap object`); }

            return TwapUpdateCap.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return TwapUpdateCap.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<TwapUpdateCap> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching TwapUpdateCap object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isTwapUpdateCap(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a TwapUpdateCap object`); }
...
export class UpdatedStingerBeesEnergyHealth implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: UpdatedStingerBeesEnergyHealthFields,) {
        this.$fullTypeName = composeSuiType(UpdatedStingerBeesEnergyHealth.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::UpdatedStingerBeesEnergyHealth`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("UpdatedStingerBeesEnergyHealth", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): UpdatedStingerBeesEnergyHealth {
    ...
    static fromJSON(json: Record<string, any>): UpdatedStingerBeesEnergyHealth {
        if (json.$typeName !== UpdatedStingerBeesEnergyHealth.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): UpdatedStingerBeesEnergyHealth {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isUpdatedStingerBeesEnergyHealth(data.bcs.type)) { throw new Error(`object at is not a UpdatedStingerBeesEnergyHealth object`); }

            return UpdatedStingerBeesEnergyHealth.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return UpdatedStingerBeesEnergyHealth.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export class UserNameUpdated implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: UserNameUpdatedFields,) {
        this.$fullTypeName = composeSuiType(UserNameUpdated.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::UserNameUpdated`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("UserNameUpdated", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): UserNameUpdated {
    ...
    static fromJSON(json: Record<string, any>): UserNameUpdated {
        if (json.$typeName !== UserNameUpdated.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): UserNameUpdated {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isUserNameUpdated(data.bcs.type)) { throw new Error(`object at is not a UserNameUpdated object`); }

            return UserNameUpdated.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return UserNameUpdated.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<UserNameUpdated> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching UserNameUpdated object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isUserNameUpdated(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a UserNameUpdated object`); }
...
export class UserWhitelistedForGenesisMint implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: UserWhitelistedForGenesisMintFields,) {
        this.$fullTypeName = composeSuiType(UserWhitelistedForGenesisMint.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::UserWhitelistedForGenesisMint`; this.$typeArgs = typeArgs;
    ...
    static get bcs() {
        return bcs.struct("UserWhitelistedForGenesisMint", {
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): UserWhitelistedForGenesisMint {
    ...
    static fromJSON(json: Record<string, any>): UserWhitelistedForGenesisMint {
        if (json.$typeName !== UserWhitelistedForGenesisMint.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): UserWhitelistedForGenesisMint {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isUserWhitelistedForGenesisMint(data.bcs.type)) { throw new Error(`object at is not a UserWhitelistedForGenesisMint object`); }

            return UserWhitelistedForGenesisMint.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return UserWhitelistedForGenesisMint.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<UserWhitelistedForGenesisMint> {
...
export class YieldFarm implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [], fields: YieldFarmFields,) {
        this.$fullTypeName = composeSuiType(YieldFarm.$typeName, ...typeArgs) as `${typeof PKG_V1}::dragon_trainer::YieldFarm`; this.$typeArgs = typeArgs;
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): YieldFarm {
    ...
    static fromJSON(json: Record<string, any>): YieldFarm {
        if (json.$typeName !== YieldFarm.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): YieldFarm {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isYieldFarm(data.bcs.type)) { throw new Error(`object at is not a YieldFarm object`); }

            return YieldFarm.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return YieldFarm.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<YieldFarm> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching YieldFarm object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isYieldFarm(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a YieldFarm object`); }

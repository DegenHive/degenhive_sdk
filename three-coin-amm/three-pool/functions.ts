...
export interface SwapArgs { clock: TransactionObjectInput; pool: TransactionObjectInput; xIn: TransactionObjectInput; xOutMin: bigint | TransactionArgument; yIn: TransactionObjectInput; yOutMin: bigint | TransactionArgument; zIn: TransactionObjectInput; zOutMin: bigint | TransactionArgument; isGiveIn: boolean | TransactionArgument }

export function swap(tx: Transaction, typeArgs: [string, string, string, string], args: SwapArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::swap`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.pool), obj(tx, args.xIn), pure(tx, args.xOutMin, `u64`), obj(tx, args.yIn), pure(tx, args.yOutMin, `u64`), obj(tx, args.zIn), pure(tx, args.zOutMin, `u64`), pure(tx, args.isGiveIn, `bool`)], }) }
...
export interface AddLiquidityArgs { clock: TransactionObjectInput; pool: TransactionObjectInput; coinX: TransactionObjectInput; coinY: TransactionObjectInput; coinZ: TransactionObjectInput; minLpMinted: bigint | TransactionArgument }

export function addLiquidity(tx: Transaction, typeArgs: [string, string, string, string], args: AddLiquidityArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::add_liquidity`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.pool), obj(tx, args.coinX), obj(tx, args.coinY), obj(tx, args.coinZ), pure(tx, args.minLpMinted, `u64`)], }) }
...
export interface FlashloanArgs { clock: TransactionObjectInput; pool: TransactionObjectInput; xLoan: bigint | TransactionArgument; yLoan: bigint | TransactionArgument; zLoan: bigint | TransactionArgument }

export function flashloan(tx: Transaction, typeArgs: [string, string, string, string], args: FlashloanArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::flashloan`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.pool), pure(tx, args.xLoan, `u64`), pure(tx, args.yLoan, `u64`), pure(tx, args.zLoan, `u64`)], }) }
...
export function getDecimalForCoin(tx: Transaction, typeArg: string, yieldFlow: TransactionObjectInput) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::get_decimal_for_coin`, typeArguments: [typeArg], arguments: [obj(tx, yieldFlow)], }) }
...
export function getPoolId(tx: Transaction, typeArgs: [string, string, string, string], registry: TransactionObjectInput) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::get_pool_id`, typeArguments: typeArgs, arguments: [obj(tx, registry)], }) }

export function getPoolIdAsAddress(tx: Transaction, typeArgs: [string, string, string, string], registry: TransactionObjectInput) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::get_pool_id_as_address`, typeArguments: typeArgs, arguments: [obj(tx, registry)], }) }

export function getPoolRegistry(tx: Transaction, registry: TransactionObjectInput) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::get_pool_registry`, arguments: [obj(tx, registry)], }) }
...
export function getScalingFactor(tx: Transaction, typeArgs: [string, string, string, string], args: GetScalingFactorArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::get_scaling_factor`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.pool)], }) }
...
export function incrementPoolRegistry(tx: Transaction, registry: TransactionObjectInput) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::increment_pool_registry`, arguments: [obj(tx, registry)], }) }
...
export interface InternalAddLiquidityArgs { clock: TransactionObjectInput; pool: TransactionObjectInput; coinX: TransactionObjectInput; coinY: TransactionObjectInput; coinZ: TransactionObjectInput }

export function internalAddLiquidity(tx: Transaction, typeArgs: [string, string, string, string], args: InternalAddLiquidityArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::internal_add_liquidity`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.pool), obj(tx, args.coinX), obj(tx, args.coinY), obj(tx, args.coinZ)], }) }

export interface InternalRegisterPoolArgs { clock: TransactionObjectInput; yieldFlow: TransactionObjectInput; registry: TransactionObjectInput; suiBalance: TransactionObjectInput; feeCollector: TransactionObjectInput; decimalX: number | TransactionArgument; decimalY: number | TransactionArgument; decimalZ: number | TransactionArgument; initParams: Array<bigint | TransactionArgument> | TransactionArgument; initialPrices: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null); weights: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null) }

export function internalRegisterPool(tx: Transaction, typeArgs: [string, string, string, string], args: InternalRegisterPoolArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::internal_register_pool`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.yieldFlow), obj(tx, args.registry), obj(tx, args.suiBalance), obj(tx, args.feeCollector), pure(tx, args.decimalX, `u8`), pure(tx, args.decimalY, `u8`), pure(tx, args.decimalZ, `u8`), pure(tx, args.initParams, `vector<u64>`), pure(tx, args.initialPrices, `${Option.$typeName}<vector<u256>>`), pure(tx, args.weights, `${Option.$typeName}<vector<u64>>`)], }) }

export interface InternalRemoveLiquidityArgs { clock: TransactionObjectInput; pool: TransactionObjectInput; lpCoinsProvidedVal: bigint | TransactionArgument; coinXOutVal: bigint | TransactionArgument; coinYOutVal: bigint | TransactionArgument; coinZOutVal: bigint | TransactionArgument }

export function internalRemoveLiquidity(tx: Transaction, typeArgs: [string, string, string, string], args: InternalRemoveLiquidityArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::internal_remove_liquidity`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.pool), pure(tx, args.lpCoinsProvidedVal, `u64`), pure(tx, args.coinXOutVal, `u64`), pure(tx, args.coinYOutVal, `u64`), pure(tx, args.coinZOutVal, `u64`)], }) }

export function isPoolRegistered(tx: Transaction, typeArgs: [string, string, string, string], registry: TransactionObjectInput) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::is_pool_registered`, typeArguments: typeArgs, arguments: [obj(tx, registry)], }) }
...
export function queryAcrossAllPools(tx: Transaction, typeArgs: [string, string, string, string], args: QueryAcrossAllPoolsArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::query_across_all_pools`, typeArguments: typeArgs, arguments: [obj(tx, args.registry), pure(tx, args.limit, `u64`)], }) }

export function queryFirstPool(tx: Transaction, registry: TransactionObjectInput) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::query_first_pool`, arguments: [obj(tx, registry)], }) }

export interface QuerySwapArgs { clock: TransactionObjectInput; pool: TransactionObjectInput; xIn: bigint | TransactionArgument; xOutMin: bigint | TransactionArgument; yIn: bigint | TransactionArgument; yOutMin: bigint | TransactionArgument; zIn: bigint | TransactionArgument; zOutMin: bigint | TransactionArgument; isGiveIn: boolean | TransactionArgument }

export function querySwap(tx: Transaction, typeArgs: [string, string, string, string], args: QuerySwapArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::query_swap`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.pool), pure(tx, args.xIn, `u64`), pure(tx, args.xOutMin, `u64`), pure(tx, args.yIn, `u64`), pure(tx, args.yOutMin, `u64`), pure(tx, args.zIn, `u64`), pure(tx, args.zOutMin, `u64`), pure(tx, args.isGiveIn, `bool`)], }) }
...
export interface RegistryAddArgs { registry: TransactionObjectInput; yieldFlow: TransactionObjectInput; decimalX: number | TransactionArgument; decimalY: number | TransactionArgument; decimalZ: number | TransactionArgument; poolId: string | TransactionArgument }

export function registryAdd(tx: Transaction, typeArgs: [string, string, string, string], args: RegistryAddArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::registry_add`, typeArguments: typeArgs, arguments: [obj(tx, args.registry), obj(tx, args.yieldFlow), pure(tx, args.decimalX, `u8`), pure(tx, args.decimalY, `u8`), pure(tx, args.decimalZ, `u8`), pure(tx, args.poolId, `${ID.$typeName}`)], }) }

export interface RemoveLiquidityArgs { clock: TransactionObjectInput; pool: TransactionObjectInput; lpCoins: TransactionObjectInput; coinXOutVal: bigint | TransactionArgument; coinYOutVal: bigint | TransactionArgument; coinZOutVal: bigint | TransactionArgument; maxLpCoinsToBurn: bigint | TransactionArgument }

export function removeLiquidity(tx: Transaction, typeArgs: [string, string, string, string], args: RemoveLiquidityArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::remove_liquidity`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.pool), obj(tx, args.lpCoins), pure(tx, args.coinXOutVal, `u64`), pure(tx, args.coinYOutVal, `u64`), pure(tx, args.coinZOutVal, `u64`), pure(tx, args.maxLpCoinsToBurn, `u64`)], }) }
...
export function updateCumulativePrices(tx: Transaction, typeArgs: [string, string, string, string], args: UpdateCumulativePricesArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::update_cumulative_prices`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.pool)], }) }
...
export function updateKraftFee(tx: Transaction, args: UpdateKraftFeeArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::update_kraft_fee`, arguments: [obj(tx, args.registry), obj(tx, args.dragonDaoCap), pure(tx, args.kraftFee, `u64`)], }) }
...
export interface HandleSuiYZPoolFeeArgs { clock: TransactionObjectInput; yieldFlow: TransactionObjectInput; pool: TransactionObjectInput; yieldFarm: TransactionObjectInput; hivePool: TransactionObjectInput; honeyPool: TransactionObjectInput }

export function handleSuiYZPoolFee(tx: Transaction, typeArgs: [string, string, string], args: HandleSuiYZPoolFeeArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::handle_sui_y_z_pool_fee`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.yieldFlow), obj(tx, args.pool), obj(tx, args.yieldFarm), obj(tx, args.hivePool), obj(tx, args.honeyPool)], }) }

export interface HandleXSuiZPoolFeeArgs { clock: TransactionObjectInput; yieldFlow: TransactionObjectInput; pool: TransactionObjectInput; yieldFarm: TransactionObjectInput; hivePool: TransactionObjectInput; honeyPool: TransactionObjectInput }

export function handleXSuiZPoolFee(tx: Transaction, typeArgs: [string, string, string], args: HandleXSuiZPoolFeeArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::handle_x_sui_z_pool_fee`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.yieldFlow), obj(tx, args.pool), obj(tx, args.yieldFarm), obj(tx, args.hivePool), obj(tx, args.honeyPool)], }) }

export interface HandleXYSuiPoolFeeArgs { clock: TransactionObjectInput; yieldFlow: TransactionObjectInput; pool: TransactionObjectInput; yieldFarm: TransactionObjectInput; hivePool: TransactionObjectInput; honeyPool: TransactionObjectInput }

export function handleXYSuiPoolFee(tx: Transaction, typeArgs: [string, string, string], args: HandleXYSuiPoolFeeArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::handle_x_y_sui_pool_fee`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.yieldFlow), obj(tx, args.pool), obj(tx, args.yieldFarm), obj(tx, args.hivePool), obj(tx, args.honeyPool)], }) }

export interface HandleXYZPoolViaSuiXHopArgs { clock: TransactionObjectInput; yieldFlow: TransactionObjectInput; pool: TransactionObjectInput; suiXPool: TransactionObjectInput; yieldFarm: TransactionObjectInput; hivePool: TransactionObjectInput; honeyPool: TransactionObjectInput }

export function handleXYZPoolViaSuiXHop(tx: Transaction, typeArgs: [string, string, string, string, string], args: HandleXYZPoolViaSuiXHopArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::handle_x_y_z_pool_via_sui_x_hop`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.yieldFlow), obj(tx, args.pool), obj(tx, args.suiXPool), obj(tx, args.yieldFarm), obj(tx, args.hivePool), obj(tx, args.honeyPool)], }) }

export interface HandleXYZPoolViaSuiYHopArgs { clock: TransactionObjectInput; yieldFlow: TransactionObjectInput; pool: TransactionObjectInput; suiYPool: TransactionObjectInput; yieldFarm: TransactionObjectInput; hivePool: TransactionObjectInput; honeyPool: TransactionObjectInput }

export function handleXYZPoolViaSuiYHop(tx: Transaction, typeArgs: [string, string, string, string, string], args: HandleXYZPoolViaSuiYHopArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::handle_x_y_z_pool_via_sui_y_hop`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.yieldFlow), obj(tx, args.pool), obj(tx, args.suiYPool), obj(tx, args.yieldFarm), obj(tx, args.hivePool), obj(tx, args.honeyPool)], }) }

export interface HandleXYZPoolViaSuiZHopArgs { clock: TransactionObjectInput; yieldFlow: TransactionObjectInput; pool: TransactionObjectInput; suiZPool: TransactionObjectInput; yieldFarm: TransactionObjectInput; hivePool: TransactionObjectInput; honeyPool: TransactionObjectInput }

export function handleXYZPoolViaSuiZHop(tx: Transaction, typeArgs: [string, string, string, string, string], args: HandleXYZPoolViaSuiZHopArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::handle_x_y_z_pool_via_sui_z_hop`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.yieldFlow), obj(tx, args.pool), obj(tx, args.suiZPool), obj(tx, args.yieldFarm), obj(tx, args.hivePool), obj(tx, args.honeyPool)], }) }

export interface HandleXYZPoolViaXSuiHopArgs { clock: TransactionObjectInput; yieldFlow: TransactionObjectInput; pool: TransactionObjectInput; xSuiPool: TransactionObjectInput; yieldFarm: TransactionObjectInput; hivePool: TransactionObjectInput; honeyPool: TransactionObjectInput }

export function handleXYZPoolViaXSuiHop(tx: Transaction, typeArgs: [string, string, string, string, string], args: HandleXYZPoolViaXSuiHopArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::handle_x_y_z_pool_via_x_sui_hop`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.yieldFlow), obj(tx, args.pool), obj(tx, args.xSuiPool), obj(tx, args.yieldFarm), obj(tx, args.hivePool), obj(tx, args.honeyPool)], }) }

export interface HandleXYZPoolViaYSuiHopArgs { clock: TransactionObjectInput; yieldFlow: TransactionObjectInput; pool: TransactionObjectInput; ySuiPool: TransactionObjectInput; yieldFarm: TransactionObjectInput; hivePool: TransactionObjectInput; honeyPool: TransactionObjectInput }

export function handleXYZPoolViaYSuiHop(tx: Transaction, typeArgs: [string, string, string, string, string], args: HandleXYZPoolViaYSuiHopArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::handle_x_y_z_pool_via_y_sui_hop`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.yieldFlow), obj(tx, args.pool), obj(tx, args.ySuiPool), obj(tx, args.yieldFarm), obj(tx, args.hivePool), obj(tx, args.honeyPool)], }) }

export interface HandleXYZPoolViaZSuiHopArgs { clock: TransactionObjectInput; yieldFlow: TransactionObjectInput; pool: TransactionObjectInput; zSuiPool: TransactionObjectInput; yieldFarm: TransactionObjectInput; hivePool: TransactionObjectInput; honeyPool: TransactionObjectInput }

export function handleXYZPoolViaZSuiHop(tx: Transaction, typeArgs: [string, string, string, string, string], args: HandleXYZPoolViaZSuiHopArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::handle_x_y_z_pool_via_z_sui_hop`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.yieldFlow), obj(tx, args.pool), obj(tx, args.zSuiPool), obj(tx, args.yieldFarm), obj(tx, args.hivePool), obj(tx, args.honeyPool)], }) }

export interface RegisterPoolAllCoinMetadataAvailableArgs { clock: TransactionObjectInput; yieldFlow: TransactionObjectInput; registry: TransactionObjectInput; suiBalance: TransactionObjectInput; feeCollector: TransactionObjectInput; metadataX: TransactionObjectInput; metadataY: TransactionObjectInput; metadataZ: TransactionObjectInput; initParams: Array<bigint | TransactionArgument> | TransactionArgument; initialPrices: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null); weights: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null) }

export function registerPoolAllCoinMetadataAvailable(tx: Transaction, typeArgs: [string, string, string, string], args: RegisterPoolAllCoinMetadataAvailableArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::register_pool_all_coin_metadata_available`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.yieldFlow), obj(tx, args.registry), obj(tx, args.suiBalance), obj(tx, args.feeCollector), obj(tx, args.metadataX), obj(tx, args.metadataY), obj(tx, args.metadataZ), pure(tx, args.initParams, `vector<u64>`), pure(tx, args.initialPrices, `${Option.$typeName}<vector<u256>>`), pure(tx, args.weights, `${Option.$typeName}<vector<u64>>`)], }) }

export interface RegisterPoolXYMetadataAvailableArgs { clock: TransactionObjectInput; yieldFlow: TransactionObjectInput; registry: TransactionObjectInput; suiBalance: TransactionObjectInput; feeCollector: TransactionObjectInput; metadataX: TransactionObjectInput; metadataY: TransactionObjectInput; initParams: Array<bigint | TransactionArgument> | TransactionArgument; initialPrices: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null); weights: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null) }
...
export function registerPoolXZMetadataAvailable(tx: Transaction, typeArgs: [string, string, string, string], args: RegisterPoolXZMetadataAvailableArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::register_pool_x_z_metadata_available`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.yieldFlow), obj(tx, args.registry), obj(tx, args.suiBalance), obj(tx, args.feeCollector), obj(tx, args.metadataX), obj(tx, args.metadataZ), pure(tx, args.initParams, `vector<u64>`), pure(tx, args.initialPrices, `${Option.$typeName}<vector<u256>>`), pure(tx, args.weights, `${Option.$typeName}<vector<u64>>`)], }) }

export interface RegisterPoolYZMetadataAvailableArgs { clock: TransactionObjectInput; yieldFlow: TransactionObjectInput; registry: TransactionObjectInput; suiBalance: TransactionObjectInput; feeCollector: TransactionObjectInput; metadataY: TransactionObjectInput; metadataZ: TransactionObjectInput; initParams: Array<bigint | TransactionArgument> | TransactionArgument; initialPrices: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null); weights: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null) }

export function registerPoolYZMetadataAvailable(tx: Transaction, typeArgs: [string, string, string, string], args: RegisterPoolYZMetadataAvailableArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::register_pool_y_z_metadata_available`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.yieldFlow), obj(tx, args.registry), obj(tx, args.suiBalance), obj(tx, args.feeCollector), obj(tx, args.metadataY), obj(tx, args.metadataZ), pure(tx, args.initParams, `vector<u64>`), pure(tx, args.initialPrices, `${Option.$typeName}<vector<u256>>`), pure(tx, args.weights, `${Option.$typeName}<vector<u64>>`)], }) }

export interface RegisterPoolZMetadataAvailableArgs { clock: TransactionObjectInput; yieldFlow: TransactionObjectInput; registry: TransactionObjectInput; suiBalance: TransactionObjectInput; feeCollector: TransactionObjectInput; metadataZ: TransactionObjectInput; initParams: Array<bigint | TransactionArgument> | TransactionArgument; initialPrices: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null); weights: (Array<bigint | TransactionArgument> | TransactionArgument | TransactionArgument | null) }

export function registerPoolZMetadataAvailable(tx: Transaction, typeArgs: [string, string, string, string], args: RegisterPoolZMetadataAvailableArgs) { return tx.moveCall({ target: `${PUBLISHED_AT}::three_pool::register_pool_z_metadata_available`, typeArguments: typeArgs, arguments: [obj(tx, args.clock), obj(tx, args.yieldFlow), obj(tx, args.registry), obj(tx, args.suiBalance), obj(tx, args.feeCollector), obj(tx, args.metadataZ), pure(tx, args.initParams, `vector<u64>`), pure(tx, args.initialPrices, `${Option.$typeName}<vector<u256>>`), pure(tx, args.weights, `${Option.$typeName}<vector<u64>>`)], }) }

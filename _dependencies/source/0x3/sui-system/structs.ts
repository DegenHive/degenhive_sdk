...
export function isSuiSystemState(type: string): boolean { type = compressSuiType(type); return type === "0x3::sui_system::SuiSystemState"; }
...
export class SuiSystemState implements StructClass { static readonly $typeName = "0x3::sui_system::SuiSystemState"; static readonly $numTypeParams = 0;
 ...
 private constructor(typeArgs: [], fields: SuiSystemStateFields, ) { this.$fullTypeName = composeSuiType( SuiSystemState.$typeName, ...typeArgs ) as "0x3::sui_system::SuiSystemState"; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.version = fields.version; }

 static reified( ): SuiSystemStateReified { return { typeName: SuiSystemState.$typeName, fullTypeName: composeSuiType( SuiSystemState.$typeName, ...[] ) as "0x3::sui_system::SuiSystemState", typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => SuiSystemState.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => SuiSystemState.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => SuiSystemState.fromBcs( data, ), bcs: SuiSystemState.bcs, fromJSONField: (field: any) => SuiSystemState.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => SuiSystemState.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => SuiSystemState.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => SuiSystemState.fetch( client, id, ), new: ( fields: SuiSystemStateFields, ) => { return new SuiSystemState( [], fields ) }, kind: "StructClassReified", } }

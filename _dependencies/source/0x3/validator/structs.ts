...
export function isConvertingToFungibleStakedSuiEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V17}::validator::ConvertingToFungibleStakedSuiEvent`; }
...
export class ConvertingToFungibleStakedSuiEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V17}::validator::ConvertingToFungibleStakedSuiEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

    readonly $typeName = ConvertingToFungibleStakedSuiEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V17}::validator::ConvertingToFungibleStakedSuiEvent`; readonly $typeArgs: []; readonly $isPhantom = ConvertingToFungibleStakedSuiEvent.$isPhantom;
    ...
    private constructor(typeArgs: [], fields: ConvertingToFungibleStakedSuiEventFields,) {
        this.$fullTypeName = composeSuiType(ConvertingToFungibleStakedSuiEvent.$typeName, ...typeArgs) as `${typeof PKG_V17}::validator::ConvertingToFungibleStakedSuiEvent`; this.$typeArgs = typeArgs;
    ...
    static fromJSON(json: Record<string, any>): ConvertingToFungibleStakedSuiEvent {
        if (json.$typeName !== ConvertingToFungibleStakedSuiEvent.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): ConvertingToFungibleStakedSuiEvent {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isConvertingToFungibleStakedSuiEvent(data.bcs.type)) { throw new Error(`object at is not a ConvertingToFungibleStakedSuiEvent object`); }

            return ConvertingToFungibleStakedSuiEvent.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ConvertingToFungibleStakedSuiEvent.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export function isRedeemingFungibleStakedSuiEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V17}::validator::RedeemingFungibleStakedSuiEvent`; }
...
export class RedeemingFungibleStakedSuiEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V17}::validator::RedeemingFungibleStakedSuiEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

    readonly $typeName = RedeemingFungibleStakedSuiEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V17}::validator::RedeemingFungibleStakedSuiEvent`; readonly $typeArgs: []; readonly $isPhantom = RedeemingFungibleStakedSuiEvent.$isPhantom;
    ...
    static fromJSON(json: Record<string, any>): RedeemingFungibleStakedSuiEvent {
        if (json.$typeName !== RedeemingFungibleStakedSuiEvent.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): RedeemingFungibleStakedSuiEvent {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isRedeemingFungibleStakedSuiEvent(data.bcs.type)) { throw new Error(`object at is not a RedeemingFungibleStakedSuiEvent object`); }

            return RedeemingFungibleStakedSuiEvent.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return RedeemingFungibleStakedSuiEvent.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export function isStakingRequestEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V17}::validator::StakingRequestEvent`; }
...
export class StakingRequestEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V17}::validator::StakingRequestEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

    readonly $typeName = StakingRequestEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V17}::validator::StakingRequestEvent`; readonly $typeArgs: []; readonly $isPhantom = StakingRequestEvent.$isPhantom;
    ...
    private constructor(typeArgs: [], fields: StakingRequestEventFields,) {
        this.$fullTypeName = composeSuiType(StakingRequestEvent.$typeName, ...typeArgs) as `${typeof PKG_V17}::validator::StakingRequestEvent`; this.$typeArgs = typeArgs;
    ...
    static fromJSON(json: Record<string, any>): StakingRequestEvent {
        if (json.$typeName !== StakingRequestEvent.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): StakingRequestEvent {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isStakingRequestEvent(data.bcs.type)) { throw new Error(`object at is not a StakingRequestEvent object`); }

            return StakingRequestEvent.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return StakingRequestEvent.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<StakingRequestEvent> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching StakingRequestEvent object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isStakingRequestEvent(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a StakingRequestEvent object`); }
...
export function isUnstakingRequestEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V17}::validator::UnstakingRequestEvent`; }
...
export class UnstakingRequestEvent implements StructClass {
    ...
    static readonly $typeName = `${PKG_V17}::validator::UnstakingRequestEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

    readonly $typeName = UnstakingRequestEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V17}::validator::UnstakingRequestEvent`; readonly $typeArgs: []; readonly $isPhantom = UnstakingRequestEvent.$isPhantom;
    ...
    private constructor(typeArgs: [], fields: UnstakingRequestEventFields,) {
        this.$fullTypeName = composeSuiType(UnstakingRequestEvent.$typeName, ...typeArgs) as `${typeof PKG_V17}::validator::UnstakingRequestEvent`; this.$typeArgs = typeArgs;
    ...
    static fromJSON(json: Record<string, any>): UnstakingRequestEvent {
        if (json.$typeName !== UnstakingRequestEvent.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): UnstakingRequestEvent {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isUnstakingRequestEvent(data.bcs.type)) { throw new Error(`object at is not a UnstakingRequestEvent object`); }

            return UnstakingRequestEvent.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return UnstakingRequestEvent.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export function isValidator(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V17}::validator::Validator`; }
...
export class Validator implements StructClass {
    ...
    static readonly $typeName = `${PKG_V17}::validator::Validator`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

    readonly $typeName = Validator.$typeName; readonly $fullTypeName: `${typeof PKG_V17}::validator::Validator`; readonly $typeArgs: []; readonly $isPhantom = Validator.$isPhantom;
    ...
    private constructor(typeArgs: [], fields: ValidatorFields,) {
        this.$fullTypeName = composeSuiType(Validator.$typeName, ...typeArgs) as `${typeof PKG_V17}::validator::Validator`; this.$typeArgs = typeArgs;
    ...
    static fromJSON(json: Record<string, any>): Validator {
        if (json.$typeName !== Validator.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): Validator {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isValidator(data.bcs.type)) { throw new Error(`object at is not a Validator object`); }

            return Validator.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return Validator.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<Validator> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching Validator object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isValidator(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a Validator object`); }
...
export function isValidatorMetadata(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V17}::validator::ValidatorMetadata`; }
...
export class ValidatorMetadata implements StructClass {
    ...
    static readonly $typeName = `${PKG_V17}::validator::ValidatorMetadata`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

    readonly $typeName = ValidatorMetadata.$typeName; readonly $fullTypeName: `${typeof PKG_V17}::validator::ValidatorMetadata`; readonly $typeArgs: []; readonly $isPhantom = ValidatorMetadata.$isPhantom;
    ...
    private constructor(typeArgs: [], fields: ValidatorMetadataFields,) {
        this.$fullTypeName = composeSuiType(ValidatorMetadata.$typeName, ...typeArgs) as `${typeof PKG_V17}::validator::ValidatorMetadata`; this.$typeArgs = typeArgs;
    ...
    static reified(): ValidatorMetadataReified { return { typeName: ValidatorMetadata.$typeName, fullTypeName: composeSuiType(ValidatorMetadata.$typeName, ...[]) as `${typeof PKG_V17}::validator::ValidatorMetadata`, typeArgs: [] as [], isPhantom: ValidatorMetadata.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => ValidatorMetadata.fromFields(fields,), fromFieldsWithTypes: (item: FieldsWithTypes) => ValidatorMetadata.fromFieldsWithTypes(item,), fromBcs: (data: Uint8Array) => ValidatorMetadata.fromBcs(data,), bcs: ValidatorMetadata.bcs, fromJSONField: (field: any) => ValidatorMetadata.fromJSONField(field,), fromJSON: (json: Record<string, any>) => ValidatorMetadata.fromJSON(json,), fromSuiParsedData: (content: SuiParsedData) => ValidatorMetadata.fromSuiParsedData(content,), fromSuiObjectData: (content: SuiObjectData) => ValidatorMetadata.fromSuiObjectData(content,), fetch: async (client: SuiClient, id: string) => ValidatorMetadata.fetch(client, id,), new: (fields: ValidatorMetadataFields,) => { return new ValidatorMetadata([], fields) }, kind: "StructClassReified", } }
    ...
    static fromJSON(json: Record<string, any>): ValidatorMetadata {
        if (json.$typeName !== ValidatorMetadata.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): ValidatorMetadata {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isValidatorMetadata(data.bcs.type)) { throw new Error(`object at is not a ValidatorMetadata object`); }

            return ValidatorMetadata.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return ValidatorMetadata.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<ValidatorMetadata> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ValidatorMetadata object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isValidatorMetadata(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ValidatorMetadata object`); }

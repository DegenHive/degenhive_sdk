...
export class FungibleStakedSui implements StructClass {
    ...
    private constructor(typeArgs: [], fields: FungibleStakedSuiFields,) {
        this.$fullTypeName = composeSuiType(FungibleStakedSui.$typeName, ...typeArgs) as `${typeof PKG_V17}::staking_pool::FungibleStakedSui`; this.$typeArgs = typeArgs;
    ...
    static fromJSON(json: Record<string, any>): FungibleStakedSui {
        if (json.$typeName !== FungibleStakedSui.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): FungibleStakedSui {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isFungibleStakedSui(data.bcs.type)) { throw new Error(`object at is not a FungibleStakedSui object`); }

            return FungibleStakedSui.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return FungibleStakedSui.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<FungibleStakedSui> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching FungibleStakedSui object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isFungibleStakedSui(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a FungibleStakedSui object`); }
...
export class FungibleStakedSuiData implements StructClass {
    ...
    private constructor(typeArgs: [], fields: FungibleStakedSuiDataFields,) {
        this.$fullTypeName = composeSuiType(FungibleStakedSuiData.$typeName, ...typeArgs) as `${typeof PKG_V17}::staking_pool::FungibleStakedSuiData`; this.$typeArgs = typeArgs;
    ...
    static fromJSON(json: Record<string, any>): FungibleStakedSuiData {
        if (json.$typeName !== FungibleStakedSuiData.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): FungibleStakedSuiData {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isFungibleStakedSuiData(data.bcs.type)) { throw new Error(`object at is not a FungibleStakedSuiData object`); }

            return FungibleStakedSuiData.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return FungibleStakedSuiData.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export class FungibleStakedSuiDataKey implements StructClass {
    ...
    private constructor(typeArgs: [], fields: FungibleStakedSuiDataKeyFields,) {
        this.$fullTypeName = composeSuiType(FungibleStakedSuiDataKey.$typeName, ...typeArgs) as `${typeof PKG_V17}::staking_pool::FungibleStakedSuiDataKey`; this.$typeArgs = typeArgs;
    ...
    static fromJSON(json: Record<string, any>): FungibleStakedSuiDataKey {
        if (json.$typeName !== FungibleStakedSuiDataKey.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): FungibleStakedSuiDataKey {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isFungibleStakedSuiDataKey(data.bcs.type)) { throw new Error(`object at is not a FungibleStakedSuiDataKey object`); }

            return FungibleStakedSuiDataKey.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return FungibleStakedSuiDataKey.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export class PoolTokenExchangeRate implements StructClass {
    ...
    static readonly $typeName = `${PKG_V17}::staking_pool::PoolTokenExchangeRate`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

    readonly $typeName = PoolTokenExchangeRate.$typeName; readonly $fullTypeName: `${typeof PKG_V17}::staking_pool::PoolTokenExchangeRate`; readonly $typeArgs: []; readonly $isPhantom = PoolTokenExchangeRate.$isPhantom;
    ...
    static fromJSON(json: Record<string, any>): PoolTokenExchangeRate {
        if (json.$typeName !== PoolTokenExchangeRate.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): PoolTokenExchangeRate {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isPoolTokenExchangeRate(data.bcs.type)) { throw new Error(`object at is not a PoolTokenExchangeRate object`); }

            return PoolTokenExchangeRate.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return PoolTokenExchangeRate.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
...
export function isStakedSui(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V17}::staking_pool::StakedSui`; }
...
export class StakedSui implements StructClass {
    ...
    static readonly $typeName = `${PKG_V17}::staking_pool::StakedSui`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

    readonly $typeName = StakedSui.$typeName; readonly $fullTypeName: `${typeof PKG_V17}::staking_pool::StakedSui`; readonly $typeArgs: []; readonly $isPhantom = StakedSui.$isPhantom;
    ...
    private constructor(typeArgs: [], fields: StakedSuiFields,) {
        this.$fullTypeName = composeSuiType(StakedSui.$typeName, ...typeArgs) as `${typeof PKG_V17}::staking_pool::StakedSui`; this.$typeArgs = typeArgs;
    ...
    static fromJSON(json: Record<string, any>): StakedSui {
        if (json.$typeName !== StakedSui.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): StakedSui {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isStakedSui(data.bcs.type)) { throw new Error(`object at is not a StakedSui object`); }

            return StakedSui.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return StakedSui.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<StakedSui> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching StakedSui object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isStakedSui(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a StakedSui object`); }
...
export function isStakingPool(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V17}::staking_pool::StakingPool`; }
...
export class StakingPool implements StructClass {
    ...
    static readonly $typeName = `${PKG_V17}::staking_pool::StakingPool`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

    readonly $typeName = StakingPool.$typeName; readonly $fullTypeName: `${typeof PKG_V17}::staking_pool::StakingPool`; readonly $typeArgs: []; readonly $isPhantom = StakingPool.$isPhantom;
    ...
    private constructor(typeArgs: [], fields: StakingPoolFields,) {
        this.$fullTypeName = composeSuiType(StakingPool.$typeName, ...typeArgs) as `${typeof PKG_V17}::staking_pool::StakingPool`; this.$typeArgs = typeArgs;
    ...
    static fromJSON(json: Record<string, any>): StakingPool {
        if (json.$typeName !== StakingPool.$typeName) { throw new Error("not a WithTwoGenerics json object") };
    ...
    static fromSuiObjectData(data: SuiObjectData): StakingPool {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isStakingPool(data.bcs.type)) { throw new Error(`object at is not a StakingPool object`); }

            return StakingPool.fromBcs(fromB64(data.bcs.bcsBytes));
        } if (data.content) { return StakingPool.fromSuiParsedData(data.content) } throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }

    static async fetch(client: SuiClient, id: string): Promise<StakingPool> {
        const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching StakingPool object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isStakingPool(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a StakingPool object`); }

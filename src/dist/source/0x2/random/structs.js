...
/* ============================== Random =============================== */
function isRandom(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V28}::random::Random`; }
class Random {
    ...
    static fromSuiObjectData(data) {
        if (data.bcs) {
            ...
            return Random.fromBcs((0, bcs_1.fromB64)(data.bcs.bcsBytes));
        }
        if (data.content) {
...
Random.$typeName = `${index_1.PKG_V28}::random::Random`;
Random.$numTypeParams = 0;
Random.$isPhantom = [];
/* ============================== RandomGenerator =============================== */
function isRandomGenerator(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V28}::random::RandomGenerator`; }
class RandomGenerator {
    ...
    static reified() { return { typeName: RandomGenerator.$typeName, fullTypeName: (0, util_1.composeSuiType)(RandomGenerator.$typeName, ...[]), typeArgs: [], isPhantom: RandomGenerator.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => RandomGenerator.fromFields(fields), fromFieldsWithTypes: (item) => RandomGenerator.fromFieldsWithTypes(item), fromBcs: (data) => RandomGenerator.fromBcs(data), bcs: RandomGenerator.bcs, fromJSONField: (field) => RandomGenerator.fromJSONField(field), fromJSON: (json) => RandomGenerator.fromJSON(json), fromSuiParsedData: (content) => RandomGenerator.fromSuiParsedData(content), fromSuiObjectData: (content) => RandomGenerator.fromSuiObjectData(content), fetch: async (client, id) => RandomGenerator.fetch(client, id), new: (fields) => { return new RandomGenerator([], fields); }, kind: "StructClassReified", }; }
    ...
    static fromSuiObjectData(data) {
        if (data.bcs) {
            ...
            return RandomGenerator.fromBcs((0, bcs_1.fromB64)(data.bcs.bcsBytes));
        }
        if (data.content) {
...
RandomGenerator.$typeName = `${index_1.PKG_V28}::random::RandomGenerator`;
RandomGenerator.$numTypeParams = 0;
RandomGenerator.$isPhantom = [];
/* ============================== RandomInner =============================== */
function isRandomInner(type) { type = (0, util_1.compressSuiType)(type); return type === `${index_1.PKG_V28}::random::RandomInner`; }
class RandomInner {
    constructor(typeArgs, fields) {
        this.__StructClass = true;
    ...
    static reified() { return { typeName: RandomInner.$typeName, fullTypeName: (0, util_1.composeSuiType)(RandomInner.$typeName, ...[]), typeArgs: [], isPhantom: RandomInner.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => RandomInner.fromFields(fields), fromFieldsWithTypes: (item) => RandomInner.fromFieldsWithTypes(item), fromBcs: (data) => RandomInner.fromBcs(data), bcs: RandomInner.bcs, fromJSONField: (field) => RandomInner.fromJSONField(field), fromJSON: (json) => RandomInner.fromJSON(json), fromSuiParsedData: (content) => RandomInner.fromSuiParsedData(content), fromSuiObjectData: (content) => RandomInner.fromSuiObjectData(content), fetch: async (client, id) => RandomInner.fetch(client, id), new: (fields) => { return new RandomInner([], fields); }, kind: "StructClassReified", }; }
    ...
    static fromSuiObjectData(data) {
        if (data.bcs) {
            ...
            return RandomInner.fromBcs((0, bcs_1.fromB64)(data.bcs.bcsBytes));
        }
        if (data.content) {
...
RandomInner.$typeName = `${index_1.PKG_V28}::random::RandomInner`;

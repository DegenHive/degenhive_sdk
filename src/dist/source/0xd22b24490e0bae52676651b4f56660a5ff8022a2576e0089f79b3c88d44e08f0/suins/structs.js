...
exports.SuiNS = exports.SUINS = exports.RegistryKey = exports.AppKey = exports.AdminCap = exports.ConfigKey = void 0;
...
class ConfigKey {
    ...
    static fromSuiObjectData(typeArg, data) {
        if (data.bcs) {
            ...
            ;
            return ConfigKey.fromBcs(typeArg, (0, bcs_1.fromB64)(data.bcs.bcsBytes));
        }
        if (data.content) {
            return ConfigKey.fromSuiParsedData(typeArg, data.content);
        }
...
class AdminCap {
    ...
    static fromSuiObjectData(data) {
        if (data.bcs) {
            ...
            return AdminCap.fromBcs((0, bcs_1.fromB64)(data.bcs.bcsBytes));
        }
        if (data.content) {
...
class AppKey {
    ...
    static fromSuiObjectData(typeArg, data) {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isAppKey(data.bcs.type)) {
                throw new Error(`object at is not a AppKey object`);
            }
            const gotTypeArgs = (0, util_1.parseTypeName)(data.bcs.type).typeArgs;
            if (gotTypeArgs.length !== 1) {
                throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`);
            ...
            ;
            return AppKey.fromBcs(typeArg, (0, bcs_1.fromB64)(data.bcs.bcsBytes));
        }
        if (data.content) {
            return AppKey.fromSuiParsedData(typeArg, data.content);
        }
        throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
    static async fetch(client, typeArg, id) {
...
class RegistryKey {
    ...
    static fromSuiObjectData(typeArg, data) {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isRegistryKey(data.bcs.type)) {
                throw new Error(`object at is not a RegistryKey object`);
            }
            const gotTypeArgs = (0, util_1.parseTypeName)(data.bcs.type).typeArgs;
            if (gotTypeArgs.length !== 1) {
                throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`);
            ...
            ;
            return RegistryKey.fromBcs(typeArg, (0, bcs_1.fromB64)(data.bcs.bcsBytes));
        }
        if (data.content) {
            return RegistryKey.fromSuiParsedData(typeArg, data.content);
        }
        throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
    static async fetch(client, typeArg, id) {
...
class SUINS {
    ...
    static reified() { return { typeName: SUINS.$typeName, fullTypeName: (0, util_1.composeSuiType)(SUINS.$typeName, ...[]), typeArgs: [], isPhantom: SUINS.$isPhantom, reifiedTypeArgs: [], fromFields: (fields) => SUINS.fromFields(fields), fromFieldsWithTypes: (item) => SUINS.fromFieldsWithTypes(item), fromBcs: (data) => SUINS.fromBcs(data), bcs: SUINS.bcs, fromJSONField: (field) => SUINS.fromJSONField(field), fromJSON: (json) => SUINS.fromJSON(json), fromSuiParsedData: (content) => SUINS.fromSuiParsedData(content), fromSuiObjectData: (content) => SUINS.fromSuiObjectData(content), fetch: async (client, id) => SUINS.fetch(client, id), new: (fields) => { return new SUINS([], fields); }, kind: "StructClassReified", }; }
    ...
    static fromSuiObjectData(data) {
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isSUINS(data.bcs.type)) {
                throw new Error(`object at is not a SUINS object`);
            }
            return SUINS.fromBcs((0, bcs_1.fromB64)(data.bcs.bcsBytes));
        }
        if (data.content) {
            return SUINS.fromSuiParsedData(data.content);
        }
        throw new Error("Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.");
    }
    static async fetch(client, id) {
